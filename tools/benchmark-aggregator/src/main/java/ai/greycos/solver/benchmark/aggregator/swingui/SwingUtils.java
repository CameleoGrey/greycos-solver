...
import static ai.greycos.solver.benchmark.aggregator.swingui.TangoColorFactory.ALUMINIUM_1;
import static ai.greycos.solver.benchmark.aggregator.swingui.TangoColorFactory.ALUMINIUM_2;
import static ai.greycos.solver.benchmark.aggregator.swingui.TangoColorFactory.ALUMINIUM_3;
import static ai.greycos.solver.benchmark.aggregator.swingui.TangoColorFactory.ALUMINIUM_4;
import static ai.greycos.solver.benchmark.aggregator.swingui.TangoColorFactory.ALUMINIUM_6;
import static ai.greycos.solver.benchmark.aggregator.swingui.TangoColorFactory.BUTTER_1;
import static ai.greycos.solver.benchmark.aggregator.swingui.TangoColorFactory.BUTTER_2;
import static ai.greycos.solver.benchmark.aggregator.swingui.TangoColorFactory.CHAMELEON_1;
import static ai.greycos.solver.benchmark.aggregator.swingui.TangoColorFactory.ORANGE_2;
import static ai.greycos.solver.benchmark.aggregator.swingui.TangoColorFactory.SCARLET_2;
import static ai.greycos.solver.benchmark.aggregator.swingui.TangoColorFactory.SKY_BLUE_1;
import static ai.greycos.solver.benchmark.aggregator.swingui.TangoColorFactory.SKY_BLUE_2;
import static ai.greycos.solver.benchmark.aggregator.swingui.TangoColorFactory.SKY_BLUE_3;
...
public class SwingUtils {
  ...
  protected static void configureLookAndFeel(String lookAndFeelName) {
    ...
    if (lookAndFeelException != null) {
      LOGGER.warn(
          "Could not switch to lookAndFeel ({}). Layout might be incorrect.",
          lookAndFeelName,
