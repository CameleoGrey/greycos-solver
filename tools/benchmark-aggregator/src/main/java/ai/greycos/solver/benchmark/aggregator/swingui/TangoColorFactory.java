...
public class TangoColorFactory {
  ...
  public static final List<Color> SEQUENCE_1 =
      unmodifiableList(
          asList(
              TangoColorFactory.CHAMELEON_1,
              TangoColorFactory.BUTTER_1,
              TangoColorFactory.SKY_BLUE_1,
              TangoColorFactory.CHOCOLATE_1,
              TangoColorFactory.PLUM_1));
  public static final List<Color> SEQUENCE_2 =
      unmodifiableList(
          asList(
              TangoColorFactory.CHAMELEON_2,
              TangoColorFactory.BUTTER_2,
              TangoColorFactory.SKY_BLUE_2,
              TangoColorFactory.CHOCOLATE_2,
              TangoColorFactory.PLUM_2));
  public static final List<Color> SEQUENCE_3 =
      unmodifiableList(
          asList(
              TangoColorFactory.CHAMELEON_3,
              TangoColorFactory.BUTTER_3,
              TangoColorFactory.SKY_BLUE_3,
              TangoColorFactory.CHOCOLATE_3,
  ...
  public static Color buildPercentageColor(
      Color floorColor, Color ceilColor, double shadePercentage) {
    return new Color(
        floorColor.getRed() + (int) (shadePercentage * (ceilColor.getRed() - floorColor.getRed())),
        floorColor.getGreen()
            + (int) (shadePercentage * (ceilColor.getGreen() - floorColor.getGreen())),
        floorColor.getBlue()
            + (int) (shadePercentage * (ceilColor.getBlue() - floorColor.getBlue())));
  }
