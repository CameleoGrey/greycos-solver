package greycos.solver.benchmark.aggregator.swingui;
...
import greycos.solver.benchmark.aggregator.BenchmarkAggregator;
import greycos.solver.benchmark.aggregator.swingui.MixedCheckBox.MixedCheckBoxStatus;
...
import greycos.solver.benchmark.impl.report.BenchmarkReportFactory;
...
import greycos.solver.benchmark.impl.statistic.common.MillisecondsSpentNumberFormat;
...
public class BenchmarkAggregatorFrame extends JFrame {
  ...
  private MixedCheckBox createSolverBenchmarkCheckBox(SolverBenchmarkResult solverBenchmarkResult) {
    var solverCheckBoxName =
        "%s (%d)".formatted(solverBenchmarkResult.getName(), solverBenchmarkResult.getRanking());
  ...
  private MixedCheckBox createSingleBenchmarkCheckBox(SingleBenchmarkResult singleBenchmarkResult) {
    var singleCheckBoxName =
        "%s (%d)".formatted(singleBenchmarkResult.getName(), singleBenchmarkResult.getRanking());
