            ...
            JavaParser.fromJavaVersion()
                ...
                .dependsOn(
                    """
                                        ...
                                        public interface SolverManager<A, B> {
                                            SolutionManager<A, B> create(Object parameter);
                                            void solve(Object parameter, Function secondParameter, Consumer thirdParameter, BiConsumer fourthParameter);
                                            void solve(Object parameter, Object secondParameter, Consumer thirdParameter, BiConsumer fourthParameter);
                                            void solve(Object parameter, Function secondParameter, Consumer thirdParameter);
                                            void solveAndListen(Object parameter, Function secondParameter, Consumer thirdParameter);
                                            void solveAndListen(Object parameter, Function secondParameter, Consumer thirdParameter, BiConsumer fourthParameter);
                                            void solveAndListen(Object parameter, Function secondParameter, Consumer thirdParameter, Consumer fourthParameter, BiConsumer fifthParameter);
                                        }""",
                    """
                                        package ai.greycos.solver.core.api.solver;
                                        ...
                                        public interface SolverFactory {
                                            ...
                                            <A, B> SolverManager<A, B> buildSolver();
                                        }"""));
  }
