    ...
    spec.recipe(new SingleConstraintAssertionMethodsRecipe())
        ...
        .parser(
            JavaParser.fromJavaVersion()
                ...
                .dependsOn(
                    """
                                        package greycos.solver.test.api.score.stream;
                                        import java.util.function.BiFunction;
                                        import greycos.solver.test.api.score.stream.SingleConstraintAssertion;

                                        public interface ConstraintVerifier {
                                            ConstraintVerifier verifyThat(BiFunction parameter);
                                            SingleConstraintAssertion given(Object parameter);
                                        }""",
                    """
                                        package greycos.solver.test.api.score.stream;
                                        import greycos.solver.test.api.score.stream.ConstraintVerifier;
                                        import java.math.BigDecimal;

                                        public interface SingleConstraintAssertion extends ConstraintVerifier {
                                            void penalizesBy(int parameter, String secondParameter);
                                            void rewardsWith(int parameter, String secondParameter);
                                            void penalizesBy(long parameter, String secondParameter);
                                            void penalizes(long parameter, String secondParameter);
                                            void rewardsWith(long parameter, String secondParameter);
                                            void rewards(long parameter, String secondParameter);
                                            void penalizesBy(BigDecimal parameter, String secondParameter);
                                            void rewardsWith(BigDecimal parameter, String secondParameter);
                                        }"""));
  }
