...
class SolutionManagerRecommendAssignmentRecipeTest implements RewriteTest {
            ...
            JavaParser.fromJavaVersion()
                ...
                .dependsOn(
                    """
                                        ...
                                        import greycos.solver.core.api.solver.RecommendedFit;
  ...
  private static String wrap(String content, boolean addImport) {
    return "import greycos.solver.core.api.solver.SolutionManager;\n"
        + "import greycos.solver.core.api.solver.SolverFactory;\n"
        + (addImport ? "import greycos.solver.core.api.solver.RecommendedFit;\n" : "")
