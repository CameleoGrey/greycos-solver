...
class GeneralMethodDeleteInvocationMigrationRecipeTest implements RewriteTest {
  ...
  public void defaults(RecipeSpec spec) {
    spec.recipes(new GeneralMethodDeleteInvocationMigrationRecipe())
        //                .typeValidationOptions(TypeValidation.builder().allowMissingType(ignore ->
        // true).build())
        .parser(
            JavaParser.fromJavaVersion()
                ...
                .dependsOn(
                    ...
                    """
                                        package greycos.solver.core.api.domain.common;
                    ...
                    """
                                        package greycos.solver.core.config.score.director;
                                        import greycos.solver.core.api.score.stream.ConstraintStreamImplType;
                    ...
                    """
                                        ...
                                        import greycos.solver.core.api.score.stream.ConstraintStreamImplType;
                                        import greycos.solver.core.api.domain.common.DomainAccessType;
