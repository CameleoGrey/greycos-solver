...
class ScoreManagerMethodsRecipeTest implements RewriteTest {
  ...
  void explain() {
    runTest(
        "Object explanation = scoreManager.explainScore(solution);",
  ...
  private static String wrap(String content, boolean addImport) {
    return "import greycos.solver.core.api.score.ScoreManager;\n"
        + (addImport ? "import greycos.solver.core.api.solver.SolutionUpdatePolicy;\n" : "")
        + "import greycos.solver.core.api.score.ScoreExplanation;\n"
