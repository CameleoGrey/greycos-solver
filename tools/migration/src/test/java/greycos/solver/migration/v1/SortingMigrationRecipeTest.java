...
class SortingMigrationRecipeTest implements RewriteTest {
    ...
    spec.recipes(new FindMissingTypes(false), new SortingMigrationRecipe())
        ...
        .parser(
            JavaParser.fromJavaVersion()
                ...
                .dependsOn(
                    """
                                        package greycos.solver.core.api.domain.entity;
                    ...
                    """
                                        package greycos.solver.core.api.domain.variable;
  ...
  private static String adjustBefore(String content) {
    return """
                ...
                import greycos.solver.core.impl.heuristic.selector.common.decorator.SelectionSorterWeightFactory;
                import greycos.solver.core.api.domain.entity.PlanningEntity;
                import greycos.solver.core.api.domain.variable.PlanningVariable;
  ...
  private static String adjustAfter(String content) {
    return """
                ...
                import greycos.solver.core.api.domain.entity.PlanningEntity;
                import greycos.solver.core.api.domain.variable.PlanningVariable;
                import greycos.solver.core.api.domain.variable.PlanningVariable.NullComparator;
                import greycos.solver.core.api.domain.variable.PlanningVariable.NullComparatorFactory;
                import greycos.solver.core.config.heuristic.selector.entity.EntitySelectorConfig;
                import greycos.solver.core.config.heuristic.selector.entity.EntitySorterManner;
                import greycos.solver.core.config.heuristic.selector.move.generic.ChangeMoveSelectorConfig;
                import greycos.solver.core.config.heuristic.selector.move.generic.list.ListSwapMoveSelectorConfig;
