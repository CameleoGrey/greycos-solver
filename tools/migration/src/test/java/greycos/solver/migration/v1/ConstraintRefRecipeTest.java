...
class ConstraintRefRecipeTest implements RewriteTest {
        ...
        .parser(
            JavaParser.fromJavaVersion()
                ...
                .dependsOn(
                    ...
                    """
                                        package greycos.solver.core.api.score.constraint;
                    ...
                    """
                                        ...
                                        import greycos.solver.core.api.score.constraint.ConstraintMatchTotal;
  ...
  void constraintMatch() {
    runTest(
        "greycos.solver.core.api.score.constraint.ConstraintMatch",
  ...
  void constraintMatchTotal() {
    runTest(
        "greycos.solver.core.api.score.constraint.ConstraintMatchTotal",
  ...
  void defaultConstraintMatchTotal() {
    runTest(
        "greycos.solver.core.impl.score.constraint.DefaultConstraintMatchTotal",
  ...
  private void runTest(String implClassFqn, String declaration, String before, String after) {
    rewriteRun(
        java(wrap(implClassFqn, declaration, before), wrap(implClassFqn, declaration, after)));
  }
