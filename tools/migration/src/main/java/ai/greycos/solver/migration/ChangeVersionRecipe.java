...
public final class ChangeVersionRecipe extends AbstractRecipe {
  ...
  public String getName() {
    return "ai.greycos.solver.migration.ChangeVersion";
  }
  ...
  public List<Recipe> getRecipeList() {
    return List.of(
        new ChangePropertyValue("version.ai.greycos.solver", version, false, true),
        new ChangePropertyValue("version.greycos", version, false, true),
        new ChangePropertyValue("ai.greycos.solver.version", version, false, true),
