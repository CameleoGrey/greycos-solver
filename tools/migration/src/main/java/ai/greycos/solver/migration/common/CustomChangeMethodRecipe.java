package ai.greycos.solver.migration.common;
...
public final class CustomChangeMethodRecipe extends AbstractRecipe {
  ...
  public CustomChangeMethodRecipe(
      String clazz, String sourceMethodPattern, String newMethodPattern) {
    this.matcherMeta = new MatcherMeta(clazz, sourceMethodPattern, newMethodPattern);
  }

  @Override
  public String getDisplayName() {
    return "Custom change method recipe for %s.%s"
        .formatted(matcherMeta.clazz, matcherMeta.methodName);
  }
