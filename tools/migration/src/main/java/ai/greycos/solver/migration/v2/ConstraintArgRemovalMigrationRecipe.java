...
public final class ConstraintArgRemovalMigrationRecipe extends AbstractRecipe {
  ...
  public String getDisplayName() {
    return "Remove the constraint package argument from ConstraintRef and ConstraintBuilder";
  }
  ...
  public List<Recipe> getRecipeList() {
    return List.of(
        new DeleteMethodArgument(
            "ai.greycos.solver.core.api.score.constraint.ConstraintRef of(String, String)", 0),
        new DeleteMethodArgument(
