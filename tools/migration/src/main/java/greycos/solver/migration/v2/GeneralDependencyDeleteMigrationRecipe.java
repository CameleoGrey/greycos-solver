...
public class GeneralDependencyDeleteMigrationRecipe extends AbstractRecipe {
  ...
  public List<Recipe> getRecipeList() {
    return List.of(
        new RemoveDependency("greycos.solver", "greycos-solver-persistence-common", null),
        new RemoveDependency("greycos.solver", "greycos-solver-webui", null),
        new RemoveDependency("greycos.solver", "greycos-solver-jsonb", null));
  }
}
