    ...
    return Preconditions.check(
        ...
        new JavaIsoVisitor<>() {
          ...
          public Expression visitExpression(Expression expression, ExecutionContext ctx) {
            ...
            maybeAddImport("greycos.solver.core.api.score.constraint.ConstraintRef");
      ...
      String className =
          switch (select) {
            case "ConstraintMatch", "ConstraintMatchTotal" ->
                "greycos.solver.core.api.score.constraint." + select;
            case "Constraint" -> "greycos.solver.core.api.score.stream." + select;
