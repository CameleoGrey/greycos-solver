...
public final class SingleConstraintAssertionMethodsRecipe extends AbstractRecipe {
  ...
  public List<Recipe> getRecipeList() {
    var methodsToReorder =
        List.of(
            new String[] {
              "greycos.solver.test.api.score.stream.SingleConstraintAssertion *(int, String)",
              "message,matchWeightTotal",
              "matchWeightTotal,message"
            },
            new String[] {
              "greycos.solver.test.api.score.stream.SingleConstraintAssertion *(long, String)",
              "message,matchWeightTotal",
              "matchWeightTotal,message"
            },
            new String[] {
              "greycos.solver.test.api.score.stream.SingleConstraintAssertion *(java.math.BigDecimal, String)",
              "message,matchWeightTotal",
              "matchWeightTotal,message"
            });
