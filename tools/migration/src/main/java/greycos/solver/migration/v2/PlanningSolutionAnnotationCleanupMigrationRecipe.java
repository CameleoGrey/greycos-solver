  ...
  public List<Recipe> getRecipeList() {
    return List.of(
        new RemoveAnnotationAttribute(
            "greycos.solver.core.api.cotwin.solution.PlanningSolution", "lookUpStrategyType"),
        new RemoveAnnotationAttribute(
            "greycos.solver.core.api.cotwin.solution.PlanningSolution", "autoDiscoverMemberType"));
  }
}
