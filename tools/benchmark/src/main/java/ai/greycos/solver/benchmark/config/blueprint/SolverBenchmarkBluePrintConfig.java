package ai.greycos.solver.benchmark.config.blueprint;
...
@XmlType(propOrder = {"solverBenchmarkBluePrintType"})
public class SolverBenchmarkBluePrintConfig {
  ...
  public void setSolverBenchmarkBluePrintType(
      @Nullable SolverBenchmarkBluePrintType solverBenchmarkBluePrintType) {
    ...
    if (solverBenchmarkBluePrintType == null) {
      throw new IllegalArgumentException(
          "The solverBenchmarkBluePrint must have"
              + " a solverBenchmarkBluePrintType ("
