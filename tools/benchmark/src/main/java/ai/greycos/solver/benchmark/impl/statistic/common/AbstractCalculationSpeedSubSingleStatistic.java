...
public abstract class AbstractCalculationSpeedSubSingleStatistic<Solution_>
  ...
  protected AbstractCalculationSpeedSubSingleStatistic(
      SolverMetric solverMetric,
      ProblemStatisticType statisticType,
      SubSingleBenchmarkResult benchmarkResult,
  ...
  @Override
  protected LongStatisticPoint createPointFromCsvLine(
