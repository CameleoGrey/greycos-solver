...
public class ScoreSubSingleBenchmarkRankingComparator
    implements Comparator<SubSingleBenchmarkResult> {

  @Override
  public int compare(SubSingleBenchmarkResult a, SubSingleBenchmarkResult b) {
    var aScoreDefinition =
        a.getSingleBenchmarkResult().getSolverBenchmarkResult().getScoreDefinition();
    return Comparator
        ...
        .thenComparing(
            SubSingleBenchmarkResult::getScore, new ResilientScoreComparator(aScoreDefinition))
        .compare(a, b);
  }
}
