...
public class SolverBenchmarkConfig extends AbstractConfig<SolverBenchmarkConfig> {
  ...
  public void setProblemBenchmarksConfig(
      @Nullable ProblemBenchmarksConfig problemBenchmarksConfig) {
  ...
  public @NonNull SolverBenchmarkConfig withProblemBenchmarksConfig(
      @NonNull ProblemBenchmarksConfig problemBenchmarksConfig) {
  ...
  public @NonNull SolverBenchmarkConfig inherit(@NonNull SolverBenchmarkConfig inheritedConfig) {
    ...
    subSingleCount =
        ConfigUtils.inheritOverwritableProperty(
            subSingleCount, inheritedConfig.getSubSingleCount());
    return this;
  }
