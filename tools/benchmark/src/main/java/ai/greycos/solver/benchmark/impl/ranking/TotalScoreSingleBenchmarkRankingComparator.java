...
public class TotalScoreSingleBenchmarkRankingComparator
    implements Comparator<SingleBenchmarkResult> {
  ...
  public int compare(SingleBenchmarkResult a, SingleBenchmarkResult b) {
    ...
    return Comparator
        ...
        .thenComparing(
            SingleBenchmarkResult::getTotalScore, new ResilientScoreComparator(aScoreDefinition))
        .compare(a, b);
  }
}
