package greycos.solver.benchmark.impl.loader;
...
public class InstanceProblemProvider<Solution_> implements ProblemProvider<Solution_> {
  ...
  @XmlTransient private Solution_ problem;
  @XmlTransient private SolutionCloner<Solution_> solutionCloner;
  ...
  public void writeSolution(Solution_ solution, SubSingleBenchmarkResult subSingleBenchmarkResult) {
    // TODO maybe we can store them in a List and somehow return a List<List<Solution_>> from
    // PlannerBenchmark?
