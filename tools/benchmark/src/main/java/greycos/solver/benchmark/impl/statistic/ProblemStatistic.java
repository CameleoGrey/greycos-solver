...
public abstract class ProblemStatistic<Chart_ extends Chart> implements ChartProvider<Chart_> {
  ...
  @XmlTransient protected List<Chart_> chartList;
  ...
  public String getAnchorId() {
    return ReportHelper.escapeHtmlId(
        problemBenchmarkResult.getName() + "_" + problemStatisticType.name());
  }
  ...
  public List<SubSingleStatistic> getSubSingleStatisticList() {
    ...
    List<SubSingleStatistic> subSingleStatisticList =
    ...
    for (SingleBenchmarkResult singleBenchmarkResult : singleBenchmarkResultList) {
      ...
      subSingleStatisticList.add(
          singleBenchmarkResult
              .getSubSingleBenchmarkResultList()
              .get(0)
              .getEffectiveSubSingleStatisticMap()
              .get(problemStatisticType));
    }
    return subSingleStatisticList;
  }

  public abstract SubSingleStatistic createSubSingleStatistic(
