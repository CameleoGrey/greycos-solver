package greycos.solver.benchmark.impl.statistic.bestsolutionmutation;
...
public final class BestSolutionMutationSubSingleStatisticTest
    extends AbstractSubSingleStatisticTest<
        ...
        BestSolutionMutationSubSingleStatistic<TestdataSolution>> {

  @Override
  protected Function<
          SubSingleBenchmarkResult, BestSolutionMutationSubSingleStatistic<TestdataSolution>>
  ...
  protected List<BestSolutionMutationStatisticPoint> getInputPoints() {
    return Collections.singletonList(
        new BestSolutionMutationStatisticPoint(Long.MAX_VALUE, Integer.MAX_VALUE));
  }

  @Override
  protected void runTest(
      SoftAssertions assertions, List<BestSolutionMutationStatisticPoint> outputPoints) {
    assertions
