...
import static greycos.solver.benchmark.impl.report.MillisecondDurationNumberFormatFactory.MillisecondDurationNumberFormat;
...
class MillisecondDurationNumberFormatFactoryTest {
  ...
  void millisecondFormatting(Long millis, String translation)
      throws TemplateValueFormatException, TemplateModelException {
    when(templateNumberModel.getAsNumber()).thenReturn(millis);
