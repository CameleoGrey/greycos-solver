...
public final class ConstraintMatchTotalStepScoreSubSingleStatisticTest
    extends AbstractSubSingleStatisticTest<
        ...
        ConstraintMatchTotalStepScoreSubSingleStatistic<TestdataSolution>> {
  ...
  protected void runTest(
      SoftAssertions assertions, List<ConstraintMatchTotalStepScoreStatisticPoint> outputPoints) {
    assertions
