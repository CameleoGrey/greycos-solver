...
public final class ConstraintMatchTotalBestScoreSubSingleStatisticTest
    extends AbstractSubSingleStatisticTest<
        ...
        ConstraintMatchTotalBestScoreSubSingleStatistic<TestdataSolution>> {
  ...
  protected void runTest(
      SoftAssertions assertions, List<ConstraintMatchTotalBestScoreStatisticPoint> outputPoints) {
    assertions
        ...
        .matches(
            s -> s.getScoreTotal().equals(SimpleScore.of(Integer.MAX_VALUE)),
            "Scores do not match.")
