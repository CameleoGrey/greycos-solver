...
final class MoveCountPerTypeSubSingleStatisticTest
    extends AbstractSubSingleStatisticTest<
        MoveCountPerTypeStatisticPoint, MoveCountPerTypeSubSingleStatistic<TestdataSolution>> {
  ...
  protected List<MoveCountPerTypeStatisticPoint> getInputPoints() {
    return List.of(
        new MoveCountPerTypeStatisticPoint("Move Type 1", Long.MIN_VALUE),
        new MoveCountPerTypeStatisticPoint("Move Type 2", Long.MAX_VALUE));
  }

  @Override
  protected void runTest(
      SoftAssertions assertions, List<MoveCountPerTypeStatisticPoint> outputPoints) {
    assertions
