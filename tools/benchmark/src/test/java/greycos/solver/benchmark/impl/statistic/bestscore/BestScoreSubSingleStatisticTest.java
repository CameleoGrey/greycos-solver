package greycos.solver.benchmark.impl.statistic.bestscore;
...
public final class BestScoreSubSingleStatisticTest
    extends AbstractSubSingleStatisticTest<
        BestScoreStatisticPoint, BestScoreSubSingleStatistic<TestdataSolution>> {
  ...
  protected List<BestScoreStatisticPoint> getInputPoints() {
    return Collections.singletonList(
        new BestScoreStatisticPoint(Long.MAX_VALUE, SimpleScore.of(Integer.MAX_VALUE), true));
  }
