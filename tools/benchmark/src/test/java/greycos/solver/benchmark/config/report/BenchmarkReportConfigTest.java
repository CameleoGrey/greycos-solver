package greycos.solver.benchmark.config.report;

import static org.assertj.core.api.Assertions.assertThat;

import java.util.Locale;

import greycos.solver.benchmark.config.ranking.SolverRankingType;
...
class BenchmarkReportConfigTest {
  ...
  void inheritBenchmarkReportConfig() {
    ...
    inheritedReportConfig.setSolverRankingWeightFactoryClass(
        TotalRankSolverRankingWeightFactory.class);
    ...
    assertThat(reportConfig.getSolverRankingType())
        .isEqualTo(inheritedReportConfig.getSolverRankingType());
