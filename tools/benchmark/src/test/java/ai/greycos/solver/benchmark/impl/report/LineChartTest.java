...
import ai.greycos.solver.benchmark.impl.report.LineChart.Builder;
  ...
  void testDownSamplingProcess() throws IOException {
    ...
    try (BufferedReader in =
        new BufferedReader(
            new FileReader(
                LineChartTest.class
                    .getResource("/ai/greycos/solver/benchmark/impl/result/xValues.csv")
                    .getFile()))) {
      String str;
    ...
    try (BufferedReader in =
        new BufferedReader(
            new FileReader(
                LineChartTest.class
                    .getResource("/ai/greycos/solver/benchmark/impl/result/yValues.csv")
                    .getFile()))) {
      String str;
      while ((str = in.readLine()) != null) {
        String[] values = str.split(",");
    ...
    try (BufferedReader in =
        new BufferedReader(
            new FileReader(
                LineChartTest.class
                    .getResource("/ai/greycos/solver/benchmark/impl/result/resultValues.csv")
                    .getFile()))) {
      String str;
      while ((str = in.readLine()) != null) {
        String[] values = str.split(",");
