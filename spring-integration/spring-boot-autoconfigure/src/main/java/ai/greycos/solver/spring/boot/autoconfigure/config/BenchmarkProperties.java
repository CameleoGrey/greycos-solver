...
public class BenchmarkProperties {
  ...
  /**
   * A classpath resource to read the benchmark configuration XML. Defaults to
   * solverBenchmarkConfig.xml. If this property isn't specified, the file is optional.
   */
  private String solverBenchmarkConfigXml;

  /**
   * The directory to which to write the benchmark HTML report and graphs, relative from the working
   * directory.
   */
  private String resultDirectory;

  @NestedConfigurationProperty private BenchmarkSolverProperties solver;
