...
public class TerminationProperties {
  ...
  /**
   * How long the solver can run. For example: "30s" is 30 seconds. "5m" is 5 minutes. "2h" is 2
   * hours. "1d" is 1 day. Also supports ISO-8601 format, see java.time.Duration.
   */
   ...
   * "0hard/-1000soft" terminates when the best score changes from "0hard/-1200soft" to
   * "0hard/-900soft". Wildcards are supported to replace numbers. For example: "0hard/*soft" to
   * terminate when any feasible score is reached.
   */
  private String bestScoreLimit;

  @NestedConfigurationProperty private DiminishedReturnsProperties diminishedReturns;
    ...
    if (!invalidKeySet.isEmpty()) {
      throw new IllegalStateException(
          """
              ...
              .formatted(
                  invalidKeySet, String.join(", ", TerminationProperty.getValidPropertyNames())));
    }
