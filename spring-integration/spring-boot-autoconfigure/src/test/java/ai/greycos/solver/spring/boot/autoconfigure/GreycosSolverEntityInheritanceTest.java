...
import ai.greycos.solver.spring.boot.autoconfigure.inheritance.entity.BothAnnotatedSpringTestConfiguration;
import ai.greycos.solver.spring.boot.autoconfigure.inheritance.entity.MultipleBothAnnotatedInterfaceSpringTestConfiguration;
import ai.greycos.solver.spring.boot.autoconfigure.inheritance.entity.MultipleBothAnnotatedMixedSpringTestConfiguration;
import ai.greycos.solver.spring.boot.autoconfigure.inheritance.entity.MultipleBothAnnotatedSpringTestConfiguration;
import ai.greycos.solver.spring.boot.autoconfigure.inheritance.entity.MultipleOnlyBaseAnnotatedInterfaceSpringTestConfiguration;
import ai.greycos.solver.spring.boot.autoconfigure.inheritance.entity.MultipleOnlyBaseAnnotatedSpringTestConfiguration;
import ai.greycos.solver.spring.boot.autoconfigure.inheritance.entity.OnlyBaseAnnotatedInterfaceSpringTestConfiguration;
import ai.greycos.solver.spring.boot.autoconfigure.inheritance.entity.OnlyBaseAnnotatedSpringTestConfiguration;
import ai.greycos.solver.spring.boot.autoconfigure.inheritance.entity.OnlyChildAnnotatedInterfaceSpringTestConfiguration;
import ai.greycos.solver.spring.boot.autoconfigure.inheritance.entity.OnlyChildAnnotatedSpringTestConfiguration;
import ai.greycos.solver.spring.boot.autoconfigure.inheritance.entity.ReplaceVarInterfaceSpringTestConfiguration;
import ai.greycos.solver.spring.boot.autoconfigure.inheritance.entity.ReplaceVarSpringTestConfiguration;
