...
class GreyCOSBenchmarkBlueprintTest extends GreyCOSBenchmarkAbstract {
  ...
  void benchmark() throws Exception {
    ...
    Path benchmarkResultPath =
        Files.walk(benchmarkResultDirectoryPath, 2)
            .filter(path -> path.endsWith("plannerBenchmarkResult.xml"))
            .findFirst()
            .orElseThrow();
    ...
    assertThat(
            xmlPath
                ...
                .stream()
                .anyMatch(node -> node.equals("true")))
        .isTrue();
  }
  ...
  public static class BlueprintTestProfile implements QuarkusTestProfile {
    ...
    public Map<String, String> getConfigOverrides() {
      ...
      overrides.put(
          ...
          "blueprintSolverBenchmarkConfig.xml");
      return overrides;
    }
  }
}
