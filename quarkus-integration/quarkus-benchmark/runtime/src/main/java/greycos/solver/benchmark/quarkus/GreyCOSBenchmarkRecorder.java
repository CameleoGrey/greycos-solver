...
import greycos.solver.benchmark.quarkus.config.GreyCOSBenchmarkRuntimeConfig;
...
public class GreyCOSBenchmarkRecorder {
  ...
  private PlannerBenchmarkConfig updateBenchmarkConfigWithRuntimeProperties(
    ...
    if (plannerBenchmarkConfig.getSolverBenchmarkBluePrintConfigList() != null) {
      ...
      if (inheritedBenchmarkConfig.getSolverConfig().getTerminationConfig() != null) {
        inheritedTerminationConfig =
            inheritedBenchmarkConfig.getSolverConfig().getTerminationConfig();
      } else {
      ...
      if (benchmarkRuntimeConfig != null && benchmarkRuntimeConfig.termination() != null) {
        benchmarkRuntimeConfig
            .termination()
            .spentLimit()
            .ifPresent(inheritedTerminationConfig::setSpentLimit);
        benchmarkRuntimeConfig
            .termination()
        ...
        benchmarkRuntimeConfig
            .termination()
            .bestScoreLimit()
            .ifPresent(inheritedTerminationConfig::setBestScoreLimit);
      }
    }

    TerminationConfig inheritedTerminationConfig = null;
    if (inheritedBenchmarkConfig != null
        && inheritedBenchmarkConfig.getSolverConfig() != null
      ...
      for (var solverBenchmarkConfig : solverBenchmarkConfigList) {
        var solverConfig_ =
            Objects.requireNonNullElseGet(
                solverBenchmarkConfig.getSolverConfig(), SolverConfig::new);
    ...
    if (plannerBenchmarkConfig.getSolverBenchmarkConfigList() != null) {
      for (var childBenchmarkConfig : plannerBenchmarkConfig.getSolverBenchmarkConfigList()) {
        ...
        inheritPropertiesFromSolverConfig(
            childBenchmarkConfig, inheritedBenchmarkConfig, solverConfig);
      }
    }
  ...
  private <T> void inheritProperty(
      SolverBenchmarkConfig childBenchmarkConfig,
      SolverBenchmarkConfig inheritedBenchmarkConfig,
      SolverConfig solverConfig,
  ...
  private void inheritScoreCalculation(
      SolverBenchmarkConfig childBenchmarkConfig,
      SolverBenchmarkConfig inheritedBenchmarkConfig,
      SolverConfig solverConfig) {
