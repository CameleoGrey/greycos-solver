package ai.greycos.solver.quarkus.it.devui;
...
public class GreycosDevUIMultipleSolversTest extends DevUIJsonRPCTest {
              ...
              () ->
                  ShrinkWrap.create(JavaArchive.class)
                      .addClasses(
                          ...
                          GreycosTestMultipleResource.class));

  @Path("/greycos/test")
  public static class GreycosTestMultipleResource {
  ...
  public GreycosDevUIMultipleSolversTest() {
  ...
  private void assertConstraintsPage(JsonNode constraintsResponse, String solverName) {
    assertThat(constraintsResponse.get(solverName))
        .containsExactly(
            new TextNode(
