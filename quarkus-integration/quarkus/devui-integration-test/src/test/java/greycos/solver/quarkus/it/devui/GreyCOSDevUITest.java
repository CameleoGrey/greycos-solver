package greycos.solver.quarkus.it.devui;
...
import greycos.solver.quarkus.it.devui.cotwin.StringLengthVariableListener;
import greycos.solver.quarkus.it.devui.cotwin.TestdataStringLengthShadowEntity;
import greycos.solver.quarkus.it.devui.cotwin.TestdataStringLengthShadowSolution;
import greycos.solver.quarkus.it.devui.solver.TestdataStringLengthConstraintProvider;
...
public class GreyCOSDevUITest extends DevUIJsonRPCTest {
          ...
          .setArchiveProducer(
              () ->
                  ShrinkWrap.create(JavaArchive.class)
                      .addClasses(
                          StringLengthVariableListener.class,
  ...
  void testModelPage() throws Exception {
    ...
    assertThat(modelResponse.get("default").get("entityClassList"))
        .containsExactly(new TextNode(TestdataStringLengthShadowEntity.class.getCanonicalName()));
    assertThat(modelResponse.get("default").get("entityClassToGenuineVariableListMap")).hasSize(1);
    assertThat(
            modelResponse
                .get("default")
                .get("entityClassToGenuineVariableListMap")
    ...
    assertThat(
            modelResponse
                .get("default")
                .get("entityClassToShadowVariableListMap")
                .get(TestdataStringLengthShadowEntity.class.getCanonicalName()))
