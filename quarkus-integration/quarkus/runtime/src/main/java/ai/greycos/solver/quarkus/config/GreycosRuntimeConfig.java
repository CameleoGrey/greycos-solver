...
public interface GreyCOSRuntimeConfig {
  ...
  /**
   * During run time, this is translated into {@link SolverConfig} runtime properties per solver. If
   * a solver name is not explicitly specified, the solver name will default to {@link
   * #DEFAULT_SOLVER_NAME}.
   */
