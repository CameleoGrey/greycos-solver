...
public interface SolverManagerRuntimeConfig {
  ...
  /**
   * The number of solvers that run in parallel. This directly influences CPU consumption. Defaults
   * to {@value SolverManagerConfig#PARALLEL_SOLVER_COUNT_AUTO}. Other options include a number or
