              ...
              methodCreator.body(
                  blockCreator -> {
                    ...
                    var errorMessageBuilder =
                        blockCreator.localVar(
                            "messageBuilder", blockCreator.new_(StringBuilder.class));
                    blockCreator.invokeVirtual(
                        MethodDesc.of(
                            StringBuilder.class, "append", StringBuilder.class, String.class),
                        errorMessageBuilder,
                        Const.of("Impossible state: encountered unknown subclass ("));
                    blockCreator.invokeVirtual(
                        MethodDesc.of(
                            StringBuilder.class, "append", StringBuilder.class, Object.class),
                        errorMessageBuilder,
                    ...
                    blockCreator.invokeVirtual(
                        MethodDesc.of(
                            StringBuilder.class, "append", StringBuilder.class, String.class),
                        errorMessageBuilder,
                        Const.of(") of (" + entityClass + ") in Quarkus."));

                    var error =
                        blockCreator.new_(
                            ConstructorDesc.of(IllegalStateException.class, String.class),
