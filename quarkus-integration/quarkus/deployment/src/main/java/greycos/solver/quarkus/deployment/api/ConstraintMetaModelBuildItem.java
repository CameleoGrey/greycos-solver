package greycos.solver.quarkus.deployment.api;
...
/**
 * Represents a {@link greycos.solver.core.api.score.stream.ConstraintMetaModel} at the build time
 * for the purpose of Quarkus augmentation.
 */
public final class ConstraintMetaModelBuildItem extends SimpleBuildItem {
  ...
  public ConstraintMetaModelBuildItem(
      Map<String, ConstraintMetaModel> constraintMetaModelsBySolverNames) {
