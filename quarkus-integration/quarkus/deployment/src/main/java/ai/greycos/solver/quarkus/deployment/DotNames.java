...
public final class DotNames {
  ...
  static final DotName PLANNING_ENTITY_PROPERTY =
      DotName.createSimple(PlanningEntityProperty.class.getName());
  static final DotName PLANNING_SCORE = DotName.createSimple(PlanningScore.class.getName());
  static final DotName PROBLEM_FACT_COLLECTION_PROPERTY =
      DotName.createSimple(ProblemFactCollectionProperty.class.getName());
  static final DotName PROBLEM_FACT_PROPERTY =
      DotName.createSimple(ProblemFactProperty.class.getName());

  static final DotName EASY_SCORE_CALCULATOR =
      DotName.createSimple(EasyScoreCalculator.class.getName());
  static final DotName CONSTRAINT_PROVIDER =
  ...
  static final DotName PLANNING_PIN_TO_INDEX =
      DotName.createSimple(PlanningPinToIndex.class.getName());
  ...
  static final DotName SHADOW_VARIABLES_INCONSISTENT =
      DotName.createSimple(ShadowVariablesInconsistent.class.getName());
  ...
  static final DotName SOLVER_MANAGER_CONFIG =
      DotName.createSimple(SolverManagerConfig.class.getName());
  ...
  static final Set<DotName> SOLVER_INJECTABLE_TYPES =
      Set.of(SOLVER_CONFIG, SOLVER_MANAGER_CONFIG, SOLVER_FACTORY, SOLVER_MANAGER);
  ...
  public enum BeanDefiningAnnotations {
    ...
    BeanDefiningAnnotations(
        DotName annotationDotName, Class<? extends Annotation> annotationClass) {
