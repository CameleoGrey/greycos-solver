...
import greycos.solver.quarkus.testcotwin.dummy.DummyTestdataQuarkusShadowVariableEasyScoreCalculator;
import greycos.solver.quarkus.testcotwin.dummy.DummyTestdataQuarkusShadowVariableIncrementalScoreCalculator;
...
class GreyCOSProcessorMultipleSolversInvalidConstraintClassTest {
          ...
          .assertException(
              t ->
                  assertThat(t)
                      ...
                      .hasMessageContaining(
                          "greycos.solver.quarkus.testcotwin.dummy.DummyTestdataQuarkusEasyScoreCalculator")
                      .hasMessageContaining(
                          "greycos.solver.quarkus.testcotwin.dummy.DummyTestdataQuarkusShadowVariableEasyScoreCalculator")
  ...
  static final QuarkusUnitTest config3 =
      new QuarkusUnitTest()
          ...
          .overrideConfigKey(
              ...
              "greycos/solver/quarkus/customSolverConfig.xml")
          .overrideConfigKey("quarkus.greycos.solver.\"solver2\".environment-mode", "PHASE_ASSERT")
          .overrideConfigKey(
          ...
          .setArchiveProducer(
              () ->
                  ShrinkWrap.create(JavaArchive.class)
                      ...
                      .addAsResource("greycos/solver/quarkus/customSolverConfig.xml"))
          .assertException(
              t ->
                  assertThat(t)
                      .isInstanceOf(IllegalStateException.class)
  ...
  static final QuarkusUnitTest config5 =
      new QuarkusUnitTest()
          ...
          .overrideConfigKey(
              "quarkus.greycos.solver.\"solver1\".solver-config-xml",
              "greycos/solver/quarkus/customSolverConfigWithoutScore.xml")
          .overrideConfigKey("quarkus.greycos.solver.\"solver2\".environment-mode", "PHASE_ASSERT")
          .overrideConfigKey(
              "quarkus.greycos.solver.\"solver2\".solver-config-xml",
              "greycos/solver/quarkus/customSolverConfigWithoutScore.xml")
          .setArchiveProducer(
              () ->
                  ShrinkWrap.create(JavaArchive.class)
                      ...
                      .addAsResource("greycos/solver/quarkus/customSolverConfigWithoutScore.xml"))
          .assertException(
              t ->
                  assertThat(t)
                      .isInstanceOf(IllegalStateException.class)
  ...
  static final QuarkusUnitTest config8 =
      new QuarkusUnitTest()
          .overrideConfigKey(
              "quarkus.greycos.solver.\"solver1\".solver-config-xml",
              "greycos/solver/quarkus/customSolverWithEasyScore.xml")
          .overrideConfigKey(
              "quarkus.greycos.solver.\"solver2\".solver-config-xml",
              "greycos/solver/quarkus/customSolverWithEasyScore.xml")
          .setArchiveProducer(
              () ->
                  ShrinkWrap.create(JavaArchive.class)
                      .addClasses(
                          ...
                          DummyTestdataQuarkusEasyScoreCalculator.class)
                      .addClasses(DummyTestdataQuarkusShadowVariableEasyScoreCalculator.class)
                      .addAsResource("greycos/solver/quarkus/customSolverWithEasyScore.xml"))
          .assertException(
              t ->
                  assertThat(t)
                      .isInstanceOf(IllegalStateException.class)
  ...
  static final QuarkusUnitTest config10 =
      new QuarkusUnitTest()
          .overrideConfigKey(
              "quarkus.greycos.solver.\"solver1\".solver-config-xml",
              "greycos/solver/quarkus/customSolverWithIncrementalScore.xml")
          .overrideConfigKey(
              "quarkus.greycos.solver.\"solver2\".solver-config-xml",
              "greycos/solver/quarkus/customSolverWithIncrementalScore.xml")
          .setArchiveProducer(
              () ->
                  ShrinkWrap.create(JavaArchive.class)
                      ...
                      .addClasses(
                          DummyTestdataQuarkusShadowVariableIncrementalScoreCalculator.class)
                      .addAsResource("greycos/solver/quarkus/customSolverWithIncrementalScore.xml"))
          .assertException(
              t ->
                  assertThat(t)
                      .isInstanceOf(IllegalStateException.class)
