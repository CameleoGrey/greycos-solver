...
import greycos.solver.quarkus.testcotwin.interfaceentity.TestdataInterfaceEntity;
import greycos.solver.quarkus.testcotwin.interfaceentity.TestdataInterfaceEntityImplementation;
import greycos.solver.quarkus.testcotwin.interfaceentity.TestdataInterfaceEntitySolution;
...
class GreyCOSProcessorInterfaceEntityTest {
          ...
          .setArchiveProducer(
              () ->
                  ShrinkWrap.create(JavaArchive.class)
                      .addPackages(true, "greycos.solver.quarkus.testcotwin.interfaceentity"));
