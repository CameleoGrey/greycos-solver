...
import greycos.solver.quarkus.rest.TestdataQuarkusSolutionConfigResource;
import greycos.solver.quarkus.testcotwin.dummy.DummyDistanceMeter;
  ...
  static final QuarkusUnitTest config1 =
      new QuarkusUnitTest()
          ...
          .overrideConfigKey(
              ...
              "greycos.solver.quarkus.testcotwin.dummy.DummyDistanceMeter")
  ...
  static final QuarkusUnitTest config2 =
      new QuarkusUnitTest()
          ...
          .overrideConfigKey(
              ...
              "greycos.solver.quarkus.rest.TestdataQuarkusSolutionConfigResource")
          .setArchiveProducer(
              () ->
                  ShrinkWrap.create(JavaArchive.class)
                      .addClasses(
