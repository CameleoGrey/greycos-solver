...
class GreyCOSProcessorGeneratedGizmoSupplierTest {
          ...
          .setArchiveProducer(
              () ->
                  ShrinkWrap.create(JavaArchive.class)
                      .addAsResource(
                          "greycos/solver/quarkus/gizmoSupplierTestSolverConfig.xml",
                          "solverConfig.xml")
                      .addClasses(
  ...
  public static class DummyChangeMoveFilter
    ...
    public boolean accept(
        ScoreDirector<TestdataSolution> scoreDirector, ChangeMove<TestdataSolution> selection) {
      return false;
    }
  }
  ...
  public static class DummyMoveIteratorFactory
    ...
    @Override
    public Iterator<DummyMove> createOriginalMoveIterator(
  ...
  public static class DummyMoveListFactory implements MoveListFactory<TestdataSolution> {
    @Override
    public List<? extends Move<TestdataSolution>> createMoveList(
        TestdataSolution testdataSolution) {
      return null;
    }
  }
}
