...
class GreyCOSProcessorXMLNearbyPropertyTest {
  ...
  static final QuarkusUnitTest config =
      new QuarkusUnitTest()
          .overrideConfigKey(
              ...
              "greycos/solver/quarkus/customNearbySolverConfig.xml")
          .setArchiveProducer(
              () ->
                  ShrinkWrap.create(JavaArchive.class)
                      ...
                      .addAsResource("greycos/solver/quarkus/customNearbySolverConfig.xml"));
