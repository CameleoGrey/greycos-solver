package ai.greycos.solver.quarkus.testdomain.declarative.simple;
...
public class TestdataQuarkusSupplierVariableSimpleConstraintProvider implements ConstraintProvider {
  ...
  public Constraint @NonNull [] defineConstraints(@NonNull ConstraintFactory factory) {
    return new Constraint[] {
      factory
          .forEach(TestdataQuarkusSupplierVariableSimpleEntity.class)
          .join(
              TestdataQuarkusSupplierVariableSimpleEntity.class,
              Joiners.equal(
                  TestdataQuarkusSupplierVariableSimpleEntity::getValue1,
