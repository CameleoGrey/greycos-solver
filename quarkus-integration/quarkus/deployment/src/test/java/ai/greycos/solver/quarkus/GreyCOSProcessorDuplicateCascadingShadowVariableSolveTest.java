...
import ai.greycos.solver.quarkus.testcotwin.cascade.TestdataQuarkusDuplicateCascadingConstraintProvider;
import ai.greycos.solver.quarkus.testcotwin.cascade.TestdataQuarkusDuplicateCascadingEntity;
import ai.greycos.solver.quarkus.testcotwin.cascade.TestdataQuarkusDuplicateCascadingSolution;
import ai.greycos.solver.quarkus.testcotwin.cascade.TestdataQuarkusDuplicateCascadingValue;
...
class GreyCOSProcessorDuplicateCascadingShadowVariableSolveTest {

  @RegisterExtension
  static final QuarkusUnitTest config =
      new QuarkusUnitTest()
          .overrideConfigKey("quarkus.greycos.solver.termination.best-score-limit", "-3")
          .setArchiveProducer(
              () ->
                  ShrinkWrap.create(JavaArchive.class)
                      .addClasses(
                          TestdataQuarkusDuplicateCascadingEntity.class,
  ...
  @Inject SolverManager<TestdataQuarkusDuplicateCascadingSolution> solverManager;
