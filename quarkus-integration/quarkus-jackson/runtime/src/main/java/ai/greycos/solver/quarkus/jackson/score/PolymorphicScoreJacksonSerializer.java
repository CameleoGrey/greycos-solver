 ...
 * field, use {@link HardSoftScoreJacksonSerializer} or similar instead.
 *
...
public class PolymorphicScoreJacksonSerializer extends JsonSerializer<Score> {
  ...
  @Override
  public void serialize(Score score, JsonGenerator generator, SerializerProvider serializers)
      throws IOException {
