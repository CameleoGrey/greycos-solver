package greycos.solver.quarkus.jackson.solution;
...
import greycos.solver.quarkus.jackson.testcotwin.JacksonTestdataEntity;
import greycos.solver.quarkus.jackson.testcotwin.JacksonTestdataSolution;
import greycos.solver.quarkus.jackson.testcotwin.JacksonTestdataValue;
...
class JacksonSolutionFileIOTest {
  ...
  void readAndWrite() {
    ...
    original.setEntityList(
        Arrays.asList(
            new JacksonTestdataEntity("e1"),
            new JacksonTestdataEntity("e2", originalV1),
            new JacksonTestdataEntity("e3")));
