    ...
    return Preconditions.check(
        ...
        new JavaIsoVisitor<>() {
          ...
          public Expression visitExpression(Expression expression, ExecutionContext ctx) {
            ...
            maybeAddImport("ai.greycos.solver.core.api.score.constraint.ConstraintRef");
      ...
      String className =
          switch (select) {
            case "ConstraintMatch", "ConstraintMatchTotal" ->
                "ai.greycos.solver.core.api.score.constraint." + select;
            case "Constraint" -> "ai.greycos.solver.core.api.score.stream." + select;
