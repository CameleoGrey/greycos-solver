package ai.greycos.solver.migration.v8;
...
public final class AsConstraintRecipe extends AbstractRecipe {
  ...
  private static final MatcherMeta[] MATCHER_METAS = {
    ...
    new MatcherMeta(
        "UniConstraintStream", "penalizeConfigurableLong(String, String, ToLongFunction)"),
    ...
    new MatcherMeta(
        "UniConstraintStream", "penalizeConfigurableBigDecimal(String, String, Function)"),
    ...
    new MatcherMeta(
        "UniConstraintStream", "rewardConfigurableLong(String, String, ToLongFunction)"),
    ...
    new MatcherMeta(
        "UniConstraintStream", "rewardConfigurableBigDecimal(String, String, Function)"),
    ...
    new MatcherMeta(
        "UniConstraintStream", "impactConfigurableLong(String, String, ToLongFunction)"),
    ...
    new MatcherMeta(
        "UniConstraintStream", "impactConfigurableBigDecimal(String, String, Function)"),
    ...
    new MatcherMeta(
        "BiConstraintStream", "penalizeConfigurableLong(String, String, ToLongBiFunction)"),
    ...
    new MatcherMeta(
        "BiConstraintStream", "penalizeConfigurableBigDecimal(String, String, BiFunction)"),
    ...
    new MatcherMeta(
        "BiConstraintStream", "rewardConfigurableLong(String, String, ToLongBiFunction)"),
    ...
    new MatcherMeta(
        "BiConstraintStream", "rewardConfigurableBigDecimal(String, String, BiFunction)"),
    ...
    new MatcherMeta(
        "BiConstraintStream", "impactConfigurableLong(String, String, ToLongBiFunction)"),
    ...
    new MatcherMeta(
        "BiConstraintStream", "impactConfigurableBigDecimal(String, String, BiFunction)"),
    ...
    new MatcherMeta(
        "TriConstraintStream", "penalizeConfigurable(String, String, ToIntTriFunction)"),
    new MatcherMeta("TriConstraintStream", "penalizeLong(String, Score, ToLongTriFunction)"),
    new MatcherMeta(
        "TriConstraintStream", "penalizeLong(String, String, Score, ToLongTriFunction)"),
    new MatcherMeta("TriConstraintStream", "penalizeConfigurableLong(String, ToLongTriFunction)"),
    new MatcherMeta(
        "TriConstraintStream", "penalizeConfigurableLong(String, String, ToLongTriFunction)"),
    new MatcherMeta("TriConstraintStream", "penalizeBigDecimal(String, Score, TriFunction)"),
    new MatcherMeta(
        "TriConstraintStream", "penalizeBigDecimal(String, String, Score, TriFunction)"),
    new MatcherMeta("TriConstraintStream", "penalizeConfigurableBigDecimal(String, TriFunction)"),
    new MatcherMeta(
        "TriConstraintStream", "penalizeConfigurableBigDecimal(String, String, TriFunction)"),
    ...
    new MatcherMeta(
        "TriConstraintStream", "rewardConfigurableLong(String, String, ToLongTriFunction)"),
    ...
    new MatcherMeta(
        "TriConstraintStream", "rewardConfigurableBigDecimal(String, String, TriFunction)"),
    ...
    new MatcherMeta(
        "TriConstraintStream", "impactConfigurableLong(String, String, ToLongTriFunction)"),
    ...
    new MatcherMeta(
        "TriConstraintStream", "impactConfigurableBigDecimal(String, String, TriFunction)"),
    ...
    new MatcherMeta(
        "QuadConstraintStream", "penalizeConfigurable(String, String, ToIntQuadFunction)"),
    new MatcherMeta("QuadConstraintStream", "penalizeLong(String, Score, ToLongQuadFunction)"),
    new MatcherMeta(
        "QuadConstraintStream", "penalizeLong(String, String, Score, ToLongQuadFunction)"),
    new MatcherMeta("QuadConstraintStream", "penalizeConfigurableLong(String, ToLongQuadFunction)"),
    new MatcherMeta(
        "QuadConstraintStream", "penalizeConfigurableLong(String, String, ToLongQuadFunction)"),
    new MatcherMeta("QuadConstraintStream", "penalizeBigDecimal(String, Score, QuadFunction)"),
    new MatcherMeta(
        "QuadConstraintStream", "penalizeBigDecimal(String, String, Score, QuadFunction)"),
    new MatcherMeta("QuadConstraintStream", "penalizeConfigurableBigDecimal(String, QuadFunction)"),
    new MatcherMeta(
        "QuadConstraintStream", "penalizeConfigurableBigDecimal(String, String, QuadFunction)"),
    ...
    new MatcherMeta(
        "QuadConstraintStream", "rewardConfigurable(String, String, ToIntQuadFunction)"),
    new MatcherMeta("QuadConstraintStream", "rewardLong(String, Score, ToLongQuadFunction)"),
    new MatcherMeta(
        "QuadConstraintStream", "rewardLong(String, String, Score, ToLongQuadFunction)"),
    new MatcherMeta("QuadConstraintStream", "rewardConfigurableLong(String, ToLongQuadFunction)"),
    new MatcherMeta(
        "QuadConstraintStream", "rewardConfigurableLong(String, String, ToLongQuadFunction)"),
    new MatcherMeta("QuadConstraintStream", "rewardBigDecimal(String, Score, QuadFunction)"),
    new MatcherMeta(
        "QuadConstraintStream", "rewardBigDecimal(String, String, Score, QuadFunction)"),
    new MatcherMeta("QuadConstraintStream", "rewardConfigurableBigDecimal(String, QuadFunction)"),
    new MatcherMeta(
        "QuadConstraintStream", "rewardConfigurableBigDecimal(String, String, QuadFunction)"),
    ...
    new MatcherMeta(
        "QuadConstraintStream", "impactConfigurable(String, String, ToIntQuadFunction)"),
    new MatcherMeta("QuadConstraintStream", "impactLong(String, Score, ToLongQuadFunction)"),
    new MatcherMeta(
        "QuadConstraintStream", "impactLong(String, String, Score, ToLongQuadFunction)"),
    new MatcherMeta("QuadConstraintStream", "impactConfigurableLong(String, ToLongQuadFunction)"),
    new MatcherMeta(
        "QuadConstraintStream", "impactConfigurableLong(String, String, ToLongQuadFunction)"),
    new MatcherMeta("QuadConstraintStream", "impactBigDecimal(String, Score, QuadFunction)"),
    new MatcherMeta(
        "QuadConstraintStream", "impactBigDecimal(String, String, Score, QuadFunction)"),
    new MatcherMeta("QuadConstraintStream", "impactConfigurableBigDecimal(String, QuadFunction)"),
    new MatcherMeta(
        "QuadConstraintStream", "impactConfigurableBigDecimal(String, String, QuadFunction)"),
  };
  ...
  public TreeVisitor<?, ExecutionContext> getVisitor() {
    TreeVisitor<?, ExecutionContext>[] visitors =
        Arrays.stream(MATCHER_METAS)
    ...
    return Preconditions.check(
        ...
        new JavaIsoVisitor<>() {
          ...
          private final Pattern uniConstraintStreamPattern =
              Pattern.compile("ai.greycos.solver.core.api.score.stream.uni.UniConstraintStream");
          private final Pattern biConstraintStreamPattern =
              Pattern.compile("ai.greycos.solver.core.api.score.stream.bi.BiConstraintStream");
          private final Pattern triConstraintStreamPattern =
              Pattern.compile("ai.greycos.solver.core.api.score.stream.tri.TriConstraintStream");
          private final Pattern quadConstraintStreamPattern =
              Pattern.compile("ai.greycos.solver.core.api.score.stream.quad.QuadConstraintStream");

          @Override
          public J.MethodInvocation visitMethodInvocation(
              J.MethodInvocation originalMethod, ExecutionContext ctx) {
            ...
            if (selectType.isAssignableFrom(uniConstraintStreamPattern)) {
              templateCode =
                  "#{any(ai.greycos.solver.core.api.score.stream.uni.UniConstraintStream)}\n";
            } else if (selectType.isAssignableFrom(biConstraintStreamPattern)) {
              templateCode =
                  "#{any(ai.greycos.solver.core.api.score.stream.bi.BiConstraintStream)}\n";
            } else if (selectType.isAssignableFrom(triConstraintStreamPattern)) {
              templateCode =
                  "#{any(ai.greycos.solver.core.api.score.stream.tri.TriConstraintStream)}\n";
            } else if (selectType.isAssignableFrom(quadConstraintStreamPattern)) {
              templateCode =
                  "#{any(ai.greycos.solver.core.api.score.stream.quad.QuadConstraintStream)}\n";
            } else {
              LOGGER.warn(
                  "Cannot refactor to asConstraint() method for deprecated method ({}).", method);
              return method;
            }
              ...
              if (!matcherMeta.matchWeigherIncluded) {
                templateCode +=
                    "."
                        ...
                        + "(#{any(ai.greycos.solver.core.api.score.Score)})\n";
              } else {
                templateCode +=
                    "."
                        + matcherMeta.methodName
            ...
            var template = JavaTemplate.builder(templateCode).javaParser(JAVA_PARSER).build();
            if (!matcherMeta.constraintPackageIncluded) {
              if (!matcherMeta.configurable) {
                if (!matcherMeta.matchWeigherIncluded) {
              ...
              if (!matcherMeta.matchWeigherIncluded) {
                return template.apply(
                    getCursor(), method.getCoordinates().replace(), select, arguments.get(0));
              }
              return template.apply(
                  getCursor(),
                  method.getCoordinates().replace(),
  ...
  private static class MatcherMeta {
    ...
    public MatcherMeta(String select, String method) {
      ...
      if ("ConstraintStream".equals(select)) {
        signature = "ai.greycos.solver.core.api.score.stream.ConstraintStream";
      } else if ("UniConstraintStream".equals(select)) {
        signature = "ai.greycos.solver.core.api.score.stream.uni.UniConstraintStream";
      } else if ("BiConstraintStream".equals(select)) {
        signature = "ai.greycos.solver.core.api.score.stream.bi.BiConstraintStream";
      } else if ("TriConstraintStream".equals(select)) {
        signature = "ai.greycos.solver.core.api.score.stream.tri.TriConstraintStream";
      } else if ("QuadConstraintStream".equals(select)) {
        signature = "ai.greycos.solver.core.api.score.stream.quad.QuadConstraintStream";
      } else {
      ...
      signature +=
          " "
              + method
                  .replace(" Score", " ai.greycos.solver.core.api.score.Score")
                  ...
                  .replace(
                      " ToIntTriFunction", " ai.greycos.solver.core.api.function.ToIntTriFunction")
                  .replace(
                      " ToLongTriFunction",
                      " ai.greycos.solver.core.api.function.ToLongTriFunction")
                  .replace(" TriFunction", " ai.greycos.solver.core.api.function.TriFunction")
                  .replace(
                      " ToIntQuadFunction",
                      " ai.greycos.solver.core.api.function.ToIntQuadFunction")
                  .replace(
                      " ToLongQuadFunction",
                      " ai.greycos.solver.core.api.function.ToLongQuadFunction")
                  .replace(" QuadFunction", " ai.greycos.solver.core.api.function.QuadFunction");
