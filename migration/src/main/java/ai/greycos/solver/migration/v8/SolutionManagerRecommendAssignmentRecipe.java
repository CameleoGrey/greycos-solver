  ...
  public List<Recipe> getRecipeList() {
    var changeMethodName =
        new ChangeMethodName(
            "ai.greycos.solver.core.api.solver.SolutionManager recommendFit("
                + "java.lang.Object, "
                + "java.lang.Object, "
    ...
    var changeMethodName2 =
        new ChangeMethodName(
            "ai.greycos.solver.core.api.solver.SolutionManager recommendFit("
                ...
                + "java.util.function.Function, "
                + "ai.greycos.solver.core.api.solver.ScoreAnalysisFetchPolicy)",
            "recommendAssignment",
            true,
            false);
    var changeType =
        new ChangeType(
            "ai.greycos.solver.core.api.solver.RecommendedFit",
            "ai.greycos.solver.core.api.solver.RecommendedAssignment",
            false);
