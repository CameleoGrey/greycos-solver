...
class RemoveConstraintPackageRecipeTest implements RewriteTest {
  ...
  public void defaults(RecipeSpec spec) {
    spec.recipe(new RemoveConstraintPackageRecipe()).parser(AbstractRecipe.JAVA_PARSER);
  }
  ...
  private static String wrap(String content) {
    return "import ai.greycos.solver.core.api.score.buildin.hardsoft.HardSoftScore;\n"
