...
class ConstraintRefRecipeTest implements RewriteTest {
  ...
  public void defaults(RecipeSpec spec) {
    spec.recipe(new ConstraintRefRecipe()).parser(AbstractRecipe.JAVA_PARSER);
  }
  ...
  void constraintMatch() {
    runTest(
        "ai.greycos.solver.core.api.score.constraint.ConstraintMatch",
  ...
  void constraintMatchTotal() {
    runTest(
        "ai.greycos.solver.core.api.score.constraint.ConstraintMatchTotal",
  ...
  void defaultConstraintMatchTotal() {
    runTest(
        "ai.greycos.solver.core.impl.score.constraint.DefaultConstraintMatchTotal",
