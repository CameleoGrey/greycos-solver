...
class ProblemBenchmarksConfigTest {
  ...
  void testDetermineProblemStatisticTypeList() {
    ...
    assertThat(ProblemStatisticType.defaultList())
        .isNotEqualTo(List.of(ProblemStatisticType.MEMORY_USE));
  ...
  void testDetermineSingleStatisticTypeList() {
    ...
    problemBenchmarksConfig.setSingleStatisticTypeList(
        List.of(SingleStatisticType.CONSTRAINT_MATCH_TOTAL_STEP_SCORE));
  ...
  void testDuplicatedDefaultMetrics() {
    ...
    assertThat(inheritedConfig.getProblemBenchmarksConfig().getProblemStatisticTypeList())
        .hasSize(1);
  }
}
