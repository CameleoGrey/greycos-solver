...
class DefaultPlannerBenchmarkTest {
  ...
  void solverBenchmarkResultListIsEmpty() {
    ...
    DefaultPlannerBenchmark benchmark =
        new DefaultPlannerBenchmark(
            benchmarkResult, benchmarkDirectory, executorService, executorService, benchmarkReport);

    assertThatExceptionOfType(IllegalArgumentException.class)
        .isThrownBy(benchmark::benchmarkingStarted)
        .withMessageContaining("solverBenchmarkResultList")
  ...
  void benchmarkDirectoryIsNull() {
    ...
    DefaultPlannerBenchmark benchmark =
        new DefaultPlannerBenchmark(
            plannerBenchmarkResult, null, executorService, executorService, benchmarkReport);
    assertThatExceptionOfType(IllegalArgumentException.class)
        .isThrownBy(benchmark::benchmarkingStarted)
        .withMessageContaining("benchmarkDirectory")
  ...
  void exceptionMessagePropagatesWhenThrownDuringWarmUp() {
    ...
    assertThatThrownBy(benchmark::benchmark).hasRootCause(exception);
  }
}
