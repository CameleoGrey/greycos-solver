...
import ai.greycos.solver.benchmark.impl.result.BenchmarkResult;
...
public class StatisticUtils {
  ...
  // TODO Do the locale formatting in benchmarkReport.html.ftl -
  // https://issues.redhat.com/browse/PLANNER-169
  public static String getStandardDeviationString(double[] standardDeviationDoubles) {
    ...
    // We don't use a local sensitive DecimalFormat, because other Scores don't use it either (see
    // PLANNER-169)
