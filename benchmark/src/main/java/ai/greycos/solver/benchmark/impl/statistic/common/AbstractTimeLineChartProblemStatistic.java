package ai.greycos.solver.benchmark.impl.statistic.common;
...
public abstract class AbstractTimeLineChartProblemStatistic
  ...
  protected AbstractTimeLineChartProblemStatistic(
      ProblemStatisticType statisticType,
  ...
  protected List<LineChart<Long, Long>> generateCharts(BenchmarkReport benchmarkReport) {
    ...
    return singletonList(
        builder.build(reportFileName, reportTitle, "Time spent", yLabel, false, true, false));
  }
