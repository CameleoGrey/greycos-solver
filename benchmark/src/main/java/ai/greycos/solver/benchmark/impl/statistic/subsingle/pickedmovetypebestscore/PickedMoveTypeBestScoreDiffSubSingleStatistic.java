...
public class PickedMoveTypeBestScoreDiffSubSingleStatistic<Solution_>
    extends PureSubSingleStatistic<
        Solution_, PickedMoveTypeBestScoreDiffStatisticPoint, LineChart<Long, Double>> {

  private PickedMoveTypeBestScoreDiffSubSingleStatistic() {
    // For JAXB.
  }

  public PickedMoveTypeBestScoreDiffSubSingleStatistic(
      ...
      LineChart<Long, Double> chart =
          builder.build(
              ...
              subSingleBenchmarkResult.getName()
                  + " picked move type best "
                  + scoreLevelLabel
                  + " diff statistic",
              "Time spent",
              "Best " + scoreLevelLabel + " diff",
              true,
              true,
              false);
      chartList.add(chart);
