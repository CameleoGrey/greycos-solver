...
import ai.greycos.solver.benchmark.impl.ranking.ScoreSubSingleBenchmarkRankingComparator;
import ai.greycos.solver.benchmark.impl.ranking.SubSingleBenchmarkRankBasedComparator;
...
import ai.greycos.solver.benchmark.impl.statistic.StatisticUtils;
...
public class SingleBenchmarkResult implements BenchmarkResult {
  ...
  @XmlID @XmlAttribute private String id = String.valueOf(ID_GENERATOR.getAndIncrement());
  ...
  // Compared to winningSingleBenchmarkResult in the same ProblemBenchmarkResult (which might not be
  ...
  public void setSubSingleBenchmarkResultList(
  ...
  public void setWorstScoreDifferencePercentage(
      ScoreDifferencePercentage worstScoreDifferencePercentage) {
  ...
  public void setWorstScoreCalculationSpeedDifferencePercentage(
  ...
  public void setAverageAndTotalScoreForTesting(
      Score<?> averageAndTotalScore, boolean allScoresInitialized) {
  ...
  public Long getScoreCalculationSpeed() {
    ...
    return timeMillisSpent == 0L
        ? scoreCalculationCountByThousand
        : scoreCalculationCountByThousand / timeMillisSpent;
  }
  ...
  public Long getMoveEvaluationSpeed() {
    ...
    // Avoid divide by zero exception on a fast CPU
    return timeMillisSpent == 0L
        ? moveEvaluationCountByThousand
        : moveEvaluationCountByThousand / timeMillisSpent;
  }
  ...
  public void accumulateResults(BenchmarkReport benchmarkReport) {
    ...
    standardDeviationDoubles =
        StatisticUtils.determineStandardDeviationDoubles(
            subSingleBenchmarkResultList, averageScore, getSuccessCount());
  ...
  private void determineRepresentativeSubSingleBenchmarkResult() {
    ...
    median =
        subSingleBenchmarkResultListCopy.get(
            ConfigUtils.ceilDivide(subSingleBenchmarkResultListCopy.size() - 1, 2));
  ...
  private static void determineRanking(
      List<SubSingleBenchmarkResult> rankedSubSingleBenchmarkResultList) {
    var subSingleBenchmarkRankingComparator = new ScoreSubSingleBenchmarkRankingComparator();
    rankedSubSingleBenchmarkResultList.sort(
    ...
    for (var subSingleBenchmarkResult : rankedSubSingleBenchmarkResultList) {
      if (previousSubSingleBenchmarkResult != null
          && subSingleBenchmarkRankingComparator.compare(
  ...
  protected static SingleBenchmarkResult createMerge(
    ...
    newResult.subSingleBenchmarkResultList =
        new ArrayList<>(oldResult.getSubSingleBenchmarkResultList().size());
