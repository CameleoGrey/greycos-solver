package ai.greycos.solver.benchmark.config.report;
...
import ai.greycos.solver.benchmark.config.ranking.SolverRankingType;
...
import ai.greycos.solver.core.impl.io.jaxb.adapter.JaxbLocaleAdapter;
...
public class BenchmarkReportConfig extends AbstractConfig<BenchmarkReportConfig> {
  ...
  public @NonNull BenchmarkReportConfig withSolverRankingType(
      @NonNull SolverRankingType solverRankingType) {
