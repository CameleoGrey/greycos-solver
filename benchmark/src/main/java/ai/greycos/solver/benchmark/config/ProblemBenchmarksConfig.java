...
public class ProblemBenchmarksConfig extends AbstractConfig<ProblemBenchmarksConfig> {
  ...
  public void setProblemStatisticTypeList(
      @Nullable List<@NonNull ProblemStatisticType> problemStatisticTypeList) {
  ...
  public void setSingleStatisticTypeList(
      @Nullable List<@NonNull SingleStatisticType> singleStatisticTypeList) {
  ...
  public @NonNull ProblemBenchmarksConfig withWriteOutputSolutionEnabled(
      @NonNull Boolean writeOutputSolutionEnabled) {
    this.setWriteOutputSolutionEnabled(writeOutputSolutionEnabled);
    return this;
  }

  public @NonNull ProblemBenchmarksConfig withInputSolutionFileList(
      @NonNull List<@NonNull File> inputSolutionFileList) {
    this.setInputSolutionFileList(inputSolutionFileList);
    return this;
  }

  public @NonNull ProblemBenchmarksConfig withInputSolutionFiles(
      @NonNull File... inputSolutionFiles) {
    this.setInputSolutionFileList(List.of(inputSolutionFiles));
    return this;
  }

  public @NonNull ProblemBenchmarksConfig withProblemStatisticsEnabled(
      @NonNull Boolean problemStatisticEnabled) {
    this.setProblemStatisticEnabled(problemStatisticEnabled);
    return this;
  }

  public @NonNull ProblemBenchmarksConfig withProblemStatisticTypeList(
      @NonNull List<@NonNull ProblemStatisticType> problemStatisticTypeList) {
    this.setProblemStatisticTypeList(problemStatisticTypeList);
    return this;
  }

  public @NonNull ProblemBenchmarksConfig withProblemStatisticTypes(
      @NonNull ProblemStatisticType... problemStatisticTypes) {
    this.setProblemStatisticTypeList(List.of(problemStatisticTypes));
    return this;
  }

  public @NonNull ProblemBenchmarksConfig withSingleStatisticTypeList(
      @NonNull List<@NonNull SingleStatisticType> singleStatisticTypeList) {
    this.setSingleStatisticTypeList(singleStatisticTypeList);
    return this;
  }

  public @NonNull ProblemBenchmarksConfig withSingleStatisticTypes(
      @NonNull SingleStatisticType... singleStatisticTypes) {
  ...
  /**
   * Return the problem statistic type list, or a list containing default metrics if
   * problemStatisticEnabled is not false. If problemStatisticEnabled is false, an empty list is
   * returned.
   */
  ...
  @Override
  public @NonNull ProblemBenchmarksConfig inherit(
    ...
    inputSolutionFileList =
        ConfigUtils.inheritMergeableListProperty(
            inputSolutionFileList, inheritedConfig.getInputSolutionFileList());
    problemStatisticEnabled =
        ConfigUtils.inheritOverwritableProperty(
            problemStatisticEnabled, inheritedConfig.getProblemStatisticEnabled());
    problemStatisticTypeList =
        ConfigUtils.inheritUniqueMergeableListProperty(
            problemStatisticTypeList, inheritedConfig.getProblemStatisticTypeList());
    singleStatisticTypeList =
        ConfigUtils.inheritUniqueMergeableListProperty(
            singleStatisticTypeList, inheritedConfig.getSingleStatisticTypeList());
    return this;
  }
