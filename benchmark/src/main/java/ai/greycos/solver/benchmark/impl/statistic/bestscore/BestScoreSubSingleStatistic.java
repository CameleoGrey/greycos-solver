...
public class BestScoreSubSingleStatistic<Solution_>
    ...
    registry.addListener(
        ...
        timestamp ->
            registry.extractScoreFromMeters(
                ...
                score ->
                    pointList.add(
                        new BestScoreStatisticPoint(
                            timestamp, score.raw(), score.isFullyAssigned()))));
  }
  ...
  @Override
  protected BestScoreStatisticPoint createPointFromCsvLine(
      ScoreDefinition<?> scoreDefinition, List<String> csvLine) {
    return new BestScoreStatisticPoint(
