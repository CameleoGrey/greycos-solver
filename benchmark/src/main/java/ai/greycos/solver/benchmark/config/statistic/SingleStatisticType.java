package ai.greycos.solver.benchmark.config.statistic;
...
public enum SingleStatisticType implements StatisticType {
  ...
  public @NonNull PureSubSingleStatistic buildPureSubSingleStatistic(
      @NonNull SubSingleBenchmarkResult subSingleBenchmarkResult) {
    switch (this) {
      ...
      default:
        throw new IllegalStateException(
            "The singleStatisticType (" + this + ") is not implemented.");
    }
  }
