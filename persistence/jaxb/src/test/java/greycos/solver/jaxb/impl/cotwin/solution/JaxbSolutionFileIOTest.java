package greycos.solver.jaxb.impl.cotwin.solution;
...
import greycos.solver.jaxb.testcotwin.JaxbTestdataEntity;
import greycos.solver.jaxb.testcotwin.JaxbTestdataSolution;
import greycos.solver.jaxb.testcotwin.JaxbTestdataValue;
...
class JaxbSolutionFileIOTest {
  ...
  @Test
  void readAndWrite() {
    JaxbSolutionFileIO<JaxbTestdataSolution> solutionFileIO =
        new JaxbSolutionFileIO<>(JaxbTestdataSolution.class);
    ...
    original.setEntityList(
        Arrays.asList(
            new JaxbTestdataEntity("e1"),
            new JaxbTestdataEntity("e2", originalV1),
            new JaxbTestdataEntity("e3")));
