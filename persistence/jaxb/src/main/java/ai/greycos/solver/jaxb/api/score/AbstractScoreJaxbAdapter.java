 ...
 *
 * <p>For example: use {@code @XmlJavaTypeAdapter(HardSoftScoreJaxbAdapter.class)} on a {@code
 * HardSoftScore score} field and it will marshalled to XML as {@code
 * <score>-999hard/-999soft</score>}.
 *
 * @see Score
