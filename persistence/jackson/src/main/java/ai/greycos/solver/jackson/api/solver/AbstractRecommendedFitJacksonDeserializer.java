...
public abstract class AbstractRecommendedFitJacksonDeserializer<
        Proposition_, Score_ extends Score<Score_>>
    extends JsonDeserializer<RecommendedFit<Proposition_, Score_>> {

  /**
   * {@link DefaultRecommendedFit} requires ID for purposes of ordering, to break ties if two
  ...
  @Override
  public final RecommendedFit<Proposition_, Score_> deserialize(
   ...
   * It is therefore the user and only the user who can deserialize the proposition. This type must
   * have a deserializer registered.
   *
   * @return never null
   */
