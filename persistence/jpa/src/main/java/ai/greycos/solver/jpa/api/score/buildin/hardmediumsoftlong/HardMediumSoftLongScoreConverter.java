package ai.greycos.solver.jpa.api.score.buildin.hardmediumsoftlong;
...
@Converter
public class HardMediumSoftLongScoreConverter
    implements AttributeConverter<HardMediumSoftLongScore, String> {
