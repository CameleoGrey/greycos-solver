package ai.greycos.solver.jpa.api.score.buildin.simplebigdecimal;
...
@Converter
public class SimpleBigDecimalScoreConverter
    implements AttributeConverter<SimpleBigDecimalScore, String> {
