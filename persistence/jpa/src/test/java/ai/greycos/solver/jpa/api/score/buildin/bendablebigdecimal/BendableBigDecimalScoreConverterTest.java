package ai.greycos.solver.jpa.api.score.buildin.bendablebigdecimal;
...
class BendableBigDecimalScoreConverterTest extends AbstractScoreJpaTest {
  ...
  void persistAndMerge() {
    persistAndMerge(
        new BendableBigDecimalScoreConverterTestJpaEntity(BendableBigDecimalScore.zero(3, 2)),
        null,
        BendableBigDecimalScore.of(
            new BigDecimal[] {
              new BigDecimal("10000.00001"),
              new BigDecimal("2000.00020"),
  ...
  @Entity
  static class BendableBigDecimalScoreConverterTestJpaEntity
      extends AbstractTestJpaEntity<BendableBigDecimalScore> {
