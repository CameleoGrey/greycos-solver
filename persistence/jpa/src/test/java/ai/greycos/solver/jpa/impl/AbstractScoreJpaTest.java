package ai.greycos.solver.jpa.impl;
...
public abstract class AbstractScoreJpaTest {
  ...
  protected <Score_ extends Score<Score_>, E extends AbstractTestJpaEntity<Score_>>
      Long persistAndAssert(E jpaEntity) {
    try {
  ...
  @SafeVarargs
  protected final <Score_ extends Score<Score_>, E extends AbstractTestJpaEntity<Score_>>
      void persistAndMerge(E jpaEntity, Score_... newScores) {
  ...
  protected <Score_ extends Score<Score_>, E extends AbstractTestJpaEntity<Score_>>
      void findAndAssert(Class<E> jpaEntityClass, Long id, Score_ score) {
    try {
      EntityManager em = entityManagerFactory.createEntityManager();
      // To avoid importing javax.transaction.*, which OpenRewrite fails to migrate.
      em.getTransaction().begin();
  ...
  @MappedSuperclass
  protected abstract static class AbstractTestJpaEntity<Score_ extends Score<Score_>> {
