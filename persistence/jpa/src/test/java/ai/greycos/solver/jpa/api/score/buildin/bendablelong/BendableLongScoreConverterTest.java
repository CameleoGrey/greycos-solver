package ai.greycos.solver.jpa.api.score.buildin.bendablelong;
...
class BendableLongScoreConverterTest extends AbstractScoreJpaTest {
  ...
  void persistAndMerge() {
    persistAndMerge(
        new BendableLongScoreConverterTestJpaEntity(BendableLongScore.zero(3, 2)),
        null,
        BendableLongScore.of(new long[] {10000L, 2000L, 300L}, new long[] {40L, 5L}));
  }

  @Entity
  static class BendableLongScoreConverterTestJpaEntity
      extends AbstractTestJpaEntity<BendableLongScore> {
