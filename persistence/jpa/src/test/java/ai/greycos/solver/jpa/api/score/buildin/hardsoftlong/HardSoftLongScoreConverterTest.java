package ai.greycos.solver.jpa.api.score.buildin.hardsoftlong;
...
class HardSoftLongScoreConverterTest extends AbstractScoreJpaTest {
  ...
  void persistAndMerge() {
    persistAndMerge(
        new HardSoftLongScoreConverterTestJpaEntity(HardSoftLongScore.ZERO),
        null,
        HardSoftLongScore.of(-10L, -2L));
  }

  @Entity
  static class HardSoftLongScoreConverterTestJpaEntity
      extends AbstractTestJpaEntity<HardSoftLongScore> {
