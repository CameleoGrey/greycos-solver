...
With Maven or Gradle, add the `io.github.cameleogrey : greycos-solver-core : {{projectVersion}}` dependency in your `pom.xml` to get started.

You can also import the GreyCOS Solver Bom (`io.github.cameleogrey : greycos-solver-bom : {{projectVersion}}`)
