...
class PillarSwapMoveSelectorConfigTest {
  ...
  void withMethodCallsProperlyChain() {
    ...
    PillarSwapMoveSelectorConfig pillarSwapMoveSelectorConfig =
        new PillarSwapMoveSelectorConfig()
            .withPillarSelectorConfig(
                new PillarSelectorConfig().withMinimumSubPillarSize(minimumSubPillarSize))
    ...
    assertSoftly(
        softly -> {
          softly
              .assertThat(pillarSwapMoveSelectorConfig.getFixedProbabilityWeight())
              .isEqualTo(fixedProbabilityWeight);
          softly.assertThat(pillarSwapMoveSelectorConfig.getPillarSelectorConfig()).isNotNull();
          softly
              .assertThat(
                  pillarSwapMoveSelectorConfig.getPillarSelectorConfig().getMinimumSubPillarSize())
              .isEqualTo(minimumSubPillarSize);
          softly
              .assertThat(pillarSwapMoveSelectorConfig.getSecondaryPillarSelectorConfig())
              .isNotNull();
          softly
              .assertThat(
