...
import ai.greycos.solver.core.testcotwin.score.TestdataHardSoftBigDecimalScoreSolution;
...
class HardSoftBigDecimalScoreInlinerTest
  ...
  void impactHard() {
    ...
    var scoreInliner =
        (AbstractScoreInliner<HardSoftBigDecimalScore>) impacter.getContext().inliner;
  ...
  void impactAll() {
    var constraintWeight =
        HardSoftBigDecimalScore.of(BigDecimal.valueOf(10), BigDecimal.valueOf(100));
    var impacter = buildScoreImpacter(constraintWeight);
    var scoreInliner =
        (AbstractScoreInliner<HardSoftBigDecimalScore>) impacter.getContext().inliner;
  ...
  @Override
  protected AbstractScoreInliner<HardSoftBigDecimalScore> buildScoreInliner(
