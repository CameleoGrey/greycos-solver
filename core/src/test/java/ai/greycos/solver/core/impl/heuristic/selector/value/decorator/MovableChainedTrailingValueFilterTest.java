...
class MovableChainedTrailingValueFilterTest {
  ...
  void getMovableChainedTrailingValueFilter() {
    VariableDescriptor<TestdataPinnedChainedSolution> variableDescriptor =
        TestdataPinnedChainedEntity.buildEntityDescriptor().getVariableDescriptor("chainedObject");
    assertThat(
            ((BasicVariableDescriptor<TestdataPinnedChainedSolution>) variableDescriptor)
