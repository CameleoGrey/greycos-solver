...
public class TestdataSimpleBigDecimalScoreSolution extends TestdataObject {
  ...
  public static SolutionDescriptor<TestdataSimpleBigDecimalScoreSolution>
      buildSolutionDescriptor() {
    return SolutionDescriptor.buildSolutionDescriptor(
        TestdataSimpleBigDecimalScoreSolution.class, TestdataEntity.class);
  }
  ...
  public static TestdataSimpleBigDecimalScoreSolution generateSolution(
    ...
    TestdataSimpleBigDecimalScoreSolution solution =
        new TestdataSimpleBigDecimalScoreSolution("Generated Solution 0");
