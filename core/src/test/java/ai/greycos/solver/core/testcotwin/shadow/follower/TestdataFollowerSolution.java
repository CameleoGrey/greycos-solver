...
public class TestdataFollowerSolution extends TestdataObject {
  ...
  @PlanningEntityCollectionProperty List<TestdataFollowerEntity> followers;
  ...
  public static TestdataFollowerSolution generateSolution(
    ...
    for (var i = 0; i < followerCount; i++) {
      ...
      followers.add(
          new TestdataFollowerEntity("Follower %d leader %s".formatted(i, leader), leader));
    }
