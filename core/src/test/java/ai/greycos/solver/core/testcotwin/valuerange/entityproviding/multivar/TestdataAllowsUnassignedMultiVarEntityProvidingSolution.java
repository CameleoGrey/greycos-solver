package ai.greycos.solver.core.testcotwin.valuerange.entityproviding.multivar;
...
public class TestdataAllowsUnassignedMultiVarEntityProvidingSolution extends TestdataObject {
  ...
  public static SolutionDescriptor<TestdataAllowsUnassignedMultiVarEntityProvidingSolution>
  ...
  public static TestdataAllowsUnassignedMultiVarEntityProvidingSolution generateSolution() {
    ...
    var solution =
        new TestdataAllowsUnassignedMultiVarEntityProvidingSolution("s1", List.of(value1, value2));
    var entity1 =
        new TestdataAllowsUnassignedMultiVarEntityProvidingEntity(
            "1", List.of(value1, value2, value3), List.of(value1, value2, value4, value5));
    var entity2 =
        new TestdataAllowsUnassignedMultiVarEntityProvidingEntity(
            "2", List.of(value1, value2, value3), List.of(value1, value2, value4, value5));
  ...
  public TestdataAllowsUnassignedMultiVarEntityProvidingSolution(
      String code, List<TestdataValue> solutionValueRange) {
    super(code);
  ...
  public void setEntityList(
      List<TestdataAllowsUnassignedMultiVarEntityProvidingEntity> entityList) {
