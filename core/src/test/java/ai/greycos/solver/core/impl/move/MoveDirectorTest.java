...
import ai.greycos.solver.core.testdomain.cascade.single.TestdataSingleCascadingEasyScoreCalculator;
...
import ai.greycos.solver.core.testdomain.cascade.single.TestdataSingleCascadingValue;
...
import ai.greycos.solver.core.testdomain.shadow.full.TestdataShadowedFullEasyScoreCalculator;
import ai.greycos.solver.core.testdomain.shadow.full.TestdataShadowedFullEntity;
import ai.greycos.solver.core.testdomain.shadow.full.TestdataShadowedFullMultiSwapListMove;
...
class MoveDirectorTest {
  ...
  void readBasicVariable() {
    ...
    var variableMetaModel =
        solutionMetaModel.entity(TestdataEntity.class).basicVariable("value", TestdataValue.class);
  ...
  void variableListenersAreTriggeredWhenSolutionIsConsistent() {
    ...
    try (var ephemeralMoveDirector = moveDirector.ephemeral()) {
      var scoreDirector = ephemeralMoveDirector.getScoreDirector();
      var move =
          new TestdataShadowedFullMultiSwapListMove(
              entityA,
              entityB,
