...
public class CorruptedUndoShadowVariableListener
  ...
  public void beforeEntityAdded(
      @NonNull ScoreDirector<CorruptedUndoShadowSolution> scoreDirector,
  ...
  private void update(
      ScoreDirector<CorruptedUndoShadowSolution> scoreDirector,
      CorruptedUndoShadowEntity corruptedUndoShadowEntity) {
    if (corruptedUndoShadowEntity.valueClone == null
        || !Objects.equals("v1", corruptedUndoShadowEntity.value.value)) {
