...
public class TestdataManyToManyShadowedEntity extends TestdataObject {
  ...
  @ShadowVariable(
      variableListenerClass = ComposedValuesUpdatingVariableListener.class,
      sourceVariableName = "primaryValue")
  @ShadowVariable(
      variableListenerClass = ComposedValuesUpdatingVariableListener.class,
      sourceVariableName = "secondaryValue")
  ...
  public static class ComposedValuesUpdatingVariableListener
      extends DummyVariableListener<
          TestdataManyToManyShadowedSolution, TestdataManyToManyShadowedEntity> {

    @Override
    public void afterEntityAdded(
        @NonNull ScoreDirector<TestdataManyToManyShadowedSolution> scoreDirector,
