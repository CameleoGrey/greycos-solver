...
class DefaultIndictmentTest {
  ...
  void getJustificationList() {
    ...
    assertThat(constraintJustification.getFacts()).containsExactly(e1, e2);

    assertThat(indictment.getJustificationList(DefaultConstraintJustification.class)).hasSize(1);
    constraintJustification =
        indictment.getJustificationList(DefaultConstraintJustification.class).get(0);
    assertThat(constraintJustification.getFacts()).containsExactly(e1, e2);
    ...
    DefaultConstraintJustification firstConstraintJustification =
        (DefaultConstraintJustification) indictment.getJustificationList().get(0);
    assertThat(firstConstraintJustification.getFacts()).containsExactly(e1, e2);
    ...
    assertThat(secondConstraintJustification.getFacts()).containsExactly(e1, e3);

    assertThat(indictment.getJustificationList(DefaultConstraintJustification.class)).hasSize(1);
    firstConstraintJustification =
        indictment.getJustificationList(DefaultConstraintJustification.class).get(0);
    assertThat(firstConstraintJustification.getFacts()).containsExactly(e1, e2);

    assertThat(indictment.getJustificationList(TestConstraintJustification.class)).hasSize(1);
    secondConstraintJustification =
        indictment.getJustificationList(TestConstraintJustification.class).get(0);
    assertThat(secondConstraintJustification.getFacts()).containsExactly(e1, e3);
  }
