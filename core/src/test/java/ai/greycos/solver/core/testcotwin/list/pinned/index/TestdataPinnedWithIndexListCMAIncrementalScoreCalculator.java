...
public class TestdataPinnedWithIndexListCMAIncrementalScoreCalculator
    implements ConstraintMatchAwareIncrementalScoreCalculator<
        TestdataPinnedWithIndexListSolution, SimpleScore> {
  ...
  public void resetWorkingSolution(
      @NonNull TestdataPinnedWithIndexListSolution workingSolution,
          ...
          Stream.of(left, right)
              .forEach(
                  value ->
                      indictmentMap
                          .computeIfAbsent(
                              value, key -> new DefaultIndictment<>(key, SimpleScore.ZERO))
