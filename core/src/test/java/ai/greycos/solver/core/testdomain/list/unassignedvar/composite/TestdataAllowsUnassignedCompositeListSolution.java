...
public class TestdataAllowsUnassignedCompositeListSolution {
  ...
  public static SolutionDescriptor<TestdataAllowsUnassignedCompositeListSolution>
  ...
  public static TestdataAllowsUnassignedCompositeListSolution generateSolution(
      int valueCount, int entityCount) {
    List<TestdataAllowsUnassignedCompositeListEntity> entityList =
        IntStream.range(0, entityCount)
            .mapToObj(i -> new TestdataAllowsUnassignedCompositeListEntity("Generated Entity " + i))
            .toList();
    List<TestdataListValue> firstValueList =
        IntStream.range(0, valueCount)
            .mapToObj(i -> new TestdataListValue("Generated Value " + i))
            .toList();
    List<TestdataListValue> secondValueList =
        IntStream.range(0, valueCount)
            .mapToObj(i -> new TestdataListValue("Generated Value " + (valueCount + i)))
            .toList();
    TestdataAllowsUnassignedCompositeListSolution solution =
        new TestdataAllowsUnassignedCompositeListSolution();
