...
public class SelectorTestUtils {
  ...
  public static <Solution_> GenuineVariableDescriptor<Solution_> mockVariableDescriptor(
      Class<?> entityClass, String variableName) {
  ...
  public static <Solution_> EntitySelector<Solution_> mockEntitySelector(
      Class<?> entityClass, Object... entities) {
    EntityDescriptor<Solution_> entityDescriptor = mockEntityDescriptor(entityClass);
  ...
  public static <Solution_> ValueSelector<Solution_> mockValueSelector(
    ...
    GenuineVariableDescriptor<Solution_> variableDescriptor =
        mockVariableDescriptor(entityClass, variableName);
  ...
  public static <Solution_> ValueSelector<Solution_> mockValueSelectorForEntity(
      Class<?> entityClass, Object entity, String variableName, Object... values) {
    return mockValueSelectorForEntity(
        entityClass, variableName, Collections.singletonMap(entity, Arrays.asList(values)));
  }

  private static <Solution_> ValueSelector<Solution_> mockValueSelectorForEntity(
      Class<?> entityClass, String variableName, Map<Object, List<Object>> entityToValues) {
    GenuineVariableDescriptor<Solution_> variableDescriptor =
        mockVariableDescriptor(entityClass, variableName);
  ...
  public static <Solution_> MimicReplayingEntitySelector<Solution_> mockReplayingEntitySelector(
      EntityDescriptor<Solution_> entityDescriptor, Object... entities) {
    MimicReplayingEntitySelector<Solution_> entitySelector =
        mock(MimicReplayingEntitySelector.class);
    when(entitySelector.getEntityDescriptor()).thenReturn(entityDescriptor);
    final List<Object> entityList = Arrays.asList(entities);
    when(entitySelector.endingIterator()).thenAnswer(invocation -> entityList.iterator());
    when(entitySelector.iterator()).thenAnswer(invocation -> entityList.iterator());
  ...
  public static <Solution_> MimicReplayingSubListSelector<Solution_> mockReplayingSubListSelector(
    ...
    MimicReplayingSubListSelector<Solution_> subListSelector =
        mock(MimicReplayingSubListSelector.class);
    ...
    List<Object> distinctValueList =
        subListList.stream()
            .map(subList -> variableDescriptor.getElement(subList.entity(), subList.fromIndex()))
            .distinct()
            .toList();
    when(subListSelector.endingValueIterator())
        .thenAnswer(invocation -> distinctValueList.iterator());
  ...
  public static <Solution_> SolverScope<Solution_> solvingStarted(
      PhaseLifecycleListener<Solution_> listener) {
  ...
  public static <Solution_> void phaseStarted(
      SolverScope<Solution_> solverScope, PhaseLifecycleListener<Solution_>... listeners) {
    for (var listener : listeners) {
      phaseStarted(listener, solverScope);
    }
  }

  public static <Solution_> AbstractPhaseScope<Solution_> phaseStarted(
      PhaseLifecycleListener<Solution_> listener, SolverScope<Solution_> solverScope) {
  ...
  public static <Solution_> AbstractStepScope<Solution_> stepStarted(
      PhaseLifecycleListener<Solution_> listener, AbstractPhaseScope<Solution_> phaseScope) {
  ...
  public static <Solution_, T extends PhaseLifecycleListener<Solution_>> void doInsideStep(
      T selector, AbstractPhaseScope<Solution_> phaseScope, Consumer<T> selectorAction) {
