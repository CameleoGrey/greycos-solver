...
@PlanningEntity
public class TestdataDynamicFollowerEntity extends TestdataObject
    implements TestdataDynamicHasValue {
  @PlanningVariable TestdataDynamicLeaderEntity leader;
