...
public class TestdataShadowedFullConsistencyListener
  ...
  public void beforeVariableChanged(
      @NonNull ScoreDirector<TestdataShadowedFullSolution> scoreDirector,
  ...
  public static void verifyConsistency(ScoreDirector<TestdataShadowedFullSolution> scoreDirector) {
    ...
    Set<TestdataShadowedFullValue> visitedValues =
        ...
        if (currentValue.nextValue != nextValue) {
          throw new IllegalStateException(
              """
                                    ...
                                    """
                  .formatted(
                      currentValue, nextValue, currentValue.nextValue, entity, entity.valueList));
        }
