...
import static ai.greycos.solver.core.testutil.PlannerAssert.assertAllCodesOfPillarSelector;
import static ai.greycos.solver.core.testutil.PlannerAssert.assertCodesOfNeverEndingPillarSelector;
import static ai.greycos.solver.core.testutil.PlannerAssert.assertEmptyNeverEndingPillarSelector;
...
class DefaultPillarSelectorTest {
  ...
  void originalNoSubs() {
    ...
    EntitySelector entitySelector =
        SelectorTestUtils.mockEntitySelector(
            variableDescriptor.getEntityDescriptor(), a, b, c, d, e, f);

    DefaultPillarSelector pillarSelector =
        new DefaultPillarSelector(
            entitySelector,
  ...
  void randomWithSubs() {
    ...
    DefaultPillarSelector pillarSelector =
        new DefaultPillarSelector(
            entitySelector,
            Arrays.asList(variableDescriptor),
            true,
  ...
  void randomWithSubs_Size2() {
    ...
    DefaultPillarSelector pillarSelector =
        new DefaultPillarSelector(
            ...
            Arrays.asList(variableDescriptor),
            true,
            SubPillarConfigPolicy.withSubpillars(2, 2));
  ...
  void sequentialUnlimited() {
    ...
    EntitySelector entitySelector =
        SelectorTestUtils.mockEntitySelector(
            ...
            e,
            c,
            b); // return entities in random order

    Comparator<TestdataEntity> lexicographicComparator =
  ...
  void reusePillarCache() {
    ...
    DefaultPillarSelector pillarSelector1 =
        new DefaultPillarSelector(
            entitySelector,
            List.of(variableDescriptor),
            false,
            SubPillarConfigPolicy.withoutSubpillars());
    DefaultPillarSelector pillarSelector2 =
        new DefaultPillarSelector(
            entitySelector,
            List.of(variableDescriptor),
            false,
