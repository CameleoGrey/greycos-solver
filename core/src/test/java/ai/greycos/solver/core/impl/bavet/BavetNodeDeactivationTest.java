...
import ai.greycos.solver.core.impl.bavet.common.tuple.ActivitySupport;
...
class BavetNodeDeactivationTest {
   ...
   * This test lives in package ai.greycos.solver.core.impl.bavet, so a base-typed reference
   * resolves them.
   *
