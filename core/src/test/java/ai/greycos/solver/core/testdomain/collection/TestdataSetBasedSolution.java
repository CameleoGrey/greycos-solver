...
public class TestdataSetBasedSolution extends TestdataObject {
  ...
  public static SolutionDescriptor<TestdataSetBasedSolution> buildSolutionDescriptor() {
    return SolutionDescriptor.buildSolutionDescriptor(
        TestdataSetBasedSolution.class, TestdataSetBasedEntity.class);
  }
  ...
  public void setEntityLinkedHashSet(LinkedHashSet<TestdataSetBasedEntity> entityLinkedHashSet) {
