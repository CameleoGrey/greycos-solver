...
class ListSwapMoveDefinitionTest {
  ...
  void fromSolution() {
    ...
    var moveIterable =
        createMoveIterable(
            new ListSwapMoveDefinition<>(variableMetaModel), solutionDescriptor, solution);
    ...
    assertSoftly(
        softly -> {
          softly.assertThat(move3.getPlanningEntities()).containsOnly(e2);
          softly.assertThat(move3.getPlanningValues()).containsOnly(assignedValue2, assignedValue3);
        });
  }
