...
import static ai.greycos.solver.core.api.solver.ScoreAnalysisFetchPolicy.FETCH_MATCH_COUNT;
import static ai.greycos.solver.core.api.solver.ScoreAnalysisFetchPolicy.FETCH_SHALLOW;
import static ai.greycos.solver.core.impl.score.director.InnerScoreDirector.getConstraintAnalysis;
...
class ScoreAnalysisTest {
  ...
  void summarize() {
    ...
    var emptyConstraintMatchTotal1 =
        new DefaultConstraintMatchTotal<>(constraintId3, SimpleScore.of(0));
    var constraintAnalysisMap =
        Map.of(
    ...
    var constraintSummary =
        constraintAnalysisMap.get(constraintMatchTotal.getConstraintRef()).summarize();
  ...
  void failFastSummarize() {
    ...
    var constraintAnalysisMap =
        Map.of(
            constraintMatchTotal.getConstraintRef(),
            getConstraintAnalysis(constraintMatchTotal, FETCH_SHALLOW));
  ...
  void summarizeWithLimit() {
    ...
    var constraintSummaryWith1 =
        constraintAnalysisMap.get(constraintMatchTotal.getConstraintRef()).summarize(1);
  ...
  void diffWithConstraintMatchesWithoutMatchAnalysis() {
    ...
    var emptyConstraintMatchTotal1 =
        new DefaultConstraintMatchTotal<>(constraintId3, SimpleScore.of(0));
    var constraintAnalysisMap1 =
        Map.of(
            constraintMatchTotal1.getConstraintRef(),
            getConstraintAnalysis(constraintMatchTotal1, FETCH_SHALLOW),
            constraintMatchTotal2.getConstraintRef(),
            getConstraintAnalysis(constraintMatchTotal2, FETCH_SHALLOW),
            emptyConstraintMatchTotal1.getConstraintRef(),
    ...
    var emptyConstraintMatchTotal2 =
        new DefaultConstraintMatchTotal<>(constraintId1, SimpleScore.of(0));
    ...
    var constraintAnalysisMap2 =
        Map.of(
            emptyConstraintMatchTotal2.getConstraintRef(),
                getConstraintAnalysis(emptyConstraintMatchTotal2, FETCH_SHALLOW),
            constraintMatchTotal3.getConstraintRef(),
                getConstraintAnalysis(constraintMatchTotal3, FETCH_SHALLOW),
            constraintMatchTotal4.getConstraintRef(),
                getConstraintAnalysis(constraintMatchTotal4, FETCH_SHALLOW));
    ...
    assertSoftly(
        softly -> {
          ...
          softly
              .assertThat(reverseDiff.constraintMap())
              .containsOnlyKeys(
                  constraintMatchTotal1.getConstraintRef(),
                  constraintMatchTotal3.getConstraintRef(),
                  constraintMatchTotal4.getConstraintRef());
  ...
  void diffWithConstraintMatchesWithMatchCountOnly() {
    ...
    var constraintAnalysisMap1 =
        Map.of(
            constraintMatchTotal1.getConstraintRef(),
            getConstraintAnalysis(constraintMatchTotal1, FETCH_MATCH_COUNT),
            constraintMatchTotal2.getConstraintRef(),
            getConstraintAnalysis(constraintMatchTotal2, FETCH_MATCH_COUNT),
            emptyConstraintMatchTotal1.getConstraintRef(),
    ...
    var constraintAnalysisMap2 =
        Map.of(
            ...
            constraintMatchTotal3.getConstraintRef(),
            getConstraintAnalysis(constraintMatchTotal3, FETCH_MATCH_COUNT),
            constraintMatchTotal4.getConstraintRef(),
            getConstraintAnalysis(constraintMatchTotal4, FETCH_MATCH_COUNT));
    var scoreAnalysis2 = new ScoreAnalysis<>(SimpleScore.of(42), constraintAnalysisMap2);
  ...
  void diffWithConstraintMatchesAndMatchAnalysis() {
    ...
    var constraintAnalysisMap1 =
        Map.of(
            constraintMatchTotal1.getConstraintRef(),
                getConstraintAnalysis(constraintMatchTotal1, FETCH_ALL),
            constraintMatchTotal2.getConstraintRef(),
                getConstraintAnalysis(constraintMatchTotal2, FETCH_ALL),
            emptyConstraintMatchTotal1.getConstraintRef(),
                getConstraintAnalysis(emptyConstraintMatchTotal1, FETCH_ALL));
    var scoreAnalysis1 = new ScoreAnalysis<>(SimpleScore.of(50), constraintAnalysisMap1);
    ...
    var constraintAnalysisMap2 =
        Map.of(
            emptyConstraintMatchTotal2.getConstraintRef(),
                getConstraintAnalysis(emptyConstraintMatchTotal2, FETCH_ALL),
            constraintMatchTotal3.getConstraintRef(),
                getConstraintAnalysis(constraintMatchTotal3, FETCH_ALL),
            constraintMatchTotal4.getConstraintRef(),
                getConstraintAnalysis(constraintMatchTotal4, FETCH_ALL));
    var scoreAnalysis2 = new ScoreAnalysis<>(SimpleScore.of(42), constraintAnalysisMap2);
    ...
    assertSoftly(
        softly -> {
          ...
          softly
              .assertThat(matchAnalyses)
              .containsOnly(
                  matchAnalysisOf(reverseConstraintAnalysis3.constraintRef(), 3, "B", "C", "D"),
  ...
  private void addConstraintMatch(
      DefaultConstraintMatchTotal<SimpleScore> constraintMatchTotal,
      SimpleScore impact,
      Object... indictments) {
    constraintMatchTotal.addConstraintMatch(
        DefaultConstraintJustification.of(impact, indictments), Arrays.asList(indictments), impact);
  }

  private static MatchAnalysis<SimpleScore> matchAnalysisOf(
      ConstraintRef constraintRef, int score, Object... facts) {
    var simpleScore = SimpleScore.of(score);
    return new MatchAnalysis<>(
        constraintRef, simpleScore, DefaultConstraintJustification.of(simpleScore, facts));
  }
}
