...
class AllowsUnassignedValuesListVariableSolverTest {
                ...
                new LocalSearchPhaseConfig()
                    .withAcceptorConfig(
                        new LocalSearchAcceptorConfig()
                            ...
                            .withValueTabuSize(1)
                            .withMoveTabuSize(1))
                    .withForagerConfig(new LocalSearchForagerConfig().withAcceptedCountLimit(100))
  ...
  enum ListVariableMoveType {
    ...
    CHANGE_SWAP_AND_SUBLIST_CHANGE(
        new ChangeMoveSelectorConfig(),
        new SwapMoveSelectorConfig(),
        new SubListChangeMoveSelectorConfig()),
    CHANGE_SWAP_AND_SUBLIST_SWAP(
        new ChangeMoveSelectorConfig(),
        new SwapMoveSelectorConfig(),
        new SubListSwapMoveSelectorConfig()),
    KOPT(new KOptListMoveSelectorConfig().withMinimumK(2).withMaximumK(3)),
    CHANGE_SWAP_AND_KOPT(
        new ChangeMoveSelectorConfig(),
        new SwapMoveSelectorConfig(),
        new KOptListMoveSelectorConfig().withMinimumK(2).withMaximumK(3)),
    ALL(
        new ChangeMoveSelectorConfig(),
        new SwapMoveSelectorConfig(),
        new SubListChangeMoveSelectorConfig(),
