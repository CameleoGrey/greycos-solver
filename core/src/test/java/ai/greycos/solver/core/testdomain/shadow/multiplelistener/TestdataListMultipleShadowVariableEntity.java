package ai.greycos.solver.core.testdomain.shadow.multiplelistener;
...
public class TestdataListMultipleShadowVariableEntity extends TestdataObject {
  ...
  public static ListVariableDescriptor<TestdataListMultipleShadowVariableSolution>
      buildVariableDescriptorForValueList() {
    return (ListVariableDescriptor<TestdataListMultipleShadowVariableSolution>)
  ...
  public TestdataListMultipleShadowVariableEntity(
      String code, List<TestdataListMultipleShadowVariableValue> valueList) {
    super(code);
    this.valueList = valueList;
  }

  public TestdataListMultipleShadowVariableEntity(
      String code, TestdataListMultipleShadowVariableValue... values) {
