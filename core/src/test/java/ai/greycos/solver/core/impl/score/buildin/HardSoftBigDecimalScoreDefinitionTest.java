...
class HardSoftBigDecimalScoreDefinitionTest {
  ...
  void getLevelLabels() {
    assertThat(new HardSoftBigDecimalScoreDefinition().getLevelLabels())
        .containsExactly("hard score", "soft score");
  }
  ...
  void divideBySanitizedDivisor() {
    ...
    var dividend = scoreDefinition.fromLevelNumbers(new Number[] {BigDecimal.ZERO, BigDecimal.TEN});
    ...
    var tenDivisor =
        scoreDefinition.fromLevelNumbers(new Number[] {BigDecimal.TEN, BigDecimal.TEN});
    assertThat(scoreDefinition.divideBySanitizedDivisor(dividend, tenDivisor))
        .isEqualTo(
            scoreDefinition.fromLevelNumbers(new Number[] {BigDecimal.ZERO, BigDecimal.ONE}));
  }
}
