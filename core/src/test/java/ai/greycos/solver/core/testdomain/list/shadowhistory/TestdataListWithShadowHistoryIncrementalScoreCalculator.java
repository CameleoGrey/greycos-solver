package ai.greycos.solver.core.testdomain.list.shadowhistory;
...
public class TestdataListWithShadowHistoryIncrementalScoreCalculator
    implements ConstraintMatchAwareIncrementalScoreCalculator<
        TestdataListSolutionWithShadowHistory, SimpleScore> {
  ...
  public void resetWorkingSolution(
      @NonNull TestdataListSolutionWithShadowHistory workingSolution,
      boolean constraintMatchEnabled) {
    this.workingSolution = workingSolution;
  }

  private DefaultConstraintMatchTotal<SimpleScore> update(
      TestdataListSolutionWithShadowHistory workingSolution) {
    ...
    for (var e : workingSolution.getEntityList()) {
      ...
      if (value != 0) {
        constraintMatchTotal.addConstraintMatch(
            Collections.singletonList(e), SimpleScore.of(-value));
      }
    }
