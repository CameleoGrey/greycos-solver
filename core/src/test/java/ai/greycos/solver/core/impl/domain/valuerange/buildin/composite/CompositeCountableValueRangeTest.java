package ai.greycos.solver.core.impl.domain.valuerange.buildin.composite;
...
class CompositeCountableValueRangeTest {
  ...
  @Test
  void getSize() {
    assertThat(createValueRange(Arrays.asList(0, 2, 5, 10), Arrays.asList(-15, 25, -1)).getSize())
        .isEqualTo(7L);
    assertThat(
            createValueRange(Arrays.asList("a", "b"), Arrays.asList("c"), Arrays.asList("d"))
                .getSize())
        .isEqualTo(4L);
  ...
  void get() {
    assertThat(
            createValueRange(Arrays.asList(0, 2, 5, 10), Arrays.asList(-15, 25, -1))
                .get(2L)
                .intValue())
        .isEqualTo(5);
    assertThat(
  ...
  @Test
  void contains() {
    assertThat(createValueRange(Arrays.asList(0, 2, 5, 10), Arrays.asList(-15, 25, -1)).contains(5))
        .isTrue();
    assertThat(createValueRange(Arrays.asList(0, 2, 5, 10), Arrays.asList(-15, 25, -1)).contains(4))
        .isFalse();
    assertThat(
            createValueRange(Arrays.asList(0, 2, 5, 10), Arrays.asList(-15, 25, -1)).contains(-15))
        .isTrue();
    assertThat(
            createValueRange(Arrays.asList(0, 2, 5, 10), Arrays.asList(-15, 25, -1)).contains(-14))
        .isFalse();
    assertThat(
            createValueRange(Arrays.asList(0, 2, 5, 10), Arrays.asList(-15, 25, -1)).contains(-1))
        .isTrue();
    assertThat(createValueRange(Arrays.asList(0, 2, 5, 10), Arrays.asList(-15, 25, -1)).contains(1))
        .isFalse();
    assertThat(
            createValueRange(Arrays.asList("a", "b"), Arrays.asList("c"), Arrays.asList("d"))
                .contains("c"))
  ...
  void createOriginalIterator() {
    ...
    assertAllElementsOfIterator(
        ...
        "c",
        "d");
    assertAllElementsOfIterator(createValueRange(Collections.emptyList()).createOriginalIterator());
  }
  ...
  void createRandomIterator() {
    ...
    assertElementsOfIterator(
        ...
        "a");
    assertElementsOfIterator(
        createValueRange(Collections.emptyList()).createRandomIterator(new TestRandom(0)));
  }
