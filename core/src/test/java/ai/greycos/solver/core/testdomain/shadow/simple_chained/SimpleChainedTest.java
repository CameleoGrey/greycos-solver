package ai.greycos.solver.core.testdomain.shadow.simple_chained;
  ...
  void simpleChained() {
    var solverConfig =
        new SolverConfig()
            ...
            .withEntityClasses(
                TestdataChainedSimpleVarEntity.class, TestdataChainedSimpleVarValue.class)
    ...
    var entityList =
        List.of(
            new TestdataChainedSimpleVarEntity("e1", Duration.ofDays(1)),
