...
class ChainedChangeMoveTest {
  ...
  void rebase() {
    ...
    assertSameProperties(
        destinationA1,
        null,
        new ChainedChangeMove<>(variableDescriptor, a1, null, inverseVariableSupply)
    ...
    assertSameProperties(
        destinationC1,
        destinationA2,
        new ChainedChangeMove<>(variableDescriptor, c1, a2, inverseVariableSupply)
            .rebase(destinationScoreDirector));
  }

  public void assertSameProperties(
      Object entity, Object toPlanningVariable, ChainedChangeMove<?> move) {
    assertSoftly(
        softly -> {
