...
import ai.greycos.solver.core.testcotwin.score.TestdataHardSoftLongScoreSolution;
...
class HardSoftLongScoreInlinerTest
  ...
  void defaultScore() {
    ...
    assertThat(scoreInliner.extractScore()).isEqualTo(HardSoftLongScore.ZERO);
  }
  ...
  void impactHard() {
    ...
    assertThat(scoreInliner.extractScore()).isEqualTo(HardSoftLongScore.of(90, 0));

    var undo2 = impacter.impactScore(2, ConstraintMatchSupplier.empty());
    assertThat(scoreInliner.extractScore()).isEqualTo(HardSoftLongScore.of(270, 0));

    undo2.run();
    assertThat(scoreInliner.extractScore()).isEqualTo(HardSoftLongScore.of(90, 0));

    undo1.run();
    assertThat(scoreInliner.extractScore()).isEqualTo(HardSoftLongScore.of(0, 0));
  }
  ...
  void impactSoft() {
    ...
    var undo1 = impacter.impactScore(1, ConstraintMatchSupplier.empty());
    assertThat(scoreInliner.extractScore()).isEqualTo(HardSoftLongScore.of(0, 90));

    var undo2 = impacter.impactScore(2, ConstraintMatchSupplier.empty());
    assertThat(scoreInliner.extractScore()).isEqualTo(HardSoftLongScore.of(0, 270));
  ...
  void impactAll() {
    ...
    assertThat(scoreInliner.extractScore()).isEqualTo(HardSoftLongScore.of(100, 1_000));

    var undo2 = impacter.impactScore(20, ConstraintMatchSupplier.empty());
    assertThat(scoreInliner.extractScore()).isEqualTo(HardSoftLongScore.of(300, 3_000));
  ...
  @Override
  protected AbstractScoreInliner<HardSoftLongScore> buildScoreInliner(
