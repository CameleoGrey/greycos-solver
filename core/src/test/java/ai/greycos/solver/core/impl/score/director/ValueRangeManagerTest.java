...
import static ai.greycos.solver.core.testutil.PlannerAssert.assertNonNullCodesOfIterator;
import static ai.greycos.solver.core.testutil.PlannerAssert.assertReversedNonNullCodesOfIterator;
...
import ai.greycos.solver.core.testdomain.composite.TestdataCompositeEntity;
import ai.greycos.solver.core.testdomain.composite.TestdataCompositeSolution;
...
import ai.greycos.solver.core.testdomain.list.composite.TestdataListCompositeEntity;
import ai.greycos.solver.core.testdomain.list.composite.TestdataListCompositeSolution;
...
import ai.greycos.solver.core.testdomain.list.unassignedvar.composite.TestdataAllowsUnassignedCompositeListEntity;
import ai.greycos.solver.core.testdomain.list.unassignedvar.composite.TestdataAllowsUnassignedCompositeListSolution;
...
import ai.greycos.solver.core.testdomain.list.valuerange.composite.TestdataListCompositeEntityProvidingEntity;
import ai.greycos.solver.core.testdomain.list.valuerange.composite.TestdataListCompositeEntityProvidingSolution;
...
import ai.greycos.solver.core.testdomain.list.valuerange.unassignedvar.composite.TestdataListUnassignedCompositeEntityProvidingEntity;
import ai.greycos.solver.core.testdomain.list.valuerange.unassignedvar.composite.TestdataListUnassignedCompositeEntityProvidingSolution;
...
import ai.greycos.solver.core.testdomain.unassignedvar.composite.TestdataAllowsUnassignedCompositeEntity;
import ai.greycos.solver.core.testdomain.unassignedvar.composite.TestdataAllowsUnassignedCompositeSolution;
import ai.greycos.solver.core.testdomain.valuerange.TestdataValueRangeEntity;
import ai.greycos.solver.core.testdomain.valuerange.TestdataValueRangeSolution;
import ai.greycos.solver.core.testdomain.valuerange.entityproviding.TestdataEntityProvidingEntity;
import ai.greycos.solver.core.testdomain.valuerange.entityproviding.TestdataEntityProvidingSolution;
import ai.greycos.solver.core.testdomain.valuerange.entityproviding.composite.TestdataCompositeEntityProvidingEntity;
import ai.greycos.solver.core.testdomain.valuerange.entityproviding.composite.TestdataCompositeEntityProvidingSolution;
...
import ai.greycos.solver.core.testdomain.valuerange.entityproviding.unassignedvar.composite.TestdataAllowsUnassignedCompositeEntityProvidingEntity;
import ai.greycos.solver.core.testdomain.valuerange.entityproviding.unassignedvar.composite.TestdataAllowsUnassignedCompositeEntityProvidingSolution;
...
class ValueRangeManagerTest {
  ...
  void extractValueFromSolutionUnassignedBasicVariable() {
    ...
    var valueRangeDescriptor =
        TestdataAllowsUnassignedEntity.buildVariableDescriptorForValue().getValueRangeDescriptor();
    var solutionDescriptor =
        valueRangeDescriptor.getVariableDescriptor().getEntityDescriptor().getSolutionDescriptor();
  ...
  void extractValueFromSolutionCompositeUnassignedBasicVariable() {
    ...
    var valueRangeDescriptor =
        TestdataAllowsUnassignedCompositeEntity.buildVariableDescriptorForValue()
  ...
  void extractValueFromSolutionAssignedBasicVariable() {
    ...
    var valueRangeDescriptor =
        TestdataEntity.buildVariableDescriptorForValue().getValueRangeDescriptor();
    var solutionDescriptor =
        valueRangeDescriptor.getVariableDescriptor().getEntityDescriptor().getSolutionDescriptor();
    var valueRangeManager = ValueRangeManager.of(solutionDescriptor, solution);
  ...
  void extractValueFromSolutionCompositeAssignedBasicVariable() {
    ...
    var valueRangeDescriptor =
        TestdataCompositeSolution.buildSolutionDescriptor()
  ...
  void extractValueFromEntityUnassignedBasicVariable() {
    ...
    var valueRangeDescriptor =
        TestdataAllowsUnassignedEntityProvidingEntity.buildVariableDescriptorForValue()
            .getValueRangeDescriptor();
    var solutionDescriptor =
        valueRangeDescriptor.getVariableDescriptor().getEntityDescriptor().getSolutionDescriptor();
    var valueRangeManager = ValueRangeManager.of(solutionDescriptor, solution);
  ...
  void sortValueFromEntityUnassignedBasicVariable() {
    var solution =
        TestdataAllowsUnassignedEntityProvidingSolution.generateUninitializedSolution(6, 2);
    var valueRangeDescriptor =
        TestdataAllowsUnassignedEntityProvidingEntity.buildVariableDescriptorForValue()
            .getValueRangeDescriptor();
    // 3 values per entity
    assertSolutionValueRangeSortingOrder(
        ...
        List.of(
            ...
            "Generated Value 4",
            "Generated Value 5"));
    assertEntityValueRangeSortingOrder(
        solution,
  ...
  void extractValueFromEntityCompositeUnassignedBasicVariable() {
    ...
    var valueRangeDescriptor =
        TestdataAllowsUnassignedCompositeEntityProvidingEntity.buildVariableDescriptorForValue()
            .getValueRangeDescriptor();
    var solutionDescriptor =
        valueRangeDescriptor.getVariableDescriptor().getEntityDescriptor().getSolutionDescriptor();
    var valueRangeManager = ValueRangeManager.of(solutionDescriptor, solution);
  ...
  void extractValueFromEntityAssignedBasicVariable() {
    ...
    var valueRangeDescriptor =
        TestdataEntityProvidingEntity.buildVariableDescriptorForValue().getValueRangeDescriptor();
    var solutionDescriptor =
        valueRangeDescriptor.getVariableDescriptor().getEntityDescriptor().getSolutionDescriptor();
    var valueRangeManager = ValueRangeManager.of(solutionDescriptor, solution);
  ...
  void extractValueFromEntityCompositeAssignedBasicVariable() {
    ...
    var valueRangeDescriptor =
        TestdataCompositeEntityProvidingEntity.buildVariableDescriptorForValue()
            .getValueRangeDescriptor();
    var solutionDescriptor =
        valueRangeDescriptor.getVariableDescriptor().getEntityDescriptor().getSolutionDescriptor();
    var valueRangeManager = ValueRangeManager.of(solutionDescriptor, solution);
  ...
  void extractValueFromSolutionCompositeUnassignedListVariable() {
    ...
    var valueRangeDescriptor =
        TestdataAllowsUnassignedCompositeListEntity.buildVariableDescriptorForValueList()
            .getValueRangeDescriptor();
    var solutionDescriptor =
        TestdataAllowsUnassignedCompositeListSolution.buildSolutionDescriptor();
    var valueRangeManager = ValueRangeManager.of(solutionDescriptor, solution);
  ...
  void extractValueFromSolutionCompositeAssignedListVariable() {
    ...
    var valueRangeDescriptor =
        TestdataListCompositeEntity.buildVariableDescriptorForValueList().getValueRangeDescriptor();
    var solutionDescriptor =
        valueRangeDescriptor.getVariableDescriptor().getEntityDescriptor().getSolutionDescriptor();
    var valueRangeManager = ValueRangeManager.of(solutionDescriptor, solution);
  ...
  void extractValueFromEntityUnassignedListVariable() {
    ...
    var valueRangeDescriptor =
        TestdataListUnassignedEntityProvidingEntity.buildVariableDescriptorForValueList()
            .getValueRangeDescriptor();
    var solutionDescriptor =
        valueRangeDescriptor.getVariableDescriptor().getEntityDescriptor().getSolutionDescriptor();
    var valueRangeManager = ValueRangeManager.of(solutionDescriptor, solution);
  ...
  void extractValueFromEntityCompositeUnassignedListVariable() {
    ...
    var valueRangeDescriptor =
        TestdataListUnassignedCompositeEntityProvidingEntity.buildVariableDescriptorForValueList()
            .getValueRangeDescriptor();
    var solutionDescriptor =
        valueRangeDescriptor.getVariableDescriptor().getEntityDescriptor().getSolutionDescriptor();
    var valueRangeManager = ValueRangeManager.of(solutionDescriptor, solution);
  ...
  void extractValueFromEntityCompositeAssignedListVariable() {
    ...
    var valueRangeDescriptor =
        TestdataListCompositeEntityProvidingEntity.buildVariableDescriptorForValueList()
            .getValueRangeDescriptor();
    var solutionDescriptor =
        valueRangeDescriptor.getVariableDescriptor().getEntityDescriptor().getSolutionDescriptor();
    var valueRangeManager = ValueRangeManager.of(solutionDescriptor, solution);
    ...
    assertSoftly(
        softly -> {
          ...
          softly
              ...
              .isCloseTo(
                  Math.log10(Math.pow(valueCount, variableCount)), Percentage.withPercentage(1.0));
        });
  }
  ...
  void basicVariableProblemScaleEntityProvidingValueRange() {
    ...
    solution.setEntityList(
        List.of(
            new TestdataAllowsUnassignedEntityProvidingEntity("A", List.of(v1, v2)),
            new TestdataAllowsUnassignedEntityProvidingEntity(
                "B", List.of(v1, v2, new TestdataValue("3")))));
    ...
    solution.setEntityList(
        List.of(
            ...
            new TestdataListEntityProvidingEntity(
                "e2", List.of(v1, v2, new TestdataListEntityProvidingValue("3")))));
  ...
  void problemScaleSingleEntityProvidingSingleValueRange() {
    ...
    var v1 = new TestdataValue("1");
    solution.setEntityList(
        List.of(new TestdataAllowsUnassignedEntityProvidingEntity("A", List.of(v1))));
  ...
  void problemScaleSingleEntityWithUnassignedValues() {
    ...
    var solution =
        TestdataAllowsUnassignedValuesListSolution.generateUninitializedSolution(
            valueCount, entityCount);
  ...
  void deduplicationForEntity() {
    ...
    var valueRangeDescriptor =
        TestdataListEntityProvidingEntity.buildVariableDescriptorForValueList()
            .getValueRangeDescriptor();
    var solution =
        TestdataListEntityProvidingSolution.generateSolution(valueCount, entityCount, true);
  ...
  private <Solution_> void assertSolutionValueRangeSortingOrder(
      Solution_ solution,
  ...
  private <Solution_, Entity_> void assertEntityValueRangeSortingOrder(
      Solution_ solution,
      Entity_ entity,
      ValueRangeDescriptor<Solution_> valueRangeDescriptor,
      List<String> allValues) {
