package ai.greycos.solver.core.testdomain.list.pinned;
...
public class TestdataPinnedListSolution {
  ...
  public static TestdataPinnedListSolution generateUninitializedSolution(
      int valueCount, int entityCount) {
