...
abstract class AbstractIndexerTest {
  ...
  private static Iterable<Object> randomIterableForQuery(
  ...
  static Iterable<Object> randomIterableForCollectionQuery(
      Indexer<Object> indexer, String... keys) {
    return randomIterableForCollectionQuery(indexer, 0, keys);
  }

  private static Iterable<Object> randomIterableForCollectionQuery(
  ...
  static List<Object> randomListForCollectionQuery(
      Indexer<Object> indexer, long seed, String... keys) {
