...
public class TestdataListUnassignedEntityProvidingSolution {
  ...
  public static SolutionDescriptor<TestdataListUnassignedEntityProvidingSolution>
  ...
  public static PlanningSolutionMetaModel<TestdataListUnassignedEntityProvidingSolution>
      buildMetaModel() {
  ...
  public static TestdataListUnassignedEntityProvidingSolution generateSolution(
    ...
    for (var i = 0; i < entityListSize; i++) {
      ...
      var entity =
          new TestdataListUnassignedEntityProvidingEntity("Generated Entity " + i, valueRange);
