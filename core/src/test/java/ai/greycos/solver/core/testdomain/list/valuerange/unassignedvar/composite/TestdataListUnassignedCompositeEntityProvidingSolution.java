package ai.greycos.solver.core.testdomain.list.valuerange.unassignedvar.composite;
...
public class TestdataListUnassignedCompositeEntityProvidingSolution {
  ...
  public static SolutionDescriptor<TestdataListUnassignedCompositeEntityProvidingSolution>
      buildSolutionDescriptor() {
    return SolutionDescriptor.buildSolutionDescriptor(
        TestdataListUnassignedCompositeEntityProvidingSolution.class,
  ...
  public static TestdataListUnassignedCompositeEntityProvidingSolution generateSolution(
    ...
    var entityList =
        new ArrayList<TestdataListUnassignedCompositeEntityProvidingEntity>(entityListSize);
    for (var i = 0; i < entityListSize; i++) {
      ...
      var entity =
          new TestdataListUnassignedCompositeEntityProvidingEntity(
  ...
  public static TestdataListUnassignedCompositeEntityProvidingSolution generateSolution() {
    ...
    var entity1 =
        new TestdataListUnassignedCompositeEntityProvidingEntity(
            "e1", List.of(value1, value2), List.of(value1, value3));
    var entity2 =
        new TestdataListUnassignedCompositeEntityProvidingEntity(
            "e2", List.of(value1, value4), List.of(value1, value5));
