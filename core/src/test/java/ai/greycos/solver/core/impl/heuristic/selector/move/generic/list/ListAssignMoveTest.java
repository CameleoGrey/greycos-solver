...
class ListAssignMoveTest {
  ...
  void isMoveDoableValueRangeProviderOnEntity() {
    ...
    assertThat(
            new ListAssignMove<>(otherVariableDescriptor, v1, e1, 0)
                .isMoveDoable(otherInnerScoreDirector))
        .isTrue();
    assertThat(
            new ListAssignMove<>(otherVariableDescriptor, v1, e2, 0)
                .isMoveDoable(otherInnerScoreDirector))
        .isTrue();
  }
  ...
  static void assertSameProperties(
      Object movedValue, Object destinationEntity, int destinationIndex, ListAssignMove<?> move) {
  ...
  void toStringTest() {
    ...
    assertThat(new ListAssignMove<>(variableDescriptor, v1, e1, 15))
