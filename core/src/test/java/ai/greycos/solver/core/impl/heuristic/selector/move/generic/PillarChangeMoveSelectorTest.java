...
import ai.greycos.solver.core.impl.heuristic.selector.entity.pillar.DefaultPillarSelector;
...
class PillarChangeMoveSelectorTest {
  ...
  void original() {
    ...
    ValueSelector<TestdataSolution> valueSelector =
        mockIterableValueSelector(TestdataEntity.class, "value", v1, v2, v3);
    ...
    assertAllCodesOfMoveSelector(
        moveSelector, "[a, b, c, d]->1", "[a, b, c, d]->2", "[a, b, c, d]->3");
  }
}
