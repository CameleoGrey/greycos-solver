package ai.greycos.solver.core.testdomain.unassignedvar.composite;
...
public class TestdataAllowsUnassignedCompositeSolution extends TestdataObject {
  ...
  public static SolutionDescriptor<TestdataAllowsUnassignedCompositeSolution>
      buildSolutionDescriptor() {
    return SolutionDescriptor.buildSolutionDescriptor(
        TestdataAllowsUnassignedCompositeSolution.class,
        TestdataAllowsUnassignedCompositeEntity.class);
  }

  public static TestdataAllowsUnassignedCompositeSolution generateSolution(
