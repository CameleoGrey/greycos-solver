...
public class TestdataAllowsUnassignedValuesListEntity extends TestdataObject {
  ...
  public static TestdataAllowsUnassignedValuesListEntity createWithValues(
      String code, TestdataAllowsUnassignedValuesListValue... values) {
  ...
  public TestdataAllowsUnassignedValuesListEntity(
      String code, List<TestdataAllowsUnassignedValuesListValue> valueList) {
    super(code);
