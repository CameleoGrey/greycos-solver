...
import static ai.greycos.solver.core.preview.api.neighborhood.stream.enumerating.collector.NeighborhoodsCollectors.collectAndThen;
import static ai.greycos.solver.core.preview.api.neighborhood.stream.enumerating.collector.NeighborhoodsCollectors.compose;
import static ai.greycos.solver.core.preview.api.neighborhood.stream.enumerating.collector.NeighborhoodsCollectors.toList;
...
class NeighborhoodsCollectorsTest {
  ...
  private static <S_, A, C_, R_> UniNeighborhoodsCollectorValueHandle<A> accumulate(
    ...
    var slot = collector.accumulator().intoGroup(null, (C_) container);
    slot.add(value);
    return slot;
  }
  ...
  void uniCompose2() {
    UniNeighborhoodsCollector<Object, Integer, ?, Pair<List<Integer>, List<Integer>>> collector =
        compose(
            toList(),
            toList(),
            (BiFunction<List<Integer>, List<Integer>, Pair<List<Integer>, List<Integer>>>)
                Pair::new);
    Object container = collector.supplier().get();
  ...
  @Test
  void biCompose2() {
    BiNeighborhoodsCollector<Object, Integer, String, ?, Pair<List<Integer>, List<Integer>>>
        collector =
            compose(
                toList((view, a, b) -> a),
                toList((view, a, b) -> a),
