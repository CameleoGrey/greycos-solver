package ai.greycos.solver.core.testdomain.shadow.multi_entity;
...
public class TestdataMultiEntityDependencyEntity {
  @PlanningListVariable List<TestdataMultiEntityDependencyValue> values;

  @PlanningVariable TestdataMultiEntityDependencyDelay delay;
