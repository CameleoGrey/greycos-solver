package ai.greycos.solver.core.testdomain.equals;
...
public class TestdataEqualsByCodeSolution extends TestdataEqualsByCodeObject {
  ...
  public static SolutionDescriptor<TestdataEqualsByCodeSolution> buildSolutionDescriptor() {
    return SolutionDescriptor.buildSolutionDescriptor(
        TestdataEqualsByCodeSolution.class, TestdataEqualsByCodeEntity.class);
  }
  ...
  public static TestdataEqualsByCodeSolution generateSolution(
      String solutionId, int valueListSize, int entityListSize) {
    ...
    for (int i = 0; i < entityListSize; i++) {
      ...
      TestdataEqualsByCodeEntity entity =
          new TestdataEqualsByCodeEntity("Generated Entity " + i, value);
