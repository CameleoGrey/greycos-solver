...
public class TestdataEntityProvidingWithParameterSolution extends TestdataObject {
  ...
  public static SolutionDescriptor<TestdataEntityProvidingWithParameterSolution>
  ...
  public static TestdataEntityProvidingWithParameterSolution generateUninitializedSolution(
      int valueListSize, int entityListSize) {
    return generateSolution(valueListSize, entityListSize, false);
  }

  private static TestdataEntityProvidingWithParameterSolution generateSolution(
    ...
    for (var i = 0; i < entityListSize; i++) {
      ...
      var entity =
          new TestdataEntityProvidingWithParameterEntity("Generated Entity " + i, valueRange);
