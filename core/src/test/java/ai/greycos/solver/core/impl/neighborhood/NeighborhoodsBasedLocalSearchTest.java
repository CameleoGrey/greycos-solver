...
class NeighborhoodsBasedLocalSearchTest {
  ...
  private static NeighborhoodsBasedMoveRepository<TestdataSolution> getMoveRepository(
    ...
    return new NeighborhoodsBasedMoveRepository<>(
        moveStreamFactory, List.of(new ChangeMoveDefinition<>(variableMetaModel)), true);
  }
