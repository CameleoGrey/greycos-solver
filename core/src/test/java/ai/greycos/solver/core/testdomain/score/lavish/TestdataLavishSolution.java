package ai.greycos.solver.core.testdomain.score.lavish;
...
public class TestdataLavishSolution extends TestdataObject {
  ...
  public static SolutionDescriptor<TestdataLavishSolution> buildSolutionDescriptor() {
    return SolutionDescriptor.buildSolutionDescriptor(
        TestdataLavishSolution.class, TestdataLavishEntity.class);
  }
  ...
  public static TestdataLavishSolution generateSolution(
      int valueGroupListSize, int valueListSize, int entityGroupListSize, int entityListSize) {
    ...
    for (int i = 0; i < valueGroupListSize; i++) {
      TestdataLavishValueGroup valueGroup =
          new TestdataLavishValueGroup("Generated ValueGroup " + i);
    ...
    for (int i = 0; i < entityGroupListSize; i++) {
      TestdataLavishEntityGroup entityGroup =
          new TestdataLavishEntityGroup("Generated EntityGroup " + i);
    ...
    for (int i = 0; i < entityListSize; i++) {
      ...
      TestdataLavishEntity entity =
          new TestdataLavishEntity("Generated Entity " + i, entityGroup, value);
  ...
  @ProblemFactCollectionProperty private List<TestdataLavishValueGroup> valueGroupList;

  @ValueRangeProvider(id = "valueRange")
  @ProblemFactCollectionProperty
  private List<TestdataLavishValue> valueList;

  @ProblemFactCollectionProperty private List<TestdataLavishExtra> extraList;
  @ProblemFactCollectionProperty private List<TestdataLavishEntityGroup> entityGroupList;
  @PlanningEntityCollectionProperty private List<TestdataLavishEntity> entityList;
