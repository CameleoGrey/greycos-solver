...
public class TestdataSingleCascadingSolution {
  ...
  public static TestdataSingleCascadingSolution generateUninitializedSolution(
  ...
  private static TestdataSingleCascadingSolution generateSolution(int valueCount, int entityCount) {
    List<TestdataSingleCascadingEntity> entityList =
        IntStream.range(1, entityCount + 1)
            .mapToObj(i -> new TestdataSingleCascadingEntity("Generated Entity " + i))
            .toList();
    List<TestdataSingleCascadingValue> valueList =
        IntStream.range(1, valueCount + 1).mapToObj(TestdataSingleCascadingValue::new).toList();
