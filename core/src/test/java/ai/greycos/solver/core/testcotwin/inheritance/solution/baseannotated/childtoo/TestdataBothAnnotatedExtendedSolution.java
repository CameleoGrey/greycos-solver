...
public class TestdataBothAnnotatedExtendedSolution extends TestdataBothAnnotatedSolution {
  ...
  public static SolutionDescriptor<TestdataBothAnnotatedExtendedSolution>
  ...
  public static TestdataBothAnnotatedExtendedSolution generateSolution(
  ...
  public static TestdataBothAnnotatedExtendedSolution generateSolution(
    ...
    solution.setEntityList(
        IntStream.range(0, entityListSize)
            .mapToObj(i -> "entity" + i)
            .map(TestdataEntity::new)
            .toList());

    solution.setSubEntityList(
        IntStream.range(0, subEntityListSize)
            .mapToObj(i -> "subEntity" + i)
            .map(TestdataBothAnnotatedChildEntity::new)
            .toList());

    solution.setRawEntityList(
        IntStream.range(0, rawEntityListSize)
  ...
  @PlanningEntityProperty private TestdataEntity entity;
  @PlanningEntityProperty private TestdataBothAnnotatedChildEntity subEntity;
  @PlanningEntityCollectionProperty private List<TestdataBothAnnotatedChildEntity> subEntityList;
  @PlanningEntityCollectionProperty private List<Object> objectEntityList;
  @PlanningEntityCollectionProperty private List rawEntityList;
