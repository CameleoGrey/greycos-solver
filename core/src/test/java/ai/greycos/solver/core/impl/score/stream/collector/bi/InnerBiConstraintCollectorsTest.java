...
final class InnerBiConstraintCollectorsTest extends AbstractConstraintCollectorsTest {
  ...
  public void countDistinct() {
    BiConstraintCollector<Integer, Integer, ?, Long> collector =
        ConstraintCollectors.countDistinct(Integer::sum);
    Object container = collector.supplier().get();
  ...
  public void sum() {
    BiConstraintCollector<Integer, Integer, ?, Long> collector =
        ConstraintCollectors.sum(Integer::sum);
    Object container = collector.supplier().get();
  ...
  @Test
  public void toSet() {
    BiConstraintCollector<Integer, Integer, ?, Set<Integer>> collector =
        ConstraintCollectors.toSet(Integer::sum);
    Object container = collector.supplier().get();
  ...
  @Test
  public void toList() {
    BiConstraintCollector<Integer, Integer, ?, List<Integer>> collector =
        ConstraintCollectors.toList(Integer::sum);
    Object container = collector.supplier().get();
  ...
  public void toMapDuplicates() {
    ...
    // Add third value, different from the second. We now have three values, two of which map to the
    // same key.
  ...
  public void toSortedMapMerged() {
    BiConstraintCollector<Integer, Integer, ?, SortedMap<Integer, Integer>> collector =
        ConstraintCollectors.toSortedMap((a, b) -> a, (a, b) -> b, Integer::sum);
    Object container = collector.supplier().get();
  ...
  public void conditionally() {
    BiConstraintCollector<Integer, Integer, Object, Integer> collector =
        ConstraintCollectors.conditionally((i, i2) -> i < 2, max(Integer::sum, i -> i));
    Object container = collector.supplier().get();
  ...
  public void compose2() {
    BiConstraintCollector<Integer, Integer, ?, Pair<Integer, Integer>> collector =
        compose(min(Integer::sum, i -> i), max(Integer::sum, i -> i), Pair::new);
    Object container = collector.supplier().get();
  ...
  public void compose4() {
    BiConstraintCollector<Integer, Integer, ?, Quadruple<Long, Integer, Integer, Double>>
        collector =
            compose(
                countBi(),
                min(Integer::sum, i -> i),
  ...
  public void consecutiveUsage() {
    var collector =
        ConstraintCollectors.toConnectedRanges(
            Interval::new, Interval::start, Interval::end, (a, b) -> b - a);
    var container = collector.supplier().get();
  ...
  public void loadBalance() {
    var collector =
        ConstraintCollectors.<String, Integer, String>loadBalance((a, b) -> a, (a, b) -> b);
    var container = collector.supplier().get();
  ...
  private static <A, B, Container_, Result_> Runnable accumulate(
      ...
      B valueB) {
    var slot =
        ((BiConstraintCollectorAccumulator<Container_, A, B>) collector.accumulator())
  ...
  public void conditionallyUpdate() {
    BiConstraintCollector<Integer, Integer, Object, Integer> collector =
        ConstraintCollectors.conditionally(
            (Integer a, Integer b) -> a < 2, min(Integer::sum, i -> i));
    Object container = collector.supplier().get();
  ...
  public void countDistinctUpdate() {
    BiConstraintCollector<String, String, ?, Long> collector =
        ConstraintCollectors.countDistinct((a, b) -> a);
    var container = collector.supplier().get();
  ...
  public void toCollectionUpdate() {
    var collector =
        InnerBiConstraintCollectors.<Integer, Integer, Integer, ArrayList<Integer>>toCollection(
            (a, b) -> a, ArrayList::new);
    var container = collector.supplier().get();
    var slot1 = insert(collector, container, 1, 0);
    var slot2 = insert(collector, container, 2, 0);
  ...
  public void toMapUpdate() {
    var collector =
        ConstraintCollectors.<Integer, Integer, Integer, Integer>toMap(Integer::sum, Integer::sum);
    var container = collector.supplier().get();
    var slot1 = insert(collector, container, 2, 0);
  ...
  public void toMapMergedUpdate() {
    var collector =
        ConstraintCollectors.<Integer, Integer, Integer, Integer>toMap(
  ...
  public void toSortedMapUpdate() {
    var collector =
        ConstraintCollectors.<Integer, Integer, Integer, Integer>toSortedMap(
  ...
  private static <Container_> void assertUnfairness(
      BiConstraintCollector<String, Integer, Container_, LoadBalance<String>> collector,
      Object container,
