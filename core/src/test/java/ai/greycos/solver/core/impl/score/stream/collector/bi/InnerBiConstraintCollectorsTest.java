...
import static ai.greycos.solver.core.api.score.stream.ConstraintCollectors.countLongBi;
...
final class InnerBiConstraintCollectorsTest extends AbstractConstraintCollectorsTest {
  ...
  public void countDistinctLong() {
    BiConstraintCollector<Integer, Integer, ?, Long> collector =
        ConstraintCollectors.countDistinctLong(Integer::sum);
    Object container = collector.supplier().get();
  ...
  public void sumLong() {
    BiConstraintCollector<Integer, Integer, ?, Long> collector =
        ConstraintCollectors.sumLong(Integer::sum);
    Object container = collector.supplier().get();
  ...
  public void compose4() {
    BiConstraintCollector<Integer, Integer, ?, Quadruple<Integer, Integer, Integer, Double>>
        collector =
            compose(
  ...
  public void collectAndThen() {
    var collector =
        ConstraintCollectors.collectAndThen(ConstraintCollectors.countBi(), i -> i * 10);
    var container = collector.supplier().get();
