...
class SubChainReversingSwapMoveTest {
  ...
  void noTrailing() {
    ...
    var inverseVariableSupply =
        SelectorTestUtils.mockSingletonInverseVariableSupply(
  ...
  void rebase() {
    ...
    assertSameProperties(
        Arrays.asList(destinationA1, destinationA2, destinationA3),
        Arrays.asList(destinationC1),
        new SubChainReversingSwapMove<>(
                variableDescriptor,
                inverseVariableSupply,
                new SubChain(Arrays.asList(a1, a2, a3)),
                new SubChain(Arrays.asList(c1)))
            .rebase(destinationScoreDirector));
    assertSameProperties(
        Arrays.asList(destinationA1, destinationA2),
        Arrays.asList(destinationA3),
        new SubChainReversingSwapMove<>(
                variableDescriptor,
                inverseVariableSupply,
  ...
  public void assertSameProperties(
      List<Object> leftEntityList, List<Object> rightEntityList, SubChainReversingSwapMove move) {
  ...
  void toStringTest() {
    ...
    assertThat(
            new SubChainReversingSwapMove<>(
                ...
                inverseVariableSupply,
                new SubChain(Arrays.asList(a2, a3, a4)),
                new SubChain(Arrays.asList(b1, b2, b3))))
        .hasToString("[a2..a4] {a1} <-reversing-> [b1..b3] {b0}");
    assertThat(
            new SubChainReversingSwapMove<>(
                variableDescriptor,
                inverseVariableSupply,
                new SubChain(Arrays.asList(a1, a2)),
                new SubChain(Arrays.asList(a4, a5))))
        .hasToString("[a1..a2] {a0} <-reversing-> [a4..a5] {a3}");
    assertThat(
            new SubChainReversingSwapMove<>(
                variableDescriptor,
                inverseVariableSupply,
                new SubChain(Arrays.asList(a3)),
                new SubChain(Arrays.asList(b2))))
        .hasToString("[a3..a3] {a2} <-reversing-> [b2..b2] {b1}");
  }
}
