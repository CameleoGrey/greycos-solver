package ai.greycos.solver.core.impl.domain.valuerange.buildin.collection;
...
class ListValueRangeTest {
  ...
  void get() {
    ...
    assertThat(new ListValueRange<>(Arrays.asList("b", "z", "a", "c", "g", "d")).get(3L))
        .isEqualTo("c");
  }
  ...
  void createOriginalIterator() {
    assertAllElementsOfIterator(
        new ListValueRange<>(Arrays.asList(0, 2, 5, 10)).createOriginalIterator(), 0, 2, 5, 10);
    assertAllElementsOfIterator(
        new ListValueRange<>(Arrays.asList(100, 120, 5, 7, 8)).createOriginalIterator(),
        100,
        120,
        5,
        7,
        8);
    assertAllElementsOfIterator(
        new ListValueRange<>(Arrays.asList(-15, 25, 0)).createOriginalIterator(), -15, 25, 0);
    assertAllElementsOfIterator(
        new ListValueRange<>(Arrays.asList("b", "z", "a")).createOriginalIterator(), "b", "z", "a");
    assertAllElementsOfIterator(
        new ListValueRange<>(Collections.emptyList()).createOriginalIterator());
  }

  @Test
  void createRandomIterator() {
    assertElementsOfIterator(
        new ListValueRange<>(Arrays.asList(0, 2, 5, 10)).createRandomIterator(new TestRandom(2, 0)),
        5,
        0);
    assertElementsOfIterator(
        new ListValueRange<>(Arrays.asList(100, 120, 5, 7, 8))
            .createRandomIterator(new TestRandom(2, 0)),
        5,
        100);
    assertElementsOfIterator(
        new ListValueRange<>(Arrays.asList(-15, 25, 0)).createRandomIterator(new TestRandom(2, 0)),
        0,
        -15);
    assertElementsOfIterator(
        new ListValueRange<>(Arrays.asList("b", "z", "a"))
            .createRandomIterator(new TestRandom(2, 0)),
        "a",
        "b");
    assertAllElementsOfIterator(
        new ListValueRange<>(Collections.emptyList()).createRandomIterator(new Random(0)));
  }
