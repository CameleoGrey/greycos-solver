...
class SimpleLongScoreInlinerTest
  ...
  void impact() {
    ...
    assertThat(scoreInliner.extractScore()).isEqualTo(SimpleLongScore.of(100));

    var undo2 = impacter.impactScore(20, ConstraintMatchSupplier.empty());
    assertThat(scoreInliner.extractScore()).isEqualTo(SimpleLongScore.of(300));

    undo2.run();
    assertThat(scoreInliner.extractScore()).isEqualTo(SimpleLongScore.of(100));

    undo1.run();
    assertThat(scoreInliner.extractScore()).isEqualTo(SimpleLongScore.of(0));
  }
  ...
  @Override
  protected AbstractScoreInliner<SimpleLongScore> buildScoreInliner(
      Map<Constraint, SimpleLongScore> constraintWeightMap,
