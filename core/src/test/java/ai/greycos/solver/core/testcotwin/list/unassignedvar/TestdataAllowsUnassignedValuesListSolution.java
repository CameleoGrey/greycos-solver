...
public class TestdataAllowsUnassignedValuesListSolution {
  ...
  public static SolutionDescriptor<TestdataAllowsUnassignedValuesListSolution>
  ...
  public static PlanningSolutionMetaModel<TestdataAllowsUnassignedValuesListSolution>
      buildMetaModel() {
    return buildSolutionDescriptor().getMetaModel();
  }

  public static TestdataAllowsUnassignedValuesListSolution generateUninitializedSolution(
      int valueCount, int entityCount) {
    return generateSolution(valueCount, entityCount);
  }

  private static TestdataAllowsUnassignedValuesListSolution generateSolution(
      int valueCount, int entityCount) {
    List<TestdataAllowsUnassignedValuesListEntity> entityList =
        IntStream.range(0, entityCount)
            .mapToObj(i -> new TestdataAllowsUnassignedValuesListEntity("Generated Entity " + i))
            .toList();
    List<TestdataAllowsUnassignedValuesListValue> valueList =
    ...
    TestdataAllowsUnassignedValuesListSolution solution =
        new TestdataAllowsUnassignedValuesListSolution();
