...
import static ai.greycos.solver.core.impl.domain.variable.declarative.GraphStructure.ARBITRARY;
import static ai.greycos.solver.core.impl.domain.variable.declarative.GraphStructure.ARBITRARY_SINGLE_ENTITY_AT_MOST_ONE_DIRECTIONAL_PARENT_TYPE;
import static ai.greycos.solver.core.impl.domain.variable.declarative.GraphStructure.EMPTY;
import static ai.greycos.solver.core.impl.domain.variable.declarative.GraphStructure.SINGLE_DIRECTIONAL_PARENT;
...
import ai.greycos.solver.core.testdomain.shadow.extended.TestdataDeclarativeExtendedBaseValue;
import ai.greycos.solver.core.testdomain.shadow.extended.TestdataDeclarativeExtendedSolution;
import ai.greycos.solver.core.testdomain.shadow.extended.TestdataDeclarativeExtendedSubclassValue;
import ai.greycos.solver.core.testdomain.shadow.follower.TestdataFollowerEntity;
import ai.greycos.solver.core.testdomain.shadow.follower.TestdataFollowerSolution;
import ai.greycos.solver.core.testdomain.shadow.multi_directional_parent.TestdataMultiDirectionConcurrentEntity;
import ai.greycos.solver.core.testdomain.shadow.multi_directional_parent.TestdataMultiDirectionConcurrentSolution;
import ai.greycos.solver.core.testdomain.shadow.multi_directional_parent.TestdataMultiDirectionConcurrentValue;
import ai.greycos.solver.core.testdomain.shadow.multi_entity.TestdataMultiEntityDependencyEntity;
import ai.greycos.solver.core.testdomain.shadow.multi_entity.TestdataMultiEntityDependencySolution;
import ai.greycos.solver.core.testdomain.shadow.multi_entity.TestdataMultiEntityDependencyValue;
import ai.greycos.solver.core.testdomain.shadow.simple_chained.TestdataChainedSimpleVarSolution;
import ai.greycos.solver.core.testdomain.shadow.simple_chained.TestdataChainedSimpleVarValue;
import ai.greycos.solver.core.testdomain.shadow.simple_list.TestdataDeclarativeSimpleListSolution;
import ai.greycos.solver.core.testdomain.shadow.simple_list.TestdataDeclarativeSimpleListValue;
