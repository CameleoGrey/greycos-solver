package ai.greycos.solver.core.testdomain.shadow.always_looped;
...
public class TestdataAlwaysLoopedSolution {
  ...
  @PlanningEntityCollectionProperty List<TestdataAlwaysLoopedEntity> entities;

  @ValueRangeProvider List<Integer> values;
  ...
  public TestdataAlwaysLoopedSolution(
      List<TestdataAlwaysLoopedEntity> entities, List<Integer> values) {
    this.values = values;
  ...
  public void setEntities(List<TestdataAlwaysLoopedEntity> entities) {
    this.entities = entities;
  }
