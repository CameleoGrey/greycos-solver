...
class SubChainReversingChangeMoveTest {
  ...
  void noTrailing() {
    ...
    var move =
        new SubChainReversingChangeMove<>(
            new SubChain(Arrays.asList(a3, a4, a5)), variableDescriptor, inverseVariableSupply, b1);
  ...
  void sameChainWithOneBetween() {
    ...
    var move =
        new SubChainReversingChangeMove<>(
            new SubChain(Arrays.asList(a1, a2, a3)), variableDescriptor, inverseVariableSupply, a4);
    moveDirector.execute(move);
  ...
  public void assertSameProperties(
      List<Object> entityList, Object toPlanningVariable, SubChainReversingChangeMove move) {
  ...
  void toStringTest() {
    ...
    assertThat(
            new SubChainReversingChangeMove<>(
                new SubChain(Arrays.asList(a1, a2, a3, a4, a5)),
                variableDescriptor,
                inverseVariableSupply,
                b3))
