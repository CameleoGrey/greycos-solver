...
/**
 * Defines methods that every constraint stream test must have. These methods are enforced because
 * they test each method of the API for basic functionality.
 */
