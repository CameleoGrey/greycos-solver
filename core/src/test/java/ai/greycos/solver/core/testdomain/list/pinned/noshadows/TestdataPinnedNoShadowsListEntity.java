...
public class TestdataPinnedNoShadowsListEntity extends TestdataObject {
  ...
  public static ListVariableDescriptor<TestdataPinnedNoShadowsListSolution>
      buildVariableDescriptorForValueList() {
    return (ListVariableDescriptor<TestdataPinnedNoShadowsListSolution>)
        buildEntityDescriptor().getGenuineVariableDescriptor("valueList");
  }

  public static TestdataPinnedNoShadowsListEntity createWithValues(
      String code, TestdataPinnedNoShadowsListValue... values) {
  ...
  public TestdataPinnedNoShadowsListEntity(
      String code, List<TestdataPinnedNoShadowsListValue> valueList) {
    super(code);
