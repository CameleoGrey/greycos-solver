package ai.greycos.solver.core.testdomain.cascade.distinct;
...
public class TestdataDifferentCascadingEntity extends TestdataObject {
  ...
  public static ListVariableDescriptor<TestdataDifferentCascadingSolution>
      buildVariableDescriptorForValueList() {
    return (ListVariableDescriptor<TestdataDifferentCascadingSolution>)
        buildEntityDescriptor().getGenuineVariableDescriptor("valueList");
  }

  public static TestdataDifferentCascadingEntity createWithValues(
      String code, TestdataDifferentCascadingValue... values) {
    // Set up shadow variables to preserve consistency.
    return new TestdataDifferentCascadingEntity(code, new ArrayList<>(Arrays.asList(values)))
  ...
  public TestdataDifferentCascadingEntity(
      String code, List<TestdataDifferentCascadingValue> valueList) {
    super(code);
  ...
  public String toString() {
    return "TestdataDifferentCascadingEntity{" + "code='" + code + '\'' + '}';
  }
}
