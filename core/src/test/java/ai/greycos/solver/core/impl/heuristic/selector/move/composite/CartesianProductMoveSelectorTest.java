...
import static ai.greycos.solver.core.testutil.PlannerAssert.assertEmptyNeverEndingMoveSelector;
...
import ai.greycos.solver.core.impl.heuristic.selector.move.generic.ChangeMoveSelector;
...
class CartesianProductMoveSelectorTest {
  ...
  public void originSelection(boolean ignoreEmptyChildIterators) {
    ...
    CartesianProductMoveSelector moveSelector =
        new CartesianProductMoveSelector(childMoveSelectorList, ignoreEmptyChildIterators, false);
    ...
    assertAllCodesOfMoveSelector(
        moveSelector, "a1+b1", "a1+b2", "a2+b1", "a2+b2", "a3+b1", "a3+b2");
  ...
  public void emptyOriginSelection(
      boolean ignoreEmptyChildIterators, boolean emptyFirst, boolean emptySecond) {
    assertThat(emptyFirst || emptySecond).isTrue();
    MoveSelector nonEmptyChildMoveSelector =
        SelectorTestUtils.mockMoveSelector(
            new DummyMove("a1"), new DummyMove("a2"), new DummyMove("a3")); // One side is not empty
    ArrayList<MoveSelector> childMoveSelectorList = new ArrayList<>();
    childMoveSelectorList.add(
        emptyFirst ? SelectorTestUtils.mockMoveSelector() : nonEmptyChildMoveSelector);
    childMoveSelectorList.add(
        emptySecond ? SelectorTestUtils.mockMoveSelector() : nonEmptyChildMoveSelector);
    CartesianProductMoveSelector moveSelector =
        new CartesianProductMoveSelector(childMoveSelectorList, ignoreEmptyChildIterators, false);
  ...
  public void originSelection3ChildMoveSelectors(boolean ignoreEmptyChildIterators) {
    ...
    childMoveSelectorList.add(
        SelectorTestUtils.mockMoveSelector(new DummyMove("b1"), new DummyMove("b2")));
    childMoveSelectorList.add(
        SelectorTestUtils.mockMoveSelector(new DummyMove("c1"), new DummyMove("c2")));
    CartesianProductMoveSelector moveSelector =
        new CartesianProductMoveSelector(childMoveSelectorList, ignoreEmptyChildIterators, false);
  ...
  public void classicRandomSelection(boolean ignoreEmptyChildIterators) {
    ...
    childMoveSelectorList.add(
        SelectorTestUtils.mockMoveSelector(new DummyMove("b1"), new DummyMove("b2")));
    CartesianProductMoveSelector moveSelector =
        new CartesianProductMoveSelector(childMoveSelectorList, ignoreEmptyChildIterators, true);
    ...
    assertCodesOfNeverEndingMoveSelector(
        moveSelector, 6, "a1+b1", "a2+b2", "a3+b1", "a1+b2", "a2+b1", "a3+b2");
  ...
  public void originalMimic(boolean ignoreEmptyChildIterators) {
    ...
    ValueSelector primaryValueSelector =
        SelectorTestUtils.mockValueSelector(
            TestdataMultiVarEntity.class,
            "primaryValue",
            new TestdataValue("1"),
            new TestdataValue("2"),
            new TestdataValue("3"));
    ValueSelector secondaryValueSelector =
        SelectorTestUtils.mockValueSelector(
            TestdataMultiVarEntity.class,
            "secondaryValue",
            new TestdataValue("8"),
    ...
    moveSelectorList.add(
        new ChangeMoveSelector(recordingEntitySelector, primaryValueSelector, false));
    moveSelectorList.add(
        new ChangeMoveSelector(
            new MimicReplayingEntitySelector(recordingEntitySelector),
            secondaryValueSelector,
            false));
    MoveSelector moveSelector =
        new CartesianProductMoveSelector(moveSelectorList, ignoreEmptyChildIterators, false);
  ...
  public void randomMimic(boolean ignoreEmptyChildIterators) {
    ...
    moveSelectorList.add(
        new ChangeMoveSelector(
            ...
            false));
    MoveSelector moveSelector =
        new CartesianProductMoveSelector(moveSelectorList, ignoreEmptyChildIterators, true);
