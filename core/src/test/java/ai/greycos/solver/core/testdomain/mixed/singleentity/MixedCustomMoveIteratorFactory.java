package ai.greycos.solver.core.testdomain.mixed.singleentity;
...
public class MixedCustomMoveIteratorFactory
  ...
  @Override
  public Iterator<ChangeMove<TestdataMixedSolution>> createOriginalMoveIterator(
      ScoreDirector<TestdataMixedSolution> scoreDirector) {
  ...
  public Iterator<ChangeMove<TestdataMixedSolution>> createRandomMoveIterator(
    ...
    var variableDescriptor =
        solutionDescriptor
            .findEntityDescriptor(TestdataMixedEntity.class)
