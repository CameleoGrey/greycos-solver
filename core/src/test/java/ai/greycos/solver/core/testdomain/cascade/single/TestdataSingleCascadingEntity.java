...
public class TestdataSingleCascadingEntity extends TestdataObject {
  ...
  public static ListVariableDescriptor<TestdataSingleCascadingSolution>
      buildVariableDescriptorForValueList() {
    return (ListVariableDescriptor<TestdataSingleCascadingSolution>)
        buildEntityDescriptor().getGenuineVariableDescriptor("valueList");
  }

  public static TestdataSingleCascadingEntity createWithValues(
      String code, TestdataSingleCascadingValue... values) {
    // Set up shadow variables to preserve consistency.
    return new TestdataSingleCascadingEntity(code, new ArrayList<>(Arrays.asList(values)))
  ...
  public String toString() {
    return "TestdataSingleCascadingEntity{" + "code='" + code + '\'' + '}';
  }
}
