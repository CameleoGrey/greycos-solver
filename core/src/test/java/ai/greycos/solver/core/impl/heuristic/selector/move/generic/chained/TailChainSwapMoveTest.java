...
import ai.greycos.solver.core.impl.domain.variable.anchor.AnchorVariableDemand;
import ai.greycos.solver.core.impl.domain.variable.anchor.AnchorVariableSupply;
...
class TailChainSwapMoveTest {
  ...
  private final SolutionDescriptor<TestdataChainedSolution> solutionDescriptor =
  ...
  void isMoveDoable() {
    ...
    var inverseVariableSupply =
        innerScoreDirector
            .getSupplyManager()
            .demand(new SingletonInverseVariableDemand<>(variableDescriptor));
    var anchorVariableSupply =
        innerScoreDirector
            .getSupplyManager()
            .demand(new AnchorVariableDemand<>(variableDescriptor));

    assertThat(
            new TailChainSwapMove<>(
                    variableDescriptor, inverseVariableSupply, anchorVariableSupply, a2, b0)
                .isMoveDoable(innerScoreDirector))
        .isTrue();
    assertThat(
            new TailChainSwapMove<>(
                    variableDescriptor, inverseVariableSupply, anchorVariableSupply, b1, a1)
                .isMoveDoable(innerScoreDirector))
        .isTrue();
    assertThat(
            new TailChainSwapMove<>(
                    variableDescriptor, inverseVariableSupply, anchorVariableSupply, a1, a2)
                .isMoveDoable(innerScoreDirector))
        .isTrue();
    assertThat(
            new TailChainSwapMove<>(
                    variableDescriptor, inverseVariableSupply, anchorVariableSupply, a3, a0)
                .isMoveDoable(innerScoreDirector))
        .isTrue();
    assertThat(
            new TailChainSwapMove<>(
                    variableDescriptor, inverseVariableSupply, anchorVariableSupply, a1, a1)
                .isMoveDoable(innerScoreDirector))
        .isFalse();
    assertThat(
            new TailChainSwapMove<>(
                    variableDescriptor, inverseVariableSupply, anchorVariableSupply, a2, a0)
                .isMoveDoable(innerScoreDirector))
        .isFalse();
  }
  ...
  void doMoveToTailValue() {
    ...
    moveDirector.execute(
        new TailChainSwapMove<>(
            variableDescriptor, inverseVariableSupply, anchorVariableSupply, a2, b1));
  ...
  void doMoveInSameChain() {
    ...
    moveDirector.executeTemporary(
        new TailChainSwapMove<>(
            variableDescriptor, inverseVariableSupply, anchorVariableSupply, a4, a1),
        (__, ___) -> {
    ...
    moveDirector.executeTemporary(
        new TailChainSwapMove<>(
            variableDescriptor, inverseVariableSupply, anchorVariableSupply, a7, a1),
        (__, ___) -> {
    ...
    moveDirector.executeTemporary(
        new TailChainSwapMove<>(
            variableDescriptor, inverseVariableSupply, anchorVariableSupply, a1, a4),
        (__, ___) -> {
    ...
    moveDirector.executeTemporary(
        new TailChainSwapMove<>(
            variableDescriptor, inverseVariableSupply, anchorVariableSupply, a3, a4),
        (__, ___) -> {
    ...
    moveDirector.executeTemporary(
        new TailChainSwapMove<>(
            variableDescriptor, inverseVariableSupply, anchorVariableSupply, a2, a6),
        (__, ___) -> {
  ...
  void rebase() {
    ...
    ScoreDirector<TestdataChainedSolution> destinationScoreDirector =
    ...
    assertSameProperties(
        ...
        destinationC1,
        new TailChainSwapMove<>(
                variableDescriptor, inverseVariableSupply, anchorVariableSupply, a1, c1)
  ...
  public void assertSameProperties(
      Object leftEntity, Object rightValue, TailChainSwapMove<TestdataChainedSolution> move) {
  ...
  void toStringTest() {
    ...
    assertThat(
            new TailChainSwapMove<>(
                variableDescriptor, inverseVariableSupply, anchorVariableSupply, a1, b0))
        .hasToString("a1 {a0} <-tailChainSwap-> b1 {b0}");
    assertThat(
            new TailChainSwapMove<>(
                variableDescriptor, inverseVariableSupply, anchorVariableSupply, a1, b1))
        .hasToString("a1 {a0} <-tailChainSwap-> null {b1}");
    assertThat(
            new TailChainSwapMove<>(
                variableDescriptor, inverseVariableSupply, anchorVariableSupply, b1, a0))
        .hasToString("b1 {b0} <-tailChainSwap-> a1 {a0}");
    assertThat(
            new TailChainSwapMove<>(
                variableDescriptor, inverseVariableSupply, anchorVariableSupply, a1, a3))
        .hasToString("a1 {a0} <-tailChainSwap-> null {a3}");
    assertThat(
            new TailChainSwapMove<>(
                variableDescriptor, inverseVariableSupply, anchorVariableSupply, a2, a0))
        .hasToString("a2 {a1} <-tailChainSwap-> a1 {a0}");
  }
