...
class ListSwapMoveTest {
  ...
  void isMoveDoable() {
    ...
    assertThat(
            new ListSwapMove<>(variableDescriptor, e1, 1, e1, 1).isMoveDoable(innerScoreDirector))
        .isFalse();
    // same entity, different index => doable
    assertThat(
            new ListSwapMove<>(variableDescriptor, e1, 0, e1, 1).isMoveDoable(innerScoreDirector))
        .isTrue();
    // different entity => doable
    assertThat(
            new ListSwapMove<>(variableDescriptor, e1, 0, e2, 0).isMoveDoable(innerScoreDirector))
        .isTrue();
  }
  ...
  void doMove() {
    ...
    moveDirector.executeTemporary(
        new ListSwapMove<>(variableDescriptor, e1, 0, e2, 0),
        (__, ___) -> {
  ...
  void tabuIntrospection_twoEntities() {
    ...
    ListSwapMove<TestdataListSolution> moveTwoEntities =
        new ListSwapMove<>(variableDescriptor, e1, 0, e2, 0);
  ...
  void tabuIntrospection_oneEntity() {
    ...
    ListSwapMove<TestdataListSolution> moveOneEntity =
        new ListSwapMove<>(variableDescriptor, e1, 0, e1, 1);
    // Do the move first because that might affect the returned values.
  ...
  void toStringTest() {
    ...
    assertThat(new ListSwapMove<>(variableDescriptor, e1, 0, e1, 1))
        .hasToString("1 {e1[0]} <-> 2 {e1[1]}");
    assertThat(new ListSwapMove<>(variableDescriptor, e1, 1, e2, 0))
