...
import ai.greycos.solver.core.testdomain.list.unassignedvar.pinned.TestdataPinnedUnassignedValuesListEntity;
import ai.greycos.solver.core.testdomain.list.unassignedvar.pinned.TestdataPinnedUnassignedValuesListSolution;
import ai.greycos.solver.core.testdomain.list.unassignedvar.pinned.TestdataPinnedUnassignedValuesListValue;
...
import ai.greycos.solver.core.testdomain.list.valuerange.pinned.TestdataListPinnedEntityProvidingEntity;
import ai.greycos.solver.core.testdomain.list.valuerange.pinned.TestdataListPinnedEntityProvidingSolution;
...
public final class TestdataListUtils {
  ...
  public static EntitySelector<TestdataListSolution> mockEntitySelector(
      TestdataListEntity... entities) {
    return SelectorTestUtils.mockEntitySelector(
        TestdataListEntity.buildEntityDescriptor(), (Object[]) entities);
  }

  public static <Solution_, Entity_> EntitySelector<Solution_> mockEntitySelector(
      EntityDescriptor<Solution_> entityDescriptor, Entity_... entities) {
    return SelectorTestUtils.mockEntitySelector(entityDescriptor, entities);
  }

  public static EntitySelector<TestdataListEntityProvidingSolution> mockEntitySelector(
      TestdataListEntityProvidingEntity... entities) {
    return SelectorTestUtils.mockEntitySelector(
        TestdataListEntityProvidingEntity.buildEntityDescriptor(), (Object[]) entities);
  }

  public static EntitySelector<TestdataPinnedWithIndexListSolution> mockEntitySelector(
      TestdataPinnedWithIndexListEntity... entities) {
    return SelectorTestUtils.mockEntitySelector(
        TestdataPinnedWithIndexListEntity.buildEntityDescriptor(), (Object[]) entities);
  }

  public static EntitySelector<TestdataAllowsUnassignedValuesListSolution> mockEntitySelector(
      TestdataAllowsUnassignedValuesListEntity... entities) {
    return SelectorTestUtils.mockEntitySelector(
        TestdataAllowsUnassignedValuesListEntity.buildEntityDescriptor(), (Object[]) entities);
  }

  public static EntitySelector<TestdataListUnassignedEntityProvidingSolution> mockEntitySelector(
      TestdataListUnassignedEntityProvidingEntity... entities) {
    return SelectorTestUtils.mockEntitySelector(
        TestdataListUnassignedEntityProvidingEntity.buildEntityDescriptor(), (Object[]) entities);
  }
  ...
  public static <Solution_>
      IterableFromEntityPropertyValueSelector<Solution_>
          mockIterableFromEntityPropertyValueSelector(
              IterableValueSelector<Solution_> childMoveSelector, boolean randomSelection) {
  ...
  public static IterableValueSelector<TestdataListUnassignedEntityProvidingSolution>
      mockAllowsUnassignedEntityRangeNeverEndingIterableValueSelector(
          ListVariableDescriptor<TestdataListUnassignedEntityProvidingSolution>
  ...
  public static DestinationSelector<TestdataListEntityProvidingSolution>
      mockEntityRangeNeverEndingDestinationSelector(ElementPosition... locationsInList) {
    return mockNeverEndingDestinationSelector(locationsInList.length, locationsInList);
  }

  public static DestinationSelector<TestdataPinnedWithIndexListSolution>
      mockPinnedNeverEndingDestinationSelector(PositionInList... locationsInList) {
    return mockNeverEndingDestinationSelector(locationsInList.length, locationsInList);
  }

  public static DestinationSelector<TestdataListPinnedEntityProvidingSolution>
      mockPinnedEntityRangeNeverEndingDestinationSelector(PositionInList... locationsInList) {
    return mockNeverEndingDestinationSelector(locationsInList.length, locationsInList);
  }

  public static DestinationSelector<TestdataAllowsUnassignedValuesListSolution>
      mockAllowsUnassignedValuesNeverEndingDestinationSelector(ElementPosition... locationsInList) {
    return mockNeverEndingDestinationSelector(locationsInList.length, locationsInList);
  }
  ...
  public static <Solution_> DestinationSelector<Solution_> mockNeverEndingDestinationSelector(
    ...
    when(destinationSelector.iterator())
        .thenAnswer(invocation -> cyclicIterator(Arrays.asList(locationsInList)));
    return destinationSelector;
  }

  public static <Solution_> DestinationSelector<Solution_> mockDestinationSelector(
      ElementPosition... locationsInList) {
  ...
  public static <Solution_> ListVariableDescriptor<Solution_> getListVariableDescriptor(
    ...
    return (ListVariableDescriptor<Solution_>)
        scoreDirector
  ...
  public static <Solution_> EntityDescriptor<Solution_> getEntityDescriptor(
      InnerScoreDirector<Solution_, ?> scoreDirector) {
    return scoreDirector.getSolutionDescriptor().getGenuineEntityDescriptors().iterator().next();
  }

  public static ListVariableDescriptor<TestdataListEntityProvidingSolution>
      getEntityRangeListVariableDescriptor(
  ...
  public static ListVariableDescriptor<TestdataListPinnedEntityProvidingSolution>
      getPinnedEntityRangeListVariableDescriptor(
          InnerScoreDirector<TestdataListPinnedEntityProvidingSolution, ?> scoreDirector) {
    return (ListVariableDescriptor<TestdataListPinnedEntityProvidingSolution>)
        scoreDirector
            .getSolutionDescriptor()
  ...
  public static ListVariableDescriptor<TestdataPinnedWithIndexListSolution>
      getPinnedListVariableDescriptor(
  ...
  public static ListVariableDescriptor<TestdataAllowsUnassignedValuesListSolution>
    ...
    return (ListVariableDescriptor<TestdataAllowsUnassignedValuesListSolution>)
        scoreDirector
            .getSolutionDescriptor()
  ...
  public static <T>
      IterableFromEntityPropertyValueSelector<T> getIterableFromEntityPropertyValueSelector(
          ValueRangeDescriptor<T> valueRangeDescriptor, boolean randomSelection) {
    var fromPropertySelector =
        new FromEntityPropertyValueSelector<>(valueRangeDescriptor, null, randomSelection);
  ...
  public static <T> MimicRecordingValueSelector<T> getMimicRecordingIterableValueSelector(
      ValueRangeDescriptor<T> valueRangeDescriptor, boolean randomSelection) {
    var valueSelector =
        getIterableFromEntityPropertyValueSelector(valueRangeDescriptor, randomSelection);
    return new MimicRecordingValueSelector<>(valueSelector);
  }

  public static <T> MimicRecordingValueSelector<T> getMimicRecordingIterableValueSelector(
      ListVariableDescriptor<T> listVariableDescriptor, Object... values) {
    var valueSelector = mockIterableValueSelector(listVariableDescriptor, values);
    return new MimicRecordingValueSelector<>(valueSelector);
  }

  public static <T> FilteringValueRangeSelector<T> getFilteringValueRangeSelector(
      MimicRecordingValueSelector<T> mimicRecordingValueSelector,
      IterableValueSelector<T> nonReplaying,
      boolean randomSelection,
      boolean assertBothSides,
      boolean generateIterableFromEntityProperty) {
    ...
    if (generateIterableFromEntityProperty) {
      ...
      return new FilteringValueRangeSelector<>(
          iterableEntityPropertyValueSelector,
          replayingValueSelector,
          randomSelection,
          assertBothSides);
    } else {
      return new FilteringValueRangeSelector<>(
          nonReplaying, replayingValueSelector, randomSelection, assertBothSides);
    }
  }
  ...
  public static <T, V> DestinationSelector<T> getEntityValueRangeDestinationSelector(
      ...
      EntityDescriptor<V> entityDescriptor,
      boolean randomSelection) {
    var destinationSelectorConfig = new DestinationSelectorConfig();
    destinationSelectorConfig.setEntitySelectorConfig(
  ...
  public static <S> DestinationSelector<S> getEntityValueRangeDestinationSelector(
      MimicRecordingValueSelector<S> innerMimicRecordingValueSelector,
      SolutionDescriptor<S> solutionDescriptor,
      EntityDescriptor<S> entityDescriptor,
      Class<? extends SelectionFilter> selectionFilterClass,
      boolean randomSelection) {
    var destinationSelectorConfig = new DestinationSelectorConfig();
    destinationSelectorConfig.setEntitySelectorConfig(
        new EntitySelectorConfig().withEntityClass(entityDescriptor.getEntityClass()));
