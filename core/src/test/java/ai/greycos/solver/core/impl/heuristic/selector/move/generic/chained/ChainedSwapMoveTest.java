...
class ChainedSwapMoveTest {
  ...
  private final GenuineVariableDescriptor<TestdataChainedSolution> chainedVariableDescriptor =
      TestdataChainedEntity.buildVariableDescriptorForChainedObject();
  private final GenuineVariableDescriptor<TestdataChainedSolution> unchainedVariableDescriptor =
      TestdataChainedEntity.buildVariableDescriptorForUnchainedValue();
  private final InnerScoreDirector<TestdataChainedSolution, SimpleScore> innerScoreDirector =
      PlannerTestUtils.mockScoreDirector(
          chainedVariableDescriptor.getEntityDescriptor().getSolutionDescriptor(), false);
  ...
  void rebase() {
    ...
    var inverseVariableSupplyList =
        Collections.singletonList(mock(SingletonInverseVariableSupply.class));
