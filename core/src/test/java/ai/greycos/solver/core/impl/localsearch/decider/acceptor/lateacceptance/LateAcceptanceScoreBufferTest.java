...
class LateAcceptanceScoreBufferTest {
  ...
  void slotWrittenAfterResetRetainsOwnValue() {
    ...
    assertThat(buffer.<SimpleScore>get(0))
        .isEqualTo(resetScore); // written before reset → resetScore
    assertThat(buffer.<SimpleScore>get(1))
        .isEqualTo(postResetScore); // written after reset → own value
