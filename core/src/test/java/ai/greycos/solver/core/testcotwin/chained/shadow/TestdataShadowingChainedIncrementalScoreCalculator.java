...
public class TestdataShadowingChainedIncrementalScoreCalculator
    implements ConstraintMatchAwareIncrementalScoreCalculator<
        TestdataShadowingChainedSolution, SimpleScore> {
  ...
  public void resetWorkingSolution(
      @NonNull TestdataShadowingChainedSolution workingSolution, boolean constraintMatchEnabled) {
  ...
  private DefaultConstraintMatchTotal<SimpleScore> update(
      TestdataShadowingChainedSolution workingSolution) {
    ...
    for (var anchor : workingSolution.getChainedAnchorList()) {
      ...
      constraintMatchTotal.addConstraintMatch(
          Collections.singletonList(anchor), SimpleScore.of(-value));
    }
