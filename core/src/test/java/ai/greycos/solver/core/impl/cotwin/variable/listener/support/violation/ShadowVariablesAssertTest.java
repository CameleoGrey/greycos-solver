...
class ShadowVariablesAssertTest {
  ...
  void violationMessage() {
    ...
    ShadowVariablesAssert snapshot =
        ShadowVariablesAssert.takeSnapshot(
            TestdataShadowingChainedSolution.buildSolutionDescriptor(), solution);
    ...
    assertThat(snapshot.createShadowVariablesViolationMessage(2))
        // FIXME shadow entities should be reported as well
        // (https://issues.redhat.com/browse/PLANNER-2691).
