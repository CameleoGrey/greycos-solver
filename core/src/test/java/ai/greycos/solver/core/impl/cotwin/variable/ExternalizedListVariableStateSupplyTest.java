    ...
    try (var supply =
      ...
      var valueRangeManager =
          ValueRangeManager.of(
              variableDescriptor.getEntityDescriptor().getSolutionDescriptor(), solution);
    ...
    try (var supply =
      ...
      assertSoftly(
          softly -> {
            ...
            softly
                .assertThat(supply.getElementPosition(v2))
                .isEqualTo(ElementPosition.unassigned());
            softly
                .assertThat(supply.getElementPosition(v3))
                .isEqualTo(ElementPosition.unassigned());
          });
      ...
      assertSoftly(
          softly -> {
            ...
            softly
                .assertThat(supply.getElementPosition(v1))
                .isEqualTo(ElementPosition.unassigned());
            softly
                .assertThat(supply.getElementPosition(v2))
                .isEqualTo(ElementPosition.unassigned());
