package ai.greycos.solver.core.testdomain.list.valuerange.composite;
...
public class TestdataListCompositeEntityProvidingSolution {
  ...
  public static SolutionDescriptor<TestdataListCompositeEntityProvidingSolution>
      buildSolutionDescriptor() {
    return SolutionDescriptor.buildSolutionDescriptor(
        TestdataListCompositeEntityProvidingSolution.class,
  ...
  public static TestdataListCompositeEntityProvidingSolution generateSolution(
    ...
    for (var i = 0; i < entityListSize; i++) {
      ...
      var entity =
          new TestdataListCompositeEntityProvidingEntity(
