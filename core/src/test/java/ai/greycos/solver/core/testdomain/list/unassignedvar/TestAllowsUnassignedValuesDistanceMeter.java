...
/**
 * For the sake of test readability, planning values (list variable elements) are placed in a
 * 1-dimensional space. An element's coordinate is represented by its ({@link
 * TestdataObject#getCode() code}. If the code is not a number, it is interpreted as zero.
 */
public class TestAllowsUnassignedValuesDistanceMeter
  ...
  public double getNearbyDistance(
      TestdataAllowsUnassignedValuesListValue origin, TestdataObject destination) {
