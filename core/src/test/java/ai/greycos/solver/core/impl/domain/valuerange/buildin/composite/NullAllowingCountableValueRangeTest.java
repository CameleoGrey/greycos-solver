...
class NullAllowingCountableValueRangeTest {
  ...
  void getSize() {
    assertThat(
        ...
        .isEqualTo(5L);
    assertThat(
            new NullAllowingCountableValueRange<>(
                    new ListValueRange<>(Arrays.asList(100, 120, 5, 7, 8)))
                .getSize())
        .isEqualTo(6L);
    assertThat(
            new NullAllowingCountableValueRange<>(new ListValueRange<>(Arrays.asList(-15, 25, 0)))
                .getSize())
        .isEqualTo(4L);
    assertThat(
            new NullAllowingCountableValueRange<>(
        ...
        .isEqualTo(4L);
    assertThat(
            new NullAllowingCountableValueRange<>(new ListValueRange<>(Collections.emptyList()))
                .getSize())
        .isEqualTo(1L);
  }
  ...
  void createRandomIterator() {
    assertElementsOfIterator(
        new NullAllowingCountableValueRange<>(new ListValueRange<>(Arrays.asList(0, 2, 5)))
