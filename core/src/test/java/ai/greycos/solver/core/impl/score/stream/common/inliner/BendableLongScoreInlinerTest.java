...
import ai.greycos.solver.core.testcotwin.score.TestdataBendableLongScoreSolution;
...
class BendableLongScoreInlinerTest
  ...
  @Override
  protected AbstractScoreInliner<BendableLongScore> buildScoreInliner(
  ...
  private BendableLongScore buildScore(long hard, long soft1, long soft2) {
    return BendableLongScore.of(new long[] {hard}, new long[] {soft1, soft2});
  }
}
