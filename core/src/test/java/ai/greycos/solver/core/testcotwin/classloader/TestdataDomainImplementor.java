package ai.greycos.solver.core.testcotwin.classloader;
...
public class TestdataDomainImplementor {
  ...
  private static final String PACKAGE = "ai.greycos.solver.core.testcotwin";
        ...
        classCreator -> {
                ...
                constructorCreator.body(
                    blockCreator -> {
                      blockCreator.invokeSpecial(
                          ConstructorDesc.of(Object.class), constructorCreator.this_());
          ...
          classCreator.method(
              ...
              methodCreator -> {
                ...
                methodCreator.body(
                    blockCreator -> blockCreator.return_(methodCreator.this_().field(codeField)));
              });
          ...
          classCreator.constructor(
              constructorCreator -> {
                ...
                constructorCreator.body(
                    blockCreator -> {
                      blockCreator.invokeSpecial(
                          ConstructorDesc.of(superClassDesc), constructorCreator.this_());
                      blockCreator.return_();
                    });
              });
              ...
              constructorCreator -> {
                ...
                constructorCreator.body(
                    blockCreator -> {
                      var thisRef = constructorCreator.this_();
                      blockCreator.invokeSpecial(
                          ConstructorDesc.of(superClassDesc, STRING_DESC), thisRef, code);
                      blockCreator.return_();
                    });
              });
        });
  ...
  private static void generateTestdataEntity(Gizmo gizmo) {
    ...
    gizmo.class_(
        ...
        classCreator -> {
          ...
          // @PlanningVariable(valueRangeProviderRefs = "valueRange") public TestdataValue
          // getValue()
          classCreator.method(
              "getValue",
              methodCreator -> {
                ...
                methodCreator.body(
                    blockCreator -> blockCreator.return_(methodCreator.this_().field(valueField)));
              });
              ...
              methodCreator -> {
                ...
                methodCreator.body(
                    blockCreator -> {
                      ...
                      var newValue =
                          blockCreator.new_(
                              ConstructorDesc.of(valueClassDesc, STRING_DESC), newCode);
  ...
  private static void generateTestdataSolution(Gizmo gizmo) {
    ...
    gizmo.class_(
        ...
        classCreator -> {
          ...
          // @ValueRangeProvider(id = "valueRange") @ProblemFactCollectionProperty public
          // List<TestdataValue> getValueList()
          classCreator.method(
              "getValueList",
              methodCreator -> {
                methodCreator.public_();
          ...
          classCreator.method(
              ...
              methodCreator -> {
                ...
                methodCreator.body(
                    blockCreator -> blockCreator.return_(methodCreator.this_().field(scoreField)));
              });
