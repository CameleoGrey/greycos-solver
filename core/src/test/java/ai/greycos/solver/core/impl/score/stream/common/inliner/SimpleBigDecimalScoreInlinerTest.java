...
class SimpleBigDecimalScoreInlinerTest
  ...
  void impact() {
    ...
    undo1.run();
    assertThat(scoreInliner.extractScore()).isEqualTo(SimpleBigDecimalScore.of(BigDecimal.ZERO));
  }
  ...
  @Override
  protected AbstractScoreInliner<SimpleBigDecimalScore> buildScoreInliner(
      Map<Constraint, SimpleBigDecimalScore> constraintWeightMap,
