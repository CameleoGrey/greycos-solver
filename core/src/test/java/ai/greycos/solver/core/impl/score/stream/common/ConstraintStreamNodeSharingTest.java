...
/**
 * Defines methods that every constraint stream node sharing test must have. These methods are
 * enforced because they test each method of the API for correctness.
 */
