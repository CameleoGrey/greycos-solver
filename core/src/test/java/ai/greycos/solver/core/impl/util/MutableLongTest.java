...
class MutableLongTest {
  ...
  void comparison() {
    ...
    assertSoftly(
        softly -> {
          softly.assertThat(mutableLong1).isEqualTo(mutableLong1);
          softly.assertThat(mutableLong1).isNotEqualTo(mutableLong2);
          softly
              .assertThat(mutableLong1)
