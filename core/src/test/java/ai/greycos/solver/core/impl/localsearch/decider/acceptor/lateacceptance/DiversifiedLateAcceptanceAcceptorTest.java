...
class DiversifiedLateAcceptanceAcceptorTest extends AbstractAcceptorTest {
  ...
  void acceptanceCriterion() {
    ...
    stepScope0
        ...
        .setInitializedScore(SimpleScore.of(-2001));
    acceptor.isAccepted(moveScope0);
    assertThat(acceptor.previousScores[0])
        .isEqualTo(InnerScore.fullyAssigned(SimpleScore.of(-2000)));
  ...
  void replacementCriterion() {
    ...
    stepScope0
        .getPhaseScope()
        .getLastCompletedStepScope()
        .setInitializedScore(SimpleScore.of(-1998));
    acceptor.isAccepted(moveScope0);
    assertThat(acceptor.previousScores[0])
        .isEqualTo(InnerScore.fullyAssigned(SimpleScore.of(-2000)));
    ...
    stepScope0
        .getPhaseScope()
        .getLastCompletedStepScope()
        .setInitializedScore(SimpleScore.of(-2000));
    acceptor.isAccepted(moveScope0);
    assertThat(acceptor.previousScores[0])
        .isEqualTo(InnerScore.fullyAssigned(SimpleScore.of(-2001)));
    ...
    stepScope0
        .getPhaseScope()
        .getLastCompletedStepScope()
        .setInitializedScore(SimpleScore.of(-1999));
    acceptor.isAccepted(moveScope0);
    assertThat(acceptor.previousScores[0])
        .isEqualTo(InnerScore.fullyAssigned(SimpleScore.of(-1998)));
