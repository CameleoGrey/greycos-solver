...
class ListChangeMoveDefinitionTest {
  ...
  void fromSolution() {
    ...
    var variableMetaModel =
        solutionDescriptor.getMetaModel().entity(TestdataListEntity.class).listVariable();
    ...
    var moveIterable =
        createMoveIterable(
            new ListChangeMoveDefinition<>(variableMetaModel), solutionDescriptor, solution);
    assertThat(moveIterable).hasSize(4);

    var moveList = StreamSupport.stream(moveIterable.spliterator(), false).toList();
    ...
    assertSoftly(
        softly -> {
          ...
          softly.assertThat(move1.getPlanningValues()).containsExactly(unassignedValue);
        });
    ...
    assertSoftly(
        softly -> {
          ...
          softly.assertThat(move2.getPlanningEntities()).containsExactly(e2, e1);
          softly.assertThat(move2.getPlanningValues()).containsExactly(initiallyAssignedValue);
        });
    ...
    assertSoftly(
        softly -> {
          ...
          softly.assertThat(move3.getPlanningValues()).containsExactly(unassignedValue);
        });
    ...
    assertSoftly(
        softly -> {
          ...
          softly.assertThat(move4.getPlanningEntities()).containsExactly(e2);
          softly.assertThat(move4.getPlanningValues()).containsExactly(unassignedValue);
        });
  }
  ...
  void fromEntity() {
    ...
    assertSoftly(
        softly -> {
          ...
          softly.assertThat(move1.getDestinationEntity()).isEqualTo(e1);
          softly.assertThat(move1.getDestinationIndex()).isEqualTo(0);
          softly.assertThat(move1.getPlanningEntities()).containsExactly(e2, e1);
    ...
    assertSoftly(
        softly -> {
          ...
          softly.assertThat(move4.getDestinationIndex()).isEqualTo(0);
          softly.assertThat(move4.getPlanningEntities()).containsExactly(e2);
          softly.assertThat(move4.getPlanningValues()).containsExactly(v3);
        });
  }
  ...
  void fromEntityAllowsUnassigned() {
    var solutionDescriptor =
        TestdataListUnassignedEntityProvidingSolution.buildSolutionDescriptor();
    var variableMetaModel =
        solutionDescriptor
            .getMetaModel()
    ...
    assertSoftly(
        softly -> {
          softly.assertThat(move1.getSourceEntity()).isEqualTo(e2);
          softly.assertThat(move1.getSourceIndex()).isEqualTo(0);
          softly.assertThat(move1.getPlanningEntities()).containsExactly(e2);
          softly.assertThat(move1.getPlanningValues()).containsExactly(v1);
        });
    ...
    assertSoftly(
        softly -> {
          ...
          softly.assertThat(move2.getDestinationIndex()).isEqualTo(0);
          softly.assertThat(move2.getPlanningEntities()).containsExactly(e2, e1);
          softly.assertThat(move2.getPlanningValues()).containsExactly(v1);
        });
    ...
    assertSoftly(
        softly -> {
          ...
          softly.assertThat(move3.getPlanningEntities()).containsExactly(e1);
    ...
    assertSoftly(
        softly -> {
          ...
          softly.assertThat(move5.getPlanningEntities()).containsExactly(e2);
          softly.assertThat(move5.getPlanningValues()).containsExactly(v3);
        });
  }
  ...
  void fromSolutionAllowsUnassigned() {
    ...
    solution
        .getEntityList()
        .forEach(TestdataAllowsUnassignedValuesListEntity::setUpShadowVariables);
    ...
    assertSoftly(
        softly -> {
          ...
          softly.assertThat(move4.getDestinationIndex()).isEqualTo(1);
          softly.assertThat(move4.getPlanningEntities()).containsExactly(e2);
          softly.assertThat(move4.getPlanningValues()).containsExactly(v2);
        });
    ...
    assertSoftly(
        softly -> {
          ...
          softly.assertThat(move5.getDestinationIndex()).isEqualTo(0);
          softly.assertThat(move5.getPlanningEntities()).containsExactly(e2);
          softly.assertThat(move5.getPlanningValues()).containsExactly(v2);
        });
  }

  private static <Solution_, Entity_, Value_>
      ListUnassignMove<Solution_, Entity_, Value_> getListUnassignMove(
  ...
  private static <Solution_, Entity_, Value_>
      ListAssignMove<Solution_, Entity_, Value_> getListAssignMove(
          List<Move<Solution_>> moveList, int index) {
  ...
  private <Solution_> Iterable<Move<Solution_>> createMoveIterable(
      MoveDefinition<Solution_> moveDefinition,
  ...
  private <Solution_> InnerScoreDirector<Solution_, ?> createScoreDirector(
    ...
    var scoreDirectorFactory =
        new BavetConstraintStreamScoreDirectorFactory<>(
            solutionDescriptor, constraintProvider, EnvironmentMode.TRACKED_FULL_ASSERT);
