...
class IterableFromSolutionPropertyValueSelectorTest {
  ...
  public void runOriginalSelection(SelectionCacheType cacheType) {
    ...
    var valueSelector =
        new IterableFromSolutionPropertyValueSelector(
            valueRangeDescriptor.getValueRangeDescriptor(),
            new TestdataObjectSorter<TestdataSolution, TestdataValue>(),
            cacheType,
            false);
    ...
    solution.setValueList(
        List.of(
            new TestdataValue("jan"),
            new TestdataValue("feb"),
            new TestdataValue("mar"),
