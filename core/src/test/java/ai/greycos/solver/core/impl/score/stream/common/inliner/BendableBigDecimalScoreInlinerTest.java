...
import ai.greycos.solver.core.testcotwin.score.TestdataBendableBigDecimalScoreSolution;

import org.junit.jupiter.api.Test;

class BendableBigDecimalScoreInlinerTest
    extends AbstractScoreInlinerTest<
        TestdataBendableBigDecimalScoreSolution, BendableBigDecimalScore> {
  ...
  void impactHard() {
    ...
    var scoreInliner =
        (AbstractScoreInliner<BendableBigDecimalScore>) impacter.getContext().inliner;
  ...
  @Override
  protected AbstractScoreInliner<BendableBigDecimalScore> buildScoreInliner(
      Map<Constraint, BendableBigDecimalScore> constraintWeightMap,
