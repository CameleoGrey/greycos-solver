...
public class TestdataEqualsByCodeListSolution extends TestdataEqualsByCodeListObject {
  ...
  public static TestdataEqualsByCodeListSolution generateSolution(
      String solutionName, int valueCount, int entityCount) {
    List<TestdataEqualsByCodeListEntity> entityList =
        IntStream.range(0, entityCount)
            .mapToObj(i -> new TestdataEqualsByCodeListEntity("Generated Entity " + i))
            .collect(Collectors.toList());
    List<TestdataEqualsByCodeListValue> valueList =
