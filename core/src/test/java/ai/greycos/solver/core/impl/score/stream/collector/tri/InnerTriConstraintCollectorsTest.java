...
import static ai.greycos.solver.core.api.score.stream.ConstraintCollectors.countLongTri;
...
final class InnerTriConstraintCollectorsTest extends AbstractConstraintCollectorsTest {
  ...
  public void compose4() {
    TriConstraintCollector<
            Integer, Integer, Integer, ?, Quadruple<Integer, Integer, Integer, Double>>
        collector =
            compose(
                ConstraintCollectors.countTri(),
                min((i, i2, i3) -> i + i2 + i3, i -> i),
  ...
  public void collectAndThen() {
    var collector =
        ConstraintCollectors.collectAndThen(ConstraintCollectors.countTri(), i -> i * 10);
    var container = collector.supplier().get();
