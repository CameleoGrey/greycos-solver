...
final class InnerTriConstraintCollectorsTest extends AbstractConstraintCollectorsTest {
  ...
  public void count() {
    ...
    Runnable firstRetractor =
        accumulate(collector, container, firstValueA, firstValueB, firstValueC);
    ...
    Runnable secondRetractor =
        accumulate(collector, container, secondValueA, secondValueB, secondValueC);
  ...
  public void minComparable() {
    ...
    var collector =
        min((Integer a, Integer b, Integer c) -> baseLocalDateTime.plusMinutes(a + b + c));
  ...
  public void minNotComparable() {
    TriConstraintCollector<String, String, String, ?, String> collector =
        min((a, b, c) -> a, o -> o);
    Object container = collector.supplier().get();
  ...
  public void maxComparable() {
    ...
    var baseLocalDateTime = LocalDateTime.of(2023, 1, 1, 0, 0);
    var collector =
        max((Integer a, Integer b, Integer c) -> baseLocalDateTime.plusMinutes(a + b + c));
    var container = collector.supplier().get();
  ...
  public void toMapMerged() {
    TriConstraintCollector<Integer, Integer, Integer, ?, Map<Integer, Integer>> collector =
        ConstraintCollectors.toMap((a, b, c) -> a, (a, b, c) -> b + c, Integer::sum);
    Object container = collector.supplier().get();
  ...
  public void toSortedMap() {
    TriConstraintCollector<Integer, Integer, Integer, ?, SortedMap<Integer, Set<Integer>>>
        collector =
  ...
  public void toSortedMapMerged() {
    TriConstraintCollector<Integer, Integer, Integer, ?, SortedMap<Integer, Integer>> collector =
        ConstraintCollectors.toSortedMap((a, b, c) -> a, (a, b, c) -> b + c, Integer::sum);
    Object container = collector.supplier().get();
  ...
  public void conditionally() {
    TriConstraintCollector<Integer, Integer, Integer, Object, Integer> collector =
        ConstraintCollectors.conditionally(
            (i, i2, i3) -> i < 2, max((i, i2, i3) -> i + i2 + i3, i -> i));
    Object container = collector.supplier().get();
  ...
  public void compose3() {
    TriConstraintCollector<Integer, Integer, Integer, ?, Triple<Integer, Integer, Double>>
        collector =
            compose(
                min((i, i2, i3) -> i + i2 + i3, i -> i),
                max((i, i2, i3) -> i + i2 + i3, i -> i),
  ...
  public void compose4() {
    TriConstraintCollector<Integer, Integer, Integer, ?, Quadruple<Long, Integer, Integer, Double>>
        collector =
            compose(
                countTri(),
                min((i, i2, i3) -> i + i2 + i3, i -> i),
  ...
  public void consecutiveUsageDynamic() {
    var dynamicCollector =
        ConstraintCollectors.toConnectedRanges(
            (DynamicInterval a, Object b, Object c) -> a,
  ...
  public void loadBalance() {
    var collector =
        ConstraintCollectors.<String, Integer, Integer, String>loadBalance(
            (a, b, c) -> a, (a, b, c) -> b);
    var container = collector.supplier().get();
  ...
  private static <A, B, C, Container_, Result_> Runnable accumulate(
      ...
      C valueC) {
    var slot =
        ((TriConstraintCollectorAccumulator<Container_, A, B, C>) collector.accumulator())
  ...
  public void conditionallyUpdate() {
    TriConstraintCollector<Integer, Integer, Integer, Object, Integer> collector =
        ConstraintCollectors.conditionally(
            (Integer a, Integer b, Integer c) -> a < 2, max((i, i2, i3) -> i + i2 + i3, i -> i));
    Object container = collector.supplier().get();
  ...
  public void toSortedSetUpdate() {
    var collector =
        ConstraintCollectors.<Integer, Integer, Integer, Integer>toSortedSet((a, b, c) -> a);
    var container = collector.supplier().get();
    var slot1 = insert(collector, container, 1, 0, 0);
    var slot2 = insert(collector, container, 2, 0, 0);
  ...
  public void toCollectionUpdate() {
    var collector =
        InnerTriConstraintCollectors
            .<Integer, Integer, Integer, Integer, ArrayList<Integer>>toCollection(
  ...
  public void toMapUpdate() {
    var collector =
        ConstraintCollectors.<Integer, Integer, Integer, Integer, Integer>toMap(
  ...
  public void toSortedMapUpdate() {
    var collector =
        ConstraintCollectors.<Integer, Integer, Integer, Integer, Integer>toSortedMap(
            (a, b, c) -> a + b + c, (a, b, c) -> a + b + c);
    var container = collector.supplier().get();
    var slot1 = insert(collector, container, 2, 0, 0);
    var slot2 = insert(collector, container, 1, 0, 0);
  ...
  private static <Container_> void assertUnfairness(
      TriConstraintCollector<String, Integer, Integer, Container_, LoadBalance<String>> collector,
      Object container,
