...
final class InnerUniConstraintCollectorsTest extends AbstractConstraintCollectorsTest {
  ...
  public void countDistinct() {
    UniConstraintCollector<Long, ?, Long> collector =
        ConstraintCollectors.countDistinct(Function.identity());
    Object container = collector.supplier().get();
  ...
  public void sumBigDecimal() {
    UniConstraintCollector<BigDecimal, ?, BigDecimal> collector =
        ConstraintCollectors.sumBigDecimal(l -> l);
    Object container = collector.supplier().get();
  ...
  public void sumBigInteger() {
    UniConstraintCollector<BigInteger, ?, BigInteger> collector =
        ConstraintCollectors.sumBigInteger(l -> l);
    Object container = collector.supplier().get();
  ...
  public void sumDuration() {
    UniConstraintCollector<Duration, ?, Duration> collector =
        ConstraintCollectors.sumDuration(l -> l);
    Object container = collector.supplier().get();
  ...
  public void toSortedSet() {
    UniConstraintCollector<Integer, ?, SortedSet<Integer>> collector =
  ...
  public void compose4() {
    UniConstraintCollector<Long, ?, Quadruple<Long, Long, Long, Double>> collector =
        compose(
            ...
            max(i -> i),
            ConstraintCollectors.average(i -> i),
            (QuadFunction<Long, Long, Long, Double, Quadruple<Long, Long, Long, Double>>)
                Quadruple::new);
    Object container = collector.supplier().get();
  ...
  public void consecutiveUsage() {
    var collector =
        ConstraintCollectors.toConnectedRanges(Interval::start, Interval::end, (a, b) -> b - a);
    var container = collector.supplier().get();
  ...
  public void consecutiveUsageDynamic() {
    var dynamicCollector =
        ConstraintCollectors.toConnectedRanges(
            DynamicInterval::getStart, DynamicInterval::getEnd, (a, b) -> b - a);
  ...
  public void loadBalance() {
    var collector =
        ConstraintCollectors.<LoadBalanced, String>loadBalance(a -> a.value, a -> a.metric);
    var container = collector.supplier().get();
  ...
  private static <A, Container_, Result_> Runnable accumulate(
    ...
    var slot =
        ((UniConstraintCollectorAccumulator<Container_, A>) collector.accumulator())
  ...
  private static <Container_> void assertUnfairness(
      UniConstraintCollector<LoadBalanced, Container_, LoadBalance<String>> collector,
      Object container,
  ...
  public void countDistinctUpdate() {
    UniConstraintCollector<String, ?, Long> collector =
        ConstraintCollectors.countDistinct(Function.identity());
    var container = collector.supplier().get();
  ...
  public void toCollectionUpdate() {
    var collector =
        InnerUniConstraintCollectors.<Integer, Integer, ArrayList<Integer>>toCollection(
  ...
  public void toMapUpdate() {
    var collector =
        ConstraintCollectors.<Integer, Integer, Integer>toMap(
  ...
  public void toSortedMapUpdate() {
    var collector =
        ConstraintCollectors.<Integer, Integer, Integer>toSortedMap(
            Function.identity(), Function.identity());
    var container = collector.supplier().get();
    var slot1 = insert(collector, container, 2);
    var slot2 = insert(collector, container, 1);
