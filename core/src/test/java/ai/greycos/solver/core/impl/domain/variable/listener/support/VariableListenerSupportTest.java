...
import ai.greycos.solver.core.impl.domain.variable.declarative.GraphNode;
import ai.greycos.solver.core.impl.domain.variable.declarative.TopologicalOrderGraph;
import ai.greycos.solver.core.impl.domain.variable.declarative.VariableUpdaterInfo;
import ai.greycos.solver.core.impl.domain.variable.descriptor.VariableDescriptor;
import ai.greycos.solver.core.impl.domain.variable.inverserelation.ExternalizedSingletonInverseVariableSupply;
import ai.greycos.solver.core.impl.domain.variable.inverserelation.SingletonInverseVariableDemand;
import ai.greycos.solver.core.impl.domain.variable.inverserelation.SingletonInverseVariableListener;
...
import ai.greycos.solver.core.testdomain.shadow.order.TestdataShadowVariableOrderEntity;
