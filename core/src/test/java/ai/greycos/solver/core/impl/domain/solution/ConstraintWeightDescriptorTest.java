...
import ai.greycos.solver.core.testdomain.inheritance.solution.baseannotated.configuration.TestdataExtendedConstraintConfiguration;
import ai.greycos.solver.core.testdomain.inheritance.solution.baseannotated.configuration.TestdataExtendedConstraintConfigurationSolution;
...
class ConstraintWeightDescriptorTest {
  ...
  void extractionFunction() {
    ...
    var constraintConfigurationDescriptor =
        ((ConstraintConfigurationBasedConstraintWeightSupplier<
                    SimpleScore, TestdataConstraintConfigurationSolution>)
                solutionDescriptor.getConstraintWeightSupplier())
            .getConstraintConfigurationDescriptor();

    var firstWeightDescriptor =
    ...
    assertThat(firstWeightDescriptor.getConstraintRef())
        .isEqualTo(
            ConstraintRef.of(
                TestdataConstraintConfigurationSolution.class.getPackage().getName(),
                "First weight"));

    var secondWeightDescriptor =
    ...
    assertThat(firstWeightDescriptor.createExtractor(accessor).apply(solution))
        .isEqualTo(SimpleScore.ZERO);
    assertThat(secondWeightDescriptor.createExtractor(accessor).apply(solution))
  ...
  void extractionFunctionExtended() {
    ...
    var constraintConfigurationDescriptor =
        ((ConstraintConfigurationBasedConstraintWeightSupplier<
                    SimpleScore, TestdataExtendedConstraintConfigurationSolution>)
                solutionDescriptor.getConstraintWeightSupplier())
            .getConstraintConfigurationDescriptor();
    ...
    assertThat(thirdWeightDescriptor.getConstraintRef())
        .isEqualTo(
            ConstraintRef.of(
                TestdataExtendedConstraintConfigurationSolution.class.getPackage().getName(),
                "Third weight"));

    var solution = new TestdataExtendedConstraintConfigurationSolution("solution");
    var constraintConfiguration =
        new TestdataExtendedConstraintConfiguration("constraintConfiguration");
    constraintConfiguration.setFirstWeight(SimpleScore.ZERO);
    constraintConfiguration.setSecondWeight(SimpleScore.of(7));
    ...
    assertThat(secondWeightDescriptor.createExtractor(accessor).apply(solution))
        .isEqualTo(SimpleScore.of(7));
    assertThat(thirdWeightDescriptor.createExtractor(accessor).apply(solution))
