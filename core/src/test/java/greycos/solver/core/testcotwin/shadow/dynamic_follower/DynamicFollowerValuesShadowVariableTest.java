...
class DynamicFollowerValuesShadowVariableTest {
  ...
  void testSolve() {
    ...
    var solverConfig =
        new SolverConfig()
            ...
            .withEntityClasses(
                TestdataDynamicLeaderEntity.class, TestdataDynamicFollowerEntity.class)
  ...
  void testLeaderValueChangeMove() {
    ...
    var solution =
        new TestdataDynamicFollowerSolution(
            "Solution",
    ...
    var variableMetamodel =
        (PlanningVariableMetaModel<
                TestdataDynamicFollowerSolution,
                ? super TestdataDynamicLeaderEntity,
                ? super TestdataValue>)
            solutionDescriptor
                .getMetaModel()
                .entity(TestdataDynamicLeaderEntity.class)
                .variable("value");
    ...
    moveAsserter.assertMoveAndApply(
        solution,
        Moves.change(variableMetamodel, leaderA, value2),
        newSolution -> {
  ...
  void testLeaderChangeMove() {
    ...
    var variableMetamodel =
        (PlanningVariableMetaModel<
                TestdataDynamicFollowerSolution,
                ? super TestdataDynamicFollowerEntity,
                ? super TestdataDynamicLeaderEntity>)
            solutionDescriptor
                .getMetaModel()
                .entity(TestdataDynamicFollowerEntity.class)
                .variable("leader");
    var moveAsserter = MoveAsserter.create(solutionDescriptor);

    moveAsserter.assertMoveAndApply(
        solution,
        Moves.change(variableMetamodel, follower1, leaderB),
        newSolution -> {
          assertThat(follower1.getValue()).isEqualTo(value2);
          assertThat(follower2.getValue()).isEqualTo(value1);
          assertThat(follower3.getValue()).isEqualTo(value2);
    ...
    moveAsserter.assertMoveAndApply(
        solution,
        Moves.change(variableMetamodel, follower3, leaderA),
        newSolution -> {
          assertThat(follower1.getValue()).isEqualTo(value2);
          assertThat(follower2.getValue()).isEqualTo(value1);
    ...
    moveAsserter.assertMoveAndApply(
        solution,
        Moves.change(variableMetamodel, follower1, null),
        newSolution -> {
