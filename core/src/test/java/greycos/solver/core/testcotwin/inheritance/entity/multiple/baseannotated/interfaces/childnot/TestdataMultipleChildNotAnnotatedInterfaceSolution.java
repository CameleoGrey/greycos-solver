package greycos.solver.core.testcotwin.inheritance.entity.multiple.baseannotated.interfaces.childnot;
...
public class TestdataMultipleChildNotAnnotatedInterfaceSolution {
  ...
  public static TestdataMultipleChildNotAnnotatedInterfaceSolution generateSolution(
    ...
    var entityList =
        new ArrayList<TestdataMultipleChildNotAnnotatedInterfaceChildEntity>(entityListSize);
  ...
  public void setEntityList(
      List<TestdataMultipleChildNotAnnotatedInterfaceChildEntity> entityList) {
