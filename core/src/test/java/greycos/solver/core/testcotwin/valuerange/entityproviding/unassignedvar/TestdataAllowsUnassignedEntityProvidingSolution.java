package greycos.solver.core.testcotwin.valuerange.entityproviding.unassignedvar;
...
public class TestdataAllowsUnassignedEntityProvidingSolution extends TestdataObject {
  ...
  public static SolutionDescriptor<TestdataAllowsUnassignedEntityProvidingSolution>
  ...
  public static TestdataAllowsUnassignedEntityProvidingSolution generateUninitializedSolution(
      int valueListSize, int entityListSize) {
    return generateSolution(valueListSize, entityListSize, false);
  }

  private static TestdataAllowsUnassignedEntityProvidingSolution generateSolution(
    ...
    for (var i = 0; i < entityListSize; i++) {
      ...
      var entity =
          new TestdataAllowsUnassignedEntityProvidingEntity("Generated Entity " + i, valueRange);
