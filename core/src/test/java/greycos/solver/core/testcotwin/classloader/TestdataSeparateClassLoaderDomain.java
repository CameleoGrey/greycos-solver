...
public class TestdataSeparateClassLoaderDomain {
  ...
  public static Class<?> getTestdataEntityClass() {
    try {
      return CLASS_LOADER.loadClass("greycos.solver.core.testcotwin.TestdataEntity");
  ...
  public static Class<?> getTestdataValueClass() {
    try {
      return CLASS_LOADER.loadClass("greycos.solver.core.testcotwin.TestdataValue");
    } catch (ClassNotFoundException e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public static Class<?> getTestdataSolutionClass() {
    try {
      return CLASS_LOADER.loadClass("greycos.solver.core.testcotwin.TestdataSolution");
    } catch (ClassNotFoundException e) {
      throw new RuntimeException(e);
    }
  }
