package greycos.solver.core.testcotwin.sort.factorydifficulty;
...
public class TestdataDifficultyFactorySortableSolution {
  ...
  public static SolutionDescriptor<TestdataDifficultyFactorySortableSolution>
  ...
  public static TestdataDifficultyFactorySortableSolution generateSolution(
      int valueCount, int entityCount, boolean shuffle) {
    var entityList =
        new ArrayList<>(
            IntStream.range(0, entityCount)
                .mapToObj(
                    i -> new TestdataDifficultyFactorySortableEntity("Generated Entity " + i, i))
                .toList());
    var valueList =
        new ArrayList<>(
    ...
    TestdataDifficultyFactorySortableSolution solution =
        new TestdataDifficultyFactorySortableSolution();
