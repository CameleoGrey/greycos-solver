...
class MockProblemChangeDirectorTest {
  ...
  void problemChange() {
    ...
    mockProblemChangeDirector
        ...
        .thenReturn(removedWorkingEntity)
        .whenLookingUp(removedFact)
        .thenReturn(removedWorkingFact)
        .whenLookingUp(changedEntity)
        .thenReturn(changedWorkingEntity);

    ProblemChange<TestdataLavishSolution> problemChange =
