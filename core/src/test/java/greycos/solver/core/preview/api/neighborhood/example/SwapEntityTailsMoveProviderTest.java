...
class SwapEntityTailsMoveProviderTest {
  ...
  void producesExactSwapAtAKnownCutAndNoneForACutPastTheSharedLength() {
    ...
    var variableMetaModel =
        solutionMetaModel.genuineEntity(TestdataListEntity.class).<TestdataListValue>listVariable();
    ...
    var context =
        NeighborhoodTester.build(
                new SwapEntityTailsMoveProvider(variableMetaModel), solutionMetaModel)
            .using(solution);
