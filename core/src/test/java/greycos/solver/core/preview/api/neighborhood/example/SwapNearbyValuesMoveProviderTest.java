  ...
  void producesNearbySwapAndNoneAcrossADistanceOfTwo() {
    ...
    var entityA =
        new TestdataListEntityProvidingEntity(
            "A", List.of(a0, a1, a2, b0), new ArrayList<>(List.of(a0, a1, a2)));
    var entityB =
        new TestdataListEntityProvidingEntity(
            "B", List.of(b0, b1, b2, a1), new ArrayList<>(List.of(b0, b1, b2)));
    var solution = new TestdataListEntityProvidingSolution();
    solution.setEntityList(List.of(entityA, entityB));

    var context =
        NeighborhoodTester.build(
                new SwapNearbyValuesMoveProvider(variableMetaModel), solutionMetaModel)
            .using(solution);
