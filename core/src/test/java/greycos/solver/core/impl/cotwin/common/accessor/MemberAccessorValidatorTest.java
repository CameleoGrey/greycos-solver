...
class MemberAccessorValidatorTest {
  ...
  void membersInPrivateClassFail() throws NoSuchFieldException, NoSuchMethodException {
    assertFieldFails(
        MemberAccessorType.FIELD_OR_GETTER_METHOD,
        PrivateClass.class.getDeclaredField("publicField"),
    ...
    assertMethodFails(
        ...
        PrivateClass.class.getDeclaredMethod("publicVoidMethod"),
        "its declaring class (%s) is not public".formatted(PrivateClass.class.getCanonicalName()));
  }
  ...
  void fieldOrReadMethod() throws NoSuchFieldException, NoSuchMethodException {
    assertFieldPasses(
        MemberAccessorType.FIELD_OR_READ_METHOD, PublicClass.class.getDeclaredField("publicField"));
    assertFieldPasses(
  ...
  void fieldOrReadMethodWithOptionalParameter() throws NoSuchFieldException, NoSuchMethodException {
    ...
    assertMethodFails(
        MemberAccessorType.FIELD_OR_READ_METHOD_WITH_OPTIONAL_PARAMETER,
        PublicClass.class.getDeclaredMethod(
            "publicReadMethodWithManyParameter", String.class, String.class),
  ...
  void voidMethod() throws NoSuchFieldException, NoSuchMethodException {
    assertMethodPasses(
        MemberAccessorType.VOID_METHOD, PublicClass.class.getDeclaredMethod("getVoidMethod"));
    ...
    assertMethodFails(
        MemberAccessorType.VOID_METHOD,
        PublicClass.class.getDeclaredMethod("privateVoidMethod"),
  ...
  void assertFieldFails(
      MemberAccessorType memberAccessorType, Field field, String... expectedMessages) {
    var prefix =
        "The field (%s) in class (%s)"
            .formatted(field.getName(), field.getDeclaringClass().getCanonicalName());
  ...
  void assertMethodFails(
      MemberAccessorType memberAccessorType, Method method, String... expectedMessages) {
    var prefix =
        "The method (%s) in class (%s)"
            .formatted(method.getName(), method.getDeclaringClass().getCanonicalName());
    var allMessages = new ArrayList<String>();
    allMessages.add(prefix);
    allMessages.addAll(Arrays.asList(expectedMessages));
