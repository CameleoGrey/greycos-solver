...
class FilteringMoveSelectorTest {
  ...
  void bailOutByTermination() {
    ...
    var filteredMoveSelector =
        FilteringMoveSelector.of(moveSelector, (scoreDirector, selection) -> false);
  ...
  public void filter(SelectionCacheType cacheType, int timesCalled) {
    ...
    SelectionFilter<TestdataSolution, DummyMove> filter =
        (scoreDirector, move) -> !move.getCode().equals("a3");
    MoveSelector moveSelector =
        FilteringMoveSelector.of(childMoveSelector, (SelectionFilter) filter);
