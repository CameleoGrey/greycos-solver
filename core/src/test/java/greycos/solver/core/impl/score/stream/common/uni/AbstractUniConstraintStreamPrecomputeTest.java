...
public abstract class AbstractUniConstraintStreamPrecomputeTest extends AbstractConstraintStreamTest
  ...
  public void filter_0_changed() {
    ...
    var entity1 =
        Mockito.spy(new TestdataLavishEntity("MyEntity 1", entityGroup, solution.getFirstValue()));
  ...
  private <T> void assertPrecompute(
  ...
  public void ifExists() {
    ...
    assertPrecompute(
        solution,
        List.of(entityWithGroup),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
                .ifExists(
                    TestdataLavishEntityGroup.class,
                    Joiners.equal(TestdataLavishEntity::getEntityGroup, Function.identity())));
  }
  ...
  private <A, B> void assertPrecomputeBi(
      TestdataLavishSolution solution,
  ...
  public void flattenNewInstances() {
    ...
    assertPrecomputeBi(
        solution,
        List.of(new Pair<>(entity1, new ValueHolder(1)), new Pair<>(entity2, new ValueHolder(2))),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
  ...
  public void flattenLast() {
    ...
    assertPrecompute(
        solution,
        List.of(entityWithoutGroup, entityWithGroup),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
  ...
  public void flattenLastNewInstances() {
    ...
    assertPrecompute(
        solution,
        List.of(new ValueHolder(1), new ValueHolder(2)),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
                .groupBy(ConstraintCollectors.toList())
                .flattenLast(
  ...
  public void map() {
    ...
    assertPrecompute(
        solution,
        List.of(entityGroup, entityGroup),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
                .filter(entity -> entity.getEntityGroup() != null)
  ...
  public void complement() {
    ...
    assertPrecompute(
        solution,
        List.of(entityWithGroup1, entityWithGroup2, entityWithoutGroup),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
                .filter(entity -> entity.getEntityGroup() != null)
