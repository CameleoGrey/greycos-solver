package greycos.solver.core.impl.localsearch.decider.forager.finalist;

import static greycos.solver.core.testutil.PlannerAssert.extractSingleton;
...
class StrategicOscillationByLevelFinalistPodiumTest {
  ...
  protected static <Solution_> LocalSearchMoveScope<Solution_> buildMoveScope(
