...
class PillarSwapMoveTest {
  ...
  void isMoveDoableValueRangeProviderOnEntity() {
    ...
    var abzMove =
        new PillarSwapMove<>(variableDescriptorList, Arrays.asList(a, b), Arrays.asList(z));
    a.setValue(v2);
    b.setValue(v2);
    z.setValue(v4);
  ...
  void doMove() {
    ...
    var abczMove =
        new PillarSwapMove<>(variableDescriptorList, Arrays.asList(a), Arrays.asList(b, c, z));
    ...
    var abczMove2 =
        new PillarSwapMove<>(variableDescriptorList, Arrays.asList(a, b), Arrays.asList(c, z));
  ...
  public void assertSameProperties(
      List<Object> leftPillar, List<Object> rightPillar, PillarSwapMove<?> move) {
  ...
  void getters() {
    ...
    var move =
        new PillarSwapMove<>(
            Arrays.asList(primaryDescriptor),
  ...
  void toStringTest() {
    ...
    var variableDescriptorList =
        TestdataEntity.buildEntityDescriptor().getGenuineVariableDescriptorList();

    assertThat(
            new PillarSwapMove<>(
                variableDescriptorList, Arrays.asList(a, b), Arrays.asList(c, d, e)))
    ...
    assertThat(
            new PillarSwapMove<>(
                variableDescriptorList, Arrays.asList(f, g), Arrays.asList(c, d, e)))
