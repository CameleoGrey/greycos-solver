...
import static greycos.solver.core.api.score.SimpleScore.ONE;
import static greycos.solver.core.api.score.SimpleScore.ZERO;
...
class ConstraintMatchTest {
  ...
  private <Score_ extends Score<Score_>> ConstraintMatch<Score_> buildConstraintMatch(
      String constraintName, Score_ score, Object... facts) {
    return new ConstraintMatch<>(
        ConstraintRef.of(constraintName), DefaultConstraintJustification.of(score, facts), score);
  }
