...
import greycos.solver.core.testcotwin.inheritance.solution.baseannotated.childnot.TestdataOnlyBaseAnnotatedConstraintProvider;
...
import greycos.solver.core.testcotwin.inheritance.solution.baseannotated.childtooabstract.TestdataBothAnnotatedAbstractChildEntity;
import greycos.solver.core.testcotwin.inheritance.solution.baseannotated.childtooabstract.TestdataBothAnnotatedAbstractExtendedConstraintProvider;
...
import greycos.solver.core.testcotwin.inheritance.solution.baseannotated.multiple.TestdataMultipleInheritanceEntity;
...
import greycos.solver.core.testcotwin.inheritance.solution.baseannotated.replacemember.TestdataReplaceMemberEntity;
...
import greycos.solver.core.testcotwin.inheritance.solution.baseanot.TestdataOnlyChildAnnotatedChildEntity;
import greycos.solver.core.testcotwin.inheritance.solution.baseanot.TestdataOnlyChildAnnotatedExtendedSolution;
...
class SolverSolutionInheritanceTest {
    ...
    var solverConfig =
        new SolverConfig()
            ...
            .withConstraintProviderClass(
                TestdataBothAnnotatedAbstractExtendedConstraintProvider.class)
  ...
  void testReplaceAnnotatedMember() {
    ...
    assertThatCode(() -> PlannerTestUtils.solve(solverConfig, problem))
        ...
        .hasMessageContaining(
            "that is duplicated by a @PlanningEntityCollectionProperty annotated member")
