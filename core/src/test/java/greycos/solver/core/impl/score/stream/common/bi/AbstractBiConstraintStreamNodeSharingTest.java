...
public abstract class AbstractBiConstraintStreamNodeSharingTest extends AbstractConstraintStreamTest
    implements ConstraintStreamNodeSharingTest {

  private ConstraintFactory constraintFactory;
  private BiConstraintStream<TestdataEntity, TestdataEntity> baseStream;

  protected AbstractBiConstraintStreamNodeSharingTest(ConstraintStreamImplSupport implSupport) {
    super(implSupport);
  }
  ...
  public void sameParentsDifferentFilteringJoin() {
    TriJoiner<TestdataEntity, TestdataEntity, TestdataValue> filteringJoiner1 =
        Joiners.filtering((a, b, c) -> false);
    TriJoiner<TestdataEntity, TestdataEntity, TestdataValue> filteringJoiner2 =
        Joiners.filtering((a, b, c) -> true);
  ...
  public void sameParentsSameFilteringJoin() {
    TriJoiner<TestdataEntity, TestdataEntity, TestdataValue> filteringJoiner =
        Joiners.filtering((a, b, c) -> true);
  ...
  public void ifExistsSameParentSameIndexer() {
    TriJoiner<TestdataEntity, TestdataEntity, TestdataEntity> joiner =
        Joiners.equal((a, b) -> a, c -> c);
  ...
  public void ifExistsSameParentDifferentIndexer() {
    TriJoiner<TestdataEntity, TestdataEntity, TestdataEntity> joiner1 =
        Joiners.equal((a, b) -> a, c -> c);
    TriJoiner<TestdataEntity, TestdataEntity, TestdataEntity> joiner2 =
        Joiners.equal((a, b) -> b, c -> c);
  ...
  public void differentParentSameFunctionFlatten() {
    BiPredicate<TestdataEntity, TestdataEntity> filter1 = (a, b) -> true;
    BiFunction<TestdataEntity, TestdataEntity, Iterable<TestdataEntity>> flattener =
  ...
  public void sameParentDifferentFunctionFlatten() {
    BiFunction<TestdataEntity, TestdataEntity, Iterable<TestdataEntity>> flattener1 =
        (a, b) -> Collections.emptyList();
    BiFunction<TestdataEntity, TestdataEntity, Iterable<TestdataEntity>> flattener2 =
