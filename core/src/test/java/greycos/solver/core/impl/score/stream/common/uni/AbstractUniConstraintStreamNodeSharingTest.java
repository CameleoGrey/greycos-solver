...
public abstract class AbstractUniConstraintStreamNodeSharingTest
  ...
  protected AbstractUniConstraintStreamNodeSharingTest(ConstraintStreamImplSupport implSupport) {
    super(implSupport);
  }
  ...
  public void sameParentsDifferentIndexerJoin() {
    BiJoiner<TestdataEntity, TestdataValue> indexedJoiner1 =
        Joiners.equal(TestdataEntity::getCode, TestdataValue::getCode);
  ...
  public void sameParentsSameIndexerJoin() {
    BiJoiner<TestdataEntity, TestdataValue> indexedJoiner =
        Joiners.equal(TestdataEntity::getCode, TestdataValue::getCode);
  ...
  public void ifExistsOtherIncludingUnassignedDifferentParent() {
    ...
    assertThat(baseStream.ifExistsOtherIncludingUnassigned(TestdataEntity.class))
        .isNotSameAs(
            baseStream.filter(filter1).ifExistsOtherIncludingUnassigned(TestdataEntity.class));
  }
  ...
  public void ifNotExistsOtherIncludingUnassignedDifferentParent() {
    ...
    assertThat(baseStream.ifNotExistsOtherIncludingUnassigned(TestdataEntity.class))
        .isNotSameAs(
            baseStream.filter(filter1).ifNotExistsOtherIncludingUnassigned(TestdataEntity.class));
  }
  ...
  public void sameDataPrecompute() {
    ...
    Assertions.assertThat(
            (UniConstraintStream<?>)
                constraintFactory.precompute(
                    precomputeFactory ->
                        precomputeFactory.forEachUnfiltered(TestdataEntity.class).filter(filter1)))
        .isSameAs(
            constraintFactory.precompute(
                precomputeFactory ->
                    precomputeFactory.forEachUnfiltered(TestdataEntity.class).filter(filter1)));
  ...
  public void differentDataPrecompute() {
    ...
    Assertions.assertThat(
        ...
        .isNotSameAs(
            constraintFactory.precompute(
                precomputeFactory ->
                    precomputeFactory.forEachUnfiltered(TestdataEntity.class).filter(filter2)));
  }
}
