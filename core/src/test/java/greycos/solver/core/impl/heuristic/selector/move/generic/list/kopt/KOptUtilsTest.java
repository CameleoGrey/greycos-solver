...
import static greycos.solver.core.impl.heuristic.selector.move.generic.list.kopt.KOptUtils.getBetweenPredicate;
...
public class KOptUtilsTest {
  ...
  void testGetRemovedEdgesList() {
    ...
    List<TestdataListValue> removedEdges = List.of(v1, v2, v3, v4, v5, v6, v7, v8);
    List<TestdataListValue> addedEdges = List.of(v1, v4, v2, v7, v5, v3, v6, v8);

    KOptDescriptor<TestdataListValue> kOptDescriptor =
        fromRemovedAndAddedEdges(originalTour, removedEdges, addedEdges);

    assertThat(KOptUtils.getRemovedEdgeList(kOptDescriptor))
        .containsExactlyInAnyOrder(
            new Pair<>(v1, v2), new Pair<>(v3, v4), new Pair<>(v5, v6), new Pair<>(v7, v8));
  }
  ...
  void testGetAddedEdgesList() {
    ...
    assertThat(KOptUtils.getAddedEdgeList(kOptDescriptor))
        .containsExactlyInAnyOrder(
            new Pair<>(v1, v4), new Pair<>(v2, v7), new Pair<>(v5, v3), new Pair<>(v6, v8));
  }
  ...
  void testGetCyclesForPermutationTwoCycle() {
    List<TestdataListValue> originalTour = List.of(v1, v2, v3, v4, v5, v6, v7, v8);
    List<TestdataListValue> removedEdges = List.of(v1, v2, v3, v4, v5, v6, v7, v8);
    List<TestdataListValue> addedEdges = List.of(v1, v4, v3, v6, v5, v8, v7, v2);
  ...
  void testGetCyclesForPermutationThreeCycle() {
    ...
    List<TestdataListValue> removedEdges =
        List.of(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12);
    List<TestdataListValue> addedEdges = List.of(v1, v4, v5, v12, v3, v6, v7, v2, v8, v10, v11, v9);
    ...
    // v2 -> v7 -> v6 -> v3
    // v8 -> v10 -> v11 -> v9
    assertThat(cycleInfo.indexToCycleIdentifier())
        .containsExactly(0, 0, 1, 1, 0, 0, 1, 1, 2, 2, 2, 2, 0);
  }
