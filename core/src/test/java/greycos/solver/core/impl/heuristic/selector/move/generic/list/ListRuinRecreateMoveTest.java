...
import greycos.solver.core.impl.heuristic.selector.move.generic.list.ruin.ListRuinRecreateMove;
...
class ListRuinRecreateMoveTest {
  ...
  void rebase() {
    ...
    assertSoftly(
        softly -> {
          softly
              .assertThat((Collection) rebasedMove.getPlanningEntities())
              .containsExactlyInAnyOrder(
                  destinationE1, destinationE2, destinationE3); // The input set is not ordered.
          softly
              .assertThat((Collection) rebasedMove.getPlanningValues())
