...
public abstract class AbstractTriConstraintStreamPrecomputeTest extends AbstractConstraintStreamTest
  ...
  private <A, B, C> void assertPrecomputeFilterChanged(
      ...
      TriFunction<
              TestdataLavishEntity, TestdataLavishValue, TestdataLavishEntityGroup, Triple<A, B, C>>
          inputDataToTuple) {
    ...
    assertPrecomputeFilterChanged(
        (precomputeFactory, entityGroup, valueGroup) ->
            precomputeFactory
                ...
                .filter(
                    (entity, value, matchedEntityGroup) ->
    ...
    assertPrecomputeFilterChanged(
        (precomputeFactory, entityGroup, valueGroup) ->
            precomputeFactory
                ...
                .join(TestdataLavishEntityGroup.class)
                .filter(
                    (value, entity, matchedEntityGroup) ->
                        entity.getEntityGroup() == entityGroup
                            && value.getValueGroup() == valueGroup
                            && matchedEntityGroup == entityGroup),
    ...
    assertPrecomputeFilterChanged(
        (precomputeFactory, entityGroup, valueGroup) ->
            precomputeFactory
                ...
                .join(TestdataLavishEntity.class)
                .filter(
                    (value, matchedEntityGroup, entity) ->
                        entity.getEntityGroup() == entityGroup
                            && value.getValueGroup() == valueGroup
                            && matchedEntityGroup == entityGroup),
  ...
  private <A, B, C> void assertPrecompute(
  ...
  public void ifExists() {
    ...
    assertPrecompute(
        solution,
        List.of(new Triple<>(entityWithGroup, value, value)),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
                ...
                .ifExists(
                    ...
                    Joiners.equal((a, b, c) -> a.getEntityGroup(), Function.identity())));
  }
  ...
  public void ifNotExists() {
    ...
    assertPrecompute(
        solution,
        List.of(new Triple<>(entityWithoutGroup, value, value)),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
                .join(TestdataLavishValue.class)
                .join(TestdataLavishValue.class)
  ...
  public void flatten() {
    ...
    assertPrecompute(
        solution,
        List.of(
            new Triple<>(entityWithoutGroup, entityWithoutGroup, value),
  ...
  public void flattenNewInstances() {
    ...
    assertPrecompute(
        solution,
        List.of(
            new Triple<>(entity1, new ValueHolder(entity1.getIntegerProperty()), value),
  ...
  public void flattenLast() {
    ...
    assertPrecompute(
        solution,
        List.of(
            new Triple<>(entityWithoutGroup, value, value),
  ...
  public void flattenLastNewInstances() {
    ...
    assertPrecompute(
        solution,
        List.of(
            new Triple<>(new ValueHolder(1), value, value),
  ...
  public void map() {
    ...
    assertPrecompute(
        solution,
        List.of(new Triple<>(entityGroup, value, value), new Triple<>(entityGroup, value, value)),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
                .join(TestdataLavishValue.class)
                .join(TestdataLavishValue.class)
                ...
                .map(
                    (entity, joinedValue1, joinedValue2) -> entity.getEntityGroup(),
            ...
            pf.forEachUnfiltered(TestdataLavishEntity.class)
                ...
                .concat(
                    pf.forEachUnfiltered(TestdataLavishEntity.class)
                        ...
                        .join(TestdataLavishValue.class)
                        .filter(
                            (entity, joinedValue1, joinedValue2) ->
  ...
  public void distinct() {
    ...
    assertPrecompute(
        solution,
        List.of(new Triple<>(entityGroup, value, value)),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
                .join(TestdataLavishValue.class)
                .join(TestdataLavishValue.class)
