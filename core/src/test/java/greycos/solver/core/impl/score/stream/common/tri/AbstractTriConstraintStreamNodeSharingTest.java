...
import greycos.solver.core.impl.score.stream.common.ConstraintStreamNodeSharingTest;
...
public abstract class AbstractTriConstraintStreamNodeSharingTest
    extends AbstractConstraintStreamTest implements ConstraintStreamNodeSharingTest {

  private ConstraintFactory constraintFactory;
  private TriConstraintStream<TestdataEntity, TestdataEntity, TestdataEntity> baseStream;

  protected AbstractTriConstraintStreamNodeSharingTest(ConstraintStreamImplSupport implSupport) {
    super(implSupport);
  }
  ...
  public void differentParentSameFilter() {
    ...
    assertThat(baseStream.filter(filter1)).isNotSameAs(baseStream.filter(filter2).filter(filter1));
  }
  ...
  public void sameParentDifferentFilter() {
    ...
    assertThat(baseStream.filter(filter1)).isNotSameAs(baseStream.filter(filter2));
  }
  ...
  public void sameParentSameFilter() {
    ...
    assertThat(baseStream.filter(filter1)).isSameAs(baseStream.filter(filter1));
  }
  ...
  public void differentRightParentJoin() {
    ...
    assertThat(baseStream.join(TestdataValue.class))
        .isNotSameAs(
            baseStream.join(constraintFactory.forEach(TestdataValue.class).filter(filter1)));
  }
  ...
  public void sameParentsJoin() {
    assertThat(baseStream.join(TestdataValue.class)).isSameAs(baseStream.join(TestdataValue.class));
  }
  ...
  public void ifNotExistsIncludingUnassignedDifferentParent() {
    ...
    assertThat(baseStream.ifNotExistsIncludingUnassigned(TestdataEntity.class))
        .isNotSameAs(
            baseStream.filter(filter1).ifNotExistsIncludingUnassigned(TestdataEntity.class));
  }
  ...
  public void differentParentGroupBy() {
    TriPredicate<TestdataEntity, TestdataEntity, TestdataEntity> filter1 = (a, b, c) -> true;
    TriFunction<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity> keyMapper =
        (a, b, c) -> a;
  ...
  public void differentKeyMapperGroupBy() {
    TriFunction<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity> keyMapper1 =
        (a, b, c) -> a;
    TriFunction<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity> keyMapper2 =
        (a, b, c) -> b;

    assertThat(baseStream.groupBy(keyMapper1)).isNotSameAs(baseStream.groupBy(keyMapper2));
  }
  ...
  public void sameParentSameKeyMapperGroupBy() {
    ...
    assertThat(baseStream.groupBy(keyMapper)).isSameAs(baseStream.groupBy(keyMapper));
  }
  ...
  public void differentParentSameFunctionExpand() {
    TriPredicate<TestdataEntity, TestdataEntity, TestdataEntity> filter1 = (a, b, c) -> true;
    TriFunction<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity> expander =
        (a, b, c) -> a;
  ...
  public void sameParentDifferentFunctionExpand() {
    TriFunction<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity> expander1 =
        (a, b, c) -> a;
    TriFunction<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity> expander2 =
        (a, b, c) -> b;

    assertThat(baseStream.expand(expander1)).isNotSameAs(baseStream.expand(expander2));
  }
  ...
  public void sameParentSameFunctionExpand() {
    ...
    assertThat(baseStream.expand(expander)).isSameAs(baseStream.expand(expander));
  }
  ...
  public void differentParentSameFunctionMap() {
    TriPredicate<TestdataEntity, TestdataEntity, TestdataEntity> filter1 = (a, b, c) -> true;
    TriFunction<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity> mapper =
        (a, b, c) -> a;

    assertThat(baseStream.map(mapper)).isNotSameAs(baseStream.filter(filter1).map(mapper));
  }

  @Override
  @TestTemplate
  public void sameParentDifferentFunctionMap() {
    TriFunction<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity> mapper1 =
        (a, b, c) -> a;
    TriFunction<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity> mapper2 =
        (a, b, c) -> a;

    assertThat(baseStream.map(mapper1)).isNotSameAs(baseStream.map(mapper2));
  }
  ...
  public void differentParentSameFunctionFlatten() {
    TriPredicate<TestdataEntity, TestdataEntity, TestdataEntity> filter1 = (a, b, c) -> true;
    TriFunction<TestdataEntity, TestdataEntity, TestdataEntity, Iterable<TestdataEntity>>
        flattener = (a, b, c) -> Collections.emptyList();
  ...
  public void sameParentDifferentFunctionFlatten() {
    TriFunction<TestdataEntity, TestdataEntity, TestdataEntity, Iterable<TestdataEntity>>
        flattener1 = (a, b, c) -> Collections.emptyList();
    TriFunction<TestdataEntity, TestdataEntity, TestdataEntity, Iterable<TestdataEntity>>
        flattener2 = (a, b, c) -> Collections.emptySet();
  ...
  public void sameParentDifferentFunctionFlattenLast() {
    ...
    assertThat(baseStream.flattenLast(flattener1)).isNotSameAs(baseStream.flattenLast(flattener2));
  }
  ...
  public void sameParentSameFunctionFlattenLast() {
    ...
    assertThat(baseStream.flattenLast(flattener)).isSameAs(baseStream.flattenLast(flattener));
  }
  ...
  public void differentParentDistinct() {
    ...
    assertThat(baseStream.distinct()).isNotSameAs(baseStream.filter(filter1).distinct());
  }

  @Override
  @TestTemplate
  public void sameParentDistinct() {
    assertThat(baseStream.distinct()).isSameAs(baseStream.distinct());
  }
  ...
  public void differentFirstSourceConcat() {
    ...
    assertThat(baseStream.concat(baseStream.filter(filter1)))
        .isNotSameAs(baseStream.filter(sourceFilter).concat(baseStream.filter(filter1)));
  }
  ...
  public void differentSecondSourceConcat() {
    ...
    assertThat(baseStream.filter(filter1).concat(baseStream))
        .isNotSameAs(baseStream.filter(filter1).concat(baseStream.filter(sourceFilter)));
  }
  ...
  public void sameDataPrecompute() {
    ...
    Assertions.assertThat(
            (TriConstraintStream<?, ?, ?>)
                constraintFactory.precompute(
                    precomputeFactory ->
                        precomputeFactory
                            .forEachUnfiltered(TestdataEntity.class)
                            .join(TestdataEntity.class)
                            .join(TestdataEntity.class)
                            .filter(filter1)))
        .isSameAs(
