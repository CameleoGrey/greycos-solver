package greycos.solver.core.impl.cotwin.solution.mutation;
...
class MutationCounterTest {
  ...
  void countMutationsOnExtendedEntities() {
    ...
    var a =
        TestdataBothAnnotatedExtendedSolution.generateSolution(
            entityListSize, subEntityListSize, rawEntityListSize);
    a.setValueList(valueList);
    ...
    assertThat(mutationCounter.countMutations(a, b))
        .isEqualTo(baseDescriptorCount + childDescriptorCount);
  }
}
