...
import static greycos.solver.core.testutil.PlannerAssert.assertCodesOfNeverEndingOfEntitySelector;
...
class FromSolutionEntitySelectorTest {
  ...
  public void runOriginalWithoutEntityListDirtyAndMinimumCacheType(SelectionCacheType cacheType) {
    ...
    final List<Object> entityList =
        Arrays.asList(new TestdataEntity("e1"), new TestdataEntity("e2"), new TestdataEntity("e3"));
