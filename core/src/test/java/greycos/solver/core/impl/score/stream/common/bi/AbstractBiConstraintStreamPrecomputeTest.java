...
public abstract class AbstractBiConstraintStreamPrecomputeTest extends AbstractConstraintStreamTest
  ...
  public void filter_0_changed() {
    ...
    assertScore(scoreDirector, assertMatch(entity2, value1), assertMatch(entity2, value2));
  ...
  public void filter_1_changed() {
        ...
        buildScoreDirector(
            factory ->
                factory
                    .precompute(
                        data ->
                            data.forEachUnfiltered(TestdataLavishValue.class)
    ...
    entity1.setValue(solution.getFirstValue());
    scoreDirector.afterVariableChanged(entity1, "value");
    assertScore(scoreDirector, assertMatch(value1, entity2), assertMatch(value2, entity2));
    Mockito.verify(entity1, Mockito.never()).getEntityGroup();
        ...
        buildScoreDirector(
            factory ->
                factory
                    .precompute(
                        data ->
                            data.forEachUnfilteredUniquePair(
  ...
  private <A, B> void assertPrecompute(
  ...
  public void ifExists() {
    ...
    assertPrecompute(
        solution,
        List.of(new Pair<>(entityWithGroup, value)),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
                .join(TestdataLavishValue.class)
                .ifExists(
                    TestdataLavishEntityGroup.class,
                    Joiners.equal((a, b) -> a.getEntityGroup(), Function.identity())));
  }
  ...
  public void ifNotExists() {
    ...
    assertPrecompute(
        solution,
        List.of(new Pair<>(entityWithoutGroup, value)),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
                .join(TestdataLavishValue.class)
                .ifNotExists(
  ...
  public void groupBy() {
    ...
    assertPrecompute(
        solution,
        List.of(new Pair<>(entityGroup, 1L)),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
  ...
  public void flatten() {
    ...
    assertPrecompute(
        solution,
        List.of(
            new Pair<>(entityWithoutGroup, entityWithoutGroup),
            new Pair<>(entityWithGroup, entityWithoutGroup)),
        pf -> pf.forEachUnfiltered(TestdataLavishEntity.class).flatten(List::of));
  }
  ...
  public void flattenNewInstances() {
    ...
    assertPrecompute(
        solution,
        List.of(
            new Pair<>(entity1, new ValueHolder(entity1.getIntegerProperty())),
  ...
  public void flattenLast() {
    ...
    assertPrecompute(
        solution,
        List.of(new Pair<>(entityWithoutGroup, value), new Pair<>(entityWithGroup, value)),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
  ...
  public void flattenLastNewInstances() {
    ...
    assertPrecompute(
        solution,
        List.of(new Pair<>(new ValueHolder(1), value), new Pair<>(new ValueHolder(2), value)),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
                .groupBy(ConstraintCollectors.toList())
                .flattenLast(
  ...
  public void map() {
    ...
    assertPrecompute(
        solution,
        List.of(new Pair<>(entityGroup, value), new Pair<>(entityGroup, value)),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
                .join(TestdataLavishValue.class)
                .filter((entity, joinedValue) -> entity.getEntityGroup() != null)
                .map(
                    (entity, joinedValue) -> entity.getEntityGroup(),
  ...
  public void distinct() {
    ...
    assertPrecompute(
        solution,
        List.of(new Pair<>(entityGroup, value)),
        pf ->
            pf.forEachUnfiltered(TestdataLavishEntity.class)
                .join(TestdataLavishValue.class)
                .filter((entity, joinedValue) -> entity.getEntityGroup() != null)
