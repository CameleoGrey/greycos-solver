...
class SelectorBasedPillarChangeMoveTest {
  ...
  void doMove() {
    ...
    var abcMove =
        new SelectorBasedPillarChangeMove<>(Arrays.asList(a, b, c), variableDescriptor, v2);
  ...
  void assertSameProperties(
      List<Object> pillar, Object toPlanningVariable, SelectorBasedPillarChangeMove<?> move) {
  ...
  void getters() {
    var move =
        new SelectorBasedPillarChangeMove<>(
  ...
  void toStringTest() {
    ...
    assertThat(
            new SelectorBasedPillarChangeMove<>(Arrays.asList(c, d, e), variableDescriptor, null))
    ...
    assertThat(new SelectorBasedPillarChangeMove<>(Arrays.asList(d), variableDescriptor, v2))
        .hasToString("[d] {v1 -> v2}");
  }
}
