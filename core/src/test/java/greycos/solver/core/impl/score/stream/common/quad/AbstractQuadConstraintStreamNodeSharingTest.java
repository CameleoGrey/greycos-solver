...
public abstract class AbstractQuadConstraintStreamNodeSharingTest
    extends AbstractConstraintStreamTest implements ConstraintStreamNodeSharingTest {

  private ConstraintFactory constraintFactory;
  private QuadConstraintStream<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity>
      baseStream;

  protected AbstractQuadConstraintStreamNodeSharingTest(ConstraintStreamImplSupport implSupport) {
    super(implSupport);
  }
  ...
  public void differentParentSameFilter() {
    QuadPredicate<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity> filter1 =
        (a, b, c, d) -> true;
    QuadPredicate<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity> filter2 =
        (a, b, c, d) -> false;
  ...
  public void ifExistsSameParentSameIndexer() {
    PentaJoiner<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity>
        joiner = Joiners.equal((a, b, c, d) -> a, e -> e);
  ...
  public void ifExistsSameParentSameFilter() {
    PentaJoiner<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity>
        joiner = Joiners.filtering((a, b, c, d, e) -> a == b);
  ...
  public void ifExistsSameParentDifferentIndexer() {
    PentaJoiner<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity>
        joiner1 = Joiners.equal((a, b, c, d) -> a, e -> e);
    PentaJoiner<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity>
        joiner2 = Joiners.equal((a, b, c, d) -> b, e -> e);
  ...
  public void ifExistsSameParentDifferentFilter() {
    PentaJoiner<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity>
        joiner1 = Joiners.filtering((a, b, c, d, e) -> a == b);
    PentaJoiner<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity>
        joiner2 = Joiners.filtering((a, b, c, d, e) -> a != b);
  ...
  public void differentParentGroupBy() {
    QuadPredicate<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity> filter1 =
        (a, b, c, d) -> true;
    QuadFunction<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity>
        keyMapper = (a, b, c, d) -> a;
  ...
  public void differentKeyMapperGroupBy() {
    QuadFunction<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity>
        keyMapper1 = (a, b, c, d) -> a;
    QuadFunction<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity>
        keyMapper2 = (a, b, c, d) -> b;
  ...
  public void differentFirstSourceConcat() {
    QuadPredicate<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity> sourceFilter =
        (a, b, c, d) -> true;
    QuadPredicate<TestdataEntity, TestdataEntity, TestdataEntity, TestdataEntity> filter1 =
        (a, b, c, d) -> false;
