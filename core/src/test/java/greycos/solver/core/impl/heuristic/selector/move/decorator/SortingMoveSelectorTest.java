...
import greycos.solver.core.impl.heuristic.selector.common.CodeAssertableSorter;
...
class SortingMoveSelectorTest {
  ...
  void applySorting(DummySorterMoveSelectorConfig moveSelectorConfig) {
    ...
    var moveSelectorFactory =
        new DummySorterMoveSelectorFactory(moveSelectorConfig, baseMoveSelector);
    var moveSelector =
        moveSelectorFactory.buildBaseMoveSelector(
  ...
  private static class DummySorterMoveSelectorConfig
      extends MoveSelectorConfig<DummySorterMoveSelectorConfig> {
  ...
  private static class DummySorterMoveSelectorFactory
    ...
    DummySorterMoveSelectorFactory(
        DummySorterMoveSelectorConfig moveSelectorConfig,
  ...
  public static class TestCodeAssertableComparatorFactory
      implements SelectionSorterWeightFactory<Object, CodeAssertable> {
