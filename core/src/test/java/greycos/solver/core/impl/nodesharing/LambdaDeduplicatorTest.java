...
class LambdaDeduplicatorTest {
  ...
  void triFunctionFieldName() {
    LambdaKey key =
        new LambdaKey(
            "greycos.solver.core.api.score.stream.TriFunction",
            "com/example/Class.lambda$1",
  ...
  void quadFunctionFieldName() {
    LambdaKey key =
        new LambdaKey(
            "greycos.solver.core.api.score.stream.QuadFunction",
            "com/example/Class.lambda$1",
  ...
  void joinerFieldName() {
    LambdaKey key =
        new LambdaKey(
            "greycos.solver.core.api.score.stream.Joiner",
            "com/example/Class.lambda$1",
  ...
  void collectorFieldName() {
    LambdaKey key =
        new LambdaKey(
            "greycos.solver.core.api.score.stream.Collector",
            "com/example/Class.lambda$1",
            "(Ljava/lang/Object;)Ljava/lang/Object;",
            List.of());
  ...
  void fieldDescriptorWithPackage() {
    ...
    assertThat(deduplicator.getFieldDescriptor(key))
        .isEqualTo("Lgreycos/solver/core/api/score/stream/TriFunction;");
  }
