...
public class DestinationSelectorConfig extends SelectorConfig<DestinationSelectorConfig> {
  ...
  public @NonNull DestinationSelectorConfig withEntitySelectorConfig(
      @NonNull EntitySelectorConfig entitySelectorConfig) {
    this.setEntitySelectorConfig(entitySelectorConfig);
    return this;
  }

  public @NonNull DestinationSelectorConfig withValueSelectorConfig(
      @NonNull ValueSelectorConfig valueSelectorConfig) {
    this.setValueSelectorConfig(valueSelectorConfig);
    return this;
  }

  public @NonNull DestinationSelectorConfig withNearbySelectionConfig(
  ...
  @Override
  public @NonNull DestinationSelectorConfig inherit(
      @NonNull DestinationSelectorConfig inheritedConfig) {
    entitySelectorConfig =
