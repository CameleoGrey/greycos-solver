...
public abstract class MoveSelectorConfig<Config_ extends MoveSelectorConfig<Config_>>
  ...
  @Nullable protected String filterClass = null;

  @Nullable protected String comparatorClass = null;
  @Nullable protected String comparatorFactoryClass = null;
  @Nullable protected SelectionSorterOrder sorterOrder = null;
  @Nullable protected String sorterClass = null;

  @Nullable protected String probabilityWeightFactoryClass = null;

  @Nullable protected Long selectedCountLimit = null;

  @Nullable private Double fixedProbabilityWeight = null;
  ...
  public Config_ withComparatorFactoryClass(
  ...
  /**
   * Gather a list of all descendant {@link MoveSelectorConfig}s except for {@link
   * UnionMoveSelectorConfig} and {@link CartesianProductMoveSelectorConfig}.
   */
  public void extractLeafMoveSelectorConfigsIntoList(
      List<MoveSelectorConfig> leafMoveSelectorConfigList) {
  ...
  /**
   * Does not inherit subclass properties because this class and {@code foldedConfig} can be of a
   * different type.
   */
