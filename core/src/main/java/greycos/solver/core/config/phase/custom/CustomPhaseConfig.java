package greycos.solver.core.config.phase.custom;
...
public final class CustomPhaseConfig extends PhaseConfig<CustomPhaseConfig> {
  ...
  public void setCustomPhaseCommandList(
      @Nullable List<? extends PhaseCommand> customPhaseCommandList) {
  ...
  public <Solution_> CustomPhaseConfig withCustomPhaseCommands(
      PhaseCommand<Solution_>... customPhaseCommands) {
