package greycos.solver.core.config.localsearch.decider.forager;
...
import greycos.solver.core.impl.localsearch.decider.forager.finalist.StrategicOscillationByLevelFinalistPodium;
    ...
    switch (this) {
      ...
      default:
        throw new IllegalStateException(
            "The finalistPodiumType (" + this + ") is not implemented.");
    }
  }
}
