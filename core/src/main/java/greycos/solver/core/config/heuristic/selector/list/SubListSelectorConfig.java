package greycos.solver.core.config.heuristic.selector.list;
...
public class SubListSelectorConfig extends SelectorConfig<SubListSelectorConfig> {
  ...
  @XmlAttribute private String id = null;
  @XmlAttribute private String mimicSelectorRef = null;
  ...
  public @NonNull SubListSelectorConfig withValueSelectorConfig(
      @NonNull ValueSelectorConfig valueSelectorConfig) {
    this.setValueSelectorConfig(valueSelectorConfig);
    return this;
  }

  public @NonNull SubListSelectorConfig withNearbySelectionConfig(
      @NonNull NearbySelectionConfig nearbySelectionConfig) {
    this.setNearbySelectionConfig(nearbySelectionConfig);
    return this;
  }

  public @NonNull SubListSelectorConfig withMinimumSubListSize(
      @NonNull Integer minimumSubListSize) {
    this.setMinimumSubListSize(minimumSubListSize);
    return this;
  }

  public @NonNull SubListSelectorConfig withMaximumSubListSize(
      @NonNull Integer maximumSubListSize) {
  ...
  public @NonNull SubListSelectorConfig inherit(@NonNull SubListSelectorConfig inheritedConfig) {
    ...
    mimicSelectorRef =
        ConfigUtils.inheritOverwritableProperty(mimicSelectorRef, inheritedConfig.mimicSelectorRef);
    valueSelectorConfig =
        ConfigUtils.inheritConfig(valueSelectorConfig, inheritedConfig.valueSelectorConfig);
    nearbySelectionConfig =
        ConfigUtils.inheritConfig(nearbySelectionConfig, inheritedConfig.nearbySelectionConfig);
    minimumSubListSize =
