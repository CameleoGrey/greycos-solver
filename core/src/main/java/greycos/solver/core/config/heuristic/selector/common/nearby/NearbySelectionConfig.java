package greycos.solver.core.config.heuristic.selector.common.nearby;
...
import greycos.solver.core.config.heuristic.selector.SelectorConfig;
...
public final class NearbySelectionConfig extends SelectorConfig<NearbySelectionConfig> {
  ...
  public void setOriginValueSelectorConfig(
      @Nullable ValueSelectorConfig originValueSelectorConfig) {
  ...
  public void setNearbySelectionDistributionType(
      @Nullable NearbySelectionDistributionType nearbySelectionDistributionType) {
  ...
  public void setBlockDistributionUniformDistributionProbability(
    ...
    this.blockDistributionUniformDistributionProbability =
        blockDistributionUniformDistributionProbability;
  }
  ...
  public void setParabolicDistributionSizeMaximum(
      @Nullable Integer parabolicDistributionSizeMaximum) {
  ...
  public @NonNull NearbySelectionConfig withOriginEntitySelectorConfig(
      @NonNull EntitySelectorConfig originEntitySelectorConfig) {
    this.setOriginEntitySelectorConfig(originEntitySelectorConfig);
    return this;
  }

  public @NonNull NearbySelectionConfig withOriginSubListSelectorConfig(
      @NonNull SubListSelectorConfig originSubListSelectorConfig) {
    this.setOriginSubListSelectorConfig(originSubListSelectorConfig);
    return this;
  }

  public @NonNull NearbySelectionConfig withOriginValueSelectorConfig(
      @NonNull ValueSelectorConfig originValueSelectorConfig) {
  ...
  public @NonNull NearbySelectionConfig withNearbySelectionDistributionType(
      @NonNull NearbySelectionDistributionType nearbySelectionDistributionType) {
    this.setNearbySelectionDistributionType(nearbySelectionDistributionType);
    return this;
  }

  public @NonNull NearbySelectionConfig withBlockDistributionSizeMinimum(
      @NonNull Integer blockDistributionSizeMinimum) {
    this.setBlockDistributionSizeMinimum(blockDistributionSizeMinimum);
    return this;
  }

  public @NonNull NearbySelectionConfig withBlockDistributionSizeMaximum(
      @NonNull Integer blockDistributionSizeMaximum) {
    this.setBlockDistributionSizeMaximum(blockDistributionSizeMaximum);
    return this;
  }

  public @NonNull NearbySelectionConfig withBlockDistributionSizeRatio(
      @NonNull Double blockDistributionSizeRatio) {
    this.setBlockDistributionSizeRatio(blockDistributionSizeRatio);
    return this;
  }

  public @NonNull NearbySelectionConfig withBlockDistributionUniformDistributionProbability(
      @NonNull Double blockDistributionUniformDistributionProbability) {
    this.setBlockDistributionUniformDistributionProbability(
        blockDistributionUniformDistributionProbability);
    return this;
  }

  public @NonNull NearbySelectionConfig withLinearDistributionSizeMaximum(
      @NonNull Integer linearDistributionSizeMaximum) {
    this.setLinearDistributionSizeMaximum(linearDistributionSizeMaximum);
    return this;
  }

  public @NonNull NearbySelectionConfig withParabolicDistributionSizeMaximum(
  ...
  public @NonNull NearbySelectionConfig withBetaDistributionAlpha(
      @NonNull Double betaDistributionAlpha) {
  ...
  public void validateNearby(
      @NonNull SelectionCacheType resolvedCacheType,
      @NonNull SelectionOrder resolvedSelectionOrder) {
    long originSelectorCount =
        Stream.of(
                originEntitySelectorConfig, originSubListSelectorConfig, originValueSelectorConfig)
      ...
      throw new IllegalArgumentException(
          ...
          """
              .formatted(
                  this,
                  originSubListSelectorConfig,
                  originSubListSelectorConfig.getMimicSelectorRef()));
    }
      ...
      throw new IllegalArgumentException(
          ...
          """
              .formatted(
                  this,
                  originValueSelectorConfig,
                  originValueSelectorConfig.getMimicSelectorRef()));
    }
  ...
  public @NonNull NearbySelectionConfig inherit(@NonNull NearbySelectionConfig inheritedConfig) {
    ...
    originSubListSelectorConfig =
        ConfigUtils.inheritConfig(
            originSubListSelectorConfig, inheritedConfig.getOriginSubListSelectorConfig());
    originValueSelectorConfig =
        ConfigUtils.inheritConfig(
    ...
    blockDistributionSizeMinimum =
        ConfigUtils.inheritOverwritableProperty(
            blockDistributionSizeMinimum, inheritedConfig.getBlockDistributionSizeMinimum());
    blockDistributionSizeMaximum =
        ConfigUtils.inheritOverwritableProperty(
            blockDistributionSizeMaximum, inheritedConfig.getBlockDistributionSizeMaximum());
    blockDistributionSizeRatio =
        ConfigUtils.inheritOverwritableProperty(
            blockDistributionSizeRatio, inheritedConfig.getBlockDistributionSizeRatio());
    blockDistributionUniformDistributionProbability =
        ConfigUtils.inheritOverwritableProperty(
            blockDistributionUniformDistributionProbability,
    ...
    linearDistributionSizeMaximum =
        ConfigUtils.inheritOverwritableProperty(
            linearDistributionSizeMaximum, inheritedConfig.getLinearDistributionSizeMaximum());
    parabolicDistributionSizeMaximum =
        ConfigUtils.inheritOverwritableProperty(
            parabolicDistributionSizeMaximum,
    ...
    betaDistributionAlpha =
        ConfigUtils.inheritOverwritableProperty(
            betaDistributionAlpha, inheritedConfig.getBetaDistributionAlpha());
    betaDistributionBeta =
        ConfigUtils.inheritOverwritableProperty(
