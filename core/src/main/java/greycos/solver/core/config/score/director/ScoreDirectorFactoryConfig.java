...
public final class ScoreDirectorFactoryConfig extends AbstractConfig<ScoreDirectorFactoryConfig> {
  ...
  public void setAssertionScoreDirectorFactory(
      @Nullable ScoreDirectorFactoryConfig assertionScoreDirectorFactory) {
  ...
  public @NonNull ScoreDirectorFactoryConfig withInitializingScoreTrend(
      @NonNull String initializingScoreTrend) {
    this.initializingScoreTrend = initializingScoreTrend;
    return this;
  }
  ...
  @Override
  public @NonNull ScoreDirectorFactoryConfig inherit(
