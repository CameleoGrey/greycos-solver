...
public class PillarSelectorConfig extends SelectorConfig<PillarSelectorConfig> {
  ...
  public @NonNull PillarSelectorConfig withEntitySelectorConfig(
      @NonNull EntitySelectorConfig entitySelectorConfig) {
    this.setEntitySelectorConfig(entitySelectorConfig);
    return this;
  }

  public @NonNull PillarSelectorConfig withMinimumSubPillarSize(
      @NonNull Integer minimumSubPillarSize) {
    this.setMinimumSubPillarSize(minimumSubPillarSize);
    return this;
  }

  public @NonNull PillarSelectorConfig withMaximumSubPillarSize(
      @NonNull Integer maximumSubPillarSize) {
  ...
  public @NonNull PillarSelectorConfig inherit(@NonNull PillarSelectorConfig inheritedConfig) {
    ...
    minimumSubPillarSize =
        ConfigUtils.inheritOverwritableProperty(
            minimumSubPillarSize, inheritedConfig.getMinimumSubPillarSize());
    maximumSubPillarSize =
        ConfigUtils.inheritOverwritableProperty(
            maximumSubPillarSize, inheritedConfig.getMaximumSubPillarSize());
    return this;
  }
