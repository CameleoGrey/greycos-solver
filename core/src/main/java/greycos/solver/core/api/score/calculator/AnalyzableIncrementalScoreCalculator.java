...
/**
 * Used for incremental Java {@link Score} calculation with support for {@link ScoreAnalysis}. Any
 * implementation is naturally stateful.
 *
...
public interface AnalyzableIncrementalScoreCalculator<Solution_, Score_ extends Score<Score_>>
  ...
  /**
   * Tells this implementation whether constraint matching should be enabled or not. Will be called
   * by the solver before the first call to {@link #resetWorkingSolution} and not again.
   *
