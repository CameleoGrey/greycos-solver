...
/**
 * As defined by {@link UniConstraintCollectorAccumulator}, only for {@link TriConstraintCollector}.
 */
@NullMarked
@FunctionalInterface
public interface TriConstraintCollectorAccumulator<ResultContainer_, A, B, C> {
  ...
  /**
   * As defined by {@link UniConstraintCollectorAccumulator#intoGroup(Object)}, only for {@link
