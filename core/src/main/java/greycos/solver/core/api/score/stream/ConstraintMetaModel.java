...
/**
 * Provides information about the known constraints. Works in combination with {@link
 * ConstraintProvider}.
 */
@NullMarked
public interface ConstraintMetaModel {
   ...
   */
  @Nullable Constraint getConstraint(ConstraintRef constraintRef);

  /**
   * Returns the constraint with the given id. Convenience shorthand for {@link
   * #getConstraint(ConstraintRef)}.
   *
   * @return null if such constraint does not exist
   */
