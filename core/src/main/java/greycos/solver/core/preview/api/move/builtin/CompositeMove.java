 ...
 *
 * <p>Warning: each of moves in the moveList must not rely on the effect of a previous move in the
 * moveList to create its undoMove correctly.
 *
...
public final class CompositeMove<Solution_> implements Move<Solution_> {
    ...
    return switch (moveList.size()) {
      case 0 ->
          throw new UnsupportedOperationException(
              "The %s cannot be built from an empty move list."
  ...
  public boolean equals(Object o) {
    return o instanceof CompositeMove<?> that && Objects.equals(moveList, that.moveList);
  }
