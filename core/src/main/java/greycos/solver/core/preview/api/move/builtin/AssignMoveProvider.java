 ...
 *
 * <p>For moving an already-assigned entity to a different non-null value, see {@link
 * ChangeMoveProvider}. For moving an already-assigned entity to null (unassigning), see {@code
 * UnassignMoveProvider}.
 *
 * <p>Requires that the variable {@link PlanningVariableMetaModel#allowsUnassigned() allows
 * unassigned}; otherwise the constructor throws {@link IllegalArgumentException}.
 */
@NullMarked
public final class AssignMoveProvider<Solution_, Entity_, Value_>
  ...
  public MoveStream<Solution_> build(MoveStreamFactory<Solution_> moveStreamFactory) {
    ...
    return moveStreamFactory
        ...
        .asMove(
            (view, entity, value) ->
                Moves.change(variableMetaModel, Objects.requireNonNull(entity), value));
  }
}
