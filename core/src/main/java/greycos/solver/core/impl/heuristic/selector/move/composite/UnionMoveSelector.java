...
public class UnionMoveSelector<Solution_> extends CompositeMoveSelector<Solution_> {
  ...
  public SelectionProbabilityWeightFactory<Solution_, MoveSelector<Solution_>>
      getSelectorProbabilityWeightFactory() {
  ...
  public boolean isNeverEnding() {
    if (randomSelection) {
      ...
      // The UnionMoveSelector is special: it can be randomSelection true and still neverEnding
      // false
      return false;
    } else {
  ...
  public long getSize() {
    ...
    for (MoveSelector<Solution_> moveSelector : childMoveSelectorList) {
      ...
      if (size > Long.MAX_VALUE - childSize) {
  ...
  private static <Solution_> Stream<Move<Solution_>> toStream(
