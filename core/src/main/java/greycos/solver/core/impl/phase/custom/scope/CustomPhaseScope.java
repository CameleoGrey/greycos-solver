package greycos.solver.core.impl.phase.custom.scope;
...
public final class CustomPhaseScope<Solution_> extends AbstractPhaseScope<Solution_> {
  ...
  public CustomPhaseScope(
      SolverScope<Solution_> solverScope, int phaseIndex, boolean phaseSendsBestSolutionEvents) {
