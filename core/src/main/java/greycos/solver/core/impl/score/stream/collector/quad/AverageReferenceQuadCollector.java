...
final class AverageReferenceQuadCollector<A, B, C, D, Mapped_, Average_>
    extends AbstractReferenceBasedQuadCollector<
        A, B, C, D, Mapped_, Average_, AbstractReferenceAverageSlot.State<Mapped_, Average_>> {
  private final Supplier<AbstractReferenceAverageSlot.State<Mapped_, Average_>> stateSupplier;

  AverageReferenceQuadCollector(
  ...
  @Override
  public @NonNull Function<AbstractReferenceAverageSlot.State<Mapped_, Average_>, Average_>
      finisher() {
  ...
  public boolean equals(Object object) {
    ...
    AverageReferenceQuadCollector<?, ?, ?, ?, ?, ?> that =
        (AverageReferenceQuadCollector<?, ?, ?, ?, ?, ?>) object;
