...
import static greycos.solver.core.impl.bavet.bi.Group0Mapping3CollectorBiNode.mergeCollectors;
import static greycos.solver.core.impl.bavet.bi.Group1Mapping0CollectorBiNode.createGroupKey;
...
public final class Group1Mapping3CollectorBiNode<
        OldA, OldB, A, B, C, D, ResultContainerB_, ResultContainerC_, ResultContainerD_>
    extends AbstractGroupBiNode<OldA, OldB, QuadTuple<A, B, C, D>, A, Object, Triple<B, C, D>> {

  private final int outputStoreSize;

  public Group1Mapping3CollectorBiNode(
    ...
    super(
        ...
        mergeCollectors(collectorB, collectorC, collectorD),
