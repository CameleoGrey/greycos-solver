...
import static greycos.solver.core.impl.score.stream.common.quad.InnerQuadConstraintStream.createDefaultJustificationMapping;
...
import greycos.solver.core.api.score.stream.quad.QuadConstraintBuilder;
...
import greycos.solver.core.impl.bavet.penta.joiner.PentaJoinerComber;
import greycos.solver.core.impl.bavet.quad.Group0Mapping1CollectorQuadNode;
import greycos.solver.core.impl.bavet.quad.Group0Mapping2CollectorQuadNode;
import greycos.solver.core.impl.bavet.quad.Group0Mapping3CollectorQuadNode;
import greycos.solver.core.impl.bavet.quad.Group0Mapping4CollectorQuadNode;
import greycos.solver.core.impl.bavet.quad.Group1Mapping0CollectorQuadNode;
import greycos.solver.core.impl.bavet.quad.Group1Mapping1CollectorQuadNode;
import greycos.solver.core.impl.bavet.quad.Group1Mapping2CollectorQuadNode;
import greycos.solver.core.impl.bavet.quad.Group1Mapping3CollectorQuadNode;
import greycos.solver.core.impl.bavet.quad.Group2Mapping0CollectorQuadNode;
import greycos.solver.core.impl.bavet.quad.Group2Mapping1CollectorQuadNode;
import greycos.solver.core.impl.bavet.quad.Group2Mapping2CollectorQuadNode;
import greycos.solver.core.impl.bavet.quad.Group3Mapping0CollectorQuadNode;
import greycos.solver.core.impl.bavet.quad.Group3Mapping1CollectorQuadNode;
import greycos.solver.core.impl.bavet.quad.Group4Mapping0CollectorQuadNode;
...
import greycos.solver.core.impl.score.stream.common.quad.InnerQuadConstraintStream;
import greycos.solver.core.impl.score.stream.common.quad.QuadConstraintBuilderImpl;
...
public abstract class BavetAbstractQuadConstraintStream<Solution_, A, B, C, D>
  ...
  protected BavetAbstractQuadConstraintStream(
  ...
  @Override
  public @NonNull BavetAbstractQuadConstraintStream<Solution_, A, B, C, D> filter(
      @NonNull QuadPredicate<A, B, C, D> predicate) {
  ...
  @SafeVarargs
  @Override
  public final <E> @NonNull QuadConstraintStream<A, B, C, D> ifExists(
      @NonNull UniConstraintStream<E> otherStream, PentaJoiner<A, B, C, D, E>... joiners) {
    return ifExistsOrNot(true, otherStream, joiners);
  }

  @SafeVarargs
  @Override
  public final @NonNull <E> QuadConstraintStream<A, B, C, D> ifNotExists(
      @NonNull UniConstraintStream<E> otherStream,
      @NonNull PentaJoiner<A, B, C, D, E> @NonNull ... joiners) {
    return ifExistsOrNot(false, otherStream, joiners);
  }

  private <E> QuadConstraintStream<A, B, C, D> ifExistsOrNot(
      boolean shouldExist,
      UniConstraintStream<E> otherStream,
  ...
  private <NewA> UniConstraintStream<NewA> buildUniGroupBy(
    ...
    var stream =
        shareAndAddChild(
            new BavetUniGroupQuadConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
  ...
  public @NonNull <ResultContainerA_, ResultA_, ResultContainerB_, ResultB_>
    ...
    GroupNodeConstructor<BiTuple<ResultA_, ResultB_>> nodeConstructor =
        GroupNodeConstructor.zeroKeysGroupBy(
            collectorA, collectorB, Group0Mapping2CollectorQuadNode::new);
  ...
  private <NewA, NewB> BiConstraintStream<NewA, NewB> buildBiGroupBy(
    ...
    var stream =
        shareAndAddChild(
            new BavetBiGroupQuadConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
  ...
  public @NonNull
    ...
    GroupNodeConstructor<TriTuple<ResultA_, ResultB_, ResultC_>> nodeConstructor =
        GroupNodeConstructor.zeroKeysGroupBy(
            collectorA, collectorB, collectorC, Group0Mapping3CollectorQuadNode::new);
  ...
  private <NewA, NewB, NewC> TriConstraintStream<NewA, NewB, NewC> buildTriGroupBy(
    ...
    var stream =
        shareAndAddChild(
            new BavetTriGroupQuadConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
  ...
  public @NonNull
    ...
    GroupNodeConstructor<QuadTuple<ResultA_, ResultB_, ResultC_, ResultD_>> nodeConstructor =
        GroupNodeConstructor.zeroKeysGroupBy(
            collectorA, collectorB, collectorC, collectorD, Group0Mapping4CollectorQuadNode::new);
  ...
  private <NewA, NewB, NewC, NewD> QuadConstraintStream<NewA, NewB, NewC, NewD> buildQuadGroupBy(
    ...
    var stream =
        shareAndAddChild(
            new BavetQuadGroupQuadConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
  ...
  public @NonNull <GroupKey_, ResultContainerB_, ResultB_, ResultContainerC_, ResultC_>
    ...
    GroupNodeConstructor<TriTuple<GroupKey_, ResultB_, ResultC_>> nodeConstructor =
        GroupNodeConstructor.oneKeyGroupBy(
            groupKeyMapping, collectorB, collectorC, Group1Mapping2CollectorQuadNode::new);
    return buildTriGroupBy(nodeConstructor);
  }
  ...
  public @NonNull <GroupKey_, ResultContainer_, Result_>
    ...
    GroupNodeConstructor<BiTuple<GroupKey_, Result_>> nodeConstructor =
        GroupNodeConstructor.oneKeyGroupBy(
            groupKeyMapping, collector, Group1Mapping1CollectorQuadNode::new);
    return buildBiGroupBy(nodeConstructor);
  }
  ...
  public @NonNull <GroupKeyA_, GroupKeyB_> BiConstraintStream<GroupKeyA_, GroupKeyB_> groupBy(
    ...
    GroupNodeConstructor<BiTuple<GroupKeyA_, GroupKeyB_>> nodeConstructor =
        GroupNodeConstructor.twoKeysGroupBy(
            groupKeyAMapping, groupKeyBMapping, Group2Mapping0CollectorQuadNode::new);
    return buildBiGroupBy(nodeConstructor);
  }
  ...
  public @NonNull <GroupKeyA_, GroupKeyB_, ResultContainer_, Result_>
    ...
    GroupNodeConstructor<TriTuple<GroupKeyA_, GroupKeyB_, Result_>> nodeConstructor =
        GroupNodeConstructor.twoKeysGroupBy(
            groupKeyAMapping, groupKeyBMapping, collector, Group2Mapping1CollectorQuadNode::new);
    return buildTriGroupBy(nodeConstructor);
  }
  ...
  @Override
  public @NonNull QuadConstraintStream<A, B, C, D> concat(
  ...
  public @NonNull QuadConstraintStream<A, B, C, D> concat(
    ...
    var concatStream =
        new BavetQuadConcatQuadConstraintStream<>(constraintFactory, leftBridge, rightBridge);
    return constraintFactory.share(
        concatStream,
        concatStream_ -> {
          // Connect the bridges upstream
  ...
  public @NonNull <ResultA_> UniConstraintStream<ResultA_> map(
    ...
    var stream =
        shareAndAddChild(new BavetUniMapQuadConstraintStream<>(constraintFactory, this, mapping));
    return constraintFactory.share(
        new BavetAftBridgeUniConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }
  ...
  public @NonNull <ResultA_, ResultB_> BiConstraintStream<ResultA_, ResultB_> map(
    ...
    var stream =
        shareAndAddChild(
            new BavetBiMapQuadConstraintStream<>(constraintFactory, this, mappingA, mappingB));
    return constraintFactory.share(
        new BavetAftBridgeBiConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }
  ...
  public @NonNull <ResultA_, ResultB_, ResultC_>
    ...
    var stream =
        shareAndAddChild(
            new BavetTriMapQuadConstraintStream<>(
  ...
  public @NonNull <ResultA_, ResultB_, ResultC_, ResultD_>
    ...
    var stream =
        shareAndAddChild(
            new BavetQuadMapQuadConstraintStream<>(
                constraintFactory, this, mappingA, mappingB, mappingC, mappingD));
    return constraintFactory.share(
        new BavetAftBridgeQuadConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }

  @Override
  public @NonNull <ResultD_> QuadConstraintStream<A, B, C, ResultD_> flattenLast(
      @NonNull Function<D, Iterable<ResultD_>> mapping) {
    var stream =
        shareAndAddChild(
            new BavetFlattenLastQuadConstraintStream<>(constraintFactory, this, mapping));
    return constraintFactory.share(
        new BavetAftBridgeQuadConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }
  ...
  private <Score_ extends Score<Score_>>
      QuadConstraintBuilderImpl<A, B, C, D, Score_> newTerminator(
