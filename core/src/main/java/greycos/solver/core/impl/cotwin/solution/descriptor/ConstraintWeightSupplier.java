...
public final class ConstraintWeightSupplier<Solution_, Score_ extends Score<Score_>> {
  ...
  public static <Solution_, Score_ extends Score<Score_>>
      ConstraintWeightSupplier<Solution_, Score_> create(
  ...
  private ConstraintWeightSupplier(
      SolutionDescriptor<Solution_> solutionDescriptor,
      MemberAccessor overridesAccessor,
      Class<? extends ConstraintWeightOverrides<Score_>> overridesClass) {
  ...
  /**
   * Has the option of failing fast in case of discrepancies between the constraints defined in
   * {@link ConstraintProvider} and the constraints defined in the configuration.
   *
   * @param workingSolution may be null, in which case the supplier will use the default constraint
   *     weights
   * @param userDefinedConstraints never null
   */
  public void validate(
      @Nullable Solution_ workingSolution, Set<ConstraintRef> userDefinedConstraints) {
    ...
    var excessiveConstraints =
        supportedConstraints.stream()
            .filter(constraintId -> !userDefinedConstraintIds.contains(constraintId))
      ...
      throw new IllegalStateException(
          ...
          """
              .formatted(
                  ...
                  userDefinedConstraintIds,
                  ConstraintProvider.class.getSimpleName()));
    }
    // Constraints are allowed to be missing; the default value provided by the ConstraintProvider
    // will be used.
  }
   ...
   * a value for unknown constraints, which is the case for {@link ConstraintWeightSupplier}.
   *
   ...
   */
  public @Nullable Score_ getConstraintWeight(
      ConstraintRef constraintRef, @Nullable Solution_ workingSolution) {
