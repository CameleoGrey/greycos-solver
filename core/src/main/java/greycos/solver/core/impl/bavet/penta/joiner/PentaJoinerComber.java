package greycos.solver.core.impl.bavet.penta.joiner;
...
public final class PentaJoinerComber<A, B, C, D, E> {
  ...
  public static <A, B, C, D, E> PentaJoinerComber<A, B, C, D, E> comb(
    ...
    for (int i = 0; i < joiners.length; i++) {
      ...
      if (joiner instanceof FilteringPentaJoiner) {
        ...
        throw new IllegalArgumentException(
            "The joiner class (" + joiner.getClass() + ") is not supported.");
      }
    }
  ...
  private static <A, B, C, D, E> PentaPredicate<A, B, C, D, E> mergeFiltering(
      List<PentaPredicate<A, B, C, D, E>> filteringList) {
  ...
  public PentaJoinerComber(
      DefaultPentaJoiner<A, B, C, D, E> mergedJoiner,
      PentaPredicate<A, B, C, D, E> mergedFiltering) {
