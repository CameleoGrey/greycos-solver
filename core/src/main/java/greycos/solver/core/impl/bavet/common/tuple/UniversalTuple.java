 ...
 * Accessed through interfaces (such as {@link UniTuple}) to hide getters/setters from higher
 * cardinalities.
 */
@NullMarked
final class UniversalTuple<A, B, C, D>
  ...
  private TupleState state =
      TupleState.DEAD; // It's the node's job to mark a new tuple as CREATING.
  ...
  public String toString() {
    return switch (cardinality) {
      ...
      default ->
          throw new IllegalStateException("Impossible cardinality: %d.".formatted(cardinality));
    };
  }
}
