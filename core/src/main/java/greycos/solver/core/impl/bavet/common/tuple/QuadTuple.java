...
public sealed interface QuadTuple<A, B, C, D> extends Tuple permits UniversalTuple {
  ...
  static <A, B, C, D> QuadTuple<A, B, C, D> of(
      @Nullable A a, @Nullable B b, @Nullable C c, int storeSize) {
  ...
  static <A, B, C, D> QuadTuple<A, B, C, D> of(
      @Nullable A a, @Nullable B b, @Nullable C c, @Nullable D d, int storeSize) {
