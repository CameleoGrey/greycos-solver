...
final class LoadBalanceBiCollector<A, B, Balanced_>
  ...
  @Override
  public @NonNull BiConstraintCollectorAccumulator<DefaultLoadBalance<Balanced_>, A, B>
      accumulator() {
    return Slot::new;
  }
  ...
  private final class Slot extends AbstractLoadBalanceSlot<Balanced_>
    ...
    public void add(A a, B b) {
      addMapped(
          balancedItemFunction.apply(a, b),
          loadFunction.applyAsLong(a, b),
