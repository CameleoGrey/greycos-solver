package greycos.solver.core.impl.neighborhood.stream.joiner;
...
/**
 * Combs an array of {@link BiNeighborhoodsJoiner} instances into a mergedJoiner and a
 * mergedFiltering.
 *
 * @param <A>
 * @param <B>
 */
@NullMarked
public record BiNeighborhoodsJoinerComber<Solution_, A, B>(
    DefaultBiNeighborhoodsJoiner<A, B> mergedJoiner,
    @Nullable BiNeighborhoodsPredicate<Solution_, A, B> mergedFiltering) {

  public static <Solution_, A, B> BiNeighborhoodsJoinerComber<Solution_, A, B> comb(
  ...
  private static <Solution_, A, B>
      @Nullable BiNeighborhoodsPredicate<Solution_, A, B> mergeFiltering(
          List<BiNeighborhoodsPredicate<Solution_, A, B>> filteringList) {
