...
public record ConsistencyTracker<Solution_>(
   ...
   *
   * <ul>
   *   <li>Do not have a {@link greycos.solver.core.api.cotwin.variable.ShadowVariablesInconsistent}
   *       member.
   *   <li>Have a {@link greycos.solver.core.api.cotwin.variable.ShadowVariablesInconsistent} member
   *       that is null.
   * </ul>
   *
   * If an entity has a {@link greycos.solver.core.api.cotwin.variable.ShadowVariablesInconsistent}
