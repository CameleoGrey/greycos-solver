...
final class ComposeFourQuadCollector<
        A,
        B,
        C,
        D,
  ...
  @Override
  public @NonNull
      Supplier<Quadruple<ResultHolder1_, ResultHolder2_, ResultHolder3_, ResultHolder4_>>
      supplier() {
    return () -> {
  ...
  @Override
  public @NonNull
      QuadConstraintCollectorAccumulator<
          Quadruple<ResultHolder1_, ResultHolder2_, ResultHolder3_, ResultHolder4_>, A, B, C, D>
      accumulator() {
  ...
  public @NonNull
    ...
    return resultHolder ->
        composeFunction.apply(
            firstFinisher.apply(resultHolder.a()),
  ...
  private final class ValueHandle implements QuadConstraintCollectorValueHandle<A, B, C, D> {
    ...
    private final QuadConstraintCollectorValueHandle<A, B, C, D> v4;
