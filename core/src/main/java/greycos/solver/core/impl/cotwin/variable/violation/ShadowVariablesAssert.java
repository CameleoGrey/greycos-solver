...
public final class ShadowVariablesAssert {
  ...
  private static final Comparator<ShadowVariableDescriptor<?>>
      SHADOW_VARIABLE_DESCRIPTOR_COMPARATOR =
          Comparator.<ShadowVariableDescriptor<?>>comparingInt(
   ...
   *
   * <p>This method should be called after a forceful update of all shadow variables.
   *
  ...
  private Map<ShadowVariableDescriptor<?>, List<String>> collectViolations() {
    var violationListMap =
        new TreeMap<ShadowVariableDescriptor<?>, List<String>>(
            SHADOW_VARIABLE_DESCRIPTOR_COMPARATOR);
