...
/**
 * Only selects values from the child value selector that are uninitialized. This used for {@link
 * QueuedValuePlacer}’s recording value selector during Construction Heuristic phase to prevent
 * reinitializing values.
 */
public final class UnassignedListValueSelector<Solution_>
    extends AbstractInverseEntityFilteringValueSelector<Solution_> {
