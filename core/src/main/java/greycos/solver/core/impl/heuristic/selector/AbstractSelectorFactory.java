...
public abstract class AbstractSelectorFactory<
        Solution_, SelectorConfig_ extends SelectorConfig<SelectorConfig_>>
    ...
    switch (resolvedSelectionOrder) {
      ...
      default:
        throw new IllegalStateException(
            "The resolvedSelectionOrder (%s) is not implemented."
