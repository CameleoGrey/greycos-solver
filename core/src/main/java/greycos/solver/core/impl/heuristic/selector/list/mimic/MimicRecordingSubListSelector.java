package greycos.solver.core.impl.heuristic.selector.list.mimic;
...
public class MimicRecordingSubListSelector<Solution_> extends AbstractSelector<Solution_>
  ...
  @Override
  public void addMimicReplayingSubListSelector(
  ...
  private class RecordingSubListIterator extends SelectionIterator<SubList> {
    ...
    public boolean hasNext() {
      ...
      for (MimicReplayingSubListSelector<Solution_> replayingValueSelector :
          replayingSubListSelectorList) {
  ...
  public boolean equals(Object other) {
    ...
    return Objects.equals(childSubListSelector, that.childSubListSelector)
        && Objects.equals(
            replayingSubListSelectorList.size(), that.replayingSubListSelectorList.size());
  }
