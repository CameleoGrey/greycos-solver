...
public record FieldHandle(Field field, MethodHandle getter, MethodHandle setter) {
  ...
  public static FieldHandle of(Field field) {
    try {
      ...
      throw new IllegalStateException(
          "The field (%s) cannot be accessed to create a planning clone.".formatted(field), e);
    }
  }
  ...
  public Object get(Object bean) {
    try { // Don't null-check the bean; if null, it fails anyway.
      ...
      throw new IllegalStateException(
          "Cannot get the field (%s) on bean of class (%s).".formatted(field.getName(), beanClass),
          e);
    }
  }
  ...
  public void set(Object bean, Object value) {
    try { // Don't null-check the bean; if null, it fails anyway.
      ...
      var beanClass = bean == null ? "null" : bean.getClass();
      throw new IllegalStateException(
          "Cannot set the field (%s) on bean of class (%s).".formatted(field.getName(), beanClass),
          e);
    }
  }
}
