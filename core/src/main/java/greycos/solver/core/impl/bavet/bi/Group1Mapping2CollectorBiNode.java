...
public final class Group1Mapping2CollectorBiNode<
        OldA, OldB, A, B, C, ResultContainerB_, ResultContainerC_>
    extends AbstractGroupBiNode<OldA, OldB, TriTuple<A, B, C>, A, Object, Pair<B, C>> {

  private final int outputStoreSize;

  public Group1Mapping2CollectorBiNode(
    ...
    super(
        ...
        Group0Mapping2CollectorBiNode.mergeCollectors(collectorB, collectorC),
