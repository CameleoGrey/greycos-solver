...
final class LoadBalanceTriCollector<A, B, C, Balanced_>
    implements TriConstraintCollector<
        A, B, C, DefaultLoadBalance<Balanced_>, LoadBalance<Balanced_>> {
  ...
  public LoadBalanceTriCollector(
  ...
  @Override
  public @NonNull TriConstraintCollectorAccumulator<DefaultLoadBalance<Balanced_>, A, B, C>
      accumulator() {
    return Slot::new;
  }
  ...
  private final class Slot extends AbstractLoadBalanceSlot<Balanced_>
    ...
    public void add(A a, B b, C c) {
      addMapped(
          balancedItemFunction.apply(a, b, c),
          loadFunction.applyAsLong(a, b, c),
