...
public final class DefaultPentaJoiner<A, B, C, D, E> extends AbstractJoiner<E>
  ...
  public static <A, B, C, D, E> DefaultPentaJoiner<A, B, C, D, E> merge(
      List<DefaultPentaJoiner<A, B, C, D, E>> joinerList) {
  ...
  @Override
  public @NonNull DefaultPentaJoiner<A, B, C, D, E> and(
      @NonNull PentaJoiner<A, B, C, D, E> otherJoiner) {
