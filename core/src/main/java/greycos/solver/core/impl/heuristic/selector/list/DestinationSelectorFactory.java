...
import static greycos.solver.core.config.heuristic.selector.entity.EntitySorterManner.NONE;
...
import greycos.solver.core.impl.heuristic.selector.common.nearby.NearbyDestinationSelector;
...
public final class DestinationSelectorFactory<Solution_>
  ...
  public static <Solution_> DestinationSelectorFactory<Solution_> create(
  ...
  public DestinationSelector<Solution_> buildDestinationSelector(
    ...
    var hasSortManner =
        configPolicy.getEntitySorterManner() != null
