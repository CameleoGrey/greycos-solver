...
import greycos.solver.core.impl.exhaustivesearch.ExhaustiveSearchPhase;
import greycos.solver.core.impl.heuristic.selector.move.generic.RuinRecreateConstructionHeuristicPhase;
import greycos.solver.core.impl.islandmodel.IslandModelPhase;
import greycos.solver.core.impl.localsearch.LocalSearchPhase;
import greycos.solver.core.impl.partitionedsearch.PartitionedSearchPhase;
