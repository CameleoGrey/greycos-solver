...
import static greycos.solver.core.impl.score.stream.common.tri.InnerTriConstraintStream.createDefaultJustificationMapping;
...
import greycos.solver.core.api.score.stream.tri.TriConstraintBuilder;
...
import greycos.solver.core.impl.bavet.quad.joiner.QuadJoinerComber;
import greycos.solver.core.impl.bavet.tri.Group0Mapping1CollectorTriNode;
import greycos.solver.core.impl.bavet.tri.Group0Mapping2CollectorTriNode;
import greycos.solver.core.impl.bavet.tri.Group0Mapping3CollectorTriNode;
import greycos.solver.core.impl.bavet.tri.Group0Mapping4CollectorTriNode;
import greycos.solver.core.impl.bavet.tri.Group1Mapping0CollectorTriNode;
import greycos.solver.core.impl.bavet.tri.Group1Mapping1CollectorTriNode;
import greycos.solver.core.impl.bavet.tri.Group1Mapping2CollectorTriNode;
import greycos.solver.core.impl.bavet.tri.Group1Mapping3CollectorTriNode;
import greycos.solver.core.impl.bavet.tri.Group2Mapping0CollectorTriNode;
import greycos.solver.core.impl.bavet.tri.Group2Mapping1CollectorTriNode;
import greycos.solver.core.impl.bavet.tri.Group2Mapping2CollectorTriNode;
import greycos.solver.core.impl.bavet.tri.Group3Mapping0CollectorTriNode;
import greycos.solver.core.impl.bavet.tri.Group3Mapping1CollectorTriNode;
import greycos.solver.core.impl.bavet.tri.Group4Mapping0CollectorTriNode;
...
import greycos.solver.core.impl.score.stream.bavet.quad.BavetJoinQuadConstraintStream;
import greycos.solver.core.impl.score.stream.bavet.quad.BavetTriConcatQuadConstraintStream;
...
import greycos.solver.core.impl.score.stream.common.tri.InnerTriConstraintStream;
import greycos.solver.core.impl.score.stream.common.tri.TriConstraintBuilderImpl;
...
public abstract class BavetAbstractTriConstraintStream<Solution_, A, B, C>
    extends BavetAbstractConstraintStream<Solution_> implements InnerTriConstraintStream<A, B, C> {

  protected BavetAbstractTriConstraintStream(
  ...
  @Override
  @SafeVarargs
  public final <D> @NonNull QuadConstraintStream<A, B, C, D> join(
      @NonNull UniConstraintStream<D> otherStream, QuadJoiner<A, B, C, D> @NonNull ... joiners) {
    ...
    var joinStream =
        new BavetJoinQuadConstraintStream<>(
            constraintFactory,
            leftBridge,
            rightBridge,
  ...
  @SafeVarargs
  @Override
  public final @NonNull <D> TriConstraintStream<A, B, C> ifExists(
  ...
  @SafeVarargs
  @Override
  public final @NonNull <D> TriConstraintStream<A, B, C> ifNotExists(
      @NonNull UniConstraintStream<D> otherStream,
      @NonNull QuadJoiner<A, B, C, D> @NonNull ... joiners) {
    return ifExistsOrNot(false, otherStream, joiners);
  }

  private <D> TriConstraintStream<A, B, C> ifExistsOrNot(
      boolean shouldExist, UniConstraintStream<D> otherStream, QuadJoiner<A, B, C, D>[] joiners) {
    var other = (BavetAbstractUniConstraintStream<Solution_, D>) otherStream;
    var joinerComber = QuadJoinerComber.comb(joiners);
    var parentBridgeD =
        other.shareAndAddChild(new BavetForeBridgeUniConstraintStream<>(constraintFactory, other));
    return constraintFactory.share(
        new BavetIfExistsTriConstraintStream<>(
            constraintFactory,
            this,
            parentBridgeD,
            shouldExist,
  ...
  private <NewA> UniConstraintStream<NewA> buildUniGroupBy(
    ...
    var stream =
        shareAndAddChild(
            new BavetUniGroupTriConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
  ...
  private <NewA, NewB> BiConstraintStream<NewA, NewB> buildBiGroupBy(
    ...
    var stream =
        shareAndAddChild(
            new BavetBiGroupTriConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
  ...
  private <NewA, NewB, NewC> TriConstraintStream<NewA, NewB, NewC> buildTriGroupBy(
    ...
    var stream =
        shareAndAddChild(
            new BavetTriGroupTriConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
  ...
  public @NonNull
    ...
    GroupNodeConstructor<QuadTuple<ResultA_, ResultB_, ResultC_, ResultD_>> nodeConstructor =
        zeroKeysGroupBy(
            collectorA, collectorB, collectorC, collectorD, Group0Mapping4CollectorTriNode::new);
  ...
  private <NewA, NewB, NewC, NewD> QuadConstraintStream<NewA, NewB, NewC, NewD> buildQuadGroupBy(
    ...
    var stream =
        shareAndAddChild(
            new BavetQuadGroupTriConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
  ...
  public @NonNull
    ...
    GroupNodeConstructor<QuadTuple<GroupKey_, ResultB_, ResultC_, ResultD_>> nodeConstructor =
        oneKeyGroupBy(
            ...
            collectorC,
            collectorD,
            Group1Mapping3CollectorTriNode::new);
    return buildQuadGroupBy(nodeConstructor);
  }

  @Override
  public @NonNull <GroupKey_, ResultContainer_, Result_>
  ...
  public @NonNull <GroupKeyA_, GroupKeyB_, ResultContainer_, Result_>
    ...
    GroupNodeConstructor<TriTuple<GroupKeyA_, GroupKeyB_, Result_>> nodeConstructor =
        twoKeysGroupBy(
            groupKeyAMapping, groupKeyBMapping, collector, Group2Mapping1CollectorTriNode::new);
    return buildTriGroupBy(nodeConstructor);
  }
  ...
  public @NonNull <GroupKeyA_, GroupKeyB_, ResultContainerC_, ResultC_, ResultContainerD_, ResultD_>
    ...
    GroupNodeConstructor<QuadTuple<GroupKeyA_, GroupKeyB_, ResultC_, ResultD_>> nodeConstructor =
        twoKeysGroupBy(
            ...
            collectorC,
            collectorD,
            Group2Mapping2CollectorTriNode::new);
    return buildQuadGroupBy(nodeConstructor);
  }
  ...
  public @NonNull <GroupKeyA_, GroupKeyB_, GroupKeyC_>
    ...
    GroupNodeConstructor<TriTuple<GroupKeyA_, GroupKeyB_, GroupKeyC_>> nodeConstructor =
        threeKeysGroupBy(
            ...
            groupKeyBMapping,
            groupKeyCMapping,
            Group3Mapping0CollectorTriNode::new);
    return buildTriGroupBy(nodeConstructor);
  }
  ...
  @Override
  public @NonNull TriConstraintStream<A, B, C> concat(
  ...
  @Override
  public @NonNull TriConstraintStream<A, B, C> concat(
      @NonNull BiConstraintStream<A, B> otherStream, @NonNull BiFunction<A, B, C> paddingFunction) {
  ...
  public @NonNull TriConstraintStream<A, B, C> concat(
    ...
    var concatStream =
        new BavetTriConcatTriConstraintStream<>(constraintFactory, leftBridge, rightBridge);
    return constraintFactory.share(
        concatStream,
        concatStream_ -> {
          // Connect the bridges upstream
  ...
  @Override
  public @NonNull <D> QuadConstraintStream<A, B, C, D> concat(
    ...
    var concatStream =
        new BavetTriConcatQuadConstraintStream<>(
            constraintFactory, leftBridge, rightBridge, paddingFunction);
    return constraintFactory.share(
        concatStream,
        concatStream_ -> {
  ...
  public @NonNull <ResultA_> UniConstraintStream<ResultA_> map(
    ...
    var stream =
        shareAndAddChild(new BavetUniMapTriConstraintStream<>(constraintFactory, this, mapping));
    return constraintFactory.share(
        new BavetAftBridgeUniConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }
  ...
  public @NonNull <ResultA_, ResultB_> BiConstraintStream<ResultA_, ResultB_> map(
    ...
    var stream =
        shareAndAddChild(
            new BavetBiMapTriConstraintStream<>(constraintFactory, this, mappingA, mappingB));
    return constraintFactory.share(
        new BavetAftBridgeBiConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }
  ...
  public @NonNull <ResultA_, ResultB_, ResultC_>
    ...
    var stream =
        shareAndAddChild(
            new BavetTriMapTriConstraintStream<>(
                constraintFactory, this, mappingA, mappingB, mappingC));
    return constraintFactory.share(
        new BavetAftBridgeTriConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }
  ...
  public <ResultA_, ResultB_, ResultC_, ResultD_>
    ...
    var stream =
        shareAndAddChild(
            new BavetQuadMapTriConstraintStream<>(
  ...
  public @NonNull <ResultC_> TriConstraintStream<A, B, ResultC_> flattenLast(
    ...
    var stream =
        shareAndAddChild(
            new BavetFlattenLastTriConstraintStream<>(constraintFactory, this, mapping));
    return constraintFactory.share(
        new BavetAftBridgeTriConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }
  ...
  @Override
  public @NonNull <ResultD_> QuadConstraintStream<A, B, C, ResultD_> expand(
