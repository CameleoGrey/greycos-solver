...
final class ToMultiMapUniCollector<
        A, Key_, Value_, Set_ extends Set<Value_>, Result_ extends Map<Key_, Set_>>
    extends AbstractReferenceBasedUniCollector<
        A, Key_, Result_, AbstractToMapSlot.State<Key_, Value_, Set_, Result_>> {
