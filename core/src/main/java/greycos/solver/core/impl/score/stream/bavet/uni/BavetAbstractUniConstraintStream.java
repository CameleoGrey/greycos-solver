...
import static greycos.solver.core.impl.bavet.common.GroupNodeConstructor.fourKeysGroupBy;
import static greycos.solver.core.impl.bavet.common.GroupNodeConstructor.oneKeyGroupBy;
import static greycos.solver.core.impl.bavet.common.GroupNodeConstructor.threeKeysGroupBy;
import static greycos.solver.core.impl.bavet.common.GroupNodeConstructor.twoKeysGroupBy;
import static greycos.solver.core.impl.bavet.common.GroupNodeConstructor.zeroKeysGroupBy;
import static greycos.solver.core.impl.score.stream.common.uni.InnerUniConstraintStream.createDefaultJustificationMapping;
...
import greycos.solver.core.impl.bavet.bi.joiner.BiJoinerComber;
...
import greycos.solver.core.impl.bavet.uni.Group0Mapping1CollectorUniNode;
import greycos.solver.core.impl.bavet.uni.Group0Mapping2CollectorUniNode;
import greycos.solver.core.impl.bavet.uni.Group0Mapping3CollectorUniNode;
import greycos.solver.core.impl.bavet.uni.Group0Mapping4CollectorUniNode;
import greycos.solver.core.impl.bavet.uni.Group1Mapping0CollectorUniNode;
import greycos.solver.core.impl.bavet.uni.Group1Mapping1CollectorUniNode;
import greycos.solver.core.impl.bavet.uni.Group1Mapping2CollectorUniNode;
import greycos.solver.core.impl.bavet.uni.Group1Mapping3CollectorUniNode;
import greycos.solver.core.impl.bavet.uni.Group2Mapping0CollectorUniNode;
import greycos.solver.core.impl.bavet.uni.Group2Mapping1CollectorUniNode;
import greycos.solver.core.impl.bavet.uni.Group2Mapping2CollectorUniNode;
import greycos.solver.core.impl.bavet.uni.Group3Mapping0CollectorUniNode;
import greycos.solver.core.impl.bavet.uni.Group3Mapping1CollectorUniNode;
import greycos.solver.core.impl.bavet.uni.Group4Mapping0CollectorUniNode;
import greycos.solver.core.impl.score.stream.bavet.BavetConstraintFactory;
import greycos.solver.core.impl.score.stream.bavet.bi.BavetAbstractBiConstraintStream;
import greycos.solver.core.impl.score.stream.bavet.bi.BavetJoinBiConstraintStream;
import greycos.solver.core.impl.score.stream.bavet.bi.BavetUniConcatBiConstraintStream;
import greycos.solver.core.impl.score.stream.bavet.common.BavetScoringConstraintStream;
...
import greycos.solver.core.impl.score.stream.bavet.common.bridge.BavetForeBridgeBiConstraintStream;
import greycos.solver.core.impl.score.stream.bavet.common.bridge.BavetForeBridgeQuadConstraintStream;
import greycos.solver.core.impl.score.stream.bavet.common.bridge.BavetForeBridgeTriConstraintStream;
...
import greycos.solver.core.impl.score.stream.bavet.quad.BavetUniConcatQuadConstraintStream;
import greycos.solver.core.impl.score.stream.bavet.tri.BavetAbstractTriConstraintStream;
import greycos.solver.core.impl.score.stream.bavet.tri.BavetUniConcatTriConstraintStream;
...
import greycos.solver.core.impl.score.stream.common.uni.InnerUniConstraintStream;
import greycos.solver.core.impl.score.stream.common.uni.UniConstraintBuilderImpl;
...
public abstract class BavetAbstractUniConstraintStream<Solution_, A>
    extends BavetAbstractConstraintStream<Solution_> implements InnerUniConstraintStream<A> {

  protected BavetAbstractUniConstraintStream(
  ...
  @Override
  @SafeVarargs
  public final @NonNull <B> BiConstraintStream<A, B> join(
  ...
  @Override
  public final <B> BiConstraintStream<A, B> join(
      UniConstraintStream<B> otherStream, BiJoinerComber<A, B> joinerComber) {
    ...
    var joinStream =
        new BavetJoinBiConstraintStream<>(
            constraintFactory,
            leftBridge,
            rightBridge,
            joinerComber.getMergedJoiner(),
            joinerComber.getMergedFiltering());
  ...
  @SafeVarargs
  @Override
  public final @NonNull <B> UniConstraintStream<A> ifExists(
      @NonNull UniConstraintStream<B> otherStream, @NonNull BiJoiner<A, B>... joiners) {
  ...
  @SafeVarargs
  @Override
  public final @NonNull <B> UniConstraintStream<A> ifNotExists(
      @NonNull UniConstraintStream<B> otherStream, @NonNull BiJoiner<A, B>... joiners) {
    return ifExistsOrNot(false, otherStream, joiners);
  }

  private <B> UniConstraintStream<A> ifExistsOrNot(
      boolean shouldExist, UniConstraintStream<B> otherStream, BiJoiner<A, B>[] joiners) {
    var other = (BavetAbstractUniConstraintStream<Solution_, B>) otherStream;
    var joinerComber = BiJoinerComber.comb(joiners);
    var parentBridgeB =
        other.shareAndAddChild(new BavetForeBridgeUniConstraintStream<>(constraintFactory, other));
    return constraintFactory.share(
        new BavetIfExistsUniConstraintStream<>(
            constraintFactory,
            this,
            parentBridgeB,
            shouldExist,
  ...
  private <NewA> UniConstraintStream<NewA> buildUniGroupBy(
      GroupNodeConstructor<UniTuple<NewA>> nodeConstructor) {
    var stream =
        shareAndAddChild(
            new BavetUniGroupUniConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
        new BavetAftBridgeUniConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }

  @Override
  public @NonNull <ResultContainerA_, ResultA_, ResultContainerB_, ResultB_>
  ...
  private <NewA, NewB> BiConstraintStream<NewA, NewB> buildBiGroupBy(
      GroupNodeConstructor<BiTuple<NewA, NewB>> nodeConstructor) {
    var stream =
        shareAndAddChild(
            new BavetBiGroupUniConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
        new BavetAftBridgeBiConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }
  ...
  private <NewA, NewB, NewC> TriConstraintStream<NewA, NewB, NewC> buildTriGroupBy(
      GroupNodeConstructor<TriTuple<NewA, NewB, NewC>> nodeConstructor) {
    var stream =
        shareAndAddChild(
            new BavetTriGroupUniConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
        new BavetAftBridgeTriConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }
  ...
  public @NonNull
    ...
    GroupNodeConstructor<QuadTuple<ResultA_, ResultB_, ResultC_, ResultD_>> nodeConstructor =
        zeroKeysGroupBy(
            collectorA, collectorB, collectorC, collectorD, Group0Mapping4CollectorUniNode::new);
    return buildQuadGroupBy(nodeConstructor);
  }

  private <NewA, NewB, NewC, NewD> QuadConstraintStream<NewA, NewB, NewC, NewD> buildQuadGroupBy(
      GroupNodeConstructor<QuadTuple<NewA, NewB, NewC, NewD>> nodeConstructor) {
    var stream =
        shareAndAddChild(
            new BavetQuadGroupUniConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
        new BavetAftBridgeQuadConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }

  @Override
  public @NonNull <GroupKey_> UniConstraintStream<GroupKey_> groupBy(
  ...
  public @NonNull
    ...
    GroupNodeConstructor<QuadTuple<GroupKey_, ResultB_, ResultC_, ResultD_>> nodeConstructor =
        oneKeyGroupBy(
            ...
            collectorC,
            collectorD,
            Group1Mapping3CollectorUniNode::new);
    return buildQuadGroupBy(nodeConstructor);
  }

  @Override
  public <GroupKey_, ResultContainer_, Result_>
      @NonNull BiConstraintStream<GroupKey_, Result_> groupBy(
          @NonNull Function<A, GroupKey_> groupKeyMapping,
          @NonNull UniConstraintCollector<A, ResultContainer_, Result_> collector) {
  ...
  @Override
  public @NonNull <GroupKeyA_, GroupKeyB_, ResultContainer_, Result_>
    ...
    GroupNodeConstructor<TriTuple<GroupKeyA_, GroupKeyB_, Result_>> nodeConstructor =
        twoKeysGroupBy(
            groupKeyAMapping, groupKeyBMapping, collector, Group2Mapping1CollectorUniNode::new);
    return buildTriGroupBy(nodeConstructor);
  }
  ...
  public @NonNull <GroupKeyA_, GroupKeyB_, ResultContainerC_, ResultC_, ResultContainerD_, ResultD_>
    ...
    GroupNodeConstructor<QuadTuple<GroupKeyA_, GroupKeyB_, ResultC_, ResultD_>> nodeConstructor =
        twoKeysGroupBy(
            ...
            collectorC,
            collectorD,
            Group2Mapping2CollectorUniNode::new);
    return buildQuadGroupBy(nodeConstructor);
  }

  @Override
  public @NonNull <GroupKeyA_, GroupKeyB_, GroupKeyC_>
    ...
    GroupNodeConstructor<TriTuple<GroupKeyA_, GroupKeyB_, GroupKeyC_>> nodeConstructor =
        threeKeysGroupBy(
            ...
            groupKeyBMapping,
            groupKeyCMapping,
            Group3Mapping0CollectorUniNode::new);
    return buildTriGroupBy(nodeConstructor);
  }
  ...
  public @NonNull <GroupKeyA_, GroupKeyB_, GroupKeyC_, ResultContainerD_, ResultD_>
    ...
    GroupNodeConstructor<QuadTuple<GroupKeyA_, GroupKeyB_, GroupKeyC_, ResultD_>> nodeConstructor =
        threeKeysGroupBy(
            ...
            groupKeyCMapping,
            collectorD,
            Group3Mapping1CollectorUniNode::new);
    return buildQuadGroupBy(nodeConstructor);
  }
  ...
  public @NonNull <GroupKeyA_, GroupKeyB_, GroupKeyC_, GroupKeyD_>
    ...
    GroupNodeConstructor<QuadTuple<GroupKeyA_, GroupKeyB_, GroupKeyC_, GroupKeyD_>>
        nodeConstructor =
            fourKeysGroupBy(
                groupKeyAMapping,
                groupKeyBMapping,
  ...
  public @NonNull UniConstraintStream<A> concat(@NonNull UniConstraintStream<A> otherStream) {
    ...
    var rightBridge = new BavetForeBridgeUniConstraintStream<>(constraintFactory, other);
    var concatStream =
        new BavetUniConcatUniConstraintStream<>(constraintFactory, leftBridge, rightBridge);
    return constraintFactory.share(
        concatStream,
        concatStream_ -> {
  ...
  @Override
  public @NonNull <B> BiConstraintStream<A, B> concat(
      @NonNull BiConstraintStream<A, B> otherStream, @NonNull Function<A, B> paddingFunction) {
    ...
    var concatStream =
        new BavetUniConcatBiConstraintStream<>(
            constraintFactory, leftBridge, rightBridge, paddingFunction);
    return constraintFactory.share(
        concatStream,
        concatStream_ -> {
          // Connect the bridges upstream
  ...
  @Override
  public @NonNull <B, C> TriConstraintStream<A, B, C> concat(
    ...
    var concatStream =
        new BavetUniConcatTriConstraintStream<>(
            constraintFactory, leftBridge, rightBridge, paddingFunctionB, paddingFunctionC);
    return constraintFactory.share(
        concatStream,
        concatStream_ -> {
          // Connect the bridges upstream
  ...
  @Override
  public @NonNull <B, C, D> QuadConstraintStream<A, B, C, D> concat(
    ...
    var concatStream =
        new BavetUniConcatQuadConstraintStream<>(
            constraintFactory,
            leftBridge,
            rightBridge,
            paddingFunctionB,
  ...
  @Override
  public @NonNull <ResultA_> UniConstraintStream<ResultA_> map(
      @NonNull Function<A, ResultA_> mapping) {
    var stream =
        shareAndAddChild(new BavetUniMapUniConstraintStream<>(constraintFactory, this, mapping));
    return constraintFactory.share(
        new BavetAftBridgeUniConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }
  ...
  public @NonNull <ResultA_, ResultB_> BiConstraintStream<ResultA_, ResultB_> map(
    ...
    var stream =
        shareAndAddChild(
            new BavetBiMapUniConstraintStream<>(
                constraintFactory, this, mappingA, mappingB, false));
    return constraintFactory.share(
        new BavetAftBridgeBiConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }

  @Override
  public @NonNull <ResultA_, ResultB_, ResultC_>
      TriConstraintStream<ResultA_, ResultB_, ResultC_> map(
          @NonNull Function<A, ResultA_> mappingA,
          @NonNull Function<A, ResultB_> mappingB,
          @NonNull Function<A, ResultC_> mappingC) {
    var stream =
        shareAndAddChild(
            new BavetTriMapUniConstraintStream<>(
                constraintFactory, this, mappingA, mappingB, mappingC, false));
    return constraintFactory.share(
        new BavetAftBridgeTriConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }

  @Override
  public @NonNull <ResultA_, ResultB_, ResultC_, ResultD_>
      QuadConstraintStream<ResultA_, ResultB_, ResultC_, ResultD_> map(
          @NonNull Function<A, ResultA_> mappingA,
          @NonNull Function<A, ResultB_> mappingB,
          @NonNull Function<A, ResultC_> mappingC,
    ...
    var stream =
        shareAndAddChild(
            new BavetQuadMapUniConstraintStream<>(
                constraintFactory, this, mappingA, mappingB, mappingC, mappingD, false));
    return constraintFactory.share(
        new BavetAftBridgeQuadConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }

  @Override
  public @NonNull <ResultA_> BiConstraintStream<A, ResultA_> flatten(
      @NonNull Function<A, Iterable<ResultA_>> mapping) {
    var stream =
        shareAndAddChild(new BavetFlattenUniConstraintStream<>(constraintFactory, this, mapping));
    return constraintFactory.share(
        new BavetAftBridgeBiConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }

  @Override
  public @NonNull <ResultA_> UniConstraintStream<ResultA_> flattenLast(
      @NonNull Function<A, Iterable<ResultA_>> mapping) {
    var stream =
        shareAndAddChild(
            new BavetFlattenLastUniConstraintStream<>(constraintFactory, this, mapping));
    return constraintFactory.share(
        new BavetAftBridgeUniConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }
  ...
  @Override
  public <ResultB_> @NonNull BiConstraintStream<A, ResultB_> expand(
      @NonNull Function<A, ResultB_> mapping) {
    var stream =
        shareAndAddChild(
            new BavetBiMapUniConstraintStream<>(
                constraintFactory, this, ConstantLambdaUtils.identity(), mapping, true));
    return constraintFactory.share(
        new BavetAftBridgeBiConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }
  ...
  public @NonNull <ResultB_, ResultC_> TriConstraintStream<A, ResultB_, ResultC_> expand(
    ...
    var stream =
        shareAndAddChild(
            new BavetTriMapUniConstraintStream<>(
                constraintFactory, this, ConstantLambdaUtils.identity(), mappingB, mappingC, true));
    return constraintFactory.share(
        new BavetAftBridgeTriConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }

  @Override
  public @NonNull <ResultB_, ResultC_, ResultD_>
      QuadConstraintStream<A, ResultB_, ResultC_, ResultD_> expand(
          @NonNull Function<A, ResultB_> mappingB,
          @NonNull Function<A, ResultC_> mappingC,
          @NonNull Function<A, ResultD_> mappingD) {
    var stream =
