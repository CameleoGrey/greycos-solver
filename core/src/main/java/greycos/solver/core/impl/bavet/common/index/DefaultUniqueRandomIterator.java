...
/**
 * Wraps a {@link RetiringRandomIterator} and calls {@link RetiringRandomIterator#retire()} right
 * after every {@link RetiringRandomIterator#next()}, so that the client of this iterator does not
 * need to call {@code retire()} itself to get unique elements.
 *
 * @param <T>
 */
@NullMarked
