package greycos.solver.core.impl.solver.exception;

import greycos.solver.core.config.solver.EnvironmentMode;

/**
 * An exception that is thrown in {@link EnvironmentMode#TRACKED_FULL_ASSERT} when undo score
 * corruption is detected. It contains the working solution before the move, after the move, and
 * after the undo move, as well as the move that caused the corruption. You can catch this exception
 * to create a reproducer of the corruption. The API for this exception is currently unstable.
 */
public final class UndoScoreCorruptionException extends ScoreCorruptionException {
  ...
  public UndoScoreCorruptionException(
      String message,
      Object beforeMoveSolution,
      Object afterMoveSolution,
   ...
   *
   * @return the state of the working solution after a move was executed, but prior to the undo
   *     move.
   */
  @SuppressWarnings("unchecked")
