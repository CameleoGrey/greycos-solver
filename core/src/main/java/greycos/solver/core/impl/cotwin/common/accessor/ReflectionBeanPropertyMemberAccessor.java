...
public final class ReflectionBeanPropertyMemberAccessor extends AbstractMemberAccessor {
  ...
  public ReflectionBeanPropertyMemberAccessor(
      Method getterMethod, AnnotatedElement annotatedElement, boolean getterOnly) {
    ...
    try {
      ...
      throw new IllegalStateException(
          """
                    ...
                    %s"""
              .formatted(getterMethod, MemberAccessorFactory.CLASSLOADER_NUDGE_MESSAGE),
          e);
    }
      ...
      try {
        ...
        throw new IllegalStateException(
            """
                        Impossible state: method (%s) not accessible.
                        %s"""
                .formatted(setterMethod, MemberAccessorFactory.CLASSLOADER_NUDGE_MESSAGE),
            e);
      }
    }
  }
  ...
  public Object executeGetter(Object bean) {
    if (bean == null) {
      throw new IllegalArgumentException(
          "Requested property (%s) getterMethod (%s) on a null bean."
    ...
    try {
      ...
      throw new IllegalStateException(
          "The property (%s) getterMethod (%s) on bean of class (%s) throws an exception."
              .formatted(propertyName, getterMethod, bean.getClass()),
          e);
    }
  }
  ...
  public void executeSetter(Object bean, Object value) {
    if (bean == null) {
      throw new IllegalArgumentException(
          "Requested property (%s) setterMethod (%s) on a null bean."
    ...
    try {
      ...
      throw new IllegalStateException(
          "The property (%s) setterMethod (%s) on bean of class (%s) throws an exception."
              .formatted(propertyName, setterMethod, bean.getClass()),
          e);
    }
  }
