...
public sealed interface VariableReferenceGraph
   ...
   *
   * <p>Called after all {@link greycos.solver.core.impl.cotwin.variable.VariableListener} are
   * triggered. Declarative {@link greycos.solver.core.api.cotwin.variable.ShadowVariable} are
