...
public sealed interface VariableReferenceGraph
  ...
  /**
   * Update all declarative {@link greycos.solver.core.api.cotwin.variable.ShadowVariable} that has
   * a source that was changed in either {@link #beforeVariableChanged(VariableMetaModel, Object)}
   * or {@link #afterVariableChanged(VariableMetaModel, Object)}.
   *
  ...
  /**
   * Called before the planning list variable corresponding to the {@link VariableMetaModel} on the
   * given entity changes. Removes the edges of declarative shadow variables sourced from the
   * elements in the changed range, since those elements may be moved elsewhere.
   *
  ...
  /**
   * Called after the planning list variable corresponding to the {@link VariableMetaModel} on the
   * given entity changes. Adds the edges of declarative shadow variables sourced from the elements
