...
import ai.greycos.solver.core.impl.score.stream.collector.AbstractLongAverageSlot;

import org.jspecify.annotations.NonNull;

final class AverageBiCollector<A, B>
    extends AbstractPrimitiveBasedBiCollector<A, B, Double, AbstractLongAverageSlot.State> {
  ...
  protected BiConstraintCollectorValueHandle<A, B> newAccumulatedValue(
      AbstractLongAverageSlot.State state) {
