...
public class PillarSwapMove<Solution_> extends AbstractMove<Solution_> {
  ...
  public PillarSwapMove<Solution_> rebase(ScoreDirector<Solution_> destinationScoreDirector) {
    return new PillarSwapMove<>(
        variableDescriptorList,
        rebaseList(leftPillar, destinationScoreDirector),
        rebaseList(rightPillar, destinationScoreDirector));
  }
  ...
  public String getSimpleMoveTypeDescription() {
    ...
    for (GenuineVariableDescriptor<Solution_> variableDescriptor : variableDescriptorList) {
      moveTypeDescription
          .append(delimiter)
          .append(variableDescriptor.getSimpleEntityAndVariableName());
      delimiter = ", ";
    }
