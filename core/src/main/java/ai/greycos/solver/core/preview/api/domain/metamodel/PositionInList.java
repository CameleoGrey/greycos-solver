...
/**
 * Uniquely identifies the position of a value in a list variable. Instances can be created by
 * {@link ElementPosition#of(Object, int)}.
 *
 * <p>Within that one list, the index is unique for each value and therefore the instances are
 * comparable. Comparing them between different lists has no meaning.
 *
