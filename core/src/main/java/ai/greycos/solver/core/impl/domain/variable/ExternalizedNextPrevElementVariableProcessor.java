...
final class ExternalizedNextPrevElementVariableProcessor<Solution_> {
  ...
  public static <Solution_> ExternalizedNextPrevElementVariableProcessor<Solution_> ofPrevious(
  ...
  public static <Solution_> ExternalizedNextPrevElementVariableProcessor<Solution_> ofNext(
  ...
  private ExternalizedNextPrevElementVariableProcessor(
      ShadowVariableDescriptor<Solution_> shadowVariableDescriptor, int modifier) {
  ...
  private void setValue(
      InnerScoreDirector<Solution_, ?> scoreDirector, Object element, Object value) {
