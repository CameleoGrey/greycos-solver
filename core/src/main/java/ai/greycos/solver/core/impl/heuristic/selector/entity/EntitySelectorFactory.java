package ai.greycos.solver.core.impl.heuristic.selector.entity;
...
import ai.greycos.solver.core.impl.heuristic.selector.entity.decorator.SelectedCountLimitEntitySelector;
...
import ai.greycos.solver.core.impl.heuristic.selector.entity.mimic.MimicRecordingEntitySelector;
...
import ai.greycos.solver.core.impl.heuristic.selector.entity.nearby.NearValueNearbyEntitySelector;
...
public class EntitySelectorFactory<Solution_>
  ...
  public EntitySelector<Solution_> buildEntitySelector(
      HeuristicConfigPolicy<Solution_> configPolicy,
   ...
   * @param valueRangeRecorderId the recorder id to be used to create a replaying selector when
   *     enabling entity value range
   * @return never null
   */
  public EntitySelector<Solution_> buildEntitySelector(
      HeuristicConfigPolicy<Solution_> configPolicy,
    ...
    // baseEntitySelector and lower should be SelectionOrder.ORIGINAL if they are going to get
    // cached completely
    var baseRandomSelection =
    ...
    entitySelector =
        applyProbability(resolvedCacheType, resolvedSelectionOrder, entitySelector, instanceCache);
  ...
  protected EntitySelector<Solution_> buildMimicReplaying(
      HeuristicConfigPolicy<Solution_> configPolicy) {
    final var anyConfigurationParameterDefined =
        Stream.of(
                config.getId(),
                ...
                determineComparatorClass(config),
                determineComparatorFactoryClass(config),
  ...
  private MimicReplayingEntitySelector<Solution_> buildMimicReplaying(
      HeuristicConfigPolicy<Solution_> configPolicy, String id) {
    ...
    return switch (resolvedSelectionOrder) {
      ...
      default ->
          throw new IllegalStateException(
              "The selectionOrder (%s) is not implemented.".formatted(resolvedSelectionOrder));
    };
  }
  ...
  private static String determineComparatorPropertyName(EntitySelectorConfig entitySelectorConfig) {
    ...
    if (sorterComparatorClass != null && comparatorClass != null) {
      throw new IllegalArgumentException(
          "The entitySelectorConfig (%s) cannot have a %s (%s) and %s (%s) at the same time."
              .formatted(
  ...
  private static Class<? extends Comparator> determineComparatorClass(
      EntitySelectorConfig entitySelectorConfig) {
  ...
  private static String determineComparatorFactoryPropertyName(
      EntitySelectorConfig entitySelectorConfig) {
  ...
  private static Class<? extends ComparatorFactory> determineComparatorFactoryClass(
      EntitySelectorConfig entitySelectorConfig) {
  ...
  private EntitySelector<Solution_> buildBaseEntitySelector(
      EntityDescriptor<Solution_> entityDescriptor,
      SelectionCacheType minimumCacheType,
    ...
    if (minimumCacheType == SelectionCacheType.SOLVER) {
      ...
      throw new IllegalArgumentException(
          "The minimumCacheType (%s) is not supported here. Please use %s instead."
  ...
  private EntitySelector<Solution_> applyEntityValueRangeFiltering(
      HeuristicConfigPolicy<Solution_> configPolicy,
          ...
          (IterableValueSelector<Solution_>)
              ValueSelectorFactory.<Solution_>create(valueSelectorConfig)
                  .buildValueSelector(
                      ...
                      minimumCacheType,
                      selectionOrder);
      return new FilteringEntityByValueSelector<>(
          entitySelector, replayingValueSelector, randomSelection);
    }
  }

  private EntitySelector<Solution_> applyNearbySelection(
      HeuristicConfigPolicy<Solution_> configPolicy,
  ...
  protected EntitySelector<Solution_> applySorting(
      SelectionCacheType resolvedCacheType,
      SelectionOrder resolvedSelectionOrder,
      EntitySelector<Solution_> entitySelector,
    ...
    if (resolvedSelectionOrder == SelectionOrder.SORTED) {
      ...
      if (sorterManner != null) {
        ...
        var sorterComparator =
            instanceCache.newInstance(
                config, determineComparatorPropertyName(config), comparatorClass);
        sorter =
        ...
        var comparatorFactory =
            instanceCache.newInstance(
                config, determineComparatorFactoryPropertyName(config), comparatorFactoryClass);
        sorter =
        ...
        throw new IllegalArgumentException(
            """
                ...
                .formatted(
                    ...
                    resolvedSelectionOrder,
                    sorterManner,
                    determineComparatorPropertyName(config),
                    comparatorClass,
  ...
  protected EntitySelector<Solution_> applyProbability(
      SelectionCacheType resolvedCacheType,
      SelectionOrder resolvedSelectionOrder,
      EntitySelector<Solution_> entitySelector,
      ClassInstanceCache instanceCache) {
    if (resolvedSelectionOrder == SelectionOrder.PROBABILISTIC) {
      ...
      entitySelector =
          new ProbabilityEntitySelector<>(
              entitySelector, resolvedCacheType, probabilityWeightFactory);
    }
    return entitySelector;
  }

  private EntitySelector<Solution_> applyShuffling(
      SelectionCacheType resolvedCacheType,
      SelectionOrder resolvedSelectionOrder,
      EntitySelector<Solution_> entitySelector) {
  ...
  private EntitySelector<Solution_> applyCaching(
      SelectionCacheType resolvedCacheType,
      SelectionOrder resolvedSelectionOrder,
      EntitySelector<Solution_> entitySelector) {
    if (resolvedCacheType.isCached()
        && resolvedCacheType.compareTo(entitySelector.getCacheType()) > 0) {
      entitySelector =
          new CachingEntitySelector<>(
              entitySelector, resolvedCacheType, resolvedSelectionOrder.toRandomSelectionBoolean());
    }
    return entitySelector;
  }
  ...
  private EntitySelector<Solution_> applySelectedLimit(
      SelectionOrder resolvedSelectionOrder, EntitySelector<Solution_> entitySelector) {
    if (config.getSelectedCountLimit() != null) {
      entitySelector =
          new SelectedCountLimitEntitySelector<>(
              entitySelector,
