...
public class SubChainReversingChangeMove<Solution_> extends AbstractMove<Solution_> {
  ...
  public SubChainReversingChangeMove(
      SubChain subChain,
    ...
    newTrailingEntity =
        toPlanningValue == null ? null : inverseVariableSupply.getInverseSingleton(toPlanningValue);
  }
  ...
  protected void doMoveOnGenuineVariables(ScoreDirector<Solution_> scoreDirector) {
    ...
    if (!unmovedReverse) {
      if (oldTrailingLastEntity != null) {
        castScoreDirector.changeVariableFacade(
            variableDescriptor, oldTrailingLastEntity, oldFirstValue);
      }
    }
    ...
    if (!unmovedReverse) {
      ...
      if (oldTrailingLastEntity != null) {
        castScoreDirector.changeVariableFacade(
            variableDescriptor, oldTrailingLastEntity, firstEntity);
      }
    }
  }

  static <Solution_> void reverseChain(
  ...
  @Override
  public SubChainReversingChangeMove<Solution_> rebase(
      ScoreDirector<Solution_> destinationScoreDirector) {
    return new SubChainReversingChangeMove<>(
        subChain.rebase(destinationScoreDirector),
        variableDescriptor,
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(subChain, other.subChain)
        && Objects.equals(
            variableDescriptor.getVariableName(), other.variableDescriptor.getVariableName())
  ...
  public String toString() {
    Object oldFirstValue = variableDescriptor.getValue(subChain.getFirstEntity());
    return subChain.toDottedString()
        + " {"
        + oldFirstValue
        + " -reversing-> "
        + toPlanningValue
