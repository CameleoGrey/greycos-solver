...
final class HardMediumSoftLongScoreContext
  ...
  public HardMediumSoftLongScoreContext(
      HardMediumSoftLongScoreInliner parent,
  ...
  public UndoScoreImpacter changeSoftScoreBy(
      long matchWeight, ConstraintMatchSupplier<HardMediumSoftLongScore> constraintMatchSupplier) {
    ...
    return impactWithConstraintMatch(
        undoScoreImpact, HardMediumSoftLongScore.ofSoft(softImpact), constraintMatchSupplier);
  }

  public UndoScoreImpacter changeMediumScoreBy(
      long matchWeight, ConstraintMatchSupplier<HardMediumSoftLongScore> constraintMatchSupplier) {
    ...
    return impactWithConstraintMatch(
        undoScoreImpact, HardMediumSoftLongScore.ofMedium(mediumImpact), constraintMatchSupplier);
  }
  ...
  public UndoScoreImpacter changeHardScoreBy(
    ...
    return impactWithConstraintMatch(
        undoScoreImpact, HardMediumSoftLongScore.ofHard(hardImpact), constraintMatchSupplier);
  }
