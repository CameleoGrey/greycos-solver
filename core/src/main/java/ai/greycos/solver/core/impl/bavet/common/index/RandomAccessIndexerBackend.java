...
/**
 * An {@link IndexerBackend} that supports random access to its entries. It is shown to be 10-20 %
 * slower than {@link LinkedListIndexerBackend} in the micro benchmarks when used as the backend for
 * constraint streams.
 *
