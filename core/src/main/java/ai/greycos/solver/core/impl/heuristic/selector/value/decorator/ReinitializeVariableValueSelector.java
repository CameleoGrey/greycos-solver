...
/**
 * Prevents reassigning of already initialized variables during Construction Heuristics and
 * Exhaustive Search.
 *
 * <p>Returns no values for an entity's variable if the variable is not reinitializable.
 *
 * <p>Does not implement {@link IterableValueSelector} because if used like that, it shouldn't be
 * added during configuration in the first place.
 */
