 ...
 * PlanningEntity}, a planningValue, a {@link Move} or a {@link Selector}). The selections are then
 * sorted by their weight, normally ascending unless it's configured descending.
 *
...
public interface SelectionSorterWeightFactory<Solution_, T>
    extends ComparatorFactory<Solution_, T> {
   ...
   *     {@link Selector}
   * @return never null, for example a {@link Integer}, {@link Double} or a more complex {@link
   *     Comparable}
   */
