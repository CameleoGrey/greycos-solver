...
public class MoveListFactoryConfig extends MoveSelectorConfig<MoveListFactoryConfig> {
  ...
  public void setMoveListFactoryCustomProperties(
      @Nullable Map<String, String> moveListFactoryCustomProperties) {
  ...
  public @NonNull MoveListFactoryConfig withMoveListFactoryCustomProperties(
      @NonNull Map<String, String> moveListFactoryCustomProperties) {
