...
import ai.greycos.solver.core.impl.bavet.tri.PrecomputeTriNode;
...
public class BavetPrecomputeTriConstraintStream<Solution_, A, B, C>
  ...
  public BavetPrecomputeTriConstraintStream(
    ...
    this.recordingPrecomputedConstraintStream =
        new BavetRecordingTriConstraintStream<>(constraintFactory, precomputedConstraintStream);
