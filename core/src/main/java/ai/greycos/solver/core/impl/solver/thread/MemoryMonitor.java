...
public class MemoryMonitor {
    ...
    public MemoryPressureLevel checkMemoryUsage() {
        ...
        if (memoryUsagePercentage >= emergencyThreshold) {
            ...
            LOGGER.warn("Memory usage is at CRITICAL level: {:.1%} ({} MB / {} MB)",
            ...
            LOGGER.warn("Memory usage is at WARNING level: {:.1%} ({} MB / {} MB)",
                    memoryUsagePercentage,
                    usedMemory / (1024 * 1024),
                    maxMemory / (1024 * 1024));
    ...
    public static class MemoryStatistics {
        ...
        public MemoryStatistics(long usedMemoryBeforeGC, long usedMemoryAfterGC, 
                               long maxMemory, long timestamp) {
