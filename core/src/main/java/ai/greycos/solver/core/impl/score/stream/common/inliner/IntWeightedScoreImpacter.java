...
final class IntWeightedScoreImpacter<
  ...
  public IntWeightedScoreImpacter(
      IntImpactFunction<Score_, Context_> impactFunction, Context_ context) {
  ...
  public UndoScoreImpacter impactScore(
    ...
    throw new UnsupportedOperationException(
        "Impossible state: passing BigDecimal into an int impacter.");
  }
