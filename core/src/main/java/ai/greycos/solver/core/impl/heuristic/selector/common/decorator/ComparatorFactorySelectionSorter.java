...
public final class ComparatorFactorySelectionSorter<Solution_, T>
  ...
  public ComparatorFactorySelectionSorter(
  ...
  public void sort(Solution_ solution, List<T> selectionList) {
    var appliedComparator =
        getAppliedComparator(selectionComparatorFactory.createComparator(solution));
  ...
  public SortedSet<T> sort(Solution_ solution, Set<T> selectionSet) {
    var treeSet =
        new TreeSet<>(getAppliedComparator(selectionComparatorFactory.createComparator(solution)));
