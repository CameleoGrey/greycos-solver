...
/**
 * Determines when a {@link Phase} should stop. See {@link SolverTermination} for the termination
 * that also supports stopping the solver. Many terminations are used at both solver-level and
 * phase-level.
 */
@NullMarked
