...
/**
 * A mutable key-value tuple. Two instances {@link Object#equals(Object) are equal} if both values
 * in the first instance are equal to their counterpart in the other instance.
 *
 * @param <A>
 * @param <B>
 */
public final class MutablePair<A, B> {
  ...
  @Override
  public int
      hashCode() { // Not using Objects.hash(Object...) as that would create an array on the hot
    // path.
