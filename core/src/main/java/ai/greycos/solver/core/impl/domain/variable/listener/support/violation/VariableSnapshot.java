...
/**
 * A {@link VariableSnapshot} is a snapshot of the value of a variable for a given entity. Only
 * {@link VariableSnapshot} from the same solution instance can be compared.
 *
...
public record VariableSnapshot<Solution_>(VariableId<Solution_> variableId, Object value) {
  ...
  public VariableSnapshot(VariableDescriptor<Solution_> variableDescriptor, Object entity) {
    this(
        new VariableId<>(variableDescriptor, entity),
        variableDescriptor.isListVariable()
            ? new ArrayList<>((List<?>) variableDescriptor.getValue(entity))
