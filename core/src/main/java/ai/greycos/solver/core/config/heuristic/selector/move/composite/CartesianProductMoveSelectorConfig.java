...
public class CartesianProductMoveSelectorConfig
  ...
  public @NonNull CartesianProductMoveSelectorConfig withMoveSelectorList(
      @NonNull List<@NonNull MoveSelectorConfig> moveSelectorConfigList) {
    this.moveSelectorConfigList = moveSelectorConfigList;
    return this;
  }

  public @NonNull CartesianProductMoveSelectorConfig withMoveSelectors(
      @NonNull MoveSelectorConfig @NonNull ... moveSelectorConfigs) {
    this.moveSelectorConfigList = Arrays.asList(moveSelectorConfigs);
    return this;
  }

  public @NonNull CartesianProductMoveSelectorConfig withIgnoreEmptyChildIterators(
      @NonNull Boolean ignoreEmptyChildIterators) {
    this.ignoreEmptyChildIterators = ignoreEmptyChildIterators;
    return this;
  }
  ...
  @Override
  public @NonNull CartesianProductMoveSelectorConfig inherit(
      @NonNull CartesianProductMoveSelectorConfig inheritedConfig) {
