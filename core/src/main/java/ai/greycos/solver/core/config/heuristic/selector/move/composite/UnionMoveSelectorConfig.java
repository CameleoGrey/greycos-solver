package ai.greycos.solver.core.config.heuristic.selector.move.composite;
...
import ai.greycos.solver.core.config.heuristic.selector.move.NearbyAutoConfigurationEnabled;
...
public class UnionMoveSelectorConfig extends MoveSelectorConfig<UnionMoveSelectorConfig>
  ...
  public void setMoveSelectorList(
  ...
  public @Nullable Class<? extends SelectionProbabilityWeightFactory>
    ...
    return ConfigUtils.resolveClass(
        selectorProbabilityWeightFactoryClass, "selectorProbabilityWeightFactoryClass", this);
  }

  public void setSelectorProbabilityWeightFactoryClass(
      @Nullable Class<? extends SelectionProbabilityWeightFactory>
          selectorProbabilityWeightFactoryClass) {
    this.selectorProbabilityWeightFactoryClass =
        selectorProbabilityWeightFactoryClass == null
            ? null
  ...
  public @NonNull UnionMoveSelectorConfig withMoveSelectorList(
      @NonNull List<@NonNull MoveSelectorConfig> moveSelectorConfigList) {
    this.moveSelectorConfigList = moveSelectorConfigList;
    return this;
  }

  public @NonNull UnionMoveSelectorConfig withMoveSelectors(
      @NonNull MoveSelectorConfig @NonNull ... moveSelectorConfigs) {
  ...
  public @NonNull UnionMoveSelectorConfig withSelectorProbabilityWeightFactoryClass(
      @NonNull Class<? extends SelectionProbabilityWeightFactory>
          selectorProbabilityWeightFactoryClass) {
  ...
  public void extractLeafMoveSelectorConfigsIntoList(
      @NonNull List<@NonNull MoveSelectorConfig> leafMoveSelectorConfigList) {
  ...
  @Override
  public @NonNull UnionMoveSelectorConfig inherit(
      @NonNull UnionMoveSelectorConfig inheritedConfig) {
    ...
    selectorProbabilityWeightFactoryClass =
        ConfigUtils.inheritOverwritableProperty(
            selectorProbabilityWeightFactoryClass,
            inheritedConfig.selectorProbabilityWeightFactoryClass);
    return this;
  }
    ...
    for (var selectorConfig : moveSelectorConfigList) {
      if (selectorConfig instanceof NearbyAutoConfigurationEnabled<?> nearbySelectorConfig) {
        if (UnionMoveSelectorConfig.class.isAssignableFrom(nearbySelectorConfig.getClass())) {
          updatedMoveSelectorList.add(
              nearbySelectorConfig.enableNearbySelection(distanceMeter, random));
        } else {
