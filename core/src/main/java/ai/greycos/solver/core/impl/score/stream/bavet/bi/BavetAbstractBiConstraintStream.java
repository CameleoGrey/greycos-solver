...
import ai.greycos.solver.core.impl.bavet.bi.Group0Mapping1CollectorBiNode;
import ai.greycos.solver.core.impl.bavet.bi.Group0Mapping2CollectorBiNode;
import ai.greycos.solver.core.impl.bavet.bi.Group0Mapping3CollectorBiNode;
import ai.greycos.solver.core.impl.bavet.bi.Group0Mapping4CollectorBiNode;
import ai.greycos.solver.core.impl.bavet.bi.Group1Mapping0CollectorBiNode;
import ai.greycos.solver.core.impl.bavet.bi.Group1Mapping1CollectorBiNode;
import ai.greycos.solver.core.impl.bavet.bi.Group1Mapping2CollectorBiNode;
import ai.greycos.solver.core.impl.bavet.bi.Group1Mapping3CollectorBiNode;
import ai.greycos.solver.core.impl.bavet.bi.Group2Mapping0CollectorBiNode;
import ai.greycos.solver.core.impl.bavet.bi.Group2Mapping1CollectorBiNode;
import ai.greycos.solver.core.impl.bavet.bi.Group2Mapping2CollectorBiNode;
import ai.greycos.solver.core.impl.bavet.bi.Group3Mapping0CollectorBiNode;
import ai.greycos.solver.core.impl.bavet.bi.Group3Mapping1CollectorBiNode;
import ai.greycos.solver.core.impl.bavet.bi.Group4Mapping0CollectorBiNode;
...
import ai.greycos.solver.core.impl.bavet.tri.joiner.TriJoinerComber;
...
import ai.greycos.solver.core.impl.score.stream.bavet.quad.BavetBiConcatQuadConstraintStream;
import ai.greycos.solver.core.impl.score.stream.bavet.tri.BavetAbstractTriConstraintStream;
import ai.greycos.solver.core.impl.score.stream.bavet.tri.BavetBiConcatTriConstraintStream;
import ai.greycos.solver.core.impl.score.stream.bavet.tri.BavetJoinTriConstraintStream;
import ai.greycos.solver.core.impl.score.stream.bavet.uni.BavetAbstractUniConstraintStream;
...
import ai.greycos.solver.core.impl.score.stream.common.bi.BiConstraintBuilderImpl;
import ai.greycos.solver.core.impl.score.stream.common.bi.InnerBiConstraintStream;
...
public abstract class BavetAbstractBiConstraintStream<Solution_, A, B>
    extends BavetAbstractConstraintStream<Solution_> implements InnerBiConstraintStream<A, B> {

  protected BavetAbstractBiConstraintStream(
  ...
  @Override
  public @NonNull BavetAbstractBiConstraintStream<Solution_, A, B> filter(
      @NonNull BiPredicate<A, B> predicate) {
  ...
  @Override
  @SafeVarargs
  public final <C> @NonNull TriConstraintStream<A, B, C> join(
      @NonNull UniConstraintStream<C> otherStream, TriJoiner<A, B, C> @NonNull ... joiners) {
    ...
    var joinStream =
        new BavetJoinTriConstraintStream<>(
            constraintFactory,
            leftBridge,
            rightBridge,
  ...
  @SafeVarargs
  @Override
  public final @NonNull <C> BiConstraintStream<A, B> ifExists(
  ...
  @SafeVarargs
  @Override
  public final <C> @NonNull BiConstraintStream<A, B> ifNotExists(
      @NonNull UniConstraintStream<C> otherStream, TriJoiner<A, B, C>... joiners) {
    return ifExistsOrNot(false, otherStream, joiners);
  }

  private <C> BiConstraintStream<A, B> ifExistsOrNot(
      boolean shouldExist, UniConstraintStream<C> otherStream, TriJoiner<A, B, C>[] joiners) {
    var other = (BavetAbstractUniConstraintStream<Solution_, C>) otherStream;
    var joinerComber = TriJoinerComber.comb(joiners);
    var parentBridgeC =
        other.shareAndAddChild(new BavetForeBridgeUniConstraintStream<>(constraintFactory, other));
    return constraintFactory.share(
        new BavetIfExistsBiConstraintStream<>(
            constraintFactory,
            this,
            parentBridgeC,
            shouldExist,
  ...
  private <NewA> UniConstraintStream<NewA> buildUniGroupBy(
    ...
    var stream =
        shareAndAddChild(
            new BavetUniGroupBiConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
        new BavetAftBridgeUniConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }

  @Override
  public <ResultContainerA_, ResultA_, ResultContainerB_, ResultB_>
    ...
    GroupNodeConstructor<BiTuple<ResultA_, ResultB_>> nodeConstructor =
        GroupNodeConstructor.zeroKeysGroupBy(
            collectorA, collectorB, Group0Mapping2CollectorBiNode::new);
  ...
  private <NewA, NewB> BiConstraintStream<NewA, NewB> buildBiGroupBy(
    ...
    var stream =
        shareAndAddChild(
            new BavetBiGroupBiConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
  ...
  public <ResultContainerA_, ResultA_, ResultContainerB_, ResultB_, ResultContainerC_, ResultC_>
    ...
    GroupNodeConstructor<TriTuple<ResultA_, ResultB_, ResultC_>> nodeConstructor =
        GroupNodeConstructor.zeroKeysGroupBy(
            collectorA, collectorB, collectorC, Group0Mapping3CollectorBiNode::new);
  ...
  private <NewA, NewB, NewC> TriConstraintStream<NewA, NewB, NewC> buildTriGroupBy(
    ...
    var stream =
        shareAndAddChild(
            new BavetTriGroupBiConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
  ...
  public <
    ...
    GroupNodeConstructor<QuadTuple<ResultA_, ResultB_, ResultC_, ResultD_>> nodeConstructor =
        GroupNodeConstructor.zeroKeysGroupBy(
            collectorA, collectorB, collectorC, collectorD, Group0Mapping4CollectorBiNode::new);
  ...
  private <NewA, NewB, NewC, NewD> QuadConstraintStream<NewA, NewB, NewC, NewD> buildQuadGroupBy(
    ...
    var stream =
        shareAndAddChild(
            new BavetQuadGroupBiConstraintStream<>(constraintFactory, this, nodeConstructor));
    return constraintFactory.share(
        new BavetAftBridgeQuadConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }

  @Override
  public <GroupKey_> @NonNull UniConstraintStream<GroupKey_> groupBy(
  ...
  public <GroupKey_, ResultContainerB_, ResultB_, ResultContainerC_, ResultC_>
    ...
    GroupNodeConstructor<TriTuple<GroupKey_, ResultB_, ResultC_>> nodeConstructor =
        GroupNodeConstructor.oneKeyGroupBy(
            groupKeyMapping, collectorB, collectorC, Group1Mapping2CollectorBiNode::new);
    return buildTriGroupBy(nodeConstructor);
  }
  ...
  public <GroupKey_, ResultContainer_, Result_>
    ...
    GroupNodeConstructor<BiTuple<GroupKey_, Result_>> nodeConstructor =
        GroupNodeConstructor.oneKeyGroupBy(
            groupKeyMapping, collector, Group1Mapping1CollectorBiNode::new);
    return buildBiGroupBy(nodeConstructor);
  }
  ...
  public <GroupKeyA_, GroupKeyB_> @NonNull BiConstraintStream<GroupKeyA_, GroupKeyB_> groupBy(
    ...
    GroupNodeConstructor<BiTuple<GroupKeyA_, GroupKeyB_>> nodeConstructor =
        GroupNodeConstructor.twoKeysGroupBy(
            groupKeyAMapping, groupKeyBMapping, Group2Mapping0CollectorBiNode::new);
    return buildBiGroupBy(nodeConstructor);
  }
  ...
  public <GroupKeyA_, GroupKeyB_, ResultContainer_, Result_>
    ...
    GroupNodeConstructor<TriTuple<GroupKeyA_, GroupKeyB_, Result_>> nodeConstructor =
        GroupNodeConstructor.twoKeysGroupBy(
            groupKeyAMapping, groupKeyBMapping, collector, Group2Mapping1CollectorBiNode::new);
    return buildTriGroupBy(nodeConstructor);
  }
  ...
  @Override
  public <GroupKeyA_, GroupKeyB_, GroupKeyC_>
    ...
    GroupNodeConstructor<TriTuple<GroupKeyA_, GroupKeyB_, GroupKeyC_>> nodeConstructor =
        GroupNodeConstructor.threeKeysGroupBy(
            groupKeyAMapping,
            groupKeyBMapping,
            groupKeyCMapping,
  ...
  public <GroupKeyA_, GroupKeyB_, GroupKeyC_, ResultContainerD_, ResultD_>
    ...
    GroupNodeConstructor<QuadTuple<GroupKeyA_, GroupKeyB_, GroupKeyC_, ResultD_>> nodeConstructor =
        GroupNodeConstructor.threeKeysGroupBy(
            ...
            groupKeyCMapping,
            collectorD,
            Group3Mapping1CollectorBiNode::new);
    return buildQuadGroupBy(nodeConstructor);
  }
  ...
  @Override
  public @NonNull BiConstraintStream<A, B> concat(
  ...
  public @NonNull BiConstraintStream<A, B> concat(@NonNull BiConstraintStream<A, B> otherStream) {
    ...
    var concatStream =
        new BavetBiConcatBiConstraintStream<>(constraintFactory, leftBridge, rightBridge);
    return constraintFactory.share(
        concatStream,
        concatStream_ -> {
          // Connect the bridges upstream
  ...
  @Override
  public @NonNull <C> TriConstraintStream<A, B, C> concat(
    ...
    var concatStream =
        new BavetBiConcatTriConstraintStream<>(
            constraintFactory, leftBridge, rightBridge, paddingFunction);
    return constraintFactory.share(
        concatStream,
        concatStream_ -> {
  ...
  @Override
  public <C, D> @NonNull QuadConstraintStream<A, B, C, D> concat(
    ...
    var concatStream =
        new BavetBiConcatQuadConstraintStream<>(
            constraintFactory, leftBridge, rightBridge, paddingFunctionC, paddingFunctionD);
    return constraintFactory.share(
        concatStream,
        concatStream_ -> {
          // Connect the bridges upstream
  ...
  @Override
  public <ResultA_> @NonNull UniConstraintStream<ResultA_> map(
      @NonNull BiFunction<A, B, ResultA_> mapping) {
    var stream =
        shareAndAddChild(new BavetUniMapBiConstraintStream<>(constraintFactory, this, mapping));
    return constraintFactory.share(
        new BavetAftBridgeUniConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }
  ...
  public <ResultA_, ResultB_> @NonNull BiConstraintStream<ResultA_, ResultB_> map(
    ...
    var stream =
        shareAndAddChild(
            new BavetBiMapBiConstraintStream<>(constraintFactory, this, mappingA, mappingB));
    return constraintFactory.share(
        new BavetAftBridgeBiConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }

  @Override
  public <ResultA_, ResultB_, ResultC_>
      @NonNull TriConstraintStream<ResultA_, ResultB_, ResultC_> map(
          @NonNull BiFunction<A, B, ResultA_> mappingA,
          @NonNull BiFunction<A, B, ResultB_> mappingB,
          @NonNull BiFunction<A, B, ResultC_> mappingC) {
    var stream =
        shareAndAddChild(
            new BavetTriMapBiConstraintStream<>(
  ...
  @Override
  public <ResultA_, ResultB_, ResultC_, ResultD_>
    ...
    var stream =
        shareAndAddChild(
            new BavetQuadMapBiConstraintStream<>(
  ...
  @Override
  public @NonNull <ResultC_> TriConstraintStream<A, B, ResultC_> flatten(
      @NonNull BiFunction<A, B, @NonNull Iterable<ResultC_>> mapping) {
    var stream =
        shareAndAddChild(new BavetFlattenBiConstraintStream<>(constraintFactory, this, mapping));
    return constraintFactory.share(
        new BavetAftBridgeTriConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }

  @Override
  public <ResultB_> @NonNull BiConstraintStream<A, ResultB_> flattenLast(
      @NonNull Function<B, @NonNull Iterable<ResultB_>> mapping) {
    var stream =
        shareAndAddChild(
            new BavetFlattenLastBiConstraintStream<>(constraintFactory, this, mapping));
    return constraintFactory.share(
        new BavetAftBridgeBiConstraintStream<>(constraintFactory, stream), stream::setAftBridge);
  }
  ...
  @Override
  public <ResultC_> @NonNull TriConstraintStream<A, B, ResultC_> expand(
