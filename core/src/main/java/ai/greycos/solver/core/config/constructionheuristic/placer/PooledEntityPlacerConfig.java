...
@XmlType(propOrder = {"moveSelectorConfig"})
public class PooledEntityPlacerConfig extends EntityPlacerConfig<PooledEntityPlacerConfig> {
  ...
  public @NonNull PooledEntityPlacerConfig withMoveSelectorConfig(
  ...
  @Override
  public @NonNull PooledEntityPlacerConfig inherit(
      @NonNull PooledEntityPlacerConfig inheritedConfig) {
