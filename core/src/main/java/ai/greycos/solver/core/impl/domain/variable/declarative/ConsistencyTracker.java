...
public record ConsistencyTracker<Solution_>(
  ...
  public EntityConsistencyState<Solution_, Object> getDeclarativeEntityConsistencyState(
   ...
   *
   * <ul>
   *   <li>Do not have a {@link
   *       ai.greycos.solver.core.api.domain.variable.ShadowVariablesInconsistent} member.
   *   <li>Have a {@link ai.greycos.solver.core.api.domain.variable.ShadowVariablesInconsistent}
   *       member that is null.
   * </ul>
   *
   * If an entity has a {@link
   * ai.greycos.solver.core.api.domain.variable.ShadowVariablesInconsistent} member that is either
   * true or false, then that value determines if the entity is consistent or not (regardless of its
   * actual consistency in the graph).
   */
