 ...
 * they are very frequent and they often end up looking up the same descriptor. These caches are
 * used to avoid looking up the same descriptor multiple times.
 *
 * @param <Solution_>
 */
public final class VariableDescriptorCache<Solution_> {
  ...
  public VariableDescriptor<Solution_> getVariableDescriptor(Object entity, String variableName) {
    if (!Objects.equals(basicVarDescritorCacheClass, entity.getClass())
      ...
      basicVarDescriptorCache =
          solutionDescriptor.findVariableDescriptorOrFail(entity, variableName);
    }
