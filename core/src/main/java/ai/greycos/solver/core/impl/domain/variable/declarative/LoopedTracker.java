...
import static ai.greycos.solver.core.impl.util.DynamicIntArray.ClearingStrategy.PARTIAL;

import java.util.Arrays;

import ai.greycos.solver.core.impl.util.DynamicIntArray;
...
public final class LoopedTracker {
  ...
  public boolean isEntityInconsistent(
      BaseTopologicalOrderGraph graph, int entityId, @Nullable Boolean wasEntityInconsistent) {
