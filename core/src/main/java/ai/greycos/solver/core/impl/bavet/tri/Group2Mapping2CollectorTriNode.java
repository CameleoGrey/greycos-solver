...
public final class Group2Mapping2CollectorTriNode<
        OldA, OldB, OldC, A, B, C, D, ResultContainerC_, ResultContainerD_>
    extends AbstractGroupTriNode<
        OldA, OldB, OldC, QuadTuple<A, B, C, D>, Pair<A, B>, Object, Pair<C, D>> {

  private final int outputStoreSize;

  public Group2Mapping2CollectorTriNode(
    ...
    super(
        ...
        undoStoreIndex,
        tuple ->
            Group2Mapping0CollectorTriNode.createGroupKey(
                groupKeyMappingA, groupKeyMappingB, tuple),
        Group0Mapping2CollectorTriNode.mergeCollectors(collectorC, collectorD),
