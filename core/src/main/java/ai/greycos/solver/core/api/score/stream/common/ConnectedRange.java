...
/**
 * Represents a collection of ranges that are connected, meaning the union of all the ranges results
 * in the range [{@link #getStart()}, {@link #getEnd()}) without gaps.
 *
 ...
 */
public interface ConnectedRange<
  ...
  /**
   * True if this {@link ConnectedRange} has at least one pair of ranges that overlaps each other,
   * false otherwise.
   *
  ...
  /**
   * Get the minimum number of overlapping ranges for any point contained by this {@link
   * ConnectedRange}.
   *
   * @return the minimum number of overlapping ranges for any point in this {@link ConnectedRange}.
   */
  int getMinimumOverlap();

  /**
   * Get the maximum number of overlapping ranges for any point contained by this {@link
   * ConnectedRange}.
   *
   * @return the maximum number of overlapping ranges for any point in this {@link ConnectedRange}.
   */
