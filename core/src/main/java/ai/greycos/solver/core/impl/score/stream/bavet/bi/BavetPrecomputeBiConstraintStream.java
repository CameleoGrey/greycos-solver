...
import ai.greycos.solver.core.impl.bavet.bi.PrecomputeBiNode;
...
public class BavetPrecomputeBiConstraintStream<Solution_, A, B>
  ...
  public BavetPrecomputeBiConstraintStream(
    ...
    this.recordingPrecomputedConstraintStream =
        new BavetRecordingBiConstraintStream<>(constraintFactory, precomputedConstraintStream);
