...
import ai.greycos.solver.core.impl.bavet.tri.FlattenLastTriNode;
...
final class BavetFlattenLastTriConstraintStream<Solution_, A, B, C, NewC>
  ...
  public BavetFlattenLastTriConstraintStream(
  ...
  public void setAftBridge(
      BavetAftBridgeTriConstraintStream<Solution_, A, B, NewC> flattenLastStream) {
  ...
  public boolean equals(Object object) {
    ...
    BavetFlattenLastTriConstraintStream<?, ?, ?, ?, ?> that =
        (BavetFlattenLastTriConstraintStream<?, ?, ?, ?, ?>) object;
