package ai.greycos.solver.core.api.score.buildin.hardmediumsoft;
...
/**
 * This {@link Score} is based on 3 levels of int constraints: hard, medium and soft. Hard
...
public final class HardMediumSoftScore implements Score<HardMediumSoftScore> {
  ...
  public static HardMediumSoftScore parseScore(String scoreString) {
    var scoreTokens =
        ScoreUtil.parseScoreTokens(
            HardMediumSoftScore.class, scoreString, HARD_LABEL, MEDIUM_LABEL, SOFT_LABEL);
    var hardScore =
        ScoreUtil.parseLevelAsInt(HardMediumSoftScore.class, scoreString, scoreTokens[0]);
    var mediumScore =
        ScoreUtil.parseLevelAsInt(HardMediumSoftScore.class, scoreString, scoreTokens[1]);
    var softScore =
        ScoreUtil.parseLevelAsInt(HardMediumSoftScore.class, scoreString, scoreTokens[2]);
  ...
  public static HardMediumSoftScore ofUninitialized(
      int initScore, int hardScore, int mediumScore, int softScore) {
    return of(hardScore, mediumScore, softScore);
  }
  ...
  public String toShortString() {
    return ScoreUtil.buildShortString(
        this, n -> n.intValue() != 0, HARD_LABEL, MEDIUM_LABEL, SOFT_LABEL);
  }
