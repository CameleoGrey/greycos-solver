...
import static ai.greycos.solver.core.impl.bavet.uni.Group3Mapping0CollectorUniNode.createGroupKey;
...
public final class Group3Mapping1CollectorUniNode<OldA, A, B, C, D, ResultContainer_>
    extends AbstractGroupUniNode<
        OldA, QuadTuple<A, B, C, D>, Triple<A, B, C>, ResultContainer_, D> {

  private final int outputStoreSize;

  public Group3Mapping1CollectorUniNode(
