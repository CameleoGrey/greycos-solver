package ai.greycos.solver.core.api.domain.valuerange;
...
public final class ValueRangeFactory {
   ...
   */
  public static @NonNull CountableValueRange<Integer> createIntValueRange(
   ...
   * @param incrementUnit {@code > 0}
   */
  public static @NonNull CountableValueRange<Long> createLongValueRange(
   ...
   * @param to exclusive maximum, {@code >= from}
   */
  public static @NonNull CountableValueRange<BigInteger> createBigIntegerValueRange(
  ...
  /**
   * Build a {@link CountableValueRange} of all {@link BigDecimal} values (of a specific scale)
   * between 2 bounds. All parameters must have the same {@link BigDecimal#scale()}.
   *
   * @param from inclusive minimum
   * @param to exclusive maximum, {@code >= from}
   */
  public static @NonNull CountableValueRange<BigDecimal> createBigDecimalValueRange(
      @NonNull BigDecimal from, @NonNull BigDecimal to) {
    return new BigDecimalValueRange(from, to);
  }

  /**
   * Build a {@link CountableValueRange} of a subset of {@link BigDecimal} values (of a specific
   * scale) between 2 bounds. All parameters must have the same {@link BigDecimal#scale()}.
   *
   * @param from inclusive minimum
   * @param to exclusive maximum, {@code >= from}
   * @param incrementUnit {@code > 0}
  ...
  /**
   * Build a {@link CountableValueRange} of a subset of {@link LocalDateTime} values between 2
   * bounds.
   *
   * <p>Facade for {@link #createTemporalValueRange(Temporal, Temporal, long, TemporalUnit)}.
   *
  ...
  /**
   * Build a {@link CountableValueRange} of a subset of {@link Temporal} values (such as {@link
   * LocalDate} or {@link LocalDateTime}) between 2 bounds. All parameters must have the same {@link
   * TemporalUnit}.
   *
   * @param from inclusive minimum
   * @param to exclusive maximum, {@code >= from}
  ...
  public static <Temporal_ extends Temporal & Comparable<? super Temporal_>>
      @NonNull CountableValueRange<Temporal_> createTemporalValueRange(
