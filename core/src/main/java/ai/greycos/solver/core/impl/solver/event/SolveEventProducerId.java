...
/** {@link EventProducerId} for when a {@link BestSolutionChangedEvent} is not caused by a phase. */
@NullMarked
public enum SolveEventProducerId implements EventProducerId {
  /**
   * The cause is unknown. This is the {@link EventProducerId} used when one of the deprecated
   * {@link BestSolutionChangedEvent} constructors are used.
   *
   * @deprecated Only used when Users manually construct instances of {@link
