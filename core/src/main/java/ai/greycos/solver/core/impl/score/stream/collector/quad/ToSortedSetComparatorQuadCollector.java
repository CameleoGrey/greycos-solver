...
import ai.greycos.solver.core.impl.score.stream.collector.SortedSetUndoableActionable;

import org.jspecify.annotations.NonNull;

final class ToSortedSetComparatorQuadCollector<A, B, C, D, Mapped_>
    extends UndoableActionableQuadCollector<
        A, B, C, D, Mapped_, SortedSet<Mapped_>, SortedSetUndoableActionable<Mapped_>> {
  ...
  public boolean equals(Object object) {
    ...
    ToSortedSetComparatorQuadCollector<?, ?, ?, ?, ?> that =
        (ToSortedSetComparatorQuadCollector<?, ?, ?, ?, ?>) object;
