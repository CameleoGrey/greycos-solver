 ...
 * boilerplate. This move will record all events that change variables, and replay them in the undo
 * move, therefore removing the need to implement the undo move.
 *
 * @param <Solution_>
 * @deprecated In favor of {@link AbstractMove}, which no longer requires undo moves to be
 *     implemented either.
 */
