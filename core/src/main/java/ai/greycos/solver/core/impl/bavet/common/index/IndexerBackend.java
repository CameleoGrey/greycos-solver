...
/**
 * Bottom-most indexer in the indexer chain. Constraint streams and Neighborhoods use different
 * indexer backends, as they have different performance characteristics and requirements.
 *
 * @param <T>
 */
@NullMarked
