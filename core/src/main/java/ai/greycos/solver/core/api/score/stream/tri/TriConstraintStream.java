...
public interface TriConstraintStream<A, B, C> extends ConstraintStream {
  ...
  /**
   * As defined by {@link #penalize(Score, ToLongTriFunction)}, with a penalty of type {@link
   * BigDecimal}.
   */
  ...
  /**
   * As defined by {@link #reward(Score, ToLongTriFunction)}, with a penalty of type {@link
   * BigDecimal}.
   */
  ...
  /**
   * As defined by {@link #impact(Score, ToLongTriFunction)}, with an impact of type {@link
   * BigDecimal}.
   */
