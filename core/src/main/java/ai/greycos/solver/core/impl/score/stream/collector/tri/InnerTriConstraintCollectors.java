...
public class InnerTriConstraintCollectors {
  ...
  public static <
    ...
    return new ComposeFourTriCollector<>(first, second, third, fourth, composeFunction);
  }
  ...
  public static <
    ...
    return new ComposeThreeTriCollector<>(first, second, third, composeFunction);
  }
  ...
  public static <A, B, C, ResultHolder1_, ResultHolder2_, Result1_, Result2_, Result_>
    ...
    return new ComposeTwoTriCollector<>(first, second, composeFunction);
  }
  ...
  public static <A, B, C, Key_, Value_, Set_ extends Set<Value_>, Result_ extends Map<Key_, Set_>>
    ...
    return new ToMultiMapTriCollector<>(keyFunction, valueFunction, mapSupplier, setFunction);
  }
  ...
  public static <A, B, C, Key_, Value_, Result_ extends Map<Key_, Value_>>
    ...
    return new ToSimpleMapTriCollector<>(keyFunction, valueFunction, mapSupplier, mergeFunction);
  }
  ...
  public static <A, B, C, Mapped_>
      TriConstraintCollector<A, B, C, ?, SortedSet<Mapped_>> toSortedSet(
          TriFunction<? super A, ? super B, ? super C, ? extends Mapped_> mapper,
  ...
  public static <A, B, C, Result_>
      TriConstraintCollector<A, B, C, ?, SequenceChain<Result_, Integer>> toConsecutiveSequences(
          TriFunction<A, B, C, Result_> resultMap, ToIntFunction<Result_> indexMap) {
  ...
  public static <
      ...
      TriConstraintCollector<A, B, C, ?, ConnectedRangeChain<Interval_, Point_, Difference_>>
          toConnectedRanges(
              TriFunction<? super A, ? super B, ? super C, ? extends Interval_> mapper,
              ...
              BiFunction<? super Point_, ? super Point_, ? extends Difference_>
                  differenceFunction) {
    return new ConnectedRangesTriConstraintCollector<>(
        mapper, startMap, endMap, differenceFunction);
  }

  public static <A, B, C, Intermediate_, Result_>
      TriConstraintCollector<A, B, C, ?, Result_> collectAndThen(
          TriConstraintCollector<A, B, C, ?, Intermediate_> delegate,
  ...
  public static <A, B, C, Balanced_>
      TriConstraintCollector<A, B, C, ?, LoadBalance<Balanced_>> loadBalance(
