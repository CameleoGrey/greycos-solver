...
import static ai.greycos.solver.core.preview.api.neighborhood.stream.joiner.NeighborhoodsJoiners.filtering;
...
import ai.greycos.solver.core.impl.neighborhood.stream.sampling.DefaultUniSamplingStream;
...
public final class DefaultMoveStreamFactory<Solution_> implements MoveStreamFactory<Solution_> {
  ...
  private final Map<
          ...
          ListVariableNodeSharingSupportFunctions<Solution_, ?, ?>>
      listVariableNodeSharingSupportFunctionsMap = new HashMap<>();

  public DefaultMoveStreamFactory(
      SolutionDescriptor<Solution_> solutionDescriptor, EnvironmentMode environmentMode) {
    this.enumeratingStreamFactory =
        new EnumeratingStreamFactory<>(solutionDescriptor, environmentMode);
  ...
  @Override
  public <A> UniEnumeratingStream<Solution_, A> forEachUnfiltered(
  ...
  public <Entity_, Value_>
      NodeSharingSupportFunctions<Solution_, Entity_, Value_> getNodeSharingSupportFunctions(
          PlanningVariableMetaModel<Solution_, Entity_, Value_> variableMetaModel) {
    return (NodeSharingSupportFunctions<Solution_, Entity_, Value_>)
        nodeSharingSupportFunctionMap.computeIfAbsent(
            variableMetaModel, ignored -> new NodeSharingSupportFunctions<>(variableMetaModel));
  }

  @Override
  public <Entity_, Value_> UniEnumeratingStream<Solution_, Value_> forEachAssignedValueUnfiltered(
  ...
  @Override
  public <Entity_, Value_> UniEnumeratingStream<Solution_, Value_> forEachUnassignedValue(
      PlanningListVariableMetaModel<Solution_, Entity_, Value_> variableMetaModel) {
    var nodeSharingSupportFunctions = getNodeSharingSupportFunctions(variableMetaModel);
    return forEach(variableMetaModel.type(), false)
  ...
  @SuppressWarnings("unchecked")
  public <Entity_, Value_>
      ListVariableNodeSharingSupportFunctions<Solution_, Entity_, Value_>
          getNodeSharingSupportFunctions(
              PlanningListVariableMetaModel<Solution_, Entity_, Value_> variableMetaModel) {
    return (ListVariableNodeSharingSupportFunctions<Solution_, Entity_, Value_>)
        listVariableNodeSharingSupportFunctionsMap.computeIfAbsent(
            variableMetaModel, ListVariableNodeSharingSupportFunctions::new);
  }
  ...
  public record NodeSharingSupportFunctions<Solution_, Entity_, Value_>(
    ...
    public NodeSharingSupportFunctions(
        PlanningVariableMetaModel<Solution_, Entity_, Value_> variableMetaModel) {
      this(
          variableMetaModel,
          (solutionView, entity) -> solutionView.getValue(variableMetaModel, entity) != null,
          (solutionView, entity, value) ->
              !Objects.equals(solutionView.getValue(variableMetaModel, entity), value),
          (solutionView, entity, value) ->
              solutionView.isValueInRange(variableMetaModel, entity, value));
    }
  }
