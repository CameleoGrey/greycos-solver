/**
 * This package contains classes and interfaces that represent the metamodel of the cotwin. This
 * meta-model describes the planning solution, its entities and their variables, typically for use
 * within {@link ai.greycos.solver.core.preview.api.move.Move}s
 *
