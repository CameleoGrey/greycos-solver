...
/**
 * Carries information on if the {@link PlanningSolution} of this score was fully initialized when
 * it was calculated. This only works for solutions where:
 *
 * <ul>
 *   <li>{@link PlanningVariable basic variables} are used, and {@link
 *       PlanningVariable#allowsUnassigned() unassigning} is not allowed.
 *   <li>{@link PlanningListVariable list variables} are used, and {@link
 *       PlanningListVariable#allowsUnassignedValues() unassigned values} are not allowed.
 * </ul>
 *
...
public record InnerScore<Score_ extends Score<Score_>>(Score_ raw, int unassignedCount)
  ...
  public static <Score_ extends Score<Score_>> InnerScore<Score_> withUnassignedCount(
      Score_ score, int unassignedCount) {
