...
public class KOptMove<Solution_> extends AbstractMove<Solution_> {
  ...
  // TODO remove me to enable multithreaded solving, but first fix
  ...
  public boolean isMoveDoable(ScoreDirector<Solution_> scoreDirector) {
    ...
    for (Object value : values) {
      Object anchor =
          variableDescriptor.isValuePotentialAnchor(value)
              ? value
  ...
  public KOptMove<Solution_> rebase(ScoreDirector<Solution_> destinationScoreDirector) {
    throw new UnsupportedOperationException(
        "https://issues.redhat.com/browse/PLANNER-1250"); // TODO test also disabled
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(entity, kOptMove.entity) && Arrays.equals(values, kOptMove.values);
  }
