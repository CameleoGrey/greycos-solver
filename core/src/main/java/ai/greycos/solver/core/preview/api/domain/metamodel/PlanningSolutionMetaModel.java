...
/**
 * Represents the meta-model of a {@link PlanningSolution}. Allows access to information about all
 * the entities and variables.
 *
...
public interface PlanningSolutionMetaModel<Solution_> {
  ...
  /**
   * Returns the meta-models of @{@link PlanningEntity planning entities} known to the solution,
   * genuine or shadow.
   *
  ...
  /**
   * Returns the meta-models of genuine @{@link PlanningEntity planning entities} known to the
   * solution.
   *
