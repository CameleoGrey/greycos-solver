...
final class HardMediumSoftBigDecimalScoreContext
  ...
  public HardMediumSoftBigDecimalScoreContext(
      HardMediumSoftBigDecimalScoreInliner parent,
      AbstractConstraint<?, ?, ?> constraint,
      HardMediumSoftBigDecimalScore constraintWeight) {
    super(parent, constraint, constraintWeight);
  }

  public ScoreImpact<HardMediumSoftBigDecimalScore> changeSoftScoreBy(
  ...
  public ScoreImpact<HardMediumSoftBigDecimalScore> changeMediumScoreBy(
      BigDecimal matchWeight,
      @Nullable ConstraintMatchSupplier<HardMediumSoftBigDecimalScore> constraintMatchSupplier) {
  ...
  public ScoreImpact<HardMediumSoftBigDecimalScore> changeHardScoreBy(
      BigDecimal matchWeight,
      @Nullable ConstraintMatchSupplier<HardMediumSoftBigDecimalScore> constraintMatchSupplier) {
  ...
  public ScoreImpact<HardMediumSoftBigDecimalScore> changeScoreBy(
      BigDecimal matchWeight,
      @Nullable ConstraintMatchSupplier<HardMediumSoftBigDecimalScore> constraintMatchSupplier) {
    var hardImpact = constraintWeight.hardScore().multiply(matchWeight);
    var mediumImpact = constraintWeight.mediumScore().multiply(matchWeight);
  ...
  private record SoftImpact(HardMediumSoftBigDecimalScoreInliner inliner, BigDecimal impact)
      implements ScoreImpact<HardMediumSoftBigDecimalScore> {
  ...
  private record ComplexImpact(
      HardMediumSoftBigDecimalScoreInliner inliner,
