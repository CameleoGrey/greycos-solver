...
public non-sealed interface PlanningListVariableMetaModel<Solution_, Entity_, Value_>
  ...
  /**
   * Returns whether the planning variable allows values not to be assigned to any entity's list
   * variable.
   *
   * @return {@code true} if the planning variable allows unassigned values, {@code false}
   *     otherwise.
   */
