...
import ai.greycos.solver.core.impl.bavet.quad.MapQuadToUniNode;
...
final class BavetUniMapQuadConstraintStream<Solution_, A, B, C, D, NewA>
  ...
  public BavetUniMapQuadConstraintStream(
      BavetConstraintFactory<Solution_> constraintFactory,
      BavetAbstractQuadConstraintStream<Solution_, A, B, C, D> parent,
      QuadFunction<A, B, C, D, NewA> mappingFunction) {
  ...
  public boolean equals(Object object) {
    ...
    BavetUniMapQuadConstraintStream<?, ?, ?, ?, ?, ?> that =
        (BavetUniMapQuadConstraintStream<?, ?, ?, ?, ?, ?>) object;
