...
public final class Group0Mapping4CollectorBiNode<
        OldA,
        OldB,
        A,
        B,
        ...
        ResultContainerC_,
        ResultContainerD_>
    extends AbstractGroupBiNode<
        OldA, OldB, QuadTuple<A, B, C, D>, Void, Object, Quadruple<A, B, C, D>> {

  private final int outputStoreSize;

  public Group0Mapping4CollectorBiNode(
      int groupStoreIndex,
      int undoStoreIndex,
  ...
  private static <
      ...
      BiConstraintCollector<OldA, OldB, Object, Quadruple<A, B, C, D>> mergeCollectors(
          ...
          BiConstraintCollector<OldA, OldB, ResultContainerC_, C> collectorC,
          BiConstraintCollector<OldA, OldB, ResultContainerD_, D> collectorD) {
    return (BiConstraintCollector<OldA, OldB, Object, Quadruple<A, B, C, D>>)
