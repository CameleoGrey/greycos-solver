...
public final class Group4Mapping0CollectorUniNode<OldA, A, B, C, D>
  ...
  private static <A, B, C, D, OldA> Quadruple<A, B, C, D> createGroupKey(
      Function<OldA, A> groupKeyMappingA,
      Function<OldA, B> groupKeyMappingB,
      Function<OldA, C> groupKeyMappingC,
      Function<OldA, D> groupKeyMappingD,
    ...
    return new Quadruple<>(
        groupKeyMappingA.apply(oldA),
        groupKeyMappingB.apply(oldA),
        groupKeyMappingC.apply(oldA),
