...
public final class ToListUniNeighborhoodsCollector<Solution_, A, Mapped_>
    implements UniNeighborhoodsCollector<
        Solution_, A, AbstractToListSlot.State<Mapped_>, List<Mapped_>> {
  ...
  public static <Solution_, A, Mapped_>
      ToListUniNeighborhoodsCollector<Solution_, A, Mapped_> create(
  ...
  @Override
  public UniNeighborhoodsCollectorAccumulator<Solution_, A, AbstractToListSlot.State<Mapped_>>
      accumulator() {
