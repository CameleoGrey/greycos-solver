...
import ai.greycos.solver.core.impl.score.stream.collector.LongCalculator;

import org.jspecify.annotations.NonNull;

abstract sealed class LongCalculatorTriCollector<
        A, B, C, Output_, Calculator_ extends LongCalculator<Output_>>
    implements TriConstraintCollector<A, B, C, Calculator_, Output_>
    permits AverageLongTriCollector, SumLongTriCollector {
