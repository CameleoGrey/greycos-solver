package ai.greycos.solver.core.preview.api.domain.metamodel;
...
/**
 * Represents the meta-model of an entity. Gives access to the entity's variable meta-models.
 *
...
public interface PlanningEntityMetaModel<Solution_, Entity_> {
   ...
   * @throws IllegalArgumentException if the variable does not exist on the entity, or is not
   *     genuine
   */
  @SuppressWarnings("unchecked")
  default <Value_> GenuineVariableMetaModel<Solution_, Entity_, Value_> genuineVariable(
    ...
    if (!(variable instanceof GenuineVariableMetaModel<Solution_, Entity_, ?> genuineVariable)) {
      throw new IllegalArgumentException(
          "The variableName (%s) exists among variables (%s) but is not genuine."
  ...
  default <Value_> GenuineVariableMetaModel<Solution_, Entity_, Value_> genuineVariable(
    ...
    if (!(variable
        instanceof GenuineVariableMetaModel<Solution_, Entity_, Value_> genuineVariable)) {
      throw new IllegalArgumentException(
          "The variableName (%s) exists among variables (%s) but is not genuine."
              .formatted(variableName, variables()));
    }
   ...
   */
  @SuppressWarnings("unchecked")
  default <Value_> VariableMetaModel<Solution_, Entity_, Value_> variable(
      String variableName, Class<Value_> variableClass) {
    for (var variableMetaModel : variables()) {
      if (variableMetaModel.name().equals(variableName)) {
   ...
   * @see #variable(String) Method to retrieve the variable's meta-model, or fail if it is not
   *     present.
   */
  ...
  /**
   * As defined by {@link #genuineVariable()}, but only succeeds if the variable is a {@link
   * PlanningVariable basic planning variable}.
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * As defined by {@link #variable(String)}, but only succeeds if the variable is a {@link
   * PlanningVariable basic planning variable}.
   */
  @SuppressWarnings("unchecked")
  default <Value_> PlanningVariableMetaModel<Solution_, Entity_, Value_> basicVariable(
  ...
  /**
   * As defined by {@link #basicVariable(String)}, but only succeeds if the variable is of a given
   * type.
   *
   * @throws IllegalArgumentException if the variable is not of the given type.
   */
  default <Value_> PlanningVariableMetaModel<Solution_, Entity_, Value_> basicVariable(
      String variableName, Class<Value_> variableClass) {
    return (PlanningVariableMetaModel<Solution_, Entity_, Value_>)
        variable(variableName, variableClass);
  }
  ...
  /**
   * As defined by {@link #listVariable(String)}, but only succeeds if the variable is of a given
   * type.
   *
   * @throws IllegalArgumentException if the variable is not of the given type.
   */
  default <Value_> PlanningListVariableMetaModel<Solution_, Entity_, Value_> listVariable(
      String variableName, Class<Value_> variableClass) {
    return (PlanningListVariableMetaModel<Solution_, Entity_, Value_>)
        variable(variableName, variableClass);
  }

  /**
   * As defined by {@link #variable(String)}, but only succeeds if the variable is a shadow
   * variable.
   */
  @SuppressWarnings("unchecked")
  default <Value_> ShadowVariableMetaModel<Solution_, Entity_, Value_> shadowVariable(
      String variableName) {
    return (ShadowVariableMetaModel<Solution_, Entity_, Value_>) variable(variableName);
  }

  /**
   * As defined by {@link #shadowVariable(String)}, but only succeeds if the variable is of a given
   * type.
   *
   * @throws IllegalArgumentException if the variable is not of the given type.
   */
