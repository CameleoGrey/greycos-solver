...
import ai.greycos.solver.core.impl.neighborhood.stream.BiMoveStream;
...
@NullMarked
public final class DefaultBiSamplingStream<Solution_, A, B>
    implements BiSamplingStream<Solution_, A, B> {

  private final UniLeftDataset<Solution_, A> leftDataset;
  private final UniRightDataset<Solution_, A, B> rightDataset;

  public DefaultBiSamplingStream(
