...
/**
 * Allows read-only access to the state of the solution that is being operated on by the {@link
 * Move}.
 *
...
public interface SolutionView<Solution_> {
   ...
   */
  <Entity_, Value_> @Nullable Value_ getValue(
      PlanningVariableMetaModel<Solution_, Entity_, Value_> variableMetaModel, Entity_ entity);

  /**
   * Reads the value of a {@link PlanningListVariable list planning variable} and returns its
   * length.
   *
   * @param variableMetaModel Describes the variable whose value is to be read.
   * @param entity The entity whose variable is to be read.
  ...
  /**
   * Reads the value of a @{@link PlanningListVariable list planning variable} of a given entity at
   * a specific index.
   *
   * @param variableMetaModel Describes the variable whose value is to be read.
   * @param entity The entity whose variable is to be read.
   ...
   *
   * <ul>
   *   <li>the entity's {@link PlanningPin} field,
   *   <li>the entity's {@link PlanningPinToIndex} field,
   *   <li>and the value's position in the list variable.
   * </ul>
   *
  ...
  /**
   * Checks if a given value is present in the value range of a genuine planning variable. If the
