  ...
  public ElementPosition next() {
    ...
    if (allowsUnassignedValues && random == 0) {
      ...
      if (value == null) {
        ...
        // This is effectively an off-by-N error where the filtering selectors report incorrect
        // sizes
        // on account of not knowing how many values are going to be filtered out.
        // As a fallback, start picking random unpinned destinations until the iteration stops
        // externally.
        ...
        // Some selectors, like FilteringValueRangeSelector can still return unassigned values when
        // bailing out
        return ElementPosition.unassigned();
      }
    }
