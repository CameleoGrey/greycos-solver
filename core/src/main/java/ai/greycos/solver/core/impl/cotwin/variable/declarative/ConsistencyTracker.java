...
public record ConsistencyTracker<Solution_>(
   ...
   *       ai.greycos.solver.core.api.cotwin.variable.ShadowVariablesInconsistent} member.
   *   <li>Have a {@link ai.greycos.solver.core.api.cotwin.variable.ShadowVariablesInconsistent}
   *       member that is null.
   * </ul>
   *
   * If an entity has a {@link
   * ai.greycos.solver.core.api.cotwin.variable.ShadowVariablesInconsistent} member that is either
