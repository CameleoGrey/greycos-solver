...
public class DefaultCustomPhaseFactory<Solution_>
  ...
  @Override
  public CustomPhase<Solution_> buildPhase(
      int phaseIndex,
    ...
    var customPhaseCommandList_ =
        new ArrayList<PhaseCommand<Solution_>>(getCustomPhaseCommandListSize());
  ...
  private PhaseCommand<Solution_> createCustomPhaseCommand(
      Class<? extends PhaseCommand> customPhaseCommandClass) {
