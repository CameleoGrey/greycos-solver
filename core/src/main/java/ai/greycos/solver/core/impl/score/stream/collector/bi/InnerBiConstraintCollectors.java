...
public class InnerBiConstraintCollectors {
  public static <A, B> BiConstraintCollector<A, B, ?, Double> average(
      ToIntBiFunction<? super A, ? super B> mapper) {
  ...
  public static <
    ...
    return new ComposeFourBiCollector<>(first, second, third, fourth, composeFunction);
  }
  ...
  public static <
    ...
    return new ComposeThreeBiCollector<>(first, second, third, composeFunction);
  }
  ...
  public static <A, B, ResultHolder1_, ResultHolder2_, Result1_, Result2_, Result_>
    ...
    return new ComposeTwoBiCollector<>(first, second, composeFunction);
  }
  ...
  public static <A, B> BiConstraintCollector<A, B, ?, Long> sum(
      ToLongBiFunction<? super A, ? super B> mapper) {
  ...
  public static <A, B, Mapped_, Result_ extends Collection<Mapped_>>
      BiConstraintCollector<A, B, ?, Result_> toCollection(
          BiFunction<? super A, ? super B, ? extends Mapped_> mapper,
  ...
  public static <A, B, Key_, Value_, Result_ extends Map<Key_, Value_>>
      BiConstraintCollector<A, B, ?, Result_> toMap(
          BiFunction<? super A, ? super B, ? extends Key_> keyFunction,
          BiFunction<? super A, ? super B, ? extends Value_> valueFunction,
          Supplier<Result_> mapSupplier,
  ...
  public static <A, B, Result_>
      BiConstraintCollector<A, B, ?, SequenceChain<Result_, Integer>> toConsecutiveSequences(
          BiFunction<A, B, Result_> resultMap, ToIntFunction<Result_> indexMap) {
  ...
  public static <
      ...
      BiConstraintCollector<A, B, ?, ConnectedRangeChain<Interval_, Point_, Difference_>>
          toConnectedRanges(
              BiFunction<? super A, ? super B, ? extends Interval_> mapper,
  ...
  public static <A, B, Intermediate_, Result_>
      BiConstraintCollector<A, B, ?, Result_> collectAndThen(
          BiConstraintCollector<A, B, ?, Intermediate_> delegate,
  ...
  public static <A, B, Balanced_>
      BiConstraintCollector<A, B, ?, LoadBalance<Balanced_>> loadBalance(
          BiFunction<A, B, Balanced_> balancedItemFunction,
          ToLongBiFunction<A, B> loadFunction,
