...
import ai.greycos.solver.core.impl.heuristic.selector.entity.mimic.EntityMimicRecorder;
...
import ai.greycos.solver.core.impl.heuristic.selector.value.mimic.ValueMimicRecorder;
...
public class HeuristicConfigPolicy<Solution_> {
  ...
  private final Map<String, EntityMimicRecorder<Solution_>> entityMimicRecorderMap =
      new HashMap<>();
  private final Map<String, SubListMimicRecorder<Solution_>> subListMimicRecorderMap =
      new HashMap<>();
  ...
  public void addEntityMimicRecorder(
      String id, EntityMimicRecorder<Solution_> mimicRecordingEntitySelector) {
  ...
  public void addSubListMimicRecorder(
      String id, SubListMimicRecorder<Solution_> mimicRecordingSubListSelector) {
  ...
  public void addValueMimicRecorder(
      String id, ValueMimicRecorder<Solution_> mimicRecordingValueSelector) {
  ...
  public static class Builder<Solution_> {
    ...
    public Builder<Solution_> withThreadFactoryClass(
    ...
    public Builder<Solution_> withInitializingScoreTrend(
        InitializingScoreTrend initializingScoreTrend) {
      this.initializingScoreTrend = initializingScoreTrend;
      return this;
    }

    public Builder<Solution_> withSolutionDescriptor(
