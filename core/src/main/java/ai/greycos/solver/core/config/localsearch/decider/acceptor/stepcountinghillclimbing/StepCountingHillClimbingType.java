package ai.greycos.solver.core.config.localsearch.decider.acceptor.stepcountinghillclimbing;
...
public enum StepCountingHillClimbingType {
   ...
   *
   * <p>Note: If {@link LocalSearchForagerConfig#getAcceptedCountLimit()} = 1, then this behaves
   * exactly the same as {link #STEP}.
   */
  ACCEPTED_MOVE,
