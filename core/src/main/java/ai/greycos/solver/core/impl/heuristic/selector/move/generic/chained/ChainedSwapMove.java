...
public class ChainedSwapMove<Solution_> extends SwapMove<Solution_> {
  ...
  public ChainedSwapMove(
    ...
    for (SingletonInverseVariableSupply inverseVariableSupply : inverseVariableSupplyList) {
      ...
      oldLeftTrailingEntityList.add(
          hasSupply ? inverseVariableSupply.getInverseSingleton(leftEntity) : null);
      oldRightTrailingEntityList.add(
          hasSupply ? inverseVariableSupply.getInverseSingleton(rightEntity) : null);
    }
  }

  public ChainedSwapMove(
      List<GenuineVariableDescriptor<Solution_>> genuineVariableDescriptors,
      Object leftEntity,
      Object rightEntity,
          ...
          if (oldRightValue == leftEntity) {
            ...
            if (oldRightTrailingEntity != null) {
              castScoreDirector.changeVariableFacade(
                  variableDescriptor, oldRightTrailingEntity, leftEntity);
            }
            ...
            if (oldLeftTrailingEntity != null) {
              castScoreDirector.changeVariableFacade(
                  variableDescriptor, oldLeftTrailingEntity, rightEntity);
            }
          } else {
            // Change the left entity
            castScoreDirector.changeVariableFacade(variableDescriptor, leftEntity, oldRightValue);
