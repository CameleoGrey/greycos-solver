 ...
 *
 * <p>Do not create a new child {@link Solver} to implement a new heuristic or metaheuristic, just
 * use a new {@link Phase} for that.
 *
...
public abstract class AbstractSolver<Solution_> implements Solver<Solution_> {
  ...
  public void solvingStarted(SolverScope<Solution_> solverScope) {
    ...
    // Using value range manager from the same score director as the working solution; this is a
    // correct use.
  ...
  /**
   * Add a {@link PhaseLifecycleListener} that is notified of {@link
   * PhaseLifecycleListener#solvingStarted(SolverScope) solving} events and also of the {@link
   * PhaseLifecycleListener#phaseStarted(AbstractPhaseScope) phase} and the {@link
   * PhaseLifecycleListener#stepStarted(AbstractStepScope) step} starting/ending events of all
   * phases.
   *
   * <p>To get notified for only 1 phase, use {@link
   * Phase#addPhaseLifecycleListener(PhaseLifecycleListener)} instead.
   *
