...
public final class Group4Mapping0CollectorQuadNode<OldA, OldB, OldC, OldD, A, B, C, D>
    extends AbstractGroupQuadNode<
        OldA, OldB, OldC, OldD, QuadTuple<A, B, C, D>, Quadruple<A, B, C, D>, Void, Void> {

  private final int outputStoreSize;

  public Group4Mapping0CollectorQuadNode(
  ...
  private static <A, B, C, D, OldA, OldB, OldC, OldD> Quadruple<A, B, C, D> createGroupKey(
    ...
    return new Quadruple<>(
        groupKeyMappingA.apply(oldA, oldB, oldC, oldD),
        groupKeyMappingB.apply(oldA, oldB, oldC, oldD),
        groupKeyMappingC.apply(oldA, oldB, oldC, oldD),
        groupKeyMappingD.apply(oldA, oldB, oldC, oldD));
  }
