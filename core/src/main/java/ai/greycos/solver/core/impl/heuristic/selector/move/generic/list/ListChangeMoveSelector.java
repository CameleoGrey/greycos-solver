...
public class ListChangeMoveSelector<Solution_> extends GenericMoveSelector<Solution_> {
  ...
  public ListChangeMoveSelector(
    ...
    this.sourceValueSelector =
        filterPinnedListPlanningVariableValuesWithIndex(
            sourceValueSelector, this::getListVariableStateSupply);
  ...
  public static <Solution_>
      IterableValueSelector<Solution_> filterPinnedListPlanningVariableValuesWithIndex(
          IterableValueSelector<Solution_> sourceValueSelector,
        ...
        FilteringValueSelector.of(
            ...
            (scoreDirector, selection) -> {
              ...
              return !listVariableDescriptor.isElementPinned(
                  scoreDirector.getWorkingSolution(), entity, elementDestination.index());
            });
  }
  ...
  public Iterator<Move<Solution_>> iterator() {
    if (randomSelection) {
      return new RandomListChangeIterator<>(
          listVariableStateSupply, sourceValueSelector, destinationSelector);
    } else {
  ...
  public boolean isNeverEnding() {
    return randomSelection
        || sourceValueSelector.isNeverEnding()
        || destinationSelector.isNeverEnding();
  }
