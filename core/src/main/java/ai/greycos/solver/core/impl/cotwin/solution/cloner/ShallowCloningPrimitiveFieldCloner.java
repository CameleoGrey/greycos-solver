...
/**
 * Copies values of primitive fields from one object to another. Unlike {@link
 * ShallowCloningReferenceFieldCloner}, this does not use method handles, as we prefer to avoid
...
final class ShallowCloningPrimitiveFieldCloner implements ShallowCloningFieldCloner {
  ...
  ShallowCloningPrimitiveFieldCloner(
      Field field, TriConsumer<Field, Object, Object> copyOperation) {
