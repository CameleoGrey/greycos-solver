...
import ai.greycos.solver.core.impl.bavet.bi.FlattenBiNode;
...
final class BavetFlattenBiConstraintStream<Solution_, A, B, NewC>
  ...
  public BavetFlattenBiConstraintStream(
      BavetConstraintFactory<Solution_> constraintFactory,
      BavetAbstractBiConstraintStream<Solution_, A, B> parent,
      BiFunction<A, B, Iterable<NewC>> mappingFunction) {
