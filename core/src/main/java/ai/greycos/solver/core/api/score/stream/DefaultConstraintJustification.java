...
/**
 * Default implementation of {@link ConstraintJustification}, returned by {@link
 * ConstraintMatch#getJustification()} unless the user defined a custom justification mapping.
 */
public final class DefaultConstraintJustification
  ...
  public static @NonNull DefaultConstraintJustification of(
      Score<?> impact, Object factA, Object factB) {
    return of(impact, Arrays.asList(factA, factB));
  }

  public static @NonNull DefaultConstraintJustification of(
      Score<?> impact, Object factA, Object factB, Object factC) {
    return of(impact, Arrays.asList(factA, factB, factC));
  }

  public static @NonNull DefaultConstraintJustification of(
      Score<?> impact, Object factA, Object factB, Object factC, Object factD) {
    ...
    if (left == right) {
      ...
      if (left instanceof Comparable comparable) {
        return comparable.compareTo(right);
          ...
          left, right)) { // They are not comparable, but at least they're equal.
        return 0;
