...
public final class FilteringEntitySelector<Solution_>
  ...
  public static <Solution_> FilteringEntitySelector<Solution_> of(
    ...
    if (childEntitySelector instanceof FilteringEntitySelector<Solution_> filteringEntitySelector) {
      return new FilteringEntitySelector<>(
  ...
  private FilteringEntitySelector(
      EntitySelector<Solution_> childEntitySelector, SelectionFilter<Solution_, Object> filter) {
  ...
  public Iterator<Object> iterator() {
    return new JustInTimeFilteringEntityIterator(
        childEntitySelector.iterator(), determineBailOutSize());
  }
  ...
  protected class JustInTimeFilteringEntityIterator extends UpcomingSelectionIterator<Object> {
    ...
    public JustInTimeFilteringEntityIterator(
        Iterator<Object> childEntityIterator, long bailOutSize) {
    ...
    protected Object createUpcomingSelection() {
      ...
      do {
        ...
        if (bailOutEnabled) {
          // if childEntityIterator is neverEnding and nothing is accepted, bail out of the infinite
          // loop
  ...
  public Iterator<Object> endingIterator() {
    return new JustInTimeFilteringEntityIterator(
        childEntitySelector.endingIterator(), determineBailOutSize());
  }
