...
public sealed interface GroupNodeConstructor<Tuple_ extends AbstractTuple>
  ...
  // Group...Node(<keyMappings>, int groupStoreIndex, TupleLifecycle<Tuple_>
  ...
  // ...).
  static <CollectorA_, Tuple_ extends AbstractTuple> GroupNodeConstructor<Tuple_> zeroKeysGroupBy(
  ...
  static <CollectorA_, CollectorB_, Tuple_ extends AbstractTuple>
  ...
  static <CollectorA_, CollectorB_, CollectorC_, Tuple_ extends AbstractTuple>
      GroupNodeConstructor<Tuple_> zeroKeysGroupBy(
          CollectorA_ collectorA,
          CollectorB_ collectorB,
  ...
  static <CollectorA_, CollectorB_, CollectorC_, CollectorD_, Tuple_ extends AbstractTuple>
      GroupNodeConstructor<Tuple_> zeroKeysGroupBy(
          CollectorA_ collectorA,
          CollectorB_ collectorB,
          CollectorC_ collectorC,
  ...
  static <KeyA_, Tuple_ extends AbstractTuple> GroupNodeConstructor<Tuple_> oneKeyGroupBy(
  ...
  static <KeyA_, CollectorB_, Tuple_ extends AbstractTuple>
  ...
  static <KeyA_, CollectorB_, CollectorC_, Tuple_ extends AbstractTuple>
      GroupNodeConstructor<Tuple_> oneKeyGroupBy(
          KeyA_ keyMappingA,
          CollectorB_ collectorB,
          CollectorC_ collectorC,
  ...
  static <KeyA_, CollectorB_, CollectorC_, CollectorD_, Tuple_ extends AbstractTuple>
      GroupNodeConstructor<Tuple_> oneKeyGroupBy(
          KeyA_ keyMappingA,
          CollectorB_ collectorB,
          CollectorC_ collectorC,
  ...
  static <KeyA_, KeyB_, Tuple_ extends AbstractTuple> GroupNodeConstructor<Tuple_> twoKeysGroupBy(
      KeyA_ keyMappingA,
      KeyB_ keyMappingB,
  ...
  static <KeyA_, KeyB_, CollectorC_, Tuple_ extends AbstractTuple>
  ...
  static <KeyA_, KeyB_, CollectorC_, CollectorD_, Tuple_ extends AbstractTuple>
      GroupNodeConstructor<Tuple_> twoKeysGroupBy(
          KeyA_ keyMappingA,
          KeyB_ keyMappingB,
          CollectorC_ collectorC,
  ...
  static <KeyA_, KeyB_, KeyC_, Tuple_ extends AbstractTuple>
  ...
  static <KeyA_, KeyB_, KeyC_, CollectorD_, Tuple_ extends AbstractTuple>
      GroupNodeConstructor<Tuple_> threeKeysGroupBy(
          KeyA_ keyMappingA,
          KeyB_ keyMappingB,
          KeyC_ keyMappingC,
  ...
  static <KeyA_, KeyB_, KeyC_, KeyD_, Tuple_ extends AbstractTuple>
  ...
  @FunctionalInterface
  interface GroupBy0Mapping2CollectorNodeBuilder<
      CollectorA_, CollectorB_, Tuple_ extends AbstractTuple> {
    AbstractNode build(
        int groupStoreIndex,
        int undoStoreIndex,
        CollectorA_ collectorA,
  ...
  interface GroupBy0Mapping3CollectorNodeBuilder<
      CollectorA_, CollectorB_, CollectorC_, Tuple_ extends AbstractTuple> {
    AbstractNode build(
        int groupStoreIndex,
        int undoStoreIndex,
        CollectorA_ collectorA,
  ...
  interface GroupBy0Mapping4CollectorNodeBuilder<
      CollectorA_, CollectorB_, CollectorC_, CollectorD_, Tuple_ extends AbstractTuple> {
    AbstractNode build(
        int groupStoreIndex,
        int undoStoreIndex,
        CollectorA_ collectorA,
  ...
  @FunctionalInterface
  interface GroupBy3Mapping0CollectorNodeBuilder<
  ...
  @FunctionalInterface
  interface GroupBy4Mapping0CollectorNodeBuilder<
      KeyA_, KeyB_, KeyC_, KeyD_, Tuple_ extends AbstractTuple> {
    AbstractNode build(
        KeyA_ keyMappingA,
        KeyB_ keyMappingB,
        KeyC_ keyMappingC,
  ...
  interface GroupBy1Mapping2CollectorNodeBuilder<
      KeyA_, CollectorB_, CollectorC_, Tuple_ extends AbstractTuple> {
    AbstractNode build(
        KeyA_ keyMapping,
        int groupStoreIndex,
        int undoStoreIndex,
  ...
  interface GroupBy1Mapping3CollectorNodeBuilder<
      KeyA_, CollectorB_, CollectorC_, CollectorD_, Tuple_ extends AbstractTuple> {
    AbstractNode build(
        KeyA_ keyMapping,
        int groupStoreIndex,
        int undoStoreIndex,
  ...
  interface GroupBy2Mapping1CollectorNodeBuilder<
      KeyA_, KeyB_, CollectorC_, Tuple_ extends AbstractTuple> {
    AbstractNode build(
        KeyA_ keyMappingA,
        KeyB_ keyMappingB,
        int groupStoreIndex,
  ...
  interface GroupBy2Mapping2CollectorNodeBuilder<
      KeyA_, KeyB_, CollectorC_, CollectorD_, Tuple_ extends AbstractTuple> {
    AbstractNode build(
        KeyA_ keyMappingA,
        KeyB_ keyMappingB,
        int groupStoreIndex,
  ...
  interface GroupBy3Mapping1CollectorNodeBuilder<
      KeyA_, KeyB_, KeyC_, CollectorD_, Tuple_ extends AbstractTuple> {
    AbstractNode build(
        KeyA_ keyMappingA,
        KeyB_ keyMappingB,
        KeyC_ keyMappingC,
