...
public class MimicRecordingValueSelector<Solution_> extends AbstractDemandEnabledSelector<Solution_>
  ...
  @Override
  public void addMimicReplayingValueSelector(
  ...
  private class RecordingValueIterator extends SelectionIterator<Object> {
    ...
    public boolean hasNext() {
      ...
      for (MimicReplayingValueSelector<Solution_> replayingValueSelector :
  ...
  public boolean equals(Object other) {
    ...
    return Objects.equals(childValueSelector, that.childValueSelector)
        && Objects.equals(
            replayingValueSelectorList.size(), that.replayingValueSelectorList.size());
  }
