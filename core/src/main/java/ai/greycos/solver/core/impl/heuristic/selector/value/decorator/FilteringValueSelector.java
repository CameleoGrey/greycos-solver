...
public class FilteringValueSelector<Solution_> extends AbstractDemandEnabledSelector<Solution_>
  ...
  public static <Solution_> ValueSelector<Solution_> of(
      ValueSelector<Solution_> valueSelector, SelectionFilter<Solution_, Object> filter) {
    if (valueSelector instanceof IterableFilteringValueSelector<Solution_> filteringValueSelector) {
      ...
      return new FilteringValueSelector<>(
  ...
  protected FilteringValueSelector(
      ValueSelector<Solution_> childValueSelector, SelectionFilter<Solution_, Object> filter) {
  ...
  public Iterator<Object> iterator(Object entity) {
    return new JustInTimeFilteringValueIterator(
        childValueSelector.iterator(entity), determineBailOutSize(entity));
  }
  ...
  public Iterator<Object> endingIterator(Object entity) {
    return new JustInTimeFilteringValueIterator(
        childValueSelector.endingIterator(entity), determineBailOutSize(entity));
  }
