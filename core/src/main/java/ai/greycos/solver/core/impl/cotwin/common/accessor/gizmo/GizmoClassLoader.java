...
/**
 * Loads a class if we have the Gizmo-generated bytecode for it, otherwise uses the current {@link
 * Thread}'s context {@link ClassLoader}. This implementation is thread-safe.
 */
@NullMarked
public final class GizmoClassLoader extends ClassLoader {

  private final Map<String, byte[]> classNameToBytecodeMap;
  @Nullable private GizmoSupportStatus gizmoSupportStatus;
