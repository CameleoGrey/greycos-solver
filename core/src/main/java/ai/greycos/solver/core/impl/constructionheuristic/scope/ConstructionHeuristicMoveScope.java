package ai.greycos.solver.core.impl.constructionheuristic.scope;

import ai.greycos.solver.core.api.domain.solution.PlanningSolution;
import ai.greycos.solver.core.impl.phase.scope.AbstractMoveScope;
...
public final class ConstructionHeuristicMoveScope<Solution_> extends AbstractMoveScope<Solution_> {
  ...
  public ConstructionHeuristicMoveScope(
