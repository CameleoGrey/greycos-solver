package ai.greycos.solver.core.api.score.director;
...
public interface ScoreDirector<Solution_> {
   ...
   *
   * <p>Because a {@link Score} is best calculated incrementally (by deltas), the {@link
   * ScoreDirector} needs to be notified when its {@link PlanningSolution working solution} changes.
   */
  ...
  /**
   * @deprecated Calling this method by user code is not recommended and will lead to unforeseen
   *     consequences. Use {@link ProblemChange} instead.
   */
  ...
  /**
   * Translates an entity or fact instance (often from another {@link Thread} or JVM) to this {@link
   * ScoreDirector}'s internal working instance. Useful for move rebasing and in a {@link
   * ProblemChange}.
   *
  ...
  /**
   * As defined by {@link #lookUpWorkingObject(Object)}, but doesn't fail fast if no workingObject
   * was ever added for the externalObject. It's recommended to use {@link
   * #lookUpWorkingObject(Object)} instead, especially in move rebasing code.
   *
