...
import ai.greycos.solver.core.impl.bavet.quad.ConcatQuadQuadNode;
...
public final class BavetQuadConcatQuadConstraintStream<Solution_, A, B, C, D>
  ...
  public BavetQuadConcatQuadConstraintStream(
  ...
  public <Score_ extends Score<Score_>> void buildNode(
    ...
    var node =
        nodeConstructor.apply(
            downstream, leftCloneStoreIndex, rightCloneStoreIndex, outputStoreSize);
  ...
  public boolean equals(Object o) {
    ...
    BavetQuadConcatQuadConstraintStream<?, ?, ?, ?, ?> other =
        (BavetQuadConcatQuadConstraintStream<?, ?, ?, ?, ?>) o;
    /*
