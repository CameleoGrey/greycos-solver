...
final class ComposeFourBiCollector<
        A,
        B,
        ResultHolder1_,
        ResultHolder2_,
    ...
    implements BiConstraintCollector<
        A, B, Quadruple<ResultHolder1_, ResultHolder2_, ResultHolder3_, ResultHolder4_>, Result_> {
  ...
  public @NonNull
      TriFunction<
          Quadruple<ResultHolder1_, ResultHolder2_, ResultHolder3_, ResultHolder4_>, A, B, Runnable>
      accumulator() {
