 ...
 * {@link ScoreDirector}'s internal working instance.
 *
...
public interface Rebaser {
  ...
  /**
   * Translates an entity or fact instance (often from another {@link Thread}) to another {@link
   * ScoreDirector}'s internal working instance. Useful for move rebasing and in a {@link
   * ProblemChange} and for multi-threaded solving.
   *
