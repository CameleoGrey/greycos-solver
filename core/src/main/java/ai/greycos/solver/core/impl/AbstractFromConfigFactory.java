package ai.greycos.solver.core.impl;
...
public abstract class AbstractFromConfigFactory<
    Solution_, Config_ extends AbstractConfig<Config_>> {
  ...
  public static <Solution_> EntitySelectorConfig getDefaultEntitySelectorConfigForEntity(
    ...
    var entitySelectorConfig =
        new EntitySelectorConfig().withId(entityClass.getName()).withEntityClass(entityClass);
    return deduceEntitySortManner(configPolicy, entityDescriptor, entitySelectorConfig);
  }

  public static <Solution_> EntitySelectorConfig deduceEntitySortManner(
  ...
  protected EntityDescriptor<Solution_> deduceEntityDescriptor(
      HeuristicConfigPolicy<Solution_> configPolicy, Class<?> entityClass) {
  ...
  private EntityDescriptor<Solution_> getEntityDescriptorForClass(
  ...
  protected EntityDescriptor<Solution_> getTheOnlyEntityDescriptor(
  ...
  protected EntityDescriptor<Solution_> getTheOnlyEntityDescriptorWithBasicVariables(
      SolutionDescriptor<Solution_> solutionDescriptor) {
  ...
  protected GenuineVariableDescriptor<Solution_> deduceGenuineVariableDescriptor(
  ...
  protected GenuineVariableDescriptor<Solution_> getVariableDescriptorForName(
      EntityDescriptor<Solution_> entityDescriptor, String variableName) {
  ...
  protected GenuineVariableDescriptor<Solution_> getTheOnlyVariableDescriptor(
      EntityDescriptor<Solution_> entityDescriptor) {
