...
public final class BiJoinerComber<A, B> {
  ...
  private static <A, B> @Nullable BiPredicate<A, B> mergeFiltering(
  ...
  public BiJoinerComber(
      DefaultBiJoiner<A, B> mergedJoiner, @Nullable BiPredicate<A, B> mergedFiltering) {
