...
public interface InnerBiConstraintStream<A, B> extends BiConstraintStream<A, B> {
  ...
  static <A, B>
      TriFunction<A, B, Score<?>, DefaultConstraintJustification>
  ...
  default <C> @NonNull TriConstraintStream<A, B, C> join(
      @NonNull Class<C> otherClass, TriJoiner<A, B, C>... joiners) {
  ...
  @Override
  default @NonNull <C> BiConstraintStream<A, B> ifExists(
      @NonNull Class<C> otherClass, TriJoiner<A, B, C> @NonNull ... joiners) {
    return switch (getRetrievalSemantics()) {
  ...
  @Override
  default @NonNull <C> BiConstraintStream<A, B> ifExistsIncludingUnassigned(
      @NonNull Class<C> otherClass, @NonNull TriJoiner<A, B, C> @NonNull ... joiners) {
    return switch (getRetrievalSemantics()) {
      case STANDARD ->
  ...
  default @NonNull <Score_ extends Score<Score_>>
      BiConstraintBuilder<A, B, Score_> penalizeBigDecimal(
  ...
  @Override
  default BiConstraintBuilder<A, B, ?> penalizeConfigurableLong(
      ToLongBiFunction<A, B> matchWeigher) {
    return innerImpact(null, matchWeigher, ScoreImpactType.PENALTY);
  }

  @Override
  default BiConstraintBuilder<A, B, ?> penalizeConfigurableBigDecimal(
  ...
  default <Score_ extends Score<Score_>>
      @NonNull BiConstraintBuilder<A, B, Score_> rewardBigDecimal(
          @NonNull Score_ constraintWeight, @NonNull BiFunction<A, B, BigDecimal> matchWeigher) {
    return innerImpact(constraintWeight, matchWeigher, ScoreImpactType.REWARD);
  }
  ...
  @Override
  default BiConstraintBuilder<A, B, ?> rewardConfigurableBigDecimal(
      BiFunction<A, B, BigDecimal> matchWeigher) {
    return innerImpact(null, matchWeigher, ScoreImpactType.REWARD);
  }
  ...
  @Override
  default <Score_ extends Score<Score_>>
      @NonNull BiConstraintBuilder<A, B, Score_> impactBigDecimal(
          @NonNull Score_ constraintWeight, @NonNull BiFunction<A, B, BigDecimal> matchWeigher) {
    return innerImpact(constraintWeight, matchWeigher, ScoreImpactType.MIXED);
  }
  ...
  @Override
  default BiConstraintBuilder<A, B, ?> impactConfigurableBigDecimal(
      BiFunction<A, B, BigDecimal> matchWeigher) {
    return innerImpact(null, matchWeigher, ScoreImpactType.MIXED);
  }

  <Score_ extends Score<Score_>> BiConstraintBuilder<A, B, Score_> innerImpact(
      Score_ constraintWeight, ToIntBiFunction<A, B> matchWeigher, ScoreImpactType scoreImpactType);
