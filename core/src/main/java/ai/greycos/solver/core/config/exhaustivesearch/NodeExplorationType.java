...
import ai.greycos.solver.core.impl.exhaustivesearch.node.comparator.BreadthFirstNodeComparator;
import ai.greycos.solver.core.impl.exhaustivesearch.node.comparator.DepthFirstNodeComparator;
import ai.greycos.solver.core.impl.exhaustivesearch.node.comparator.OptimisticBoundFirstNodeComparator;
import ai.greycos.solver.core.impl.exhaustivesearch.node.comparator.OriginalOrderNodeComparator;
    ...
    switch (this) {
      ...
      default:
        throw new IllegalStateException(
            "The nodeExplorationType (" + this + ") is not implemented.");
    }
  }
}
