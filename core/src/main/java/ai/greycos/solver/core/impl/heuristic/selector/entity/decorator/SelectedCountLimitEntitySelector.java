...
public final class SelectedCountLimitEntitySelector<Solution_>
  ...
  public SelectedCountLimitEntitySelector(
  ...
  public Iterator<Object> endingIterator() {
    if (randomSelection) {
      ...
      // so it's illegal to only return the first n elements in original order (that breaks
      // NearbySelection)
  ...
  public boolean equals(Object other) {
    ...
    return randomSelection == that.randomSelection
        && selectedCountLimit == that.selectedCountLimit
