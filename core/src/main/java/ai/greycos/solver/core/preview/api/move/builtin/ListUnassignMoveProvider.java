...
public class ListUnassignMoveProvider<Solution_, Entity_, Value_>
  ...
  public ListUnassignMoveProvider(
  ...
  public MoveStream<Solution_> build(MoveStreamFactory<Solution_> moveStreamFactory) {
    return moveStreamFactory
        .pick(moveStreamFactory.forEachAssignedValue(variableMetaModel))
        .asMove(
            (view, value) ->
                Moves.unassign(
                    variableMetaModel,
                    view.getPositionOf(variableMetaModel, Objects.requireNonNull(value))
                        .ensureAssigned()));
  }
}
