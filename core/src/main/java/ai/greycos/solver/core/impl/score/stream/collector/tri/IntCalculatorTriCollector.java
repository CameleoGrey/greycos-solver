...
import ai.greycos.solver.core.impl.score.stream.collector.IntCalculator;

import org.jspecify.annotations.NonNull;

abstract sealed class IntCalculatorTriCollector<
        A, B, C, Output_, Calculator_ extends IntCalculator<Output_>>
    implements TriConstraintCollector<A, B, C, Calculator_, Output_>
    permits AverageIntTriCollector, SumIntTriCollector {
