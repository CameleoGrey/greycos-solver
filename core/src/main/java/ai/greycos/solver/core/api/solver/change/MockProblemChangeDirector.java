...
/**
 * Use for unit-testing {@link ProblemChange}s. Together with Mockito this class makes it possible
 * to verify that a {@link ProblemChange} implementation correctly calls methods of the {@link
...
public class MockProblemChangeDirector implements ProblemChangeDirector {
  ...
  public <Entity> void changeVariable(
      Entity entity, String variableName, Consumer<Entity> entityConsumer) {
    entityConsumer.accept(this.lookUpWorkingObject(entity));
  }
   ...
   */
  @Override
  public <EntityOrProblemFact> @Nullable EntityOrProblemFact lookUpWorkingObject(
