 ...
 *
 * <p>If you need an instance created, use {@link ConstraintRef#of(String)} and not the record's
 * constructors.
 *
 * @param id The constraint id. It must be unique.
 */
@NullMarked
public record ConstraintRef(String id) implements Comparable<ConstraintRef> {
