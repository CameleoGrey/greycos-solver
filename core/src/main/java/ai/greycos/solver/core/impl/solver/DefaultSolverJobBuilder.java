...
public final class DefaultSolverJobBuilder<Solution_, ProblemId_>
  ...
  public DefaultSolverJobBuilder(DefaultSolverManager<Solution_, ProblemId_> solverManager) {
    this.solverManager =
        Objects.requireNonNull(
            solverManager, "The SolverManager (" + solverManager + ") cannot be null.");
  }

  @Override
  public @NonNull SolverJobBuilder<Solution_, ProblemId_> withProblemId(
      @NonNull ProblemId_ problemId) {
    this.problemId =
        Objects.requireNonNull(problemId, "Invalid problemId (null) given to SolverJobBuilder.");
    return this;
  }

  @Override
  public @NonNull SolverJobBuilder<Solution_, ProblemId_> withProblemFinder(
      @NonNull Function<? super ProblemId_, ? extends Solution_> problemFinder) {
    this.problemFinder =
        Objects.requireNonNull(
            problemFinder, "Invalid problemFinder (null) given to SolverJobBuilder.");
    return this;
  }

  @Override
  public @NonNull SolverJobBuilder<Solution_, ProblemId_> withBestSolutionEventConsumer(
      @NonNull Consumer<NewBestSolutionEvent<Solution_>> bestSolutionConsumer) {
    this.bestSolutionConsumer =
        Objects.requireNonNull(
            bestSolutionConsumer, "Invalid bestSolutionConsumer (null) given to SolverJobBuilder.");
    return this;
  }

  @Override
  public @NonNull SolverJobBuilder<Solution_, ProblemId_> withFinalBestSolutionEventConsumer(
  ...
  @Override
  public @NonNull SolverJobBuilder<Solution_, ProblemId_> withFirstInitializedSolutionEventConsumer(
      @NonNull Consumer<FirstInitializedSolutionEvent<Solution_>>
          firstInitializedSolutionConsumer) {
    this.initializedSolutionConsumer =
        Objects.requireNonNull(
            firstInitializedSolutionConsumer,
  ...
  @Override
  public SolverJobBuilder<Solution_, ProblemId_> withSolverJobStartedEventConsumer(
      Consumer<SolverJobStartedEvent<Solution_>> solverJobStartedConsumer) {
    this.solverJobStartedConsumer =
        Objects.requireNonNull(
  ...
  @Override
  public @NonNull SolverJobBuilder<Solution_, ProblemId_> withExceptionHandler(
      @NonNull BiConsumer<? super ProblemId_, ? super Throwable> exceptionHandler) {
    this.exceptionHandler =
        Objects.requireNonNull(
            exceptionHandler, "Invalid exceptionHandler (null) given to SolverJobBuilder.");
    return this;
  }

  @Override
  public @NonNull SolverJobBuilder<Solution_, ProblemId_> withConfigOverride(
      @NonNull SolverConfigOverride<Solution_> solverConfigOverride) {
    this.solverConfigOverride =
        Objects.requireNonNull(
            solverConfigOverride, "Invalid solverConfigOverride (null) given to SolverJobBuilder.");
    return this;
  }
