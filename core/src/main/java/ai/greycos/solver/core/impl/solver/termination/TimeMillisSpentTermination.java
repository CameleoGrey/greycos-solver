...
@NullMarked
final class TimeMillisSpentTermination<Solution_> extends AbstractUniversalTermination<Solution_>
  ...
  public TimeMillisSpentTermination(long timeMillisSpentLimit) {
    ...
    if (timeMillisSpentLimit < 0L) {
      throw new IllegalArgumentException(
          "The timeMillisSpentLimit (%d) cannot be negative.".formatted(timeMillisSpentLimit));
    }
  }
