...
import static ai.greycos.solver.core.config.solver.termination.TerminationConfig.requireNonNegative;
...
public class DiminishedReturnsTerminationConfig
  ...
  // ************************************************************************
  @NonNull
  public DiminishedReturnsTerminationConfig withSlidingWindowDuration(
      @NonNull Duration slidingWindowDuration) {
    this.slidingWindowDuration = slidingWindowDuration;
    return this;
  }

  @NonNull
  public DiminishedReturnsTerminationConfig withSlidingWindowMilliseconds(
      @NonNull Long slidingWindowMilliseconds) {
    this.slidingWindowMilliseconds = slidingWindowMilliseconds;
    return this;
  }

  @NonNull
  public DiminishedReturnsTerminationConfig withSlidingWindowSeconds(
      @NonNull Long slidingWindowSeconds) {
    this.slidingWindowSeconds = slidingWindowSeconds;
    return this;
  }

  @NonNull
  public DiminishedReturnsTerminationConfig withSlidingWindowMinutes(
      @NonNull Long slidingWindowMinutes) {
    this.slidingWindowMinutes = slidingWindowMinutes;
    return this;
  }

  @NonNull
  public DiminishedReturnsTerminationConfig withSlidingWindowHours(
      @NonNull Long slidingWindowHours) {
    this.slidingWindowHours = slidingWindowHours;
    return this;
  }
  ...
  @NonNull
  public DiminishedReturnsTerminationConfig withMinimumImprovementRatio(
      @NonNull Double minimumImprovementRatio) {
    this.minimumImprovementRatio = minimumImprovementRatio;
    return this;
  }
  ...
  // Complex methods
  @Override
  public @NonNull DiminishedReturnsTerminationConfig inherit(
      @NonNull DiminishedReturnsTerminationConfig inheritedConfig) {
    if (!slidingWindowIsSet()) {
      inheritSlidingWindow(inheritedConfig);
    }
    minimumImprovementRatio =
        ConfigUtils.inheritOverwritableProperty(
            minimumImprovementRatio, inheritedConfig.getMinimumImprovementRatio());
    return this;
  }
  ...
  private void inheritSlidingWindow(@NonNull DiminishedReturnsTerminationConfig parent) {
    slidingWindowDuration =
        ConfigUtils.inheritOverwritableProperty(
            slidingWindowDuration, parent.getSlidingWindowDuration());
    slidingWindowMilliseconds =
        ConfigUtils.inheritOverwritableProperty(
            slidingWindowMilliseconds, parent.getSlidingWindowMilliseconds());
    slidingWindowSeconds =
        ConfigUtils.inheritOverwritableProperty(
            slidingWindowSeconds, parent.getSlidingWindowSeconds());
    slidingWindowMinutes =
        ConfigUtils.inheritOverwritableProperty(
            slidingWindowMinutes, parent.getSlidingWindowMinutes());
    slidingWindowHours =
        ConfigUtils.inheritOverwritableProperty(slidingWindowHours, parent.getSlidingWindowHours());
    slidingWindowDays =
        ConfigUtils.inheritOverwritableProperty(slidingWindowDays, parent.getSlidingWindowDays());
  }
  ...
  public @Nullable Long calculateSlidingWindowMilliseconds() {
    if (slidingWindowMilliseconds == null
        && slidingWindowSeconds == null
        && slidingWindowMinutes == null
        && slidingWindowHours == null
        && slidingWindowDays == null) {
      if (slidingWindowDuration != null) {
        if (slidingWindowDuration.getNano() % 1000 != 0) {
          throw new IllegalArgumentException(
              "The termination slidingWindowDuration ("
                  + slidingWindowDuration
    ...
    if (slidingWindowDuration != null) {
      throw new IllegalArgumentException(
          "The termination slidingWindowDuration ("
              + slidingWindowDuration
              + ") cannot be combined with slidingWindowMilliseconds ("
              + slidingWindowMilliseconds
              + "), slidingWindowSeconds ("
              + slidingWindowSeconds
              + "), slidingWindowMinutes ("
              ...
              + slidingWindowHours
              + "),"
              + ") or slidingWindowDays ("
              + slidingWindowDays
              + ").");
    }
    long slidingWindowMillis =
        0L
