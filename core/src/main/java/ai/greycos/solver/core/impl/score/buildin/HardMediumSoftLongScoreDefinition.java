...
public class HardMediumSoftLongScoreDefinition
  ...
  public HardMediumSoftLongScore fromLevelNumbers(Number[] levelNumbers) {
    ...
    return HardMediumSoftLongScore.of(
        (Long) levelNumbers[0], (Long) levelNumbers[1], (Long) levelNumbers[2]);
  }

  @Override
  public HardMediumSoftLongScore buildOptimisticBound(
      InitializingScoreTrend initializingScoreTrend, HardMediumSoftLongScore score) {
  ...
  @Override
  public HardMediumSoftLongScore buildPessimisticBound(
      InitializingScoreTrend initializingScoreTrend, HardMediumSoftLongScore score) {
    var trendLevels = initializingScoreTrend.trendLevels();
    return HardMediumSoftLongScore.of(
  ...
  @Override
  public HardMediumSoftLongScore divideBySanitizedDivisor(
      HardMediumSoftLongScore dividend, HardMediumSoftLongScore divisor) {
