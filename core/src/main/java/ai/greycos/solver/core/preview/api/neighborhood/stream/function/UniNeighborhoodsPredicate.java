...
public interface UniNeighborhoodsPredicate<Solution_, A>
  ...
  @Override
  default UniNeighborhoodsPredicate<Solution_, A> and(
      BiPredicate<? super SolutionView<Solution_>, ? super A> other) {
    return (UniNeighborhoodsPredicate<Solution_, A>) BiPredicate.super.and(other);
  }
