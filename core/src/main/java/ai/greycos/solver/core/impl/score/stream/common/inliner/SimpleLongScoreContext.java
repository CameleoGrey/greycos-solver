...
final class SimpleLongScoreContext extends ScoreContext<SimpleLongScore, SimpleLongScoreInliner> {
  ...
  public SimpleLongScoreContext(
      SimpleLongScoreInliner parent,
  ...
  public UndoScoreImpacter changeScoreBy(
      long matchWeight, ConstraintMatchSupplier<SimpleLongScore> constraintMatchSupplier) {
    ...
    return impactWithConstraintMatch(
        undoScoreImpact, SimpleLongScore.of(impact), constraintMatchSupplier);
  }
}
