...
final class NotifiableRegistry<Solution_> {
  ...
  void registerNotifiable(
      VariableDescriptor<Solution_> source, EntityNotifiable<Solution_> notifiable) {
    registerNotifiable(Collections.singletonList(source), notifiable);
  }

  void registerNotifiable(
      Collection<VariableDescriptor<Solution_>> sources, EntityNotifiable<Solution_> notifiable) {
  ...
  Collection<VariableListenerNotifiable<Solution_>> get(VariableDescriptor<?> variableDescriptor) {
    var notifiables =
        sourceVariableToNotifiableListArray[variableDescriptor.getEntityDescriptor().getOrdinal()][
  ...
  Collection<
          ListVariableListenerNotifiable<
              Solution_, InnerListVariableListener<Solution_, Object, Object>>>
