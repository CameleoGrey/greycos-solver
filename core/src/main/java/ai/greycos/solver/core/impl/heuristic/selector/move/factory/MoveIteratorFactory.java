 ...
 *
 * <p>For a more simple version, see {@link MoveListFactory}.
 *
...
public interface MoveIteratorFactory<Solution_, Move_ extends Move<Solution_>> {
  ...
  /**
   * Called when the phase (for example Local Search) ends, to clean up anything cached since {@link
   * #phaseStarted(ScoreDirector)}.
   *
   * @param scoreDirector never null
   */
   ...
   * @return the approximate number of elements generated by {@link
