...
public class ChangeMoveSelectorConfig extends MoveSelectorConfig<ChangeMoveSelectorConfig>
  ...
  public @NonNull ChangeMoveSelectorConfig withEntitySelectorConfig(
      @NonNull EntitySelectorConfig entitySelectorConfig) {
    this.setEntitySelectorConfig(entitySelectorConfig);
    return this;
  }

  public @NonNull ChangeMoveSelectorConfig withValueSelectorConfig(
  ...
  @Override
  public @NonNull ChangeMoveSelectorConfig inherit(
      @NonNull ChangeMoveSelectorConfig inheritedConfig) {
