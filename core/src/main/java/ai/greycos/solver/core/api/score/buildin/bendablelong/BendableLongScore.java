...
public final class BendableLongScore implements IBendableScore<BendableLongScore> {
  ...
  public static BendableLongScore parseScore(String scoreString) {
    ...
    for (var i = 0; i < hardScores.length; i++) {
      hardScores[i] =
          ScoreUtil.parseLevelAsLong(BendableLongScore.class, scoreString, scoreTokens[0][i]);
    }
    var softScores = new long[scoreTokens[1].length];
    for (var i = 0; i < softScores.length; i++) {
      softScores[i] =
          ScoreUtil.parseLevelAsLong(BendableLongScore.class, scoreString, scoreTokens[1][i]);
    }
  ...
  public static BendableLongScore ofUninitialized(
      int initScore, long[] hardScores, long[] softScores) {
   ...
   * @param hardScore any
   */
  public static BendableLongScore ofHard(
   ...
   * @param softScore any
   */
  public static BendableLongScore ofSoft(
