...
public interface SequenceChain<Value_, Difference_ extends Comparable<Difference_>> {
  ...
  /**
   * @return the sequences contained in the collection in ascending order; must not be modified by
   *     the caller.
   */
  @NonNull Collection<Sequence<Value_, Difference_>> getConsecutiveSequences();

  /**
   * @return the breaks contained in the collection in ascending order; must not be modified by the
   *     caller.
   */
  @NonNull Collection<Break<Value_, Difference_>> getBreaks();
   ...
   */
  @Nullable Sequence<Value_, Difference_> getFirstSequence();
   ...
   * @return null if there are no sequences
   */
  @Nullable Sequence<Value_, Difference_> getLastSequence();
   ...
   */
  @Nullable Break<Value_, Difference_> getFirstBreak();
   ...
   * @return null if there are less than two sequences
   */
  @Nullable Break<Value_, Difference_> getLastBreak();
}
