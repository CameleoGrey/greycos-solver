...
public final class ScoreUtil {
  ...
  public static String[] parseScoreTokens(
      ...
      throw new IllegalArgumentException(
          """
              ...
              .formatted(
                  ...
                  buildScorePattern(false, levelSuffixes),
                  suffixedScoreTokens.length,
                  levelSuffixes.length,
                  levelSuffixes.length + 1));
    }
  ...
  public static BigDecimal parseLevelAsBigDecimal(
      Class<? extends Score<?>> scoreClass, String scoreString, String levelString) {
    if (levelString.equals("*")) {
      throw new IllegalArgumentException(
          """
  ...
  public static <Score_ extends Score<Score_>> String buildShortString(
      Score<Score_> score, Predicate<Number> notZero, String... levelLabels) {
    ...
    if (shortString.isEmpty()) {
      // Even for BigDecimals we use "0" over "0.0" because different levels can have different
      // scales
      return "0";
    }
  ...
  public static String[][] parseBendableScoreTokens(
        ...
        throw new IllegalArgumentException(
            """
                ...
                .formatted(
                    scoreString,
                    scoreClass.getSimpleName(),
                    buildScorePattern(true, LEVEL_SUFFIXES),
                    levelSuffix,
                    scoreString.substring(startIndex)));
      }
  ...
  public static <Score_ extends IBendableScore<Score_>> String buildBendableShortString(
