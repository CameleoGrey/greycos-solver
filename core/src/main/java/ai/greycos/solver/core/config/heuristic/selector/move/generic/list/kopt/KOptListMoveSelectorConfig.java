...
public class KOptListMoveSelectorConfig extends MoveSelectorConfig<KOptListMoveSelectorConfig>
  ...
  public @NonNull KOptListMoveSelectorConfig withOriginSelectorConfig(
      @NonNull ValueSelectorConfig originSelectorConfig) {
    this.originSelectorConfig = originSelectorConfig;
    return this;
  }

  public @NonNull KOptListMoveSelectorConfig withValueSelectorConfig(
  ...
  @Override
  public @NonNull KOptListMoveSelectorConfig inherit(
      @NonNull KOptListMoveSelectorConfig inheritedConfig) {
    ...
    this.originSelectorConfig =
        ConfigUtils.inheritConfig(originSelectorConfig, inheritedConfig.originSelectorConfig);
    this.valueSelectorConfig =
