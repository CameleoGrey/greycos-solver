...
import ai.greycos.solver.core.impl.bavet.uni.PrecomputeUniNode;
...
public class BavetPrecomputeUniConstraintStream<Solution_, A>
  ...
  public BavetPrecomputeUniConstraintStream(
    ...
    this.recordingPrecomputedConstraintStream =
        new BavetRecordingUniConstraintStream<>(constraintFactory, precomputedConstraintStream);
  ...
  public boolean equals(Object o) {
    if (this == o) {
      ...
      return recordingPrecomputedConstraintStream.equals(
          other.recordingPrecomputedConstraintStream);
    } else {
      return false;
    }
  }
