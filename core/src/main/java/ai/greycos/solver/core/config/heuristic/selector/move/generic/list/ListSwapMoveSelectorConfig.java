...
public class ListSwapMoveSelectorConfig extends MoveSelectorConfig<ListSwapMoveSelectorConfig>
  ...
  public void setSecondaryValueSelectorConfig(
      @Nullable ValueSelectorConfig secondaryValueSelectorConfig) {
  ...
  public @NonNull ListSwapMoveSelectorConfig withValueSelectorConfig(
      @NonNull ValueSelectorConfig valueSelectorConfig) {
    this.setValueSelectorConfig(valueSelectorConfig);
    return this;
  }

  public @NonNull ListSwapMoveSelectorConfig withSecondaryValueSelectorConfig(
      @NonNull ValueSelectorConfig secondaryValueSelectorConfig) {
  ...
  @Override
  public @NonNull ListSwapMoveSelectorConfig inherit(
      @NonNull ListSwapMoveSelectorConfig inheritedConfig) {
    ...
    secondaryValueSelectorConfig =
        ConfigUtils.inheritConfig(
            secondaryValueSelectorConfig, inheritedConfig.getSecondaryValueSelectorConfig());
    return this;
  }
  ...
  public boolean hasNearbySelectionConfig() {
    return (valueSelectorConfig != null && valueSelectorConfig.hasNearbySelectionConfig())
        || (secondaryValueSelectorConfig != null
            && secondaryValueSelectorConfig.hasNearbySelectionConfig());
  }
