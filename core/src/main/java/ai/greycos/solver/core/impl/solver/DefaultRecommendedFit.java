...
@NullMarked
public record DefaultRecommendedFit<Proposition_, Score_ extends Score<Score_>>(
    long index, @Nullable Proposition_ proposition, ScoreAnalysis<Score_> scoreAnalysisDiff)
    implements RecommendedFit<Proposition_, Score_>,
