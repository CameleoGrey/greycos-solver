...
import ai.greycos.solver.core.impl.localsearch.decider.acceptor.lateacceptance.DiversifiedLateAcceptanceAcceptor;
...
import ai.greycos.solver.core.impl.localsearch.decider.acceptor.stepcountinghillclimbing.StepCountingHillClimbingAcceptor;
...
import ai.greycos.solver.core.impl.localsearch.decider.acceptor.tabu.size.EntityRatioTabuSizeStrategy;
...
public class AcceptorFactory<Solution_> {
  ...
  public static <Solution_> AcceptorFactory<Solution_> create(
  ...
  public Acceptor<Solution_> buildAcceptor(HeuristicConfigPolicy<Solution_> configPolicy) {
    List<Acceptor<Solution_>> acceptorList =
        Stream.of(
    ...
    if (acceptorList.size() == 1) {
      ...
      throw new IllegalArgumentException(
          "The acceptor does not specify any acceptorType ("
  ...
  private Optional<StepCountingHillClimbingAcceptor<Solution_>>
      buildStepCountingHillClimbingAcceptor() {
    if (acceptorTypeListsContainsAcceptorType(AcceptorType.STEP_COUNTING_HILL_CLIMBING)
      ...
      var stepCountingHillClimbingType_ =
          Objects.requireNonNullElse(
              acceptorConfig.getStepCountingHillClimbingType(), StepCountingHillClimbingType.STEP);
      var acceptor =
          new StepCountingHillClimbingAcceptor<Solution_>(
  ...
  private Optional<EntityTabuAcceptor<Solution_>> buildEntityTabuAcceptor(
      HeuristicConfigPolicy<Solution_> configPolicy) {
    if (acceptorTypeListsContainsAcceptorType(AcceptorType.ENTITY_TABU)
        || acceptorConfig.getEntityTabuSize() != null
        || acceptorConfig.getEntityTabuRatio() != null
        || acceptorConfig.getFadingEntityTabuSize() != null
        || acceptorConfig.getFadingEntityTabuRatio() != null) {
      ...
      if (acceptorConfig.getEntityTabuSize() != null) {
        if (acceptorConfig.getEntityTabuRatio() != null) {
          throw new IllegalArgumentException(
              "The acceptor cannot have both acceptorConfig.getEntityTabuSize() ("
                  + acceptorConfig.getEntityTabuSize()
                  + ") and acceptorConfig.getEntityTabuRatio() ("
                  + acceptorConfig.getEntityTabuRatio()
                  + ").");
        }
        acceptor.setTabuSizeStrategy(
            new FixedTabuSizeStrategy<>(acceptorConfig.getEntityTabuSize()));
      } else if (acceptorConfig.getEntityTabuRatio() != null) {
        acceptor.setTabuSizeStrategy(
            new EntityRatioTabuSizeStrategy<>(acceptorConfig.getEntityTabuRatio()));
      } else if (acceptorConfig.getFadingEntityTabuSize() == null
          && acceptorConfig.getFadingEntityTabuRatio() == null) {
      ...
      if (acceptorConfig.getFadingEntityTabuSize() != null) {
        ...
        acceptor.setFadingTabuSizeStrategy(
            new FixedTabuSizeStrategy<>(acceptorConfig.getFadingEntityTabuSize()));
  ...
  private Optional<ValueTabuAcceptor<Solution_>> buildValueTabuAcceptor(
      HeuristicConfigPolicy<Solution_> configPolicy) {
    if (acceptorTypeListsContainsAcceptorType(AcceptorType.VALUE_TABU)
        || acceptorConfig.getValueTabuSize() != null
        || acceptorConfig.getValueTabuRatio() != null
        || acceptorConfig.getFadingValueTabuSize() != null
        || acceptorConfig.getFadingValueTabuRatio() != null) {
      ...
      if (acceptorConfig.getValueTabuSize() != null) {
        if (acceptorConfig.getValueTabuRatio() != null) {
          throw new IllegalArgumentException(
              "The acceptor cannot have both acceptorConfig.getValueTabuSize() ("
                  + acceptorConfig.getValueTabuSize()
                  + ") and acceptorConfig.getValueTabuRatio() ("
                  + acceptorConfig.getValueTabuRatio()
                  + ").");
        }
        acceptor.setTabuSizeStrategy(
            new FixedTabuSizeStrategy<>(acceptorConfig.getValueTabuSize()));
      ...
      if (acceptorConfig.getFadingValueTabuSize() != null) {
        if (acceptorConfig.getFadingValueTabuRatio() != null) {
          throw new IllegalArgumentException(
              "The acceptor cannot have both acceptorConfig.getFadingValueTabuSize() ("
                  + acceptorConfig.getFadingValueTabuSize()
                  + ") and acceptorConfig.getFadingValueTabuRatio() ("
                  + acceptorConfig.getFadingValueTabuRatio()
                  + ").");
        }
        acceptor.setFadingTabuSizeStrategy(
            new FixedTabuSizeStrategy<>(acceptorConfig.getFadingValueTabuSize()));
  ...
  private Optional<MoveTabuAcceptor<Solution_>> buildMoveTabuAcceptor(
      HeuristicConfigPolicy<Solution_> configPolicy) {
    if (acceptorTypeListsContainsAcceptorType(AcceptorType.MOVE_TABU)
        || acceptorConfig.getMoveTabuSize() != null
        || acceptorConfig.getFadingMoveTabuSize() != null) {
      ...
      if (acceptorConfig.getFadingMoveTabuSize() != null) {
        acceptor.setFadingTabuSizeStrategy(
            new FixedTabuSizeStrategy<>(acceptorConfig.getFadingMoveTabuSize()));
      }
      if (configPolicy.getEnvironmentMode().isFullyAsserted()) {
        acceptor.setAssertTabuHashCodeCorrectness(true);
      }
  ...
  private Optional<SimulatedAnnealingAcceptor<Solution_>> buildSimulatedAnnealingAcceptor(
      HeuristicConfigPolicy<Solution_> configPolicy) {
  ...
  private Optional<LateAcceptanceAcceptor<Solution_>> buildLateAcceptanceAcceptor() {
    if (acceptorTypeListsContainsAcceptorType(AcceptorType.LATE_ACCEPTANCE)
      ...
      acceptor.setLateAcceptanceSize(
          Objects.requireNonNullElse(acceptorConfig.getLateAcceptanceSize(), 400));
      return Optional.of(acceptor);
    }
    return Optional.empty();
  }
  ...
  private Optional<GreatDelugeAcceptor<Solution_>> buildGreatDelugeAcceptor(
      HeuristicConfigPolicy<Solution_> configPolicy) {
    if (acceptorTypeListsContainsAcceptorType(AcceptorType.GREAT_DELUGE)
      ...
      if (acceptorConfig.getGreatDelugeWaterLevelIncrementScore() != null) {
        if (acceptorConfig.getGreatDelugeWaterLevelIncrementRatio() != null) {
          throw new IllegalArgumentException(
              "The acceptor cannot have both a "
        ...
        if (acceptorConfig.getGreatDelugeWaterLevelIncrementRatio() <= 0.0) {
          throw new IllegalArgumentException(
              "The acceptorConfig.getGreatDelugeWaterLevelIncrementRatio() ("
                  + acceptorConfig.getGreatDelugeWaterLevelIncrementRatio()
