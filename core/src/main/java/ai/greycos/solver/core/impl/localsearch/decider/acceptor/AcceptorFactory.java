...
public class AcceptorFactory<Solution_> {
  ...
  private Optional<EntityTabuAcceptor<Solution_>> buildEntityTabuAcceptor(
    ...
    if (acceptorTypeListsContainsAcceptorType(AcceptorType.ENTITY_TABU)
        || entityTabuSize != null
        || entityTabuRatio != null
        || fadingEntityTabuSize != null
        || fadingEntityTabuRatio != null) {
  ...
  private static <Solution_> void configureFixedSizeTabuAcceptor(
      AbstractTabuAcceptor<Solution_> acceptor,
      HeuristicConfigPolicy<Solution_> configPolicy,
      Integer tabuSize,
      Integer fadingTabuSize) {
    if (tabuSize != null) {
