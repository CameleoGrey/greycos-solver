...
import ai.greycos.solver.core.impl.domain.variable.listener.SourcedListVariableListener;
 ...
 * ai.greycos.solver.core.api.domain.variable.IndexShadowVariable}, {@link
 * ai.greycos.solver.core.api.domain.variable.InverseRelationShadowVariable}, {@link
 * ai.greycos.solver.core.api.domain.variable.PreviousElementShadowVariable}, {@link
 * ai.greycos.solver.core.api.domain.variable.NextElementShadowVariable}), and use values from this
...
public interface ListVariableStateSupply<Solution_, Entity_, Element_>
   ...
   * unassigned count is 0, {@link #isAssigned(Object)} is guaranteed to return true.
   *
   ...
   */
  @Nullable Element_ getPreviousElement(Element_ element);

  /**
   * @param element never null
   * @return null if the element is the last element in the list
   */
  @Nullable Element_ getNextElement(Element_ element);
}
