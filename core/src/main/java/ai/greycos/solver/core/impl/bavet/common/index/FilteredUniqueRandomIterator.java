...
/**
 * Unlike {@link DefaultUniqueRandomIterator}, this class only returns elements that match the given
...
public final class FilteredUniqueRandomIterator<T> implements UniqueRandomIterator<T> {
  ...
  FilteredUniqueRandomIterator(
      ElementAwareArrayList<T> source, RandomGenerator workingRandom, Predicate<T> filter) {
