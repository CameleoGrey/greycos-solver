...
final class ExternalizedListVariableStateSupply<Solution_, Entity_>
  ...
  public void afterChange(
    ...
    // Include the last element of the previous part of the list, if any, for the next element
    // shadow var.
  ...
  public boolean isPinned(Object element) {
    ...
    if (position instanceof PositionInList assignedPosition) {
      return sourceVariableDescriptor.isElementPinned(
          Objects.requireNonNull(workingSolution),
          assignedPosition.entity(),
