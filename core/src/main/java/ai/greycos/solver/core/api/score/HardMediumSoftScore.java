 ...
 */
@NullMarked
public record HardMediumSoftScore(long hardScore, long mediumScore, long softScore)
  ...
  public static HardMediumSoftScore parseScore(String scoreString) {
    ...
    var hardScore =
        ScoreUtil.parseLevelAsLong(HardMediumSoftScore.class, scoreString, scoreTokens[0]);
    var mediumScore =
        ScoreUtil.parseLevelAsLong(HardMediumSoftScore.class, scoreString, scoreTokens[1]);
    var softScore =
        ScoreUtil.parseLevelAsLong(HardMediumSoftScore.class, scoreString, scoreTokens[2]);
