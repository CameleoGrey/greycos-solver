...
@NullMarked
public final class DefaultBiEnumeratingJoiner<A, B> extends AbstractJoiner<B>
    implements BiEnumeratingJoiner<A, B> {
  ...
  public <Property_> DefaultBiEnumeratingJoiner(
      Function<A, Property_> leftMapping,
  ...
  private <Property_> DefaultBiEnumeratingJoiner(
      Function<A, Property_>[] leftMappings,
  ...
  public static <A, B> DefaultBiEnumeratingJoiner<A, B> merge(
      List<DefaultBiEnumeratingJoiner<A, B>> joinerList) {
