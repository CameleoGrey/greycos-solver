...
import ai.greycos.solver.core.impl.bavet.bi.MapBiToQuadNode;
...
final class BavetQuadMapBiConstraintStream<Solution_, A, B, NewA, NewB, NewC, NewD>
  ...
  public BavetQuadMapBiConstraintStream(
      ...
      BiFunction<A, B, NewD> mappingFunctionD,
      boolean isExpand) {
  ...
  public boolean equals(Object object) {
    ...
    BavetQuadMapBiConstraintStream<?, ?, ?, ?, ?, ?, ?> that =
        (BavetQuadMapBiConstraintStream<?, ?, ?, ?, ?, ?, ?>) object;
