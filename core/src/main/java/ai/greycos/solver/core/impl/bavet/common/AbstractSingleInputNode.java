...
public abstract non-sealed class AbstractSingleInputNode<Tuple_ extends Tuple> extends AbstractNode
  ...
  @Override
  public void afterAllFactsInserted(
      boolean upstreamCanProduceTuples) { // We only delegate; implementations can override.
