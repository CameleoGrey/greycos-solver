...
public interface CountableValueRange<T> extends ValueRange<T> {
  ...
  /**
   * Used by uniform random selection in a composite CountableValueRange, or one which includes
   * nulls.
   *
   * @return the exact number of elements generated by this {@link CountableValueRange}, always
   *     {@code >= 0}
   */
  long getSize();
