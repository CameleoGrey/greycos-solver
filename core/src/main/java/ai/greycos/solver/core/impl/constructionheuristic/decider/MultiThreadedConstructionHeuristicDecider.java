...
/**
 * Multithreaded implementation of ConstructionHeuristicDecider that evaluates moves in parallel using
...
public class MultiThreadedConstructionHeuristicDecider<Solution_> extends ConstructionHeuristicDecider<Solution_> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MultiThreadedConstructionHeuristicDecider.class);
    ...
    private boolean forageResult(ConstructionHeuristicStepScope<Solution_> stepScope, int stepIndex) {
        ...
        ConstructionHeuristicMoveScope<Solution_> moveScope = new ConstructionHeuristicMoveScope<>(
        ...
        if (!result.isMoveDoable()) {
            ...
            moveScope.setScore(result.getScore().raw());
