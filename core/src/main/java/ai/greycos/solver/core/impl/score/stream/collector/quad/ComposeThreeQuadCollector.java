...
final class ComposeThreeQuadCollector<
        A,
        B,
        C,
        D,
    ...
    implements QuadConstraintCollector<
        A, B, C, D, Triple<ResultHolder1_, ResultHolder2_, ResultHolder3_>, Result_> {
  ...
  @Override
  public @NonNull
      PentaFunction<Triple<ResultHolder1_, ResultHolder2_, ResultHolder3_>, A, B, C, D, Runnable>
      accumulator() {
    return (resultHolder, a, b, c, d) ->
        composeUndo(
            firstAccumulator.apply(resultHolder.a(), a, b, c, d),
