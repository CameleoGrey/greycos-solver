...
public final class Group1Mapping3CollectorQuadNode<
        OldA, OldB, OldC, OldD, A, B, C, D, ResultContainerB_, ResultContainerC_, ResultContainerD_>
    extends AbstractGroupQuadNode<
        OldA, OldB, OldC, OldD, QuadTuple<A, B, C, D>, A, Object, Triple<B, C, D>> {
  ...
  public Group1Mapping3CollectorQuadNode(
    ...
    super(
        ...
        Group0Mapping3CollectorQuadNode.mergeCollectors(collectorB, collectorC, collectorD),
