 ...
 *
 * <p>For example: a Cartesian product of {A, B, C} and {X, Y} will result in {AX, AY, BX, BY, CX,
 * CY}.
 *
 * <p>Warning: there is no duplicated {@link Move} check, so union of {A, B} and {B} will result in
 * {AB, BB}.
 *
...
public class CartesianProductMoveSelector<Solution_> extends CompositeMoveSelector<Solution_> {
  ...
  public CartesianProductMoveSelector(
  ...
  public class OriginalCartesianProductMoveIterator
    ...
    protected Move<Solution_> createUpcomingSelection() {
      ...
      if (subSelections == null) {
        ...
        moveList[startingIndex] =
            moveIteratorList.get(startingIndex).next(); // Increment the 4 in 004999
      }
      ...
      // No need to clone to avoid CompositeMove corruption because subSelections's elements never
      // change
