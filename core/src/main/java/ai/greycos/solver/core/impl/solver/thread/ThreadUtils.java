...
public class ThreadUtils {
  ...
  public static void shutdownAwaitOrKill(
    ...
    if (Thread.interrupted()) {
      ...
      // to finish
      // solving upon detecting the termination issued previously (step 1). Shutting down the
      // executor
      // service is important because the JVM cannot exit until all non-daemon threads have
      // terminated.
      executor.shutdown();
    }
