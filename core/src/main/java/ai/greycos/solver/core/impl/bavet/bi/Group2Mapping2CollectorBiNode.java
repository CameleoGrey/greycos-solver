...
public final class Group2Mapping2CollectorBiNode<
        OldA, OldB, A, B, C, D, ResultContainerC_, ResultContainerD_>
    extends AbstractGroupBiNode<OldA, OldB, QuadTuple<A, B, C, D>, Pair<A, B>, Object, Pair<C, D>> {

  private final int outputStoreSize;

  public Group2Mapping2CollectorBiNode(
    ...
    super(
        ...
        undoStoreIndex,
        tuple ->
            Group2Mapping0CollectorBiNode.createGroupKey(groupKeyMappingA, groupKeyMappingB, tuple),
        Group0Mapping2CollectorBiNode.mergeCollectors(collectorC, collectorD),
