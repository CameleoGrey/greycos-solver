...
import ai.greycos.solver.core.impl.bavet.quad.MapQuadToQuadNode;
...
final class BavetQuadMapQuadConstraintStream<Solution_, A, B, C, D, NewA, NewB, NewC, NewD>
  ...
  public BavetQuadMapQuadConstraintStream(
  ...
  public void setAftBridge(
      BavetAftBridgeQuadConstraintStream<Solution_, NewA, NewB, NewC, NewD> aftStream) {
  ...
  public int hashCode() {
    return Objects.hash(
        parent, mappingFunctionA, mappingFunctionB, mappingFunctionC, mappingFunctionD);
  }
