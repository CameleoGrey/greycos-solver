package ai.greycos.solver.core.impl.cotwin.valuerange.sort;
...
@NullMarked
public record SelectionSorterAdapter<Solution_, T>(
    Solution_ solution, SelectionSorter<Solution_, T> innerSelectionSorter)
    implements ValueRangeSorter<T> {

  public static <Solution_, T> ValueRangeSorter<T> of(
      Solution_ solution, SelectionSorter<Solution_, T> selectionSorter) {
