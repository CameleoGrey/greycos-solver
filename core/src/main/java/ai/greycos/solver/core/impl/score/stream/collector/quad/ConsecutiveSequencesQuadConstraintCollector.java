...
import ai.greycos.solver.core.impl.score.stream.collector.AbstractSequenceSlot;
...
final class ConsecutiveSequencesQuadConstraintCollector<A, B, C, D, Result_>
    extends AbstractReferenceBasedQuadCollector<
        A, B, C, D, Result_, SequenceChain<Result_, Integer>, AbstractSequenceSlot.State<Result_>> {

  private final ToIntFunction<Result_> indexMap;

  public ConsecutiveSequencesQuadConstraintCollector(
  ...
  @Override
  public @NonNull Function<AbstractSequenceSlot.State<Result_>, SequenceChain<Result_, Integer>>
      finisher() {
  ...
  public boolean equals(Object o) {
    if (o instanceof ConsecutiveSequencesQuadConstraintCollector<?, ?, ?, ?, ?> other) {
      return Objects.equals(mapper, other.mapper) && Objects.equals(indexMap, other.indexMap);
    }
    return false;
  }
