...
final class LongWeightedScoreImpacter<
  ...
  public LongWeightedScoreImpacter(
      LongImpactFunction<Score_, Context_> impactFunction, Context_ context) {
  ...
  public UndoScoreImpacter impactScore(
    ...
    return impactFunction.impact(
        context, matchWeight, constraintMatchSupplier); // int can be cast to long
  }
  ...
  public UndoScoreImpacter impactScore(
    ...
    throw new UnsupportedOperationException(
        "Impossible state: passing BigDecimal into a long impacter.");
  }
