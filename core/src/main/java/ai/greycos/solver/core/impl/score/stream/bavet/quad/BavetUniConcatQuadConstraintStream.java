...
import ai.greycos.solver.core.impl.bavet.quad.ConcatQuadUniNode;
import ai.greycos.solver.core.impl.bavet.quad.ConcatUniQuadNode;
...
public final class BavetUniConcatQuadConstraintStream<Solution_, A, B, C, D>
  ...
  public BavetUniConcatQuadConstraintStream(
      ...
      Function<A, B> paddingFunctionB,
      Function<A, C> paddingFunctionC,
      Function<A, D> paddingFunctionD) {
