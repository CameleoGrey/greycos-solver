 ...
 * JDK's, stateless lambdas are bound to a {@link java.lang.invoke.ConstantCallSite} inside the
 * method that defined them, but that {@link java.lang.invoke.ConstantCallSite} is not shared across
 * methods, even for methods in the same class. Thus, when lambda reference equality is important
 * (such as for node sharing in Constraint Streams), the lambdas in this class should be used.
 */
