...
/**
 * A class that holds common lambdas that are guaranteed to be the same across method calls. In most
 * JDK's, stateless lambdas are bound to a {@link ConstantCallSite} inside the method that defined
 * them, but that {@link ConstantCallSite} is not shared across methods, even for methods in the
 * same class. Thus, when lambda reference equality is important (such as for node sharing in
 * Constraint Streams), the lambdas in this class should be used.
 */
public final class ConstantLambdaUtils {
  ...
  private static final UniNeighborhoodsMapper<Object, Object, Object> NEIGHBORHOODS_UNI_PICK_FIRST =
      (view, a) -> a;

  private static final BiNeighborhoodsMapper<Object, Object, Object, Object>
      NEIGHBORHOODS_BI_PICK_FIRST = (view, a, b) -> a;

  private static final BiNeighborhoodsMapper<Object, Object, Object, Object>
      NEIGHBORHOODS_BI_PICK_SECOND = (view, a, b) -> b;
  ...
  /**
   * Returns a {@link BiPredicate} that return true if and only if its inputs are not equal
  ...
  @SuppressWarnings("unchecked")
  public static <Solution_, A, B>
      BiNeighborhoodsMapper<Solution_, A, B, A> neighborhoodsBiPickFirst() {
    return (BiNeighborhoodsMapper<Solution_, A, B, A>) NEIGHBORHOODS_BI_PICK_FIRST;
  }

  @SuppressWarnings("unchecked")
  public static <Solution_, A, B>
      BiNeighborhoodsMapper<Solution_, A, B, B> neighborhoodsBiPickSecond() {
