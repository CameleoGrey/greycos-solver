...
final class BendableBigDecimalScoreContext
  ...
  public BendableBigDecimalScoreContext(
      BendableBigDecimalScoreInliner parent,
  ...
  public ScoreImpact<BendableBigDecimalScore> changeSoftScoreBy(
  ...
  public ScoreImpact<BendableBigDecimalScore> changeHardScoreBy(
      BigDecimal matchWeight,
      @Nullable ConstraintMatchSupplier<BendableBigDecimalScore> constraintMatchSupplier) {
  ...
  public ScoreImpact<BendableBigDecimalScore> changeScoreBy(
      BigDecimal matchWeight,
      @Nullable ConstraintMatchSupplier<BendableBigDecimalScore> constraintMatchSupplier) {
  ...
  private record SingleSoftImpact(BendableBigDecimalScoreContext ctx, BigDecimal impact)
      implements ScoreImpact<BendableBigDecimalScore> {
    ...
    public BendableBigDecimalScore toScore() {
      return BendableBigDecimalScore.ofSoft(
  ...
  private record SingleHardImpact(BendableBigDecimalScoreContext ctx, BigDecimal impact)
    ...
    @Override
    public BendableBigDecimalScore toScore() {
      return BendableBigDecimalScore.ofHard(
          ctx.hardScoreLevelCount, ctx.softScoreLevelCount, ctx.scoreLevel, impact);
    }
  }
  ...
  private record ComplexImpact(
      BendableBigDecimalScoreContext ctx, BigDecimal[] hardImpacts, BigDecimal[] softImpacts)
      implements ScoreImpact<BendableBigDecimalScore> {
    ...
    public void undo() {
      ...
      for (var hardScoreLevel = 0; hardScoreLevel < ctx.hardScoreLevelCount; hardScoreLevel++) {
        inliner.hardScores[hardScoreLevel] =
            inliner.hardScores[hardScoreLevel].subtract(hardImpacts[hardScoreLevel]);
      }
      for (var softScoreLevel = 0; softScoreLevel < ctx.softScoreLevelCount; softScoreLevel++) {
        inliner.softScores[softScoreLevel] =
            inliner.softScores[softScoreLevel].subtract(softImpacts[softScoreLevel]);
      }
    }
    ...
    public boolean equals(Object o) {
      ...
      if (!(o
          instanceof
          ComplexImpact(
              BendableBigDecimalScoreContext otherCtx,
              BigDecimal[] otherHardImpacts,
              BigDecimal[] otherSoftImpacts))) {
        return false;
      }
