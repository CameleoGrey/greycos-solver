...
public class ExternalizedSingletonInverseVariableSupply<Solution_>
    implements SourcedBasicVariableListener<Solution_, Object>, SingletonInverseVariableSupply {

  protected final VariableDescriptor<Solution_> sourceVariableDescriptor;

  protected Map<Object, Object> inverseEntityMap = null;

  public ExternalizedSingletonInverseVariableSupply(
    ...
    if (oldInverseEntity != null) {
      throw new IllegalStateException(
          "The supply ("
              ...
              + ") cannot be inserted: another entity ("
              + oldInverseEntity
    ...
    if (oldInverseEntity != entity) {
      throw new IllegalStateException(
          "The supply ("
              ...
              + ") for sourceVariable ("
              + sourceVariableDescriptor.getVariableName()
              + ") cannot be retracted: the entity was never inserted for that value ("
              + value
              + ").");
    }
  }
