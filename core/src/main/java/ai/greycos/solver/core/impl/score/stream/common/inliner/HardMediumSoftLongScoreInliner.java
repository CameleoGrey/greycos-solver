...
final class HardMediumSoftLongScoreInliner extends AbstractScoreInliner<HardMediumSoftLongScore> {
  ...
  @Override
  public WeightedScoreImpacter<HardMediumSoftLongScore, ?> buildWeightedScoreImpacter(
    ...
    HardMediumSoftLongScoreContext context =
        new HardMediumSoftLongScoreContext(this, constraint, constraintWeight);
    if (mediumConstraintWeight == 0L && softConstraintWeight == 0L) {
      return WeightedScoreImpacter.of(
          context,
          (HardMediumSoftLongScoreContext ctx,
              long matchWeight,
      ...
      return WeightedScoreImpacter.of(
          ...
          (HardMediumSoftLongScoreContext ctx,
              long matchWeight,
              ConstraintMatchSupplier<HardMediumSoftLongScore> constraintMatchSupplier) ->
              ctx.changeMediumScoreBy(matchWeight, constraintMatchSupplier));
