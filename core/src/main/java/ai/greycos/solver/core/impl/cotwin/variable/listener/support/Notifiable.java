 ...
 * generalized form of a notifiable. It covers variable listener methods that are executed
 * immediately ({@link InnerVariableListener#resetWorkingSolution} and {@link
 * InnerVariableListener#close}.
 *
 * <p>Specialized notifiables use {@link Notification}s to record planing variable changes and defer
 * triggering of "after" methods so that dependent variable listeners can be executed in the correct
 * order.
 */
