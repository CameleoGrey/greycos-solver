  ...
  protected MoveSelector<Solution_> buildBaseMoveSelector(
    ...
    var secondaryEntitySelectorConfig =
        Objects.requireNonNullElseGet(
            config.getSecondaryEntitySelectorConfig(), entitySelectorConfig::copyConfig);
    ...
    var enableEntityValueRangeFilter =
        entityDescriptor.getSolutionDescriptor().getBasicVariableDescriptorList().stream()
    ...
    if (enableEntityValueRangeFilter) {
      if (entitySelectorConfig.getId() == null
        ...
        entityRecorderId =
            entitySelectorConfig.getId() != null
                ? entitySelectorConfig.getId()
        ...
        throw new IllegalArgumentException(
            "The entitySelector (%s)'s entityClass (%s) and secondaryEntitySelectorConfig (%s)'s entityClass (%s) must be the same entity class."
                .formatted(
                    ...
                    onlySecondaryEntityDescriptor == null
                        ? null
    ...
    if (entityDescriptors.size() == 1
      ...
      for (var entityDescriptor : entityDescriptors) {
        ...
        if (config.getSecondaryEntitySelectorConfig() != null) {
          ...
          childMoveSelectorConfig.setSecondaryEntitySelectorConfig(
              childSecondaryEntitySelectorConfig);
        }
