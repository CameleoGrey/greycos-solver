package ai.greycos.solver.core.config.localsearch.decider.acceptor;
...
public class LocalSearchAcceptorConfig extends AbstractConfig<LocalSearchAcceptorConfig> {
  ...
  public void setSimulatedAnnealingStartingTemperature(
      @Nullable String simulatedAnnealingStartingTemperature) {
  ...
  public void setGreatDelugeWaterLevelIncrementScore(
      @Nullable String greatDelugeWaterLevelIncrementScore) {
  ...
  public void setGreatDelugeWaterLevelIncrementRatio(
      @Nullable Double greatDelugeWaterLevelIncrementRatio) {
  ...
  public void setStepCountingHillClimbingType(
      @Nullable StepCountingHillClimbingType stepCountingHillClimbingType) {
  ...
  public @NonNull LocalSearchAcceptorConfig withAcceptorTypeList(
      @NonNull List<AcceptorType> acceptorTypeList) {
    this.acceptorTypeList = acceptorTypeList;
    return this;
  }
  ...
  public @NonNull LocalSearchAcceptorConfig withFadingEntityTabuSize(
      @NonNull Integer fadingEntityTabuSize) {
    this.fadingEntityTabuSize = fadingEntityTabuSize;
    return this;
  }

  public @NonNull LocalSearchAcceptorConfig withFadingEntityTabuRatio(
      @NonNull Double fadingEntityTabuRatio) {
    this.fadingEntityTabuRatio = fadingEntityTabuRatio;
    return this;
  }
  ...
  public @NonNull LocalSearchAcceptorConfig withFadingValueTabuSize(
      @NonNull Integer fadingValueTabuSize) {
    this.fadingValueTabuSize = fadingValueTabuSize;
    return this;
  }

  public @NonNull LocalSearchAcceptorConfig withFadingValueTabuRatio(
      @NonNull Double fadingValueTabuRatio) {
    this.fadingValueTabuRatio = fadingValueTabuRatio;
    return this;
  }
  ...
  public @NonNull LocalSearchAcceptorConfig withFadingMoveTabuSize(
      @NonNull Integer fadingMoveTabuSize) {
    this.fadingMoveTabuSize = fadingMoveTabuSize;
    return this;
  }
  ...
  public @NonNull LocalSearchAcceptorConfig withSimulatedAnnealingStartingTemperature(
      @NonNull String simulatedAnnealingStartingTemperature) {
    this.simulatedAnnealingStartingTemperature = simulatedAnnealingStartingTemperature;
    return this;
  }

  public @NonNull LocalSearchAcceptorConfig withLateAcceptanceSize(
      @NonNull Integer lateAcceptanceSize) {
    this.lateAcceptanceSize = lateAcceptanceSize;
    return this;
  }

  public @NonNull LocalSearchAcceptorConfig withStepCountingHillClimbingSize(
      @NonNull Integer stepCountingHillClimbingSize) {
    this.stepCountingHillClimbingSize = stepCountingHillClimbingSize;
    return this;
  }

  public @NonNull LocalSearchAcceptorConfig withStepCountingHillClimbingType(
      @NonNull StepCountingHillClimbingType stepCountingHillClimbingType) {
    this.stepCountingHillClimbingType = stepCountingHillClimbingType;
    return this;
  }

  @Override
  public @NonNull LocalSearchAcceptorConfig inherit(
      @NonNull LocalSearchAcceptorConfig inheritedConfig) {
    ...
    entityTabuRatio =
        ConfigUtils.inheritOverwritableProperty(
            entityTabuRatio, inheritedConfig.getEntityTabuRatio());
    fadingEntityTabuSize =
        ConfigUtils.inheritOverwritableProperty(
            fadingEntityTabuSize, inheritedConfig.getFadingEntityTabuSize());
    fadingEntityTabuRatio =
        ConfigUtils.inheritOverwritableProperty(
            fadingEntityTabuRatio, inheritedConfig.getFadingEntityTabuRatio());
    valueTabuSize =
        ConfigUtils.inheritOverwritableProperty(valueTabuSize, inheritedConfig.getValueTabuSize());
    valueTabuRatio =
        ConfigUtils.inheritOverwritableProperty(
            valueTabuRatio, inheritedConfig.getValueTabuRatio());
    fadingValueTabuSize =
        ConfigUtils.inheritOverwritableProperty(
            fadingValueTabuSize, inheritedConfig.getFadingValueTabuSize());
    fadingValueTabuRatio =
        ConfigUtils.inheritOverwritableProperty(
            fadingValueTabuRatio, inheritedConfig.getFadingValueTabuRatio());
    moveTabuSize =
        ConfigUtils.inheritOverwritableProperty(moveTabuSize, inheritedConfig.getMoveTabuSize());
    fadingMoveTabuSize =
        ConfigUtils.inheritOverwritableProperty(
    ...
    stepCountingHillClimbingSize =
        ConfigUtils.inheritOverwritableProperty(
            stepCountingHillClimbingSize, inheritedConfig.getStepCountingHillClimbingSize());
    stepCountingHillClimbingType =
        ConfigUtils.inheritOverwritableProperty(
            stepCountingHillClimbingType, inheritedConfig.getStepCountingHillClimbingType());
    return this;
  }
