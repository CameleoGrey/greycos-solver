...
import ai.greycos.solver.core.impl.bavet.uni.MapUniToQuadNode;
...
final class BavetQuadMapUniConstraintStream<Solution_, A, NewA, NewB, NewC, NewD>
  ...
  public BavetQuadMapUniConstraintStream(
      ...
      Function<A, NewD> mappingFunctionD,
      boolean isExpand) {
  ...
  public boolean equals(Object object) {
    ...
    BavetQuadMapUniConstraintStream<?, ?, ?, ?, ?, ?> that =
        (BavetQuadMapUniConstraintStream<?, ?, ?, ?, ?, ?>) object;
