...
@NullMarked
public class SwapMoveDefinition<Solution_, Entity_> implements MoveDefinition<Solution_> {
  ...
  static <Solution_, Entity_> @Nullable Function<Entity_, Comparable> getPlanningIdGetter(
      PlanningEntityMetaModel<Solution_, Entity_> metaModel) {
    var solutionDescriptor =
        ((DefaultPlanningSolutionMetaModel<Solution_>) metaModel.solution()).solutionDescriptor();
  ...
  public MoveStream<Solution_> build(MoveStreamFactory<Solution_> moveStreamFactory) {
    ...
    if (planningIdGetter
        == null) { // If the user hasn't defined a planning ID, we will follow a slower path.
      return moveStreamFactory
          .pick(entityStream)
          .pick(entityStream, EnumeratingJoiners.filtering(this::isValidSwap))
  ...
  private boolean isValidSwap(
      SolutionView<Solution_> solutionView, Entity_ leftEntity, Entity_ rightEntity) {
