...
public final class IndexedIfExistsQuadNode<A, B, C, D, E>
  ...
  public IndexedIfExistsQuadNode(
      boolean shouldExist,
      IndexerFactory<E> indexerFactory,
  ...
  public IndexedIfExistsQuadNode(
    ...
    super(
        shouldExist,
        indexerFactory.buildQuadLeftKeysExtractor(),
        indexerFactory,
  ...
  protected boolean testFiltering(QuadTuple<A, B, C, D> leftTuple, UniTuple<E> rightTuple) {
    return filtering.test(
        leftTuple.factA, leftTuple.factB, leftTuple.factC, leftTuple.factD, rightTuple.factA);
  }
}
