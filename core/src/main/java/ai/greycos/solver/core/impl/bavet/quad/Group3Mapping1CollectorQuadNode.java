...
public final class Group3Mapping1CollectorQuadNode<
        OldA, OldB, OldC, OldD, A, B, C, D, ResultContainer_>
    extends AbstractGroupQuadNode<
        OldA, OldB, OldC, OldD, QuadTuple<A, B, C, D>, Triple<A, B, C>, ResultContainer_, D> {
  ...
  public Group3Mapping1CollectorQuadNode(
    ...
    super(
        ...
        undoStoreIndex,
        tuple ->
            Group3Mapping0CollectorQuadNode.createGroupKey(
                groupKeyMappingA, groupKeyMappingB, groupKeyMappingC, tuple),
        collector,
