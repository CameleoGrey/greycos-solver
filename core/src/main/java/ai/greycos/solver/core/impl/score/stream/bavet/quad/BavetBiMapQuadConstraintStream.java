...
import ai.greycos.solver.core.impl.bavet.quad.MapQuadToBiNode;
...
final class BavetBiMapQuadConstraintStream<Solution_, A, B, C, D, NewA, NewB>
  ...
  public BavetBiMapQuadConstraintStream(
  ...
  public boolean equals(Object object) {
    ...
    BavetBiMapQuadConstraintStream<?, ?, ?, ?, ?, ?, ?> that =
        (BavetBiMapQuadConstraintStream<?, ?, ?, ?, ?, ?, ?>) object;
