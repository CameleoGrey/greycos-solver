...
public final class DefaultGenuineEntityMetaModel<Solution_, Entity_>
  ...
  DefaultGenuineEntityMetaModel(
      PlanningSolutionMetaModel<Solution_> solution, EntityDescriptor<Solution_> entityDescriptor) {
  ...
  @SuppressWarnings("unchecked")
  private <Value_> GenuineVariableMetaModel<Solution_, Entity_, Value_> castOrFailGenuine(
      VariableMetaModel<Solution_, Entity_, ?> variable, String variableName) {
  ...
  public <Value_> PlanningVariableMetaModel<Solution_, Entity_, Value_> basicVariable() {
    ...
    if (variable
        instanceof PlanningVariableMetaModel<Solution_, Entity_, ?> basicVariableMetaModel) {
      return (PlanningVariableMetaModel<Solution_, Entity_, Value_>) basicVariableMetaModel;
    }
    throw new IllegalArgumentException(
        "The single genuine variable exists but is a list variable, not a basic variable.");
  }
  ...
  @SuppressWarnings("unchecked")
  private <Value_> PlanningVariableMetaModel<Solution_, Entity_, Value_> castOrFailBasic(
      GenuineVariableMetaModel<Solution_, Entity_, ?> variable, String variableName) {
  ...
  public <Value_> PlanningListVariableMetaModel<Solution_, Entity_, Value_> listVariable() {
    var variable = genuineVariable();
    if (variable
        instanceof PlanningListVariableMetaModel<Solution_, Entity_, ?> listVariableMetaModel) {
      return (PlanningListVariableMetaModel<Solution_, Entity_, Value_>) listVariableMetaModel;
    }
    throw new IllegalArgumentException(
        "The single genuine variable exists but is a basic variable, not a list variable.");
  }
  ...
  @SuppressWarnings("unchecked")
  private <Value_> PlanningListVariableMetaModel<Solution_, Entity_, Value_> castOrFailList(
      GenuineVariableMetaModel<Solution_, Entity_, ?> variable, String variableName) {
    if (!(variable
        instanceof PlanningListVariableMetaModel<Solution_, Entity_, ?> genuineVariable)) {
      throw new IllegalArgumentException(
  ...
  @Override
  public <Value_> ShadowVariableMetaModel<Solution_, Entity_, Value_> shadowVariable(
      String variableName) {
    return castOrFailShadow(variable(variableName), variableName);
  }

  @SuppressWarnings("unchecked")
  private <Value_> ShadowVariableMetaModel<Solution_, Entity_, Value_> castOrFailShadow(
      VariableMetaModel<Solution_, Entity_, ?> variable, String variableName) {
    if (!(variable
        instanceof ShadowVariableMetaModel<Solution_, Entity_, ?> shadowVariableMetaModel)) {
      throw new IllegalArgumentException(
  ...
  public void addVariable(VariableMetaModel<Solution_, Entity_, ?> variable) {
    if (variable.entity() != this) {
      throw new IllegalArgumentException(
          "The variable (%s) is not part of this entity (%s)."
  ...
  public String toString() {
    return "Genuine entity (%s) with variables (%s)"
        .formatted(
            type.getCanonicalName(), variables().stream().map(VariableMetaModel::name).toList());
  }
}
