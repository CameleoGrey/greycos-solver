...
import ai.greycos.solver.core.impl.heuristic.selector.value.decorator.MovableChainedTrailingValueFilter;
...
public final class BasicVariableDescriptor<Solution_> extends GenuineVariableDescriptor<Solution_> {
  ...
  public BasicVariableDescriptor(
      int ordinal,
  ...
  protected void processPropertyAnnotations(DescriptorPolicy descriptorPolicy) {
    PlanningVariable planningVariableAnnotation =
        variableMemberAccessor.getAnnotation(PlanningVariable.class);
    ...
    processSorting(
        sortingProperties.comparatorPropertyName(),
        sortingProperties.comparatorClass(),
        sortingProperties.comparatorFactoryPropertyName(),
        sortingProperties.comparatorFactoryClass());
  }
  ...
  private SortingProperties assertSortingProperties(PlanningVariable planningVariableAnnotation) {
    ...
    if (strengthWeightFactoryClass != null
        && PlanningVariable.NullComparatorFactory.class.isAssignableFrom(
    ...
    return new SortingProperties(
        selectedComparatorPropertyName,
        selectedComparatorClass,
  ...
  public <Entity_, Value_>
      PlanningVariableMetaModel<Solution_, Entity_, Value_> getVariableMetaModel() {
    return (PlanningVariableMetaModel<Solution_, Entity_, Value_>) super.getVariableMetaModel();
  }

  private record SortingProperties(
