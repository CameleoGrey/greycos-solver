...
public final class IterableFromSolutionPropertyValueSelector<Solution_>
  ...
  public IterableFromSolutionPropertyValueSelector(
  ...
  public SelectionCacheType getCacheType() {
    var intrinsicCacheType =
        valueRangeMightContainEntity ? SelectionCacheType.STEP : SelectionCacheType.PHASE;
  ...
  public void phaseStarted(AbstractPhaseScope<Solution_> phaseScope) {
    ...
    cachedValueRange =
        scoreDirector
            ...
            .getFromSolution(
                valueRangeDescriptor, scoreDirector.getWorkingSolution(), selectionSorter);
  ...
  public boolean equals(Object o) {
    if (!(o instanceof IterableFromSolutionPropertyValueSelector<?> that)) return false;
