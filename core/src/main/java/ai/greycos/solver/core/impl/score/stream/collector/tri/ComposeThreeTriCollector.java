...
final class ComposeThreeTriCollector<
        A,
        B,
        C,
        ResultHolder1_,
    ...
    implements TriConstraintCollector<
        A, B, C, Triple<ResultHolder1_, ResultHolder2_, ResultHolder3_>, Result_> {
  ...
  @Override
  public @NonNull
      QuadFunction<Triple<ResultHolder1_, ResultHolder2_, ResultHolder3_>, A, B, C, Runnable>
      accumulator() {
