...
import ai.greycos.solver.core.impl.bavet.tri.MapTriToBiNode;
...
final class BavetBiMapTriConstraintStream<Solution_, A, B, C, NewA, NewB>
  ...
  public BavetBiMapTriConstraintStream(
  ...
  public boolean equals(Object object) {
    ...
    BavetBiMapTriConstraintStream<?, ?, ?, ?, ?, ?> that =
        (BavetBiMapTriConstraintStream<?, ?, ?, ?, ?, ?>) object;
