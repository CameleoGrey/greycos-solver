...
public final class SimpleBigDecimalScore implements Score<SimpleBigDecimalScore> {
  ...
  /**
   * The total of the broken negative constraints and fulfilled positive constraints. Their weight
   * is included in the total. The score is usually a negative number because most use cases only
   * have negative constraints.
   *
