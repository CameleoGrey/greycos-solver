...
/**
 * When adding fields, remember to add them to the JSON serialization code as well, if you want them
 * exposed.
 *
 * @param <Value_>
 * @param <Point_>
...
final class SequenceImpl<
  ...
  SequenceImpl(
      ConsecutiveSetTree<Value_, Point_, Difference_> sourceTree,
