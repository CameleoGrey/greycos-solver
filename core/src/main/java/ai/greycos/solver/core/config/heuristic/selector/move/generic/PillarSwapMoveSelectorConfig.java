...
public class PillarSwapMoveSelectorConfig
  ...
  public void setSecondaryPillarSelectorConfig(
      @Nullable PillarSelectorConfig secondaryPillarSelectorConfig) {
  ...
  public @NonNull PillarSwapMoveSelectorConfig withSecondaryPillarSelectorConfig(
      @NonNull PillarSelectorConfig pillarSelectorConfig) {
    this.setSecondaryPillarSelectorConfig(pillarSelectorConfig);
    return this;
  }

  public @NonNull PillarSwapMoveSelectorConfig withVariableNameIncludeList(
      @NonNull List<@NonNull String> variableNameIncludeList) {
    this.setVariableNameIncludeList(variableNameIncludeList);
    return this;
  }

  public @NonNull PillarSwapMoveSelectorConfig withVariableNameIncludes(
      @NonNull String @NonNull ... variableNameIncludes) {
    this.setVariableNameIncludeList(List.of(variableNameIncludes));
    return this;
  }

  @Override
  public @NonNull PillarSwapMoveSelectorConfig inherit(
      @NonNull PillarSwapMoveSelectorConfig inheritedConfig) {
  ...
  public boolean hasNearbySelectionConfig() {
    return (pillarSelectorConfig != null && pillarSelectorConfig.hasNearbySelectionConfig())
        || (secondaryPillarSelectorConfig != null
            && secondaryPillarSelectorConfig.hasNearbySelectionConfig());
  }
