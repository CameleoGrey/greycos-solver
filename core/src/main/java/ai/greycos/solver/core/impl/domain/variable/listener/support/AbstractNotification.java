...
abstract class AbstractNotification {
  ...
  /**
   * Warning: do not test equality of {@link AbstractNotification}s for different {@link
   * InnerVariableListener}s (so {@link ShadowVariableDescriptor}s) because equality does not take
   * those into account (for performance)!
   *
