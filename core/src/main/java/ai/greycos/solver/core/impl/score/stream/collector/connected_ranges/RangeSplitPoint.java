...
public final class RangeSplitPoint<Range_, Point_ extends Comparable<Point_>>
  ...
  private static <Range_, Point_ extends Comparable<Point_>>
      Comparator<Range<Range_, Point_>> comparator(
          Function<Range<Range_, Point_>, Point_> function) {
  ...
  public void removeRangeStartingAtSplitPoint(Range<Range_, Point_> range) {
    Integer newCount =
        startpointRangeToCountMap.computeIfPresent(
            range.getValue(),
            (key, count) -> {
              if (count > 1) {
                return count - 1;
  ...
  public void removeRangeEndingAtSplitPoint(Range<Range_, Point_> range) {
    Integer newCount =
        endpointRangeToCountMap.computeIfPresent(
            range.getValue(),
            (key, count) -> {
              if (count > 1) {
                return count - 1;
  ...
  public boolean equals(Object o) {
    ...
    return o instanceof RangeSplitPoint<?, ?> other && splitPoint.equals(other.splitPoint);
  }
