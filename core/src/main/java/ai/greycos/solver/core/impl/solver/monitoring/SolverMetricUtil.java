package ai.greycos.solver.core.impl.solver.monitoring;
...
public final class SolverMetricUtil {
  ...
  public static @Nullable Double getGaugeValue(
      MeterRegistry registry, SolverMetric metric, Tags runId) {
  ...
  public static <Score_ extends Score<Score_>> @Nullable InnerScore<Score_> extractScore(
      SolverMetric metric,
      ScoreDefinition<Score_> scoreDefinition,
      Function<String, @Nullable Number> scoreLevelFunction) {
    var levelLabels = getLevelLabels(scoreDefinition);
