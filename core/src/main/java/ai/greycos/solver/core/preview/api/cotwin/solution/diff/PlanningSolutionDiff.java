...
/**
 * A diff between two instances of a {@link PlanningSolution}. Obtain using {@link
 * SolutionManager#diff(Object, Object)}. The first argument to that method is called the "old"
 * solution, and the second argument is called the "new" solution. See the Javadoc of {@link
 * SolutionManager#diff(Object, Object)} for more information.
 *
...
public interface PlanningSolutionDiff<Solution_> {
   ...
   */
  @Nullable <Entity_> PlanningEntityDiff<Solution_, Entity_> entityDiff(Entity_ entity);

  /**
   * Returns the diffs of all entities that can be found in both the old and new solution, where at
   * least one variable (genuine or shadow) of that entity changed.
   */
