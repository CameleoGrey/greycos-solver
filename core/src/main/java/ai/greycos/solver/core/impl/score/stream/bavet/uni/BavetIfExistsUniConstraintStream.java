...
import ai.greycos.solver.core.impl.bavet.uni.IndexedIfExistsUniNode;
import ai.greycos.solver.core.impl.bavet.uni.UnindexedIfExistsUniNode;
...
final class BavetIfExistsUniConstraintStream<Solution_, A, B>
  ...
  public BavetIfExistsUniConstraintStream(
  ...
  public <Score_ extends Score<Score_>> void buildNode(
    ...
    TupleLifecycle<UniTuple<A>> downstream =
    ...
    var positionTracker =
        buildHelper.getTupleStorePositionTracker(
            this, parentA.getTupleSource(), parentBridgeB.getTupleSource());
    var node =
        indexerFactory.hasJoiners()
            ...
            : (filtering == null
                ? new UnindexedIfExistsUniNode<>(shouldExist, downstream, positionTracker)
                : new UnindexedIfExistsUniNode<>(
  ...
  public boolean equals(Object object) {
    ...
    BavetIfExistsUniConstraintStream<?, ?, ?> that =
        (BavetIfExistsUniConstraintStream<?, ?, ?>) object;
    /*
    ...
    return shouldExist == that.shouldExist
        ...
        && Objects.equals(parentBridgeB.getParent(), that.parentBridgeB.getParent())
