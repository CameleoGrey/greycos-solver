...
final class RangeGapImpl<
  ...
  RangeGapImpl(
      ConnectedRange<Range_, Point_, Difference_> previousConnectedRange,
      ConnectedRange<Range_, Point_, Difference_> nextConnectedRange,
      Difference_ length) {
  ...
  void setPreviousConnectedRange(
      ConnectedRange<Range_, Point_, Difference_> previousConnectedRange) {
    this.previousConnectedRange = previousConnectedRange;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RangeGapImpl<?, ?, ?> rangeGap)) return false;
