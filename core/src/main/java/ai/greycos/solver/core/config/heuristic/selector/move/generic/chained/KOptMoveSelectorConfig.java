...
/**
 * THIS CLASS IS EXPERIMENTAL AND UNSUPPORTED. Backward compatibility is not guaranteed. It's NOT
 * DOCUMENTED because we'll only document it when it actually works in more than 1 use case.
 *
 * <p>Do not use.
 *
...
public class KOptMoveSelectorConfig extends MoveSelectorConfig<KOptMoveSelectorConfig> {
  ...
  /**
   * Like {@link TailChainSwapMoveSelectorConfig#valueSelectorConfig} but used multiple times to
   * create 1 move.
   */
  ...
  public @NonNull KOptMoveSelectorConfig withEntitySelectorConfig(
      @NonNull EntitySelectorConfig entitySelectorConfig) {
    this.setEntitySelectorConfig(entitySelectorConfig);
    return this;
  }

  public @NonNull KOptMoveSelectorConfig withValueSelectorConfig(
