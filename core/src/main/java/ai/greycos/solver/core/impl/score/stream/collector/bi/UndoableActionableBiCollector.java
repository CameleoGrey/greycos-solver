...
abstract sealed class UndoableActionableBiCollector<
        A, B, Input_, Output_, Calculator_ extends UndoableActionable<Input_, Output_>>
    implements BiConstraintCollector<A, B, Calculator_, Output_>
    permits MaxComparableBiCollector,
        MaxComparatorBiCollector,
        MaxPropertyBiCollector,
        MinComparableBiCollector,
        MinComparatorBiCollector,
