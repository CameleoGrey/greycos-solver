...
import ai.greycos.solver.core.impl.bavet.common.BavetRootNode.LifecycleOperation;
...
public abstract class AbstractSession {
  ...
  protected AbstractSession(NodeNetwork nodeNetwork) {
    ...
    this.retractEffectiveClassToNodeArrayMap =
        new IdentityHashMap<>(nodeNetwork.forEachNodeCount());
  }
  ...
  private BavetRootNode<Object>[] findNodes(
