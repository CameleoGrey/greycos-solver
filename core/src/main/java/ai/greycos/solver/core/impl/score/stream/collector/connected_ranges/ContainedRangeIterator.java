...
final class ContainedRangeIterator<Range_, Point_ extends Comparable<Point_>>
    implements Iterator<Range_> {
  ...
  ContainedRangeIterator(Iterable<RangeSplitPoint<Range_, Point_>> splitPointSet) {
    ...
    if (splitPointSetIterator.hasNext()) {
      splitPointValueIterator =
          splitPointSetIterator.next().getValuesStartingFromSplitPointIterator();
    }
  }
