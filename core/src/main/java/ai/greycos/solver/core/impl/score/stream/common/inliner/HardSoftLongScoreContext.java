...
final class HardSoftLongScoreContext
    extends ScoreContext<HardSoftLongScore, HardSoftLongScoreInliner> {

  public HardSoftLongScoreContext(
      HardSoftLongScoreInliner parent,
  ...
  public UndoScoreImpacter changeSoftScoreBy(
      long matchWeight, ConstraintMatchSupplier<HardSoftLongScore> constraintMatchSupplier) {
    ...
    return impactWithConstraintMatch(
        undoScoreImpact, HardSoftLongScore.ofSoft(softImpact), constraintMatchSupplier);
  }
  ...
  public UndoScoreImpacter changeHardScoreBy(
    ...
    return impactWithConstraintMatch(
        undoScoreImpact, HardSoftLongScore.ofHard(hardImpact), constraintMatchSupplier);
  }
  ...
  public UndoScoreImpacter changeScoreBy(
    ...
    return impactWithConstraintMatch(
        undoScoreImpact, HardSoftLongScore.of(hardImpact, softImpact), constraintMatchSupplier);
  }
}
