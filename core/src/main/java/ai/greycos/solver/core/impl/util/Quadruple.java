...
/**
 * An immutable tuple of four values. Two instances {@link Object#equals(Object) are equal} if all
 * four values in the first instance are equal to their counterpart in the other instance.
 *
 * @param <A>
 * @param <B>
 * @param <C>
