...
public interface SolverManager<Solution_> extends AutoCloseable {
   ...
   * @param <Solution_> the solution type, the class with the {@link PlanningSolution} annotation
   */
  static <Solution_> SolverManager<Solution_> create(
   ...
   */
  default SolverJob<Solution_> solve(
      Object problemId,
      Solution_ problem,
   ...
   */
  default SolverJob<Solution_> solveAndListen(
      Object problemId, Solution_ problem, Consumer<? super Solution_> bestSolutionConsumer) {
    return solveBuilder()
  ...
  default CompletableFuture<Void> addProblemChange(
      Object problemId, ProblemChange<Solution_> problemChange) {
   ...
   */
  CompletableFuture<Void> addProblemChanges(
