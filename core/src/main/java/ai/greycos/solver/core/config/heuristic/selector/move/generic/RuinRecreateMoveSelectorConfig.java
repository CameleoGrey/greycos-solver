...
public class RuinRecreateMoveSelectorConfig
  ...
  public @NonNull RuinRecreateMoveSelectorConfig withMinimumRuinedCount(
  ...
  public @NonNull RuinRecreateMoveSelectorConfig withMaximumRuinedCount(
  ...
  public @NonNull RuinRecreateMoveSelectorConfig withMinimumRuinedPercentage(
  ...
  public @NonNull RuinRecreateMoveSelectorConfig withEntitySelectorConfig(
  ...
  @Override
  public @NonNull RuinRecreateMoveSelectorConfig inherit(
      @NonNull RuinRecreateMoveSelectorConfig inheritedConfig) {
