package ai.greycos.solver.core.api.score.buildin.hardmediumsoftlong;
...
/**
 * This {@link Score} is based on 3 levels of long constraints: hard, medium and soft. Hard
 * constraints have priority over medium constraints. Medium constraints have priority over soft
 * constraints. Hard constraints determine feasibility.
 *
...
public final class HardMediumSoftLongScore implements Score<HardMediumSoftLongScore> {
  ...
  private static final HardMediumSoftLongScore MINUS_ONE_HARD =
      new HardMediumSoftLongScore(-1L, 0L, 0L);
  public static final HardMediumSoftLongScore ONE_MEDIUM = new HardMediumSoftLongScore(0L, 1L, 0L);
  private static final HardMediumSoftLongScore MINUS_ONE_MEDIUM =
      new HardMediumSoftLongScore(0L, -1L, 0L);
  public static final HardMediumSoftLongScore ONE_SOFT = new HardMediumSoftLongScore(0L, 0L, 1L);
  private static final HardMediumSoftLongScore MINUS_ONE_SOFT =
      new HardMediumSoftLongScore(0L, 0L, -1L);

  public static HardMediumSoftLongScore parseScore(String scoreString) {
    var scoreTokens =
        ScoreUtil.parseScoreTokens(
            HardMediumSoftLongScore.class, scoreString, HARD_LABEL, MEDIUM_LABEL, SOFT_LABEL);
    var hardScore =
        ScoreUtil.parseLevelAsLong(HardMediumSoftLongScore.class, scoreString, scoreTokens[0]);
    var mediumScore =
        ScoreUtil.parseLevelAsLong(HardMediumSoftLongScore.class, scoreString, scoreTokens[1]);
    var softScore =
        ScoreUtil.parseLevelAsLong(HardMediumSoftLongScore.class, scoreString, scoreTokens[2]);
  ...
  public static HardMediumSoftLongScore ofUninitialized(
      int initScore, long hardScore, long mediumScore, long softScore) {
    return of(hardScore, mediumScore, softScore);
  }
  ...
  public String toShortString() {
    return ScoreUtil.buildShortString(
        this, n -> n.longValue() != 0L, HARD_LABEL, MEDIUM_LABEL, SOFT_LABEL);
  }
