...
public final class SortingEntitySelector<Solution_>
  ...
  /**
   * The method ensures that cached items are loaded and sorted when the cache is set to STEP. This
   * logic is necessary for making the node compatible with sorting elements at the STEP level when
   * using entity-range. For this specific use case, we will fetch and sort the data after the phase
   * has started but before the step begins.
   */
  ...
  public void constructCache(SolverScope<Solution_> solverScope) {
    ...
    logger.trace(
        "    Sorted cachedEntityList: size ({}), entitySelector ({}).",
