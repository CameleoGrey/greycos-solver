...
import ai.greycos.solver.core.impl.neighborhood.stream.enumerating.joiner.FilteringBiEnumeratingJoiner;
...
/**
 * Creates an {@link BiEnumeratingJoiner}, ... instance for use in {@link
 * UniEnumeratingStream#join(Class, BiEnumeratingJoiner[])}, ...
 */
@NullMarked
public final class EnumeratingJoiners {
   ...
   */
  public static <A, B, Property_> BiEnumeratingJoiner<A, B> equal(
   ...
   * @param <Property_> the type of the property to compare
   */
  public static <A, Property_ extends Comparable<Property_>> BiEnumeratingJoiner<A, A> lessThan(
  ...
  public static <A, Property_ extends Comparable<Property_>>
      BiEnumeratingJoiner<A, A> lessThanOrEqual(Function<A, Property_> mapping) {
  ...
  public static <A, B, Property_ extends Comparable<Property_>>
      BiEnumeratingJoiner<A, B> lessThanOrEqual(
          Function<A, Property_> leftMapping, Function<B, Property_> rightMapping) {
    return new DefaultBiEnumeratingJoiner<>(
   ...
   */
  public static <A, B, Property_ extends Comparable<Property_>>
      BiEnumeratingJoiner<A, B> greaterThan(
          Function<A, Property_> leftMapping, Function<B, Property_> rightMapping) {
   ...
   */
  public static <A, Property_ extends Comparable<Property_>>
      BiEnumeratingJoiner<A, A> greaterThanOrEqual(Function<A, Property_> mapping) {
   ...
   */
  public static <A, B, Property_ extends Comparable<Property_>>
      BiEnumeratingJoiner<A, B> greaterThanOrEqual(
          Function<A, Property_> leftMapping, Function<B, Property_> rightMapping) {
    return new DefaultBiEnumeratingJoiner<>(
   ...
   */
  public static <Solution_, A, B> BiEnumeratingJoiner<A, B> filtering(
   ...
   */
  public static <A, B, Property_ extends Comparable<Property_>>
      BiEnumeratingJoiner<A, B> overlapping(
