...
public final class MemberAccessorFactory {
   ...
   * @param classLoader null or {@link GizmoClassLoader} if domainAccessType is {@link
    ...
    return memberAccessorCache.computeIfAbsent(
        ...
        k ->
            MemberAccessorFactory.buildMemberAccessor(
                member, memberAccessorType, annotationClass, domainAccessType, gizmoClassLoader));
  }
   ...
   */
  public MemberAccessor buildAndCacheMemberAccessor(
      Member member, MemberAccessorType memberAccessorType, DomainAccessType domainAccessType) {
    String generatedClassName = GizmoMemberAccessorFactory.getGeneratedClassName(member);
    return memberAccessorCache.computeIfAbsent(
        generatedClassName,
        k ->
            MemberAccessorFactory.buildMemberAccessor(
                member, memberAccessorType, domainAccessType, gizmoClassLoader));
  }
