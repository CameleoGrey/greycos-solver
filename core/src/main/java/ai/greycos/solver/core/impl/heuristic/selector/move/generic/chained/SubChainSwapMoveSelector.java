...
public class SubChainSwapMoveSelector<Solution_> extends GenericMoveSelector<Solution_> {
  ...
  public SubChainSwapMoveSelector(
  ...
  public boolean isNeverEnding() {
    return randomSelection
        || leftSubChainSelector.isNeverEnding()
        || rightSubChainSelector.isNeverEnding();
  }
    ...
    if (!randomSelection) {
      return new AbstractOriginalSwapIterator<>(leftSubChainSelector, rightSubChainSelector) {
        ...
        protected Move<Solution_> newSwapSelection(
            SubChain leftSubSelection, SubChain rightSubSelection) {
