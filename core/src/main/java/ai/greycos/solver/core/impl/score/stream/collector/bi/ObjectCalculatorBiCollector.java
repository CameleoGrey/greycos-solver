...
abstract sealed class ObjectCalculatorBiCollector<
        A,
        B,
        Input_,
        Output_,
    ...
    permits AverageReferenceBiCollector,
        ConnectedRangesBiConstraintCollector,
        ConsecutiveSequencesBiConstraintCollector,
        CountDistinctIntBiCollector,
        CountDistinctLongBiCollector,
