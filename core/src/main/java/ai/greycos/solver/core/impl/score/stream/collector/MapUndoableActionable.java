...
public final class MapUndoableActionable<
        Key_, Value_, ResultValue_, Result_ extends Map<Key_, ResultValue_>>
    implements UndoableActionable<Pair<Key_, Value_>, Result_> {
  ToMapResultContainer<Key_, Value_, ResultValue_, Result_> container;

  private MapUndoableActionable(
      ToMapResultContainer<Key_, Value_, ResultValue_, Result_> container) {
  ...
  public static <Key_, Value_, Set_ extends Set<Value_>, Result_ extends Map<Key_, Set_>>
    ...
    return new MapUndoableActionable<>(
        new ToMultiMapResultContainer<>(resultSupplier, setFunction));
  }

  public static <Key_, Value_, Result_ extends Map<Key_, Value_>>
      MapUndoableActionable<Key_, Value_, Value_, Result_> mergeMap(
          Supplier<Result_> resultSupplier, BinaryOperator<Value_> mergeFunction) {
    return new MapUndoableActionable<>(
        new ToSimpleMapResultContainer<>(resultSupplier, mergeFunction));
  }
