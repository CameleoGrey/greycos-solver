...
import ai.greycos.solver.core.impl.bavet.uni.ForEachFilteredUniNode;
import ai.greycos.solver.core.impl.bavet.uni.ForEachUnfilteredUniNode;
...
public final class BavetForEachUniConstraintStream<Solution_, A>
  ...
  public BavetForEachUniConstraintStream(
  ...
  public <Score_ extends Score<Score_>> void buildNode(
    ...
    TupleLifecycle<UniTuple<A>> tupleLifecycle =
    ...
    var node =
        filter == null
            ? new ForEachUnfilteredUniNode<>(forEachClass, tupleLifecycle, outputStoreSize)
  ...
  public boolean equals(Object other) {
    ...
    return Objects.equals(forEachClass, that.forEachClass)
  ...
  public String toString() {
    if (filterFunction != null) {
      return "ForEach("
          + forEachClass.getSimpleName()
          + ") with filter and "
          + childStreamList.size()
          + " children";
    }
    return "ForEach("
        + forEachClass.getSimpleName()
