...
public class DeclarativeShadowVariableDescriptor<Solution_>
  ...
  public DeclarativeShadowVariableDescriptor(
      int ordinal,
  ...
  public void processAnnotations(DescriptorPolicy descriptorPolicy) {
    ...
    if (shadowVariableUpdater.alignmentKey() != null
        && !shadowVariableUpdater.alignmentKey().isEmpty()) {
  ...
  public void linkVariableDescriptors(DescriptorPolicy descriptorPolicy) {
    ...
    var alignmentKeyMember =
        getAlignmentKeyMemberForEntityProperty(
            solutionMetamodel,
            entityDescriptor.getEntityClass(),
            calculator,
            variableName,
  ...
  protected static Member getAlignmentKeyMemberForEntityProperty(
    ...
    Member member =
        RootVariableSource.getMember(entityClass, propertyName, entityClass, propertyName);
    if (RootVariableSource.isVariable(
  ...
  void visitAllReferencedEntities(
      Object entity, BiConsumer<RootVariableSource<?, ?>, Object> visitor) {
