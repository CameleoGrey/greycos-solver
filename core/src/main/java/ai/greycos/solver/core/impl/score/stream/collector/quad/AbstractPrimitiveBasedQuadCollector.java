...
abstract class AbstractPrimitiveBasedQuadCollector<A, B, C, D, Output_, State_>
  ...
  public AbstractPrimitiveBasedQuadCollector(
      ToLongQuadFunction<? super A, ? super B, ? super C, ? super D> mapper) {
    this.mapper = mapper;
  }

  protected abstract QuadConstraintCollectorValueHandle<A, B, C, D> newAccumulatedValue(
      State_ state);
  ...
  public boolean equals(Object object) {
    ...
    var that = (AbstractPrimitiveBasedQuadCollector<?, ?, ?, ?, ?, ?>) object;
