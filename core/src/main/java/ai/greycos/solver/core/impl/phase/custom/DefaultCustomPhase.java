...
import ai.greycos.solver.core.impl.phase.custom.scope.CustomStepScope;
...
public final class DefaultCustomPhase<Solution_>
    extends AbstractPossiblyInitializingPhase<Solution_> implements CustomPhase<Solution_> {
  ...
  public void solve(SolverScope<Solution_> solverScope) {
    ...
    // ended.
    terminationStatus =
        translateEarlyTermination(phaseScope, earlyTerminationStatus, iterator.hasNext());
  ...
  public void stepEnded(CustomStepScope<Solution_> stepScope) {
    ...
    if (logger.isDebugEnabled()) {
      logger.debug(
          "{}    Custom step ({}), time spent ({}), score ({}), {} best score ({}).",
          logIndentation,
