...
import ai.greycos.solver.core.impl.bavet.tri.MapTriToUniNode;
...
final class BavetUniMapTriConstraintStream<Solution_, A, B, C, NewA>
  ...
  public BavetUniMapTriConstraintStream(
      BavetConstraintFactory<Solution_> constraintFactory,
      BavetAbstractTriConstraintStream<Solution_, A, B, C> parent,
      TriFunction<A, B, C, NewA> mappingFunction) {
  ...
  public boolean equals(Object object) {
    ...
    BavetUniMapTriConstraintStream<?, ?, ?, ?, ?> that =
        (BavetUniMapTriConstraintStream<?, ?, ?, ?, ?>) object;
