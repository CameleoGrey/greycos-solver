package ai.greycos.solver.core.impl.bavet.quad.joiner;
...
public final class QuadJoinerComber<A, B, C, D> {
  ...
  private static <A, B, C, D> QuadPredicate<A, B, C, D> mergeFiltering(
  ...
  public QuadJoinerComber(
      DefaultQuadJoiner<A, B, C, D> mergedJoiner, QuadPredicate<A, B, C, D> mergedFiltering) {
