...
public class PillarChangeMoveSelectorConfig
  ...
  public @NonNull PillarChangeMoveSelectorConfig withValueSelectorConfig(
  ...
  @Override
  public @NonNull PillarChangeMoveSelectorConfig inherit(
      @NonNull PillarChangeMoveSelectorConfig inheritedConfig) {
