package ai.greycos.solver.core.config.constructionheuristic.placer;
...
public class QueuedEntityPlacerConfig extends EntityPlacerConfig<QueuedEntityPlacerConfig> {
  ...
  @Override
  public @NonNull QueuedEntityPlacerConfig inherit(
      @NonNull QueuedEntityPlacerConfig inheritedConfig) {
