...
public final class DefaultSolverFactory<Solution_> implements SolverFactory<Solution_> {
  ...
  public @NonNull Solver<Solution_> buildSolver(
    ...
    return new DefaultSolver<>(
        ...
        moveThreadCount == null
            ...
            : Integer.toString(moveThreadCount));
  }

  public @Nullable Integer resolveMoveThreadCount(boolean enforceMaximum) {
    var maybeCount =
        new MoveThreadCountResolver()
            .resolveMoveThreadCount(solverConfig.getMoveThreadCount(), enforceMaximum);
  ...
  public List<Phase<Solution_>> buildPhaseList(
    ...
    if (ConfigUtils.isEmptyCollection(phaseConfigList)) {
      var genuineEntityDescriptorCollection =
    ...
    return PhaseFactory.buildPhases(
        phaseConfigList, configPolicy, bestSolutionRecaller, termination);
  }

  private ConstructionHeuristicPhaseConfig buildConstructionHeuristicPhaseConfigForBasicVariable(
  ...
  public void ensurePreviewFeature(PreviewFeature previewFeature) {
    HeuristicConfigPolicy.ensurePreviewFeature(
        previewFeature, solverConfig.getEnablePreviewFeatureSet());
  }
