...
public class TailChainSwapMove<Solution_> extends AbstractMove<Solution_> {
  ...
  public TailChainSwapMove(
    ...
    rightAnchor =
        variableDescriptor.isValuePotentialAnchor(rightValue)
            ? rightValue
    ...
    if (!sameAnchor) {
      ...
      rightNextEntity =
          rightEntity == null ? null : inverseVariableSupply.getInverseSingleton(rightEntity);
      Object lastEntityInChainOrLeftEntity =
          findLastEntityInChainOrLeftEntity(inverseVariableSupply);
  ...
  private Object findLastEntityInChainOrLeftEntity(
      SingletonInverseVariableSupply inverseVariableSupply) {
  ...
  public boolean isMoveDoable(ScoreDirector<Solution_> scoreDirector) {
    if (Objects.equals(leftValue, rightValue)
        || Objects.equals(leftEntity, rightValue)
        || Objects.equals(rightEntity, leftValue)) {
      return false;
    }
    if (rightEntity == null) {
