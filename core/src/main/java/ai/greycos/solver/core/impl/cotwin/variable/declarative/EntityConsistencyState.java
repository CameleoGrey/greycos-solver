...
public final class EntityConsistencyState<Solution_, Entity_> {
  ...
  @Nullable
  private final ExternalizedShadowVariableInconsistentProcessor<Solution_>
  ...
  EntityConsistencyState(
    ...
    var entityIsInconsistentDescriptor =
    ...
    if (entityIsInconsistentDescriptor == null) {
      ...
      arbitraryDeclarativeVariableDescriptor =
          entityDescriptor.getShadowVariableDescriptors().stream()
              .filter(
                  variableDescriptor ->
                      variableDescriptor instanceof DeclarativeShadowVariableDescriptor<?>)
              .findFirst()
              .orElseThrow(
                  () ->
  ...
  public void setEntityIsInconsistent(
      ChangedVariableNotifier<Solution_> changedVariableNotifier,
      Entity_ entity,
      boolean isInconsistent) {
    if (externalizedShadowVariableInconsistentProcessor != null) {
      externalizedShadowVariableInconsistentProcessor.setIsEntityInconsistent(
          changedVariableNotifier, entity, isInconsistent);
    }
    ...
    changedVariableNotifier
        ...
        .accept(arbitraryDeclarativeVariableDescriptor, entity);
