...
import ai.greycos.solver.core.impl.neighborhood.stream.enumerating.common.AbstractRightDataset;
...
public final class UniRightDataset<Solution_, A, B> extends AbstractRightDataset<Solution_, B> {
  ...
  @Override
  public UniRightDatasetInstance<Solution_, A, B> instantiate(
      int compositeKeyStoreIndex, int entryStoreIndex) {
    var indexerFactory = new IndexerFactory<>(joinerComber.mergedJoiner());
    return new UniRightDatasetInstance<>(
        this,
        indexerFactory,
