...
@NullMarked
public final class ComposeTwoUniNeighborhoodsCollector<
        Solution_, A, ResultHolder1_, ResultHolder2_, Result1_, Result2_, Result_>
    implements UniNeighborhoodsCollector<
        Solution_, A, Pair<ResultHolder1_, ResultHolder2_>, Result_> {
  ...
  private final UniNeighborhoodsCollectorAccumulator<Solution_, A, ResultHolder2_>
      secondAccumulator;
  ...
  @Override
  public UniNeighborhoodsCollectorAccumulator<Solution_, A, Pair<ResultHolder1_, ResultHolder2_>>
      accumulator() {
