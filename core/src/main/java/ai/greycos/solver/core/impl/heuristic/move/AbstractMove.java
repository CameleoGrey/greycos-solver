...
public abstract class AbstractMove<Solution_> extends AbstractSelectorBasedMove<Solution_>
  ...
  /**
   * Called before the move is done, so the move can be evaluated and then be undone without
   * resulting into a permanent change in the solution.
   *
  ...
  public static <E> List<E> rebaseList(
