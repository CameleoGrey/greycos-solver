...
final class ComposeTwoTriCollector<
        A, B, C, ResultHolder1_, ResultHolder2_, Result1_, Result2_, Result_>
  ...
  @Override
  public @NonNull QuadFunction<Pair<ResultHolder1_, ResultHolder2_>, A, B, C, Runnable>
      accumulator() {
    return (resultHolder, a, b, c) ->
        composeUndo(
            firstAccumulator.apply(resultHolder.key(), a, b, c),
