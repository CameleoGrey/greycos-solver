...
public final class ListVariableDescriptor<Solution_> extends GenuineVariableDescriptor<Solution_> {
  ...
  protected void processPropertyAnnotations(DescriptorPolicy descriptorPolicy) {
    PlanningListVariable planningVariableAnnotation =
        variableMemberAccessor.getAnnotation(PlanningListVariable.class);
    ...
    processSorting(
        "comparatorClass",
        planningVariableAnnotation.comparatorClass(),
  ...
  public Class<?> getElementType() {
    return ConfigUtils.extractGenericTypeParameterOrFail(
        "entityClass",
        entityDescriptor.getEntityClass(),
        variableMemberAccessor.getType(),
        variableMemberAccessor.getGenericType(),
        PlanningListVariable.class,
        variableMemberAccessor.getName());
  }

  public InverseRelationShadowVariableDescriptor<Solution_>
    ...
    var applicableShadowDescriptors =
        inverseRelationEntityDescriptor.getShadowVariableDescriptors().stream()
            .filter(
                f ->
                    f
                            instanceof
    ...
    if (applicableShadowDescriptors.isEmpty()) {
      ...
      return (InverseRelationShadowVariableDescriptor<Solution_>)
          applicableShadowDescriptors.get(0);
    }
  }
  ...
  public List<Object> getValue(Object entity) {
    ...
    if (value == null) {
      throw new IllegalStateException(
          "The planning list variable (%s) of entity (%s) is null.".formatted(this, entity));
    }
  ...
  public Object getRandomUnpinnedElement(Object entity, Random workingRandom) {
    ...
    return listVariable.get(
        workingRandom.nextInt(listVariable.size() - firstUnpinnedIndex) + firstUnpinnedIndex);
  }
  ...
  public <Entity_, Value_>
      PlanningListVariableMetaModel<Solution_, Entity_, Value_> getVariableMetaModel() {
