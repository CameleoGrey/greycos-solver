...
/**
 * Tracks variable listener events for a given {@link
...
public class ListVariableTracker<Solution_>
  ...
  /**
   * In order for the {@link ListVariableTracker} to be registered as a variable listener, it needs
   * to be passed to the {@link InnerScoreDirector#getSupplyManager()}, which requires a {@link
   * Demand}.
   *
