...
import ai.greycos.solver.core.impl.bavet.quad.FlattenLastQuadNode;
...
final class BavetFlattenLastQuadConstraintStream<Solution_, A, B, C, D, NewD>
  ...
  public BavetFlattenLastQuadConstraintStream(
  ...
  public void setAftBridge(
      BavetAftBridgeQuadConstraintStream<Solution_, A, B, C, NewD> flattenLastStream) {
