...
import ai.greycos.solver.core.impl.bavet.bi.MapBiToTriNode;
...
final class BavetTriMapBiConstraintStream<Solution_, A, B, NewA, NewB, NewC>
  ...
  public BavetTriMapBiConstraintStream(
      BavetConstraintFactory<Solution_> constraintFactory,
      BavetAbstractBiConstraintStream<Solution_, A, B> parent,
      BiFunction<A, B, NewA> mappingFunctionA,
  ...
  public void setAftBridge(
      BavetAftBridgeTriConstraintStream<Solution_, NewA, NewB, NewC> aftStream) {
  ...
  public boolean equals(Object object) {
    ...
    BavetTriMapBiConstraintStream<?, ?, ?, ?, ?, ?> that =
        (BavetTriMapBiConstraintStream<?, ?, ?, ?, ?, ?>) object;
    return Objects.equals(parent, that.parent)
        && guaranteesDistinct == that.guaranteesDistinct
  ...
  public int hashCode() {
    return Objects.hash(
        parent, mappingFunctionA, mappingFunctionB, mappingFunctionC, guaranteesDistinct);
  }
