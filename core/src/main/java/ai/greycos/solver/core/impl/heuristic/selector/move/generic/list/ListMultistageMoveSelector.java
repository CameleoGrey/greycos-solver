...
import ai.greycos.solver.core.impl.heuristic.selector.move.generic.MultistageMoveSelector;
 ...
 * Extends basic {@link MultistageMoveSelector} to provide list-specific optimizations and type
 * safety.
 *
 * <p>Example use cases:
 *
 ...
 * </ul>
 *
 * <p>The behavior is identical to basic multistage move selector, but this class exists for:
 *
 * <ul>
 ...
 */
public class ListMultistageMoveSelector<Solution_> extends MultistageMoveSelector<Solution_> {
