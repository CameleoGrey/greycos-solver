...
public class SubChainSwapMoveSelectorConfig
  ...
  public void setSecondarySubChainSelectorConfig(
  ...
  public @NonNull SubChainSwapMoveSelectorConfig withSubChainSelectorConfig(
      @NonNull SubChainSelectorConfig subChainSelectorConfig) {
    this.setSubChainSelectorConfig(subChainSelectorConfig);
    return this;
  }

  public @NonNull SubChainSwapMoveSelectorConfig withSecondarySubChainSelectorConfig(
  ...
  public @NonNull SubChainSwapMoveSelectorConfig withSelectReversingMoveToo(
  ...
  @Override
  public @NonNull SubChainSwapMoveSelectorConfig inherit(
      @NonNull SubChainSwapMoveSelectorConfig inheritedConfig) {
  ...
  public boolean hasNearbySelectionConfig() {
    return (subChainSelectorConfig != null && subChainSelectorConfig.hasNearbySelectionConfig())
        || (secondarySubChainSelectorConfig != null
            && secondarySubChainSelectorConfig.hasNearbySelectionConfig());
  }
