...
import ai.greycos.solver.core.impl.bavet.tri.MapTriToTriNode;
...
final class BavetTriMapTriConstraintStream<Solution_, A, B, C, NewA, NewB, NewC>
  ...
  public BavetTriMapTriConstraintStream(
      ...
      TriFunction<A, B, C, NewC> mappingFunctionC) {
  ...
  public boolean equals(Object object) {
    ...
    BavetTriMapTriConstraintStream<?, ?, ?, ?, ?, ?, ?> that =
        (BavetTriMapTriConstraintStream<?, ?, ?, ?, ?, ?, ?>) object;
