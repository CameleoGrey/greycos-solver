...
import ai.greycos.solver.core.impl.bavet.common.AbstractConcatNode;
...
import ai.greycos.solver.core.impl.bavet.quad.ConcatBiQuadNode;
import ai.greycos.solver.core.impl.bavet.quad.ConcatQuadBiNode;
import ai.greycos.solver.core.impl.score.stream.bavet.BavetConstraintFactory;
import ai.greycos.solver.core.impl.score.stream.bavet.common.BavetConcatConstraintStream;
...
public final class BavetBiConcatQuadConstraintStream<Solution_, A, B, C, D>
  ...
  public BavetBiConcatQuadConstraintStream(
      ...
      BiFunction<A, B, C> paddingFunctionC,
  ...
  private interface ConcatNodeConstructor<A, B, C, D> {
    ...
    AbstractConcatNode<?, ?, ?> apply(
        ...
        int leftCloneStoreIndex,
        int rightCloneStoreIndex,
        int outputStoreSize);
  }
}
