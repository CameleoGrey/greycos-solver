...
/**
 * For each entity whose basic planning variable is currently assigned (non-null), creates a move to
 * unassign it (set the variable to null).
 *
 * <p>This provider only applies to planning variables that allow unassigned values. For the
 * complementary moves:
 *
 * <ul>
 *   <li>Use {@link AssignMoveProvider} to assign a value to currently-unassigned entities.
 *   <li>Use {@link ChangeMoveProvider} to change an entity's value to a different non-null value.
 * </ul>
 *
 ...
 */
@NullMarked
public class UnassignMoveProvider<Solution_, Entity_, Value_> implements MoveProvider<Solution_> {

  private final PlanningVariableMetaModel<Solution_, Entity_, Value_> variableMetaModel;

  public UnassignMoveProvider(
  ...
  public MoveStream<Solution_> build(MoveStreamFactory<Solution_> moveStreamFactory) {
    return moveStreamFactory
        ...
        .asMove(
            (view, entity) ->
                Moves.change(variableMetaModel, Objects.requireNonNull(entity), null));
  }
}
