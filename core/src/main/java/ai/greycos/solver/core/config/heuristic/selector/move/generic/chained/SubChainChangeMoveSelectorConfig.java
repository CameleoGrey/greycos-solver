...
public class SubChainChangeMoveSelectorConfig
    extends MoveSelectorConfig<SubChainChangeMoveSelectorConfig> {
  ...
  public @NonNull SubChainChangeMoveSelectorConfig withSubChainSelectorConfig(
      @NonNull SubChainSelectorConfig subChainSelectorConfig) {
    this.setSubChainSelectorConfig(subChainSelectorConfig);
    return this;
  }

  public @NonNull SubChainChangeMoveSelectorConfig withValueSelectorConfig(
      @NonNull ValueSelectorConfig valueSelectorConfig) {
    this.setValueSelectorConfig(valueSelectorConfig);
    return this;
  }

  public @NonNull SubChainChangeMoveSelectorConfig withSelectReversingMoveToo(
  ...
  @Override
  public @NonNull SubChainChangeMoveSelectorConfig inherit(
      @NonNull SubChainChangeMoveSelectorConfig inheritedConfig) {
