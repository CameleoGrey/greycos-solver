...
import ai.greycos.solver.core.impl.heuristic.selector.value.chained.SubChainSelectorFactory;
  ...
  protected MoveSelector<Solution_> buildBaseMoveSelector(
    ...
    SubChainSelectorConfig subChainSelectorConfig =
        Objects.requireNonNullElseGet(
            config.getSubChainSelectorConfig(), SubChainSelectorConfig::new);
    SubChainSelectorConfig secondarySubChainSelectorConfig =
        Objects.requireNonNullElse(
            config.getSecondarySubChainSelectorConfig(), subChainSelectorConfig);
    ...
    SubChainSelector<Solution_> rightSubChainSelector =
        SubChainSelectorFactory.<Solution_>create(secondarySubChainSelectorConfig)
            .buildSubChainSelector(
                configPolicy, entityDescriptor, minimumCacheType, selectionOrder);
    return new SubChainSwapMoveSelector<>(
