...
public class SubListSwapMove<Solution_> extends AbstractMove<Solution_> {
  ...
  public SubListSwapMove(
    ...
    if (leftSubList.entity() == rightSubList.entity()
        && leftSubList.fromIndex() > rightSubList.fromIndex()) {
  ...
  protected void doMoveOnGenuineVariables(ScoreDirector<Solution_> scoreDirector) {
    ...
    if (leftEntity == rightEntity) {
      ...
      castScoreDirector.beforeListVariableChanged(
          variableDescriptor, leftEntity, leftFromIndex, leftFromIndex + leftSubListLength);
      castScoreDirector.beforeListVariableChanged(
          variableDescriptor, rightEntity, rightFromIndex, rightFromIndex + rightSubListLength);
      rightSubListView.clear();
      leftSubListView.clear();
      leftList.addAll(leftFromIndex, rightPlanningValueList);
      rightList.addAll(rightFromIndex, leftPlanningValueList);
      castScoreDirector.afterListVariableChanged(
          variableDescriptor, leftEntity, leftFromIndex, leftFromIndex + rightSubListLength);
      castScoreDirector.afterListVariableChanged(
  ...
  private List<Object> subList(SubList subList) {
    return variableDescriptor
        .getValue(subList.entity())
        .subList(subList.fromIndex(), subList.getToIndex());
  }
  ...
  public boolean equals(Object o) {
    ...
    return reversing == other.reversing
        && rightFromIndex == other.rightFromIndex
        && leftToIndex == other.leftToIndex
  ...
  public int hashCode() {
    return Objects.hash(
        variableDescriptor, leftSubList, rightSubList, reversing, rightFromIndex, leftToIndex);
  }
