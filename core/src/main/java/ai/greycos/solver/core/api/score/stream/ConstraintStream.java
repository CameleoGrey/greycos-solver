...
public interface ConstraintStream {
   ...
   *
   * <p>To avoid hard-coding the constraintWeight, to allow end-users to tweak it, use {@link
   * #penalizeConfigurable(String)} and a {@link ConstraintConfiguration} instead.
   *
   * <p>The {@link ConstraintRef#packageName() constraint package} defaults to the package of the
   * {@link PlanningSolution} class.
   *
   * @deprecated Prefer {@link UniConstraintStream#penalize(Score)} and equivalent bi/tri/...
   *     overloads.
   * @param constraintName shows up in {@link ConstraintMatchTotal} during score justification
   */
  @Deprecated(forRemoval = true)
  @NonNull Constraint penalize(@NonNull String constraintName, @NonNull Score<?> constraintWeight);
   ...
   */
  @Deprecated(forRemoval = true)
  @NonNull Constraint penalizeConfigurable(@NonNull String constraintName);
   ...
   * {@link PlanningSolution} class.
   *
   * @deprecated Prefer {@link UniConstraintStream#reward(Score)} and equivalent bi/tri/...
   *     overloads.
   * @param constraintName shows up in {@link ConstraintMatchTotal} during score justification
   */
  @Deprecated(forRemoval = true)
  @NonNull Constraint reward(@NonNull String constraintName, @NonNull Score<?> constraintWeight);
   ...
   */
  @Deprecated(forRemoval = true)
  @NonNull Constraint rewardConfigurable(@NonNull String constraintName);
   ...
   */
  @Deprecated(forRemoval = true)
  @NonNull Constraint rewardConfigurable(
      @NonNull String constraintPackage, @NonNull String constraintName);
   ...
   * {@link PlanningSolution} class.
   *
   * @deprecated Prefer {@link UniConstraintStream#impact(Score)} and equivalent bi/tri/...
   *     overloads.
   * @param constraintName shows up in {@link ConstraintMatchTotal} during score justification
   */
  @Deprecated(forRemoval = true)
  @NonNull Constraint impact(@NonNull String constraintName, @NonNull Score<?> constraintWeight);
