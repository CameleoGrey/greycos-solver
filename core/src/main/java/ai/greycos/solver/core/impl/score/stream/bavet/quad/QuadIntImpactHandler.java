...
@NullMarked
record QuadIntImpactHandler<A, B, C, D>(ToIntQuadFunction<A, B, C, D> matchWeigher)
  ...
  public ScoreImpact<?> impactNaked(
    ...
    return impacter.impactScore(
        matchWeigher.applyAsInt(tuple.getA(), tuple.getB(), tuple.getC(), tuple.getD()), null);
  }
  ...
  public ScoreImpact<?> impactWithoutJustification(
      WeightedScoreImpacter<?, ?> impacter, QuadTuple<A, B, C, D> tuple) {
    return impacter.impactScore(
        matchWeigher.applyAsInt(tuple.getA(), tuple.getB(), tuple.getC(), tuple.getD()),
