package ai.greycos.solver.core.config.heuristic.selector.value.chained;
...
public class SubChainSelectorConfig extends SelectorConfig<SubChainSelectorConfig> {
  ...
  public @NonNull SubChainSelectorConfig withValueSelectorConfig(
      @NonNull ValueSelectorConfig valueSelectorConfig) {
    this.setValueSelectorConfig(valueSelectorConfig);
    return this;
  }

  public @NonNull SubChainSelectorConfig withMinimumSubChainSize(
      @NonNull Integer minimumSubChainSize) {
    this.setMinimumSubChainSize(minimumSubChainSize);
    return this;
  }

  public @NonNull SubChainSelectorConfig withMaximumSubChainSize(
      @NonNull Integer maximumSubChainSize) {
  ...
  public @NonNull SubChainSelectorConfig inherit(@NonNull SubChainSelectorConfig inheritedConfig) {
    ...
    minimumSubChainSize =
        ConfigUtils.inheritOverwritableProperty(
            minimumSubChainSize, inheritedConfig.getMinimumSubChainSize());
    maximumSubChainSize =
        ConfigUtils.inheritOverwritableProperty(
            maximumSubChainSize, inheritedConfig.getMaximumSubChainSize());
    return this;
  }
