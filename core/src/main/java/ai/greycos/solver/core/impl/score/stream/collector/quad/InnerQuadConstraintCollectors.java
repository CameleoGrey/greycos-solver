...
public class InnerQuadConstraintCollectors {
  ...
  public static <
    ...
    return new ComposeFourQuadCollector<>(first, second, third, fourth, composeFunction);
  }
  ...
  public static <
    ...
    return new ComposeThreeQuadCollector<>(first, second, third, composeFunction);
  }
  ...
  public static <A, B, C, D, ResultHolder1_, ResultHolder2_, Result1_, Result2_, Result_>
    ...
    return new ComposeTwoQuadCollector<>(first, second, composeFunction);
  }
  ...
  public static <
          A, B, C, D, Key_, Value_, Set_ extends Set<Value_>, Result_ extends Map<Key_, Set_>>
    ...
    return new ToMultiMapQuadCollector<>(keyFunction, valueFunction, mapSupplier, setFunction);
  }
  ...
  public static <A, B, C, D, Key_, Value_, Result_ extends Map<Key_, Value_>>
    ...
    return new ToSimpleMapQuadCollector<>(keyFunction, valueFunction, mapSupplier, mergeFunction);
  }
  ...
  public static <A, B, C, D, Mapped_>
      QuadConstraintCollector<A, B, C, D, ?, SortedSet<Mapped_>> toSortedSet(
          QuadFunction<? super A, ? super B, ? super C, ? super D, ? extends Mapped_> mapper,
  ...
  public static <A, B, C, D, Result_>
      QuadConstraintCollector<A, B, C, D, ?, SequenceChain<Result_, Integer>>
          toConsecutiveSequences(
              QuadFunction<A, B, C, D, Result_> resultMap, ToIntFunction<Result_> indexMap) {
      ...
      QuadConstraintCollector<A, B, C, D, ?, ConnectedRangeChain<Interval_, Point_, Difference_>>
          toConnectedRanges(
              ...
              BiFunction<? super Point_, ? super Point_, ? extends Difference_>
                  differenceFunction) {
    return new ConnectedRangesQuadConstraintCollector<>(
        mapper, startMap, endMap, differenceFunction);
  }

  public static <A, B, C, D, Intermediate_, Result_>
      QuadConstraintCollector<A, B, C, D, ?, Result_> collectAndThen(
          QuadConstraintCollector<A, B, C, D, ?, Intermediate_> delegate,
  ...
  public static <A, B, C, D, Balanced_>
      QuadConstraintCollector<A, B, C, D, ?, LoadBalance<Balanced_>> loadBalance(
          QuadFunction<A, B, C, D, Balanced_> balancedItemFunction,
          ToLongQuadFunction<A, B, C, D> loadFunction,
