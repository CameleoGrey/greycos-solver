 ...
 * @param unassignedValueCount How many values aren't in any list variable, assuming unassigned
 *     values aren't allowed. Otherwise zero.
 * @param notInAnyListValueCount How many values aren't in any list variable, regardless of whether
 *     unassigned values are allowed.
 */
public record SolutionInitializationStatistics(
    int genuineEntityCount,
    int shadowEntityCount,
    int uninitializedEntityCount,
