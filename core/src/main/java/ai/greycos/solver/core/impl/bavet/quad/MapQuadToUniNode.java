...
import ai.greycos.solver.core.impl.bavet.common.AbstractMapNode;
...
public final class MapQuadToUniNode<A, B, C, D, NewA>
  ...
  protected UniTuple<NewA> map(QuadTuple<A, B, C, D> tuple) {
    ...
    C factC = tuple.factC;
    D factD = tuple.factD;
    return new UniTuple<>(mappingFunction.apply(factA, factB, factC, factD), outputStoreSize);
  }
