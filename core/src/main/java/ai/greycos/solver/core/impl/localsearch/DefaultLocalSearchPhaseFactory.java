...
import ai.greycos.solver.core.impl.neighborhood.NeighborhoodsMoveSelector;
...
public class DefaultLocalSearchPhaseFactory<Solution_>
  ...
  private LocalSearchDecider<Solution_> buildMoveSelectorBasedDecider(
  ...
  private LocalSearchDecider<Solution_> buildNeighborhoodsBasedDecider(
    ...
    if (moveSelectorConfig == null) {
      ...
      moveSelector =
          moveSelectorFactory.buildMoveSelector(
              configPolicy, defaultCacheType, defaultSelectionOrder, true);
    }
    return moveSelector;
  }
