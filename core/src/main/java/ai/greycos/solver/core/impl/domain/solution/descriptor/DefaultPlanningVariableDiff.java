...
@NullMarked
record DefaultPlanningVariableDiff<Solution_, Entity_, Value_>(
    PlanningEntityDiff<Solution_, Entity_> entityDiff,
    VariableMetaModel<Solution_, Entity_, Value_> variableMetaModel,
    Value_ oldValue,
    Value_ newValue)
    implements PlanningVariableDiff<Solution_, Entity_, Value_> {
  ...
  public String toString() {
    return """
                ...
                """
        .formatted(
            variableMetaModel instanceof GenuineVariableMetaModel<Solution_, Entity_, Value_>
                ? "genuine"
                : "shadow",
            variableMetaModel.name(),
            entityDiff.entity(),
            entityDiff.entityMetaModel().type(),
            oldValue,
            newValue);
  }
