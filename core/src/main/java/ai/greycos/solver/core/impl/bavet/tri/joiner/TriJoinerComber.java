package ai.greycos.solver.core.impl.bavet.tri.joiner;
...
public final class TriJoinerComber<A, B, C> {
  ...
  private static <A, B, C> TriPredicate<A, B, C> mergeFiltering(
      List<TriPredicate<A, B, C>> filteringList) {
  ...
  public TriJoinerComber(
      DefaultTriJoiner<A, B, C> mergedJoiner, TriPredicate<A, B, C> mergedFiltering) {
