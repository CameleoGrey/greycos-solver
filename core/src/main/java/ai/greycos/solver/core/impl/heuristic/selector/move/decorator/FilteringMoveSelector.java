...
public final class FilteringMoveSelector<Solution_> extends AbstractMoveSelector<Solution_> {
  ...
  public static <Solution_> FilteringMoveSelector<Solution_> of(
      MoveSelector<Solution_> moveSelector, SelectionFilter<Solution_, Move<Solution_>> filter) {
    if (moveSelector instanceof FilteringMoveSelector<Solution_> filteringMoveSelector) {
      return new FilteringMoveSelector<>(
  ...
  public Iterator<Move<Solution_>> iterator() {
    return new JustInTimeFilteringMoveIterator(
        childMoveSelector.iterator(), determineBailOutSize(), phaseScope);
  }
  ...
  private class JustInTimeFilteringMoveIterator extends UpcomingSelectionIterator<Move<Solution_>> {
    ...
    public JustInTimeFilteringMoveIterator(
        Iterator<Move<Solution_>> childMoveIterator,
        long bailOutSize,
    ...
    protected Move<Solution_> createUpcomingSelection() {
      ...
      do {
        ...
        if (bailOutEnabled) {
          // if childMoveIterator is neverEnding and nothing is accepted, bail out of the infinite
          // loop
