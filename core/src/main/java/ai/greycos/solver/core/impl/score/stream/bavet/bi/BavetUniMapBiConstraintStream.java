...
import ai.greycos.solver.core.impl.bavet.bi.MapBiToUniNode;
...
final class BavetUniMapBiConstraintStream<Solution_, A, B, NewA>
  ...
  public BavetUniMapBiConstraintStream(
      BavetConstraintFactory<Solution_> constraintFactory,
      BavetAbstractBiConstraintStream<Solution_, A, B> parent,
      BiFunction<A, B, NewA> mappingFunction) {
  ...
  public boolean equals(Object object) {
    ...
    BavetUniMapBiConstraintStream<?, ?, ?, ?> that =
        (BavetUniMapBiConstraintStream<?, ?, ?, ?>) object;
