...
public final class DefaultScoreExplanation<Solution_, Score_ extends Score<Score_>>
  ...
  private final AtomicReference<String> summary =
      new AtomicReference<>(); // Will be calculated lazily.

  public static <Score_ extends Score<Score_>> String explainScore(
    ...
    return explainScore(
        ...
        DEFAULT_SCORE_EXPLANATION_INDICTMENT_LIMIT,
        DEFAULT_SCORE_EXPLANATION_CONSTRAINT_MATCH_LIMIT);
  }
  ...
  public static <Score_ extends Score<Score_>> String explainScore(
    ...
    scoreExplanation.append(
        """
            ...
            .formatted(
                workingScore,
                workingScore.isFullyAssigned() ? "" : " for an uninitialized solution"));

    Comparator<ConstraintMatchTotal<Score_>> constraintMatchTotalComparator =
        comparing(ConstraintMatchTotal::getScore);
    Comparator<ConstraintMatch<Score_>> constraintMatchComparator =
            ...
            constraintMatchTotal -> {
              ...
              scoreExplanation.append(
                  """
                            ...
                            """
                      .formatted(
                          constraintMatchTotal.getScore().toShortString(),
    ...
    Comparator<ConstraintMatch<Score_>> constraintMatchScoreComparator =
        comparing(ConstraintMatch::getScore);
            ...
            indictment -> {
              ...
              scoreExplanation.append(
                  """
                            ...
                            """
                      .formatted(
                          indictment.getScore().toShortString(),
                          indictment.getIndictedObject(),
                          constraintMatchSet.size()));
              constraintMatchSet.stream()
  ...
  public DefaultScoreExplanation(
      Solution_ solution,
    ...
    this.constraintJustificationList =
        workingConstraintJustificationList.isEmpty()
            ? Collections.emptyList()
            : workingConstraintJustificationList;
  ...
  public @NonNull String getSummary() {
    return summary.updateAndGet(
        currentSummary ->
            Objects.requireNonNullElseGet(
                currentSummary,
                () ->
                    explainScore(
                        innerScore, constraintMatchTotalMap.values(), indictmentMap.values())));
  }
