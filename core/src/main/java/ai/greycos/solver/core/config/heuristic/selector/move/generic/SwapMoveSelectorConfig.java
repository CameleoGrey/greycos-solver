...
public class SwapMoveSelectorConfig extends MoveSelectorConfig<SwapMoveSelectorConfig>
  ...
  public void setSecondaryEntitySelectorConfig(
  ...
  public @NonNull SwapMoveSelectorConfig withEntitySelectorConfig(
      @NonNull EntitySelectorConfig entitySelectorConfig) {
    this.setEntitySelectorConfig(entitySelectorConfig);
    return this;
  }

  public @NonNull SwapMoveSelectorConfig withSecondaryEntitySelectorConfig(
      @NonNull EntitySelectorConfig secondaryEntitySelectorConfig) {
    this.setSecondaryEntitySelectorConfig(secondaryEntitySelectorConfig);
    return this;
  }

  public @NonNull SwapMoveSelectorConfig withVariableNameIncludes(
  ...
  public boolean hasNearbySelectionConfig() {
    return (entitySelectorConfig != null && entitySelectorConfig.hasNearbySelectionConfig())
        || (secondaryEntitySelectorConfig != null
            && secondaryEntitySelectorConfig.hasNearbySelectionConfig());
  }
