...
/**
 * Decides the order of a {@link List} of selection (which is a {@link PlanningEntity}, a
...
public interface SelectionSorter<Solution_, T> {
   ...
   * @param selectionList never null, a {@link List} of {@link PlanningEntity}, planningValue,
   *     {@link Move} or {@link Selector} that will be sorted.
   */
