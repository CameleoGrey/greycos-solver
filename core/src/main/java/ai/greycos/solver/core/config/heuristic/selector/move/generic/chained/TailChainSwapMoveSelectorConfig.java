package ai.greycos.solver.core.config.heuristic.selector.move.generic.chained;
...
import ai.greycos.solver.core.config.heuristic.selector.move.NearbyUtil;
...
public class TailChainSwapMoveSelectorConfig
  ...
  /**
   * Uses a valueSelector instead of a secondaryEntitySelector because the secondary entity might
   * not exist if the value is a buoy (= the last entity in a chain) and also because with nearby
   * selection, it's more important that the value is near (instead of the secondary entity).
   */
  ...
  public @NonNull TailChainSwapMoveSelectorConfig withEntitySelectorConfig(
      @NonNull EntitySelectorConfig entitySelectorConfig) {
    this.entitySelectorConfig = entitySelectorConfig;
    return this;
  }

  public @NonNull TailChainSwapMoveSelectorConfig withValueSelectorConfig(
  ...
  @Override
  public @NonNull TailChainSwapMoveSelectorConfig inherit(
      @NonNull TailChainSwapMoveSelectorConfig inheritedConfig) {
