 ...
 * ai.greycos.solver.core.preview.api.move.Move}, giving the user an option to override certain
 * methods which they should not. Specifically, the following methods must not be overridden by the
 * user, as suitable default implementations are provided:
 *
 * <ul>
 ...
 * @see AbstractMove
 */
public interface Move<Solution_> extends ai.greycos.solver.core.preview.api.move.Move<Solution_> {
