...
import ai.greycos.solver.core.impl.constructionheuristic.DefaultConstructionHeuristicPhase;
...
public final class RuinRecreateConstructionHeuristicPhaseBuilder<Solution_>
  ...
  public static <Solution_> RuinRecreateConstructionHeuristicPhaseBuilder<Solution_> create(
    ...
    var queuedEntityPlacerConfig =
        new QueuedEntityPlacerConfig().withEntitySelectorConfig(entitySelectorConfig);
    var constructionHeuristicConfig =
        new ConstructionHeuristicPhaseConfig().withEntityPlacerConfig(queuedEntityPlacerConfig);
  ...
  public static <Solution_> RuinRecreateConstructionHeuristicPhaseBuilder<Solution_> create(
    ...
    var builder =
        (RuinRecreateConstructionHeuristicPhaseBuilder<Solution_>)
            constructionHeuristicPhaseFactory.getBuilder(
                0,
                false,
                solverConfigPolicy,
  ...
  private final RuinRecreateConstructionHeuristicPhaseFactory<Solution_>
  ...
  public RuinRecreateConstructionHeuristicPhaseBuilder<Solution_> ensureThreadSafe(
    ...
    if (multithreaded && scoreDirector.isDerived()) {
      return new RuinRecreateConstructionHeuristicPhaseBuilder<>(
          ...
          constructionHeuristicPhaseFactory,
          phaseTermination,
          super.getEntityPlacer().copy(),
          constructionHeuristicPhaseFactory.buildDecider(configPolicy, phaseTermination));
    }
    return this;
  }

  public RuinRecreateConstructionHeuristicPhaseBuilder<Solution_> withElementsToRecreate(
      List<Object> elements) {
    this.elementsToRecreate = elements;
    return this;
  }

  public RuinRecreateConstructionHeuristicPhaseBuilder<Solution_> withElementsToRuin(
      Set<Object> elements) {
  ...
  public EntityPlacer<Solution_> getEntityPlacer() {
    ...
    return placer.rebuildWithFilter(
