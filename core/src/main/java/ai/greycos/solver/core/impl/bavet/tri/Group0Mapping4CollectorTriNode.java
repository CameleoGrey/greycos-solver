...
public final class Group0Mapping4CollectorTriNode<
        OldA,
        OldB,
        OldC,
        A,
    ...
    extends AbstractGroupTriNode<
        OldA, OldB, OldC, QuadTuple<A, B, C, D>, Void, Object, Quadruple<A, B, C, D>> {

  private final int outputStoreSize;

  public Group0Mapping4CollectorTriNode(
      int groupStoreIndex,
      int undoStoreIndex,
  ...
  static <
      ...
      TriConstraintCollector<OldA, OldB, OldC, Object, Quadruple<A, B, C, D>> mergeCollectors(
          ...
          TriConstraintCollector<OldA, OldB, OldC, ResultContainerC_, C> collectorC,
          TriConstraintCollector<OldA, OldB, OldC, ResultContainerD_, D> collectorD) {
    return (TriConstraintCollector<OldA, OldB, OldC, Object, Quadruple<A, B, C, D>>)
