...
/**
 * Describes the minimal amount of cycles a permutation can be expressed as and provide a mapping of
 * removed edge endpoint index to cycle identifier (where all indices that are in the same k-cycle
 * have the same identifier).
 *
 * @param cycleCount The total number of k-cycles in the permutation. This is one more than the
...
record KOptCycle(int cycleCount, int[] indexToCycleIdentifier) {
  ...
  public String toString() {
    var arrayString =
        IntStream.of(indexToCycleIdentifier)
            .sequential()
            .skip(1)
