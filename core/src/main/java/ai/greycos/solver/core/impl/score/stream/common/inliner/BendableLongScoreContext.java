...
final class BendableLongScoreContext
  ...
  public BendableLongScoreContext(
      BendableLongScoreInliner parent,
  ...
  public UndoScoreImpacter changeSoftScoreBy(
      long matchWeight, ConstraintMatchSupplier<BendableLongScore> constraintMatchSupplier) {
  ...
  public UndoScoreImpacter changeScoreBy(
    ...
    return impactWithConstraintMatch(
        undoScoreImpact, BendableLongScore.of(hardImpacts, softImpacts), constraintMatchSupplier);
  }
}
