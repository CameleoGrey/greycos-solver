    ...
    while (moveIterator.hasNext()) {
      ...
      if (!allowedNonDoableMove) {
        ...
        if (!MoveAdapters.isDoable(moveDirector, move)) {
          ...
          //      2/ ChangeMove for basic variable; move from null to null means "try to not assign
          // that value".
          //      3/ Technically also ChainedChangeMove, but chained doesn't support unassigned
          // values.
          ...
          // Note: CH will only ever see change moves, as its purpose is to assign a variable to a
          // value.
