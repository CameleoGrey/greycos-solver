...
public class ListSwapMoveDefinition<Solution_, Entity_, Value_>
  ...
  public MoveStream<Solution_> build(MoveStreamFactory<Solution_> moveStreamFactory) {
    ...
    if (planningIdGetter
      ...
      return moveStreamFactory
          ...
          .pick(assignedValueStream, EnumeratingJoiners.filtering(this::isValidSwap))
  ...
  private Move<Solution_> buildMove(
      ...
      FullElementPosition<Entity_, Value_> a,
  ...
  @NullMarked
  private record FullElementPosition<Entity_, Value_>(
      Value_ value,
      PositionInList elementPosition,
      @Nullable Function<Entity_, Comparable> planningIdGetter)
      implements Comparable<FullElementPosition<Entity_, Value_>> {
    ...
    public int compareTo(FullElementPosition<Entity_, Value_> o) {
      if (planningIdGetter == null) { // The code will not get here if the getter is null.
        throw new IllegalStateException(
            "Impossible state: The planningIdGetter is null, cannot compare entities.");
      }
      var entityComparison =
          planningIdGetter.apply(this.entity()).compareTo(planningIdGetter.apply(o.entity()));
