package ai.greycos.solver.core.impl.heuristic.selector.value.mimic;
...
public class MimicReplayingValueSelector<Solution_> extends AbstractDemandEnabledSelector<Solution_>
  ...
  public Iterator<Object> iterator(Object entity) {
    // Ignores the entity, but the constructor of this class guarantees that the valueRange is
    // entity independent
    ...
    public boolean hasNext() {
      if (!hasRecordingCreated) {
        throw new IllegalStateException(
            "Replay must occur after record."
                + " The recordingValueSelector ("
                + valueMimicRecorder
