...
import ai.greycos.solver.core.impl.domain.valuerange.AbstractUncountableValueRange;
...
/**
 * Note: Floating point numbers (float, double) cannot represent a decimal number correctly. If
 * floating point numbers leak into the scoring function, they are likely to cause score
 * corruptions. To avoid that, use either {@link java.math.BigDecimal} or fixed-point arithmetic.
 *
