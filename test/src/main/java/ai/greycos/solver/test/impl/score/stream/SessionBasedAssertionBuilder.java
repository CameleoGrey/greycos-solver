...
final class SessionBasedAssertionBuilder<Solution_, Score_ extends Score<Score_>> {
  ...
  public SessionBasedAssertionBuilder(
      AbstractConstraintStreamScoreDirectorFactory<Solution_, Score_, ?>
          constraintStreamScoreDirectorFactory) {
    this.constraintStreamScoreDirectorFactory =
        Objects.requireNonNull(constraintStreamScoreDirectorFactory);
  }
  ...
  public DefaultMultiConstraintAssertion<Solution_, Score_> multiConstraintGiven(
    ...
    return new DefaultMultiConstraintAssertion<>(
        constraintProvider,
        constraintStreamScoreDirectorFactory,
