...
/**
 * Use for unit-testing {@link ai.greycos.solver.core.api.solver.change.ProblemChange}s.
 *
 * <p>Together with Mockito this class makes it possible to verify that a {@link
 * ai.greycos.solver.core.api.solver.change.ProblemChange} implementation correctly calls methods of
...
public class MockProblemChangeDirector implements ProblemChangeDirector {
  ...
  @Override
  public <ProblemFact> void addProblemFact(
  ...
  @Override
  public <ProblemFact> void removeProblemFact(
      @NonNull ProblemFact problemFact, @NonNull Consumer<ProblemFact> problemFactConsumer) {
    problemFactConsumer.accept(lookUpWorkingObjectOrFail(problemFact));
  }

  @Override
  public <EntityOrProblemFact> void changeProblemProperty(
  ...
  /**
   * If the look-up result has been provided by a {@link #whenLookingUp(Object)} call, returns the
   * defined object. Otherwise, returns the original externalObject.
   *
   * @param externalObject entity or problem fact to look up
   */
  @Override
  public <EntityOrProblemFact> @Nullable EntityOrProblemFact lookUpWorkingObjectOrFail(
  ...
  /**
   * If the look-up result has been provided by a {@link #whenLookingUp(Object)} call, returns the
   * defined object. Otherwise, returns null.
   *
   * @param externalObject entity or problem fact to look up
   */
  @Override
  public <EntityOrProblemFact> Optional<EntityOrProblemFact> lookUpWorkingObject(
      @Nullable EntityOrProblemFact externalObject) {
