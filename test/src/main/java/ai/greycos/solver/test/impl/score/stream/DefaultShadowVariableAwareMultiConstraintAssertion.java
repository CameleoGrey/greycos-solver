...
import ai.greycos.solver.test.api.score.stream.MultiConstraintAssertion;
import ai.greycos.solver.test.api.score.stream.ShadowVariableAwareMultiConstraintAssertion;

public final class DefaultShadowVariableAwareMultiConstraintAssertion<
  ...
  DefaultShadowVariableAwareMultiConstraintAssertion(
