...
import ai.greycos.solver.core.api.solver.SolverManager;
import ai.greycos.solver.core.config.solver.SolverManagerConfig;
import ai.greycos.solver.spring.boot.autoconfigure.GreyCOSAutoConfiguration;
...
module org.acme.vehiclerouting {
    ...
    opens org.acme.vehiclerouting.domain to ai.greycos.solver.core; // Domain classes
    opens org.acme.vehiclerouting.solver to ai.greycos.solver.core; // Constraints
    ...
}
----
...
** Debug logging `ai.greycos.solver` can be between 0% and 15% slower than info logging. Trace logging can be between 5% and 70% slower than info logging.
