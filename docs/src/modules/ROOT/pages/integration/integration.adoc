...
which implies that when the solution is xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#cloningASolution[planning cloned], they need to be cloned too.
...
[NOTE]
====
GreyCOS Solver Spring Boot Starter only supports Spring Boot version 3.5.x.
====
