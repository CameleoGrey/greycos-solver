...
in the `ai.greycos.solver.core.preview.api.domain.solution.diff` package,
...
https://github.com/CameleoGrey/greycos-solver/discussions[Greycos Solver Github]
or to https://discord.com/channels/1413420192213631086/1414521616955605003[Greycos Discord]
