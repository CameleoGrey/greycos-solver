...
** `greycos.solver.core.api`
** `greycos.solver.benchmark.api`
** `greycos.solver.*.api`
** `greycos.solver.core.config`
** `greycos.solver.benchmark.config`
...
in the `greycos.solver.core.preview.api.cotwin.solution.diff` package and in the `SolutionManager`,
- Neighborhoods API.
