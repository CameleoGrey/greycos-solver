...
If both xref:using-greycos-solver/modeling-planning-problems.adoc#planningVariable[basic] and xref:using-greycos-solver/modeling-planning-problems.adoc#planningListVariable[list] variables are included in the model,
...
|"variableName"
|Refers to a variable (genuine or shadow) on the same planning entity. A planning list variable cannot be a source.
