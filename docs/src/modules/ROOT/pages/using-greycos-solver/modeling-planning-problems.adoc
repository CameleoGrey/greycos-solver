...
Explore our documentation and available models https://docs.greycos.ai/[here].
====
...
If the model uses a xref:using-greycos-solver/modeling-planning-problems#planningListVariable[list variable],
...
If both xref:using-greycos-solver/modeling-planning-problems.adoc#planningVariable[basic] and xref:using-greycos-solver/modeling-planning-problems#planningListVariable[list] variables are included in the model,
