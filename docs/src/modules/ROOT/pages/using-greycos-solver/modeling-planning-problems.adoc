...
GreyCOS Solver needs to map problem facts and planning entities to an ID.
...
xref:xref:using-greycos-solver/configuration.adoc.adoc#annotationAlternatives[Annotating the field] instead of the property works too:
...
This also helps reduce the overhead of the xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#cloningASolution[solution cloning],
...
If the model uses a xref:xref:using-greycos-solver/modeling-planning-problems.adoc#planningListVariable[list variable],
...
If both xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#planningVariable[basic] and xref:xref:using-greycos-solver/modeling-planning-problems.adoc#planningListVariable[list] variables are included in the model,
...
some can also be deduced automatically by GreyCOS Solver:
