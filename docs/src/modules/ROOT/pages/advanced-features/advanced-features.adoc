...
* <<multistageMoves,Multistage moves>>
...
----
    <unionMoveSelector>
      ...
      <subListChangeMoveSelector>
        <selectReversingMoveToo>true</selectReversingMoveToo</selectReversingMoveToo>
...
to back your choices by extensive xref:xref:using-greycos-solver/benchmarking-and-tweaking.adoc.adoc#benchmarker[benchmarking].
====
...
For a primer on multi-threaded solving in general, see xref:xref:using-greycos-solver/running-the-solver.adoc.adoc#multithreadedSolving[Multi-threaded solving].
...
by xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#planningId[adding a `@PlanningId` annotation]
...
[WARNING]
====
Models with xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#chainedPlanningVariable[chained variables] cannot apply the partitioned search method.
====
...
Also xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#planningId[add a `@PlanningId` annotation]
on every planning entity class and planning value class.
...
[IMPORTANT]
====
A xref:xref:using-greycos-solver/running-the-solver.adoc.adoc#logging[logging level] of `debug` or `trace` causes congestion in multi-threaded Partitioned Search
...
(so the xref:xref:using-greycos-solver/benchmarking-and-tweaking.adoc.adoc#benchmarker[Benchmarker] can tweak those parameters),
add the `solutionPartitionerCustomProperties` element and use xref:xref:using-greycos-solver/configuration.adoc.adoc#customPropertiesConfiguration[custom properties]:
...
[IMPORTANT]
====
The island model requires xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#planningId[`@PlanningId` annotations]
