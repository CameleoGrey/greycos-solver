...
also called xref:using-greycos-solver/modeling-planning-problems.adoc#planningVariable[basic variables].
...
if it doesn't apply on a xref:using-greycos-solver/modeling-planning-problems.adoc#chainedPlanningVariable[chained] variable.
...
This move selector only supports xref:optimization-algorithms/overview.adoc#cacheType[phase or solver caching]
if it doesn't apply on any xref:using-greycos-solver/modeling-planning-problems.adoc#chainedPlanningVariable[chained] variables.
...
If xref:using-greycos-solver/modeling-planning-problems.adoc#planningVariableAllowingUnassigned[unassigned values] are allowed,
...
We recommend that you xref:using-greycos-solver/benchmarking-and-tweaking.adoc#benchmarker[experiment with these values]
...
These moves are applicable to xref:using-greycos-solver/modeling-planning-problems.adoc#planningListVariable[list planning variables].
...
Then it runs a construction heuristic to assign them again.
If xref:using-greycos-solver/modeling-planning-problems.adoc#planningListVariableAllowingUnassigned[unassigned values] are allowed,
it may leave them unassigned.
...
These moves are applicable to xref:using-greycos-solver/modeling-planning-problems.adoc#chainedPlanningVariable[chained planning variable].
