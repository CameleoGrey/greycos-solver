...
also called xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#planningVariable[basic variables].
...
if it doesn't apply on a xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#chainedPlanningVariable[chained] variable.
...
This move selector only supports xref:optimization-algorithms/overview.adoc#cacheType[phase or solver caching]
if it doesn't apply on any xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#chainedPlanningVariable[chained] variables.
...
If xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#planningVariableAllowingUnassigned[unassigned values] are allowed,
...
[NOTE]
====
If xref:advanced-features/advanced-features.adoc#nearbySelection[nearby selection] is enabled,
...
We recommend that you xref:xref:using-greycos-solver/benchmarking-and-tweaking.adoc.adoc#benchmarker[experiment with these values]
...
[NOTE]
====
This is an advanced feature of GreyCOS Solver.
See xref:advanced-features/advanced-features.adoc#multistageMoves[Multistage moves] for more information.
====
...
These moves are applicable to xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#planningListVariable[list planning variables].
...
Then it runs a construction heuristic to assign them again.
If xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#planningListVariableAllowingUnassigned[unassigned values] are allowed,
it may leave them unassigned.
...
These moves are applicable to xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#chainedPlanningVariable[chained planning variable].
...
and to work correctly with xref:advanced-features/advanced-features.adoc#nearbySelection[nearby selection]
