...
Requires the model
to support xref:using-greycos-solver/modeling-planning-problems.adoc#planningEntitySorting[planning entity sorting].
...
Requires the model
to support xref:using-greycos-solver/modeling-planning-problems.adoc#planningValueSorting[planning value sorting].
...
Requires the model
to support xref:using-greycos-solver/modeling-planning-problems.adoc#planningEntitySorting[planning entity sorting]
and xref:using-greycos-solver/modeling-planning-problems.adoc#planningValueSorting[planning value sorting].
...
Requires the model
to support xref:using-greycos-solver/modeling-planning-problems.adoc#planningEntitySorting[planning entity sorting].
* `DESCENDING_IF_AVAILABLE` (default): If the model supports xref:using-greycos-solver/modeling-planning-problems.adoc#planningEntitySorting[planning entity sorting], behave like ``DESCENDING``, else like ``NONE``.
...
Requires the model
to support xref:using-greycos-solver/modeling-planning-problems.adoc#planningValueSorting[planning value sorting].
* `ASCENDING_IF_AVAILABLE` (default): If the model supports xref:using-greycos-solver/modeling-planning-problems.adoc#planningValueSorting[planning value sorting], behave like ``ASCENDING``, else like ``NONE``.
* ``DESCENDING``: Evaluate the planning values in descending order based on a given metric.
Requires the model to support xref:using-greycos-solver/modeling-planning-problems.adoc#planningValueSorting[planning value sorting].
* ``DESCENDING_IF_AVAILABLE``: If the model supports xref:using-greycos-solver/modeling-planning-problems.adoc#planningValueSorting[planning value sorting], behave like ``DESCENDING``, else like ``NONE``.
...
The default behavior of the construction heuristic for xref:using-greycos-solver/modeling-planning-problems.adoc#mixedModels[mixed models] is
...
If the xref:using-greycos-solver/benchmarking-and-tweaking.adoc#benchmarker[Benchmarker] proves that this is not the case, there's a number of improvements that can be done:
...
Let the xref:using-greycos-solver/benchmarking-and-tweaking.adoc#benchmarker[Benchmarker] guide you.
====
