...
The GreyCOS Team <https://github.com/CameleoGrey/greycos-solver>
:doctype: book
:imagesdir: .
:title-logo-image: image:shared/GreyCOS_logo_no_background.png[align="center"]
:toc: left
:toclevels: 3
:sectnums:
:sectanchors:
...
ifndef::backend-pdf[]
image::shared/greycos-solver-logo.png[align="center"]
endif::[]
