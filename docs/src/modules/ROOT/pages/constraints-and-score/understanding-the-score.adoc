...
For example, if your constraints penalize each vehicle, then there will be one `ai.greycos.solver.core.api.score.constraint.Indictment` instance per vehicle, carrying the vehicle as an indicted object.
