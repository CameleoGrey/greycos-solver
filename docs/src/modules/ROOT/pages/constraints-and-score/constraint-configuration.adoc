...
The field will be automatically exposed as a xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#problemFacts[problem fact],
...
* You use GreyCOS Solver's xref:integration/integration.adoc#integrationWithQuarkus[Quarkus integration],
* you use GreyCOS Solver's xref:integration/integration.adoc#integrationWithSpringBoot[Spring Boot integration],
* or you directly included the `greycos-solver-jackson` module in your project.
...
This will expose the `ConstraintParameters` as a xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#problemFacts[problem fact],
...
[NOTE]
====
This feature is deprecated and will be removed in a future release of GreyCOS Solver.
...
as a xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#problemFacts[problem fact],
there is no need to add a `@ProblemFactProperty` annotation.
...
The type of the constraint weights must be the same score class as xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#scoreOfASolution[the planning solution's score member].
