...
The field will be automatically exposed as a xref:using-greycos-solver/modeling-planning-problems.adoc#problemFacts[problem fact],
...
This will expose the `ConstraintParameters` as a xref:using-greycos-solver/modeling-planning-problems.adoc#problemFacts[problem fact],
...
as a xref:using-greycos-solver/modeling-planning-problems.adoc#problemFacts[problem fact],
there is no need to add a `@ProblemFactProperty` annotation.
...
The type of the constraint weights must be the same score class as xref:using-greycos-solver/modeling-planning-problems.adoc#scoreOfASolution[the planning solution's score member].
