...
GreyCOS Solver uses the variable type to connect to a xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#planningValueRangeProvider[value range provider]
