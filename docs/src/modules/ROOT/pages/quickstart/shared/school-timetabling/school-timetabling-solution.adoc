...
by matching the type of the planning variable with the type returned by the xref:xref:using-greycos-solver/modeling-planning-problems.adoc.adoc#planningValueRangeProvider[value range provider].
