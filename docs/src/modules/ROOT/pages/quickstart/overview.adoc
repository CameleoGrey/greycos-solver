...
We also provide off-the-shelf models to solve common planning problems. https://github.com/CameleoGrey/greycos-solver[These can be found here.]
====

Each _quick start guide_ gets you up and running with GreyCOS Solver quickly.
...
** Build a simple Java or Kotlin application that uses GreyCOS Solver to optimize a school timetable for students and teachers.
* xref:quickstart/quarkus/quarkus-quickstart.adoc#quarkusQuickStart[*Quarkus*]
** Build a REST application with Java or Kotlin that uses GreyCOS Solver to optimize a school timetable for students and teachers.
...
All three quick starts use GreyCOS Solver to optimize a school timetable for student and teachers:

IMPORTANT: The https://github.com/CameleoGrey/greycos-quickstarts[greycos-quickstarts] repository contains the source code for all these guides and more.
...
For other use cases,
take a look at https://github.com/CameleoGrey/greycos-quickstarts[the `greycos-quickstarts` Github repository].
