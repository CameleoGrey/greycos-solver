...
Because GreyCOS Solver changes this field, `Vehicle` is a xref:using-greycos-solver/modeling-planning-problems.adoc#planningEntity[_planning entity_]:
...
To ensure that GreyCOS Solver recognizes it as a xref:using-greycos-solver/modeling-planning-problems.adoc#planningListVariable[sequence of connected variables],
...
but no genuine variables and is called a xref:using-greycos-solver/modeling-planning-problems.adoc#shadowVariable[shadow entity].
...
They are called xref:using-greycos-solver/modeling-planning-problems.adoc#shadowVariable[shadow variables],
and because GreyCOS Solver changes them,
`Visit` is a xref:using-greycos-solver/modeling-planning-problems.adoc#planningEntity[_planning entity_]:
