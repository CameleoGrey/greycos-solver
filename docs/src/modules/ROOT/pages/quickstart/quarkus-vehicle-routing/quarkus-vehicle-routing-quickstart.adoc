...
with https://quarkus.io/[Quarkus] and https://greycos.ai[Greycos]'s constraint solving Artificial Intelligence (AI).

[TIP]
====
https://docs.greycos.ai/field-service-routing/latest/introduction[Check out our off-the-shelf model for Field Service Routing] (REST API)
====
...
Congratulations!
You have just developed a Quarkus application with https://greycos.ai[Greycos]!
