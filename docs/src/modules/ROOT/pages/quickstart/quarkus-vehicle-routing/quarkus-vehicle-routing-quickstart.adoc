...
Use https://code.quarkus.io/?a=greycos-solver-quickstart&j=17&e=rest&e=rest-jackson&e=greycos.solver%3Agreycos-solver-quarkus-jackson&e=greycos.solver%3Agreycos-solver-quarkus[code.quarkus.io] to generate an application
