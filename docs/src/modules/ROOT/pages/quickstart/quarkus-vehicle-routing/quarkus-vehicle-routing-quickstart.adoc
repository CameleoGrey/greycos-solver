...
Use https://code.quarkus.io/?a=greycos-solver-quickstart&j=17&e=rest&e=rest-jackson&e=io.github.cameleogrey%3Agreycos-solver-quarkus-jackson&e=io.github.cameleogrey%3Agreycos-solver-quarkus[code.quarkus.io] to generate an application
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <properties>
    ...
    <version.greycos.solver>{greycos-solver-version}</version.greycos.solver>
  </properties>
  ...
  <dependencyManagement>
    <dependencies>
      ...
      <dependency>
        ...
        <version>${version.greycos.solver}</version>
        <type>pom</type>
        <scope>import</scope>
      </dependency>
    </dependencies>
...
[source,properties]
----
quarkus.log.category."greycos.solver".level=debug
----
