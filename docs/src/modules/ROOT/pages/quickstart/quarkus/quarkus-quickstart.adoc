...
with https://github.com/CameleoGrey/greycos-solver[GreyCOS]'s constraint solving Artificial Intelligence (AI).
...
----
    ...
    <dependency>
      ...
      <version>{greycos-solver-version}</version>
      <scope>test</scope>
    </dependency>
----
--
...
----
    ...
    testImplementation "ai.greycos.solver:greycos-solver-test:{greycos-solver-version}"
----
--
====
...
- Check out more information about GreyCOS's integration with Quarkus in our xref:../integration/integration.adoc#integrationWithQuarkus[Integration documentation].
