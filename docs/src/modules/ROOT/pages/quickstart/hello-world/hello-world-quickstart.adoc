...
* A xref:using-greycos-solver/running-the-solver.adoc#logging[logging] implementation, such as `logback-classic` (runtime scope), to see what Greycos Solver is doing.
...
Congratulations!
You have just developed a Java or Kotlin application with https://greycos.ai[Greycos]!
