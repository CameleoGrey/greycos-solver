...
Greycos Solver Enterprise Edition is a commercial product that offers additional features,
...
Unlike Greycos Solver Community Edition, the Enterprise Edition is not open-source.
You are allowed to use Greycos Solver Enterprise Edition for evaluation and development.
Please https://greycos.ai/contact[contact Greycos]
to obtain the credentials necessary to start your evaluation.

TIP: Looking for quicker time-to-value?
Greycos offers https://docs.greycos.ai/[pre-built, fully tuned optimization models], no constraint building required.
Just plug into our API and start optimizing immediately.

For a high-level overview of the differences between Greycos offerings,
see https://greycos.ai/pricing[Greycos Pricing].
...
// =============================
// To switch from Greycos Solver Community Edition to Enterprise Edition,
// https://greycos.ai/contact[contact us first] to obtain an Enterprise License.
// This license is represented by a file named `greycos-solver-enterprise-license.pem`,
// which you can introduce to your project by one of the following methods:
//
// * Place the file in the user's home directory.
// * Store the path to the file in `GREYCOS_ENTERPRISE_LICENSE` system property.
...
<project>
  ...
  <repositories>
    <repository>
      <id>greycos-solver-enterprise</id>
      <name>Greycos Solver Enterprise Edition</name>
      <url>https://greycos.jfrog.io/artifactory/releases/</url>
    </repository>
  </repositories>
  ...
</project>
...
<settings>
  ...
  <servers>
    <server>
      <!-- Replace "my_username" and "my_password" with credentials obtained from a Greycos representative. -->
      <id>greycos-solver-enterprise</id>
...
repositories {
  mavenCentral()
  maven {
    url "https://greycos.jfrog.io/artifactory/releases/"
    credentials { // Replace "my_username" and "my_password" with credentials obtained from a Greycos representative.
...
|`ai.greycos.solver:greycos-solver-bom`
|`ai.greycos.solver.enterprise:greycos-solver-enterprise-bom`

|`ai.greycos.solver:greycos-solver-core`
|`ai.greycos.solver.enterprise:greycos-solver-enterprise-core`

|`ai.greycos.solver:greycos-solver-quarkus`
|`ai.greycos.solver.enterprise:greycos-solver-enterprise-quarkus`

|`ai.greycos.solver:greycos-solver-spring-boot-starter`
|`ai.greycos.solver.enterprise:greycos-solver-enterprise-spring-boot-starter`
|===
...
The following features are only available in Greycos Solver Enterprise Edition:
...
[NOTE]
====
This feature is a commercial feature of Greycos Solver Enterprise Edition.
...
Greycos Solver Enterprise Edition makes multi-threaded solving more powerful by introducing
...
----
...
import ai.greycos.solver.enterprise.core.api.ThrottlingBestSolutionEventConsumer;
