...
. *If there are multiple relationships (or fields), check for xref:using-greycos-solver/modeling-planning-problems.adoc#shadowVariable[shadow variables]*.
...
The other side will become an xref:using-greycos-solver/modeling-planning-problems.adoc#bidirectionalVariable[inverse relation shadow variable] later on.
...
xref:using-greycos-solver/modeling-planning-problems.adoc#planningListVariable[Planning list variable] is not a means of achieving a many-to-one relationship;
...
use a xref:using-greycos-solver/modeling-planning-problems.adoc#shadowVariable[shadow variable] to calculate the time.

This pattern is implemented using either the xref:using-greycos-solver/modeling-planning-problems.adoc#chainedPlanningVariable[chained planning variable]
or the xref:using-greycos-solver/modeling-planning-problems.adoc#planningListVariable[planning list variable].
...
Using the xref:using-greycos-solver/modeling-planning-problems.adoc#chainedPlanningVariable[chained planning variable], planning entities are arranged in a recursive data structure, forming a chain, that ends with an anchor.
...
The starting time of an entity is usually a xref:using-greycos-solver/modeling-planning-problems.adoc#shadowVariable[shadow variable].
...
GreyCOS Solver distributes planning values into planning entities’ xref:using-greycos-solver/modeling-planning-problems.adoc#planningListVariable[planning list variable].
...
It lasts 52 minutes, therefore her second task starts at 8:52.
The starting time of an element is usually a xref:using-greycos-solver/modeling-planning-problems.adoc#shadowVariable[shadow variable].
...
Implement the automatic collapse in the xref:using-greycos-solver/modeling-planning-problems.adoc#customVariableListener[custom variable listener]
...
Implement the automatic delay in the xref:using-greycos-solver/modeling-planning-problems.adoc#customVariableListener[custom variable listener]
